# 1 "./lib/main/CMSIS/CM4/DeviceSupport/ST/STM32F30x/stm32f30x_gpio.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/CMSIS/CM4/DeviceSupport/ST/STM32F30x/stm32f30x_gpio.c"
# 77 "./lib/main/CMSIS/CM4/DeviceSupport/ST/STM32F30x/stm32f30x_gpio.c"
...
# 78 "./lib/main/CMSIS/CM4/DeviceSupport/ST/STM32F30x/stm32f30x_gpio.c" 2
# 121 "./lib/main/CMSIS/CM4/DeviceSupport/ST/STM32F30x/stm32f30x_gpio.c"
void GPIO_DeInit(GPIO_TypeDef* GPIOx)
{

  ((void)0);

  if(GPIOx == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0000)))
  {
    RCC_AHBPeriphResetCmd(((uint32_t)0x00020000), ENABLE);
    RCC_AHBPeriphResetCmd(((uint32_t)0x00020000), DISABLE);
  }
  else if(GPIOx == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0400)))
  {
    RCC_AHBPeriphResetCmd(((uint32_t)0x00040000), ENABLE);
    RCC_AHBPeriphResetCmd(((uint32_t)0x00040000), DISABLE);
  }
  else if(GPIOx == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0800)))
  {
    RCC_AHBPeriphResetCmd(((uint32_t)0x00080000), ENABLE);
    RCC_AHBPeriphResetCmd(((uint32_t)0x00080000), DISABLE);
  }
  else if(GPIOx == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0C00)))
  {
    RCC_AHBPeriphResetCmd(((uint32_t)0x00100000), ENABLE);
    RCC_AHBPeriphResetCmd(((uint32_t)0x00100000), DISABLE);
  }
  else if(GPIOx == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x1000)))
  {
    RCC_AHBPeriphResetCmd(((uint32_t)0x00200000), ENABLE);
    RCC_AHBPeriphResetCmd(((uint32_t)0x00200000), DISABLE);
  }
  else
  {
    if(GPIOx == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x1400)))
    {
...
# 174 "./lib/main/CMSIS/CM4/DeviceSupport/ST/STM32F30x/stm32f30x_gpio.c"
void GPIO_Init(GPIO_TypeDef* GPIOx, GPIO_InitTypeDef* GPIO_InitStruct)
{
  ...
  for (pinpos = 0x00; pinpos < 0x10; pinpos++)
  {
    ...
    if (currentpin == pos)
    {
      ...
      tmpreg = GPIOx->PUPDR;
      tmpreg &= ~(((uint32_t)0x00000003) << ((uint16_t)pinpos * 2));
...
# 254 "./lib/main/CMSIS/CM4/DeviceSupport/ST/STM32F30x/stm32f30x_gpio.c"
void GPIO_PinLockConfig(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin)
{
...
# 300 "./lib/main/CMSIS/CM4/DeviceSupport/ST/STM32F30x/stm32f30x_gpio.c"
uint8_t GPIO_ReadInputDataBit(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin)
{
...
# 341 "./lib/main/CMSIS/CM4/DeviceSupport/ST/STM32F30x/stm32f30x_gpio.c"
uint8_t GPIO_ReadOutputDataBit(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin)
{
  uint8_t bitstatus = 0x00;
...
# 382 "./lib/main/CMSIS/CM4/DeviceSupport/ST/STM32F30x/stm32f30x_gpio.c"
void GPIO_SetBits(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin)
{
...
# 400 "./lib/main/CMSIS/CM4/DeviceSupport/ST/STM32F30x/stm32f30x_gpio.c"
void GPIO_ResetBits(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin)
{
...
# 422 "./lib/main/CMSIS/CM4/DeviceSupport/ST/STM32F30x/stm32f30x_gpio.c"
void GPIO_WriteBit(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin, BitAction BitVal)
{
...
# 446 "./lib/main/CMSIS/CM4/DeviceSupport/ST/STM32F30x/stm32f30x_gpio.c"
void GPIO_Write(GPIO_TypeDef* GPIOx, uint16_t PortVal)
{
...
# 503 "./lib/main/CMSIS/CM4/DeviceSupport/ST/STM32F30x/stm32f30x_gpio.c"
void GPIO_PinAFConfig(GPIO_TypeDef* GPIOx, uint16_t GPIO_PinSource, uint8_t GPIO_AF)
{
  uint32_t temp = 0x00;
