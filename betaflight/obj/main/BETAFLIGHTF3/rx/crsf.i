...
# 45 "./src/main/rx/crsf.c" 2
# 54 "./src/main/rx/crsf.c"
static 
# 54 "./src/main/rx/crsf.c" 3 4
                  _Bool 
# 54 "./src/main/rx/crsf.c"
                       crsfFrameDone = 
# 54 "./src/main/rx/crsf.c" 3 4
...
static void crsfDataReceive(uint16_t c, void *data)
{
    ...
    if (currentTimeUs > crsfFrameStartAtUs + 1100) {
    ...
    if (crsfFramePosition < fullFrameLength) {
        ...
        crsfFrameDone = crsfFramePosition < fullFrameLength ? 
# 149 "./src/main/rx/crsf.c" 3 4
                                                             0 
# 149 "./src/main/rx/crsf.c"
                                                                   : 
# 149 "./src/main/rx/crsf.c" 3 4
                                                                     1
# 149 "./src/main/rx/crsf.c"
...
static uint8_t crsfFrameStatus(rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    if (crsfFrameDone) {
        crsfFrameDone = 
# 183 "./src/main/rx/crsf.c" 3 4
                       0
# 183 "./src/main/rx/crsf.c"
                            ;
        if (crsfFrame.frame.type == CRSF_FRAMETYPE_RC_CHANNELS_PACKED) {
...
# 244 "./src/main/rx/crsf.c" 3 4
_Bool 
# 244 "./src/main/rx/crsf.c"
    crsfRxInit(const rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    rxRuntimeConfig->rxRefreshRate = 6667;
    ...
    if (!portConfig) {
        return 
# 258 "./src/main/rx/crsf.c" 3 4
              0
# 258 "./src/main/rx/crsf.c"
                   ;
    }
...
# 264 "./src/main/rx/crsf.c" 3 4
       ((void *)0)
# 264 "./src/main/rx/crsf.c"
           ,
        420000,
        MODE_RXTX,
        (SERIAL_STOPBITS_1 | SERIAL_PARITY_NO) | (rxConfig->serialrx_inverted ? SERIAL_INVERTED : 0)
        );

    return serialPort != 
# 270 "./src/main/rx/crsf.c" 3 4
                        ((void *)0)
# 270 "./src/main/rx/crsf.c"
                            ;
}


# 273 "./src/main/rx/crsf.c" 3 4
_Bool 
# 273 "./src/main/rx/crsf.c"
    crsfRxIsActive(void)
{
    return serialPort != 
# 275 "./src/main/rx/crsf.c" 3 4
                        ((void *)0)
# 275 "./src/main/rx/crsf.c"
                            ;
}
