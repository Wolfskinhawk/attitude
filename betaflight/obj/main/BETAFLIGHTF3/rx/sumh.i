...
# 44 "./src/main/rx/sumh.c" 2
# 52 "./src/main/rx/sumh.c"
static 
# 52 "./src/main/rx/sumh.c" 3 4
      _Bool 
# 52 "./src/main/rx/sumh.c"
           sumhFrameDone = 
# 52 "./src/main/rx/sumh.c" 3 4
...
static uint8_t sumhFrame[21];
static uint32_t sumhChannels[8];
...
static void sumhDataReceive(uint16_t c, void *data)
{
    ...
    if (sumhFramePosition == 21 - 1) {

        sumhFrameDone = 
# 79 "./src/main/rx/sumh.c" 3 4
                       1
# 79 "./src/main/rx/sumh.c"
                           ;
    } else {
        sumhFramePosition++;
    }
...
static uint8_t sumhFrameStatus(rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    sumhFrameDone = 
# 95 "./src/main/rx/sumh.c" 3 4
                   0
# 95 "./src/main/rx/sumh.c"
                        ;

    if (!((sumhFrame[0] == 0xA8) && (sumhFrame[21 - 2] == 0))) {
        return RX_FRAME_PENDING;
    }
...
# 119 "./src/main/rx/sumh.c" 3 4
_Bool 
# 119 "./src/main/rx/sumh.c"
    sumhInit(const rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig)
{
    (void)(rxConfig);
    ...
    if (!portConfig) {
        return 
# 131 "./src/main/rx/sumh.c" 3 4
              0
# 131 "./src/main/rx/sumh.c"
                   ;
    }


    
# 135 "./src/main/rx/sumh.c" 3 4
   _Bool 
# 135 "./src/main/rx/sumh.c"
        portShared = telemetryCheckRxPortShared(portConfig);




    sumhPort = openSerialPort(portConfig->identifier, FUNCTION_RX_SERIAL, sumhDataReceive, 
# 140 "./src/main/rx/sumh.c" 3 4
                                                                                          ((void *)0)
# 140 "./src/main/rx/sumh.c"
                                                                                              , 115200, portShared ? MODE_RXTX : MODE_RX, (rxConfig->serialrx_inverted ? SERIAL_INVERTED : 0));
    ...
    return sumhPort != 
# 148 "./src/main/rx/sumh.c" 3 4
                      ((void *)0)
# 148 "./src/main/rx/sumh.c"
                          ;
}
