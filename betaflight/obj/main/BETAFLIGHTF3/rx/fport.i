...
# 42 "./src/main/rx/fport.c" 2
# 1 "./src/main/rx/sbus_channels.h" 1
# 18 "./src/main/rx/sbus_channels.h"
       
# 27 "./src/main/rx/sbus_channels.h"
...
# 44 "./src/main/rx/fport.c" 2
# 63 "./src/main/rx/fport.c"
enum {
...
enum {
    FPORT_FRAME_ID_NULL = 0x00,
    FPORT_FRAME_ID_DATA = 0x10,
    FPORT_FRAME_ID_READ = 0x30,
    FPORT_FRAME_ID_WRITE = 0x31,
    FPORT_FRAME_ID_RESPONSE = 0x32,
};
...
# 121 "./src/main/rx/fport.c"
typedef struct fportBuffer_s {
    uint8_t data[(sizeof(fportFrame_t) + 2 * sizeof(uint8_t))];
    uint8_t length;
} fportBuffer_t;

static fportBuffer_t rxBuffer[3];
...
static volatile 
# 132 "./src/main/rx/fport.c" 3 4
               _Bool 
# 132 "./src/main/rx/fport.c"
                    clearToSend = 
# 132 "./src/main/rx/fport.c" 3 4
                                  0
# 132 "./src/main/rx/fport.c"
...
static smartPortPayload_t *mspPayload = 
# 136 "./src/main/rx/fport.c" 3 4
                                       ((void *)0)
# 136 "./src/main/rx/fport.c"
                                           ;
static timeUs_t lastRcFrameReceivedMs = 0;

static serialPort_t *fportPort;
static 
# 140 "./src/main/rx/fport.c" 3 4
      _Bool 
# 140 "./src/main/rx/fport.c"
           telemetryEnabled = 
# 140 "./src/main/rx/fport.c" 3 4
                              0
# 140 "./src/main/rx/fport.c"
...
static void reportFrameError(uint8_t errorReason) {
    ...
    {if (debugMode == (DEBUG_FPORT)) {debug[(DEBUG_FPORT_FRAME_ERRORS)] = (++frameErrors);}};
    {if (debugMode == (DEBUG_FPORT)) {debug[(DEBUG_FPORT_FRAME_LAST_ERROR)] = (errorReason);}};
}
...
static void fportDataReceive(uint16_t c, void *data)
{
    ...
    static 
# 155 "./src/main/rx/fport.c" 3 4
          _Bool 
# 155 "./src/main/rx/fport.c"
               escapedCharacter = 
# 155 "./src/main/rx/fport.c" 3 4
                                  0
# 155 "./src/main/rx/fport.c"
    ...
    static 
# 157 "./src/main/rx/fport.c" 3 4
          _Bool 
# 157 "./src/main/rx/fport.c"
               telemetryFrame = 
# 157 "./src/main/rx/fport.c" 3 4
                                0
# 157 "./src/main/rx/fport.c"
    ...
    clearToSend = 
# 161 "./src/main/rx/fport.c" 3 4
                 0
# 161 "./src/main/rx/fport.c"
                      ;

    if (framePosition > 1 && cmpTimeUs(currentTimeUs, frameStartAt) > 3000 + 500) {
    ...
    if (val == 0x7E) {
        if (framePosition > 1) {
            const uint8_t nextWriteIndex = (rxBufferWriteIndex + 1) % 3;
            ...
            if (telemetryFrame) {
                clearToSend = 
# 180 "./src/main/rx/fport.c" 3 4
                             1
# 180 "./src/main/rx/fport.c"
                                 ;
                lastTelemetryFrameReceivedUs = currentTimeUs;
                telemetryFrame = 
# 182 "./src/main/rx/fport.c" 3 4
                                0
# 182 "./src/main/rx/fport.c"
                                     ;
            }

            {if (debugMode == (DEBUG_FPORT)) {debug[(DEBUG_FPORT_FRAME_INTERVAL)] = (currentTimeUs - lastFrameReceivedUs);}};
            lastFrameReceivedUs = currentTimeUs;

            escapedCharacter = 
# 188 "./src/main/rx/fport.c" 3 4
                              0
# 188 "./src/main/rx/fport.c"
                                   ;
        }
        ...
        if (framePosition >= (sizeof(fportFrame_t) + 2 * sizeof(uint8_t)) + 1) {
                framePosition = 0;
            ...
            if (escapedCharacter) {
                val = val ^ 0x20;
                escapedCharacter = 
# 201 "./src/main/rx/fport.c" 3 4
                                  0
# 201 "./src/main/rx/fport.c"
                                       ;
            } else if (val == 0x7D) {
                escapedCharacter = 
# 203 "./src/main/rx/fport.c" 3 4
                                  1
# 203 "./src/main/rx/fport.c"
                                      ;
            ...
            if (framePosition == 2 && val == FPORT_FRAME_TYPE_TELEMETRY_REQUEST) {
                telemetryFrame = 
# 209 "./src/main/rx/fport.c" 3 4
                                1
# 209 "./src/main/rx/fport.c"
                                    ;
            }
...
static void smartPortWriteFrameFport(const smartPortPayload_t *payload)
{
    ...
    uint16_t checksum = 0;
    smartPortSendByte((sizeof(uint8_t) + sizeof(smartPortPayload_t)), &checksum, fportPort);
...
static 
# 230 "./src/main/rx/fport.c" 3 4
      _Bool 
# 230 "./src/main/rx/fport.c"
           checkChecksum(uint8_t *data, uint8_t length)
{
    uint16_t checksum = 0;
        ...
        if (frameLength != bufferLength - 2) {
            ...
            if (!checkChecksum(&rxBuffer[rxBufferReadIndex].data[0], bufferLength)) {
                ...
                case FPORT_FRAME_TYPE_CONTROL:
                    if (frameLength != (sizeof(uint8_t) + sizeof(fportControlData_t))) {
                ...
                case FPORT_FRAME_TYPE_TELEMETRY_REQUEST:
                    if (frameLength != (sizeof(uint8_t) + sizeof(smartPortPayload_t))) {
                        reportFrameError(DEBUG_FPORT_ERROR_TYPE_SIZE);
                    } else {
                        ...
                        mspPayload = 
# 281 "./src/main/rx/fport.c" 3 4
                                    ((void *)0)
# 281 "./src/main/rx/fport.c"
                                        ;
        ...
        rxBufferReadIndex = (rxBufferReadIndex + 1) % 3;
    }

    if (lastRcFrameReceivedMs && ((millis() - lastRcFrameReceivedMs) > 500)) {
...
static 
# 323 "./src/main/rx/fport.c" 3 4
      _Bool 
# 323 "./src/main/rx/fport.c"
           fportProcessFrame(const rxRuntimeConfig_t *rxRuntimeConfig)
{
    (void)(rxRuntimeConfig);

    
# 327 "./src/main/rx/fport.c" 3 4
   _Bool 
# 327 "./src/main/rx/fport.c"
        processingDone = 
# 327 "./src/main/rx/fport.c" 3 4
                         0
# 327 "./src/main/rx/fport.c"
    ...
    if (telemetryEnabled && clearToSend && cmpTimeUs(currentTimeUs, lastTelemetryFrameReceivedUs) >= 500) {
        if (cmpTimeUs(currentTimeUs, lastTelemetryFrameReceivedUs) > 2000) {
           clearToSend = 
# 333 "./src/main/rx/fport.c" 3 4
                        0
# 333 "./src/main/rx/fport.c"
                             ;
        }

        if (clearToSend) {
           {if (debugMode == (DEBUG_FPORT)) {debug[(DEBUG_FPORT_TELEMETRY_DELAY)] = (currentTimeUs - lastTelemetryFrameReceivedUs);}};

            processSmartPortTelemetry(mspPayload, &clearToSend, 
# 339 "./src/main/rx/fport.c" 3 4
                                                               ((void *)0)
# 339 "./src/main/rx/fport.c"
                                                                   );
            ...
            if (clearToSend) {
                ...
                clearToSend = 
# 344 "./src/main/rx/fport.c" 3 4
                             0
# 344 "./src/main/rx/fport.c"
                                  ;
            }
        }

        processingDone = 
# 348 "./src/main/rx/fport.c" 3 4
                        1
# 348 "./src/main/rx/fport.c"
                            ;
    }
...
# 357 "./src/main/rx/fport.c" 3 4
_Bool 
# 357 "./src/main/rx/fport.c"
    fportRxInit(const rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig)
{
    static uint16_t sbusChannelData[18];
    rxRuntimeConfig->channelData = sbusChannelData;
    sbusChannelsInit(rxConfig, rxRuntimeConfig);

    rxRuntimeConfig->channelCount = 18;
    ...
    if (!portConfig) {
        return 
# 371 "./src/main/rx/fport.c" 3 4
              0
# 371 "./src/main/rx/fport.c"
                   ;
    }
...
# 377 "./src/main/rx/fport.c" 3 4
       ((void *)0)
# 377 "./src/main/rx/fport.c"
           ,
        115200,
        MODE_RXTX,
        (SERIAL_STOPBITS_1 | SERIAL_PARITY_NO) | (rxConfig->serialrx_inverted ? SERIAL_INVERTED : 0) | (rxConfig->halfDuplex ? SERIAL_BIDIR : 0)
    );
    ...
    return fportPort != 
# 393 "./src/main/rx/fport.c" 3 4
                       ((void *)0)
# 393 "./src/main/rx/fport.c"
                           ;
}
