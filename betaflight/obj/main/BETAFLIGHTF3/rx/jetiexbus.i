...
# 55 "./src/main/rx/jetiexbus.c" 2
# 76 "./src/main/rx/jetiexbus.c"
...
static uint8_t jetiExBusChannelFrame[(6 + 16*2 + 2)];
uint8_t jetiExBusRequestFrame[9];

static uint16_t jetiExBusChannelData[16];
...
void jetiExBusFrameReset(void)
{
    ...
    jetiExBusFrameLength = (6 + 16*2 + 2);
}
# 148 "./src/main/rx/jetiexbus.c"
static void jetiExBusDataReceive(uint16_t c, void *data)
{
    ...
    if (jetiExBusFramePosition == 6) {

        if ((jetiExBusFrameState == EXBUS_STATE_IN_PROGRESS) && (jetiExBusFrame[EXBUS_HEADER_MSG_LEN] <= (6 + 16*2 + 2))) {
            jetiExBusFrameLength = jetiExBusFrame[EXBUS_HEADER_MSG_LEN];
            return;
        }

        if ((jetiExBusRequestState == EXBUS_STATE_IN_PROGRESS) && (jetiExBusFrame[EXBUS_HEADER_MSG_LEN] <= 9)) {
            jetiExBusFrameLength = jetiExBusFrame[EXBUS_HEADER_MSG_LEN];
            return;
        }
...
# 250 "./src/main/rx/jetiexbus.c" 3 4
_Bool 
# 250 "./src/main/rx/jetiexbus.c"
    jetiExBusInit(const rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig)
{
    (void)(rxConfig);
    ...
    if (!portConfig) {
        return 
# 265 "./src/main/rx/jetiexbus.c" 3 4
              0
# 265 "./src/main/rx/jetiexbus.c"
                   ;
    }
...
# 271 "./src/main/rx/jetiexbus.c" 3 4
       ((void *)0)
# 271 "./src/main/rx/jetiexbus.c"
           ,
        125000,
        MODE_RXTX,
    ...
    return jetiExBusPort != 
# 277 "./src/main/rx/jetiexbus.c" 3 4
                           ((void *)0)
# 277 "./src/main/rx/jetiexbus.c"
                               ;
}
