...
# 38 "./src/main/rx/xbus.c" 2
# 78 "./src/main/rx/xbus.c"
static 
# 78 "./src/main/rx/xbus.c" 3 4
      _Bool 
# 78 "./src/main/rx/xbus.c"
           xBusFrameReceived = 
# 78 "./src/main/rx/xbus.c" 3 4
...
# 78 "./src/main/rx/xbus.c"
                                    ;
static 
# 79 "./src/main/rx/xbus.c" 3 4
      _Bool 
# 79 "./src/main/rx/xbus.c"
           xBusDataIncoming = 
# 79 "./src/main/rx/xbus.c" 3 4
                              0
# 79 "./src/main/rx/xbus.c"
...
static volatile uint8_t xBusFrame[35];
static uint16_t xBusChannelData[12];
...
static void xBusUnpackModeBFrame(uint8_t offsetBytes)
{
    ...
    if (crc == inCrc) {
        ...
        for (int i = 0; i < xBusChannelCount; i++) {
            ...
            xBusChannelData[i] = (800 + ((value * 1400) >> 12));
        }

        xBusFrameReceived = 
# 132 "./src/main/rx/xbus.c" 3 4
                           1
# 132 "./src/main/rx/xbus.c"
                               ;
    }
}
...
static void xBusDataReceive(uint16_t c, void *data)
{
    ...
    xBusTimeLast = now;
    if (xBusTimeInterval > 8000) {
        xBusFramePosition = 0;
        xBusDataIncoming = 
# 197 "./src/main/rx/xbus.c" 3 4
                          0
# 197 "./src/main/rx/xbus.c"
                               ;
    }
    ...
    if (xBusFramePosition == 0) {
        if (c == (0xA1)) {
            xBusDataIncoming = 
# 203 "./src/main/rx/xbus.c" 3 4
                              1
# 203 "./src/main/rx/xbus.c"
                                  ;
            xBusFrameLength = 27;
        } else if (c == (0xA2)) {
            xBusDataIncoming = 
# 206 "./src/main/rx/xbus.c" 3 4
                              1
# 206 "./src/main/rx/xbus.c"
                                  ;
            xBusFrameLength = 35;
        }
    }
    ...
    if (xBusDataIncoming == 
# 212 "./src/main/rx/xbus.c" 3 4
                           1
# 212 "./src/main/rx/xbus.c"
                               ) {
    ...
    if (xBusFramePosition == xBusFrameLength) {
        ...
        xBusDataIncoming = 
# 227 "./src/main/rx/xbus.c" 3 4
                          0
# 227 "./src/main/rx/xbus.c"
                               ;
        xBusFramePosition = 0;
    }
}
...
static uint8_t xBusFrameStatus(rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    xBusFrameReceived = 
# 241 "./src/main/rx/xbus.c" 3 4
                       0
# 241 "./src/main/rx/xbus.c"
                            ;
...
# 260 "./src/main/rx/xbus.c" 3 4
_Bool 
# 260 "./src/main/rx/xbus.c"
    xBusInit(const rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig)
{
    uint32_t baudRate;
    ...
    case SERIALRX_XBUS_MODE_B:
        ...
        xBusFrameReceived = 
# 267 "./src/main/rx/xbus.c" 3 4
                           0
# 267 "./src/main/rx/xbus.c"
                                ;
        xBusDataIncoming = 
# 268 "./src/main/rx/xbus.c" 3 4
                          0
# 268 "./src/main/rx/xbus.c"
                               ;
        xBusFramePosition = 0;
        baudRate = 115200;
        xBusFrameLength = 27;
    ...
    case SERIALRX_XBUS_MODE_B_RJ01:
        rxRuntimeConfig->channelCount = 12;
        xBusFrameReceived = 
# 277 "./src/main/rx/xbus.c" 3 4
                           0
# 277 "./src/main/rx/xbus.c"
                                ;
        xBusDataIncoming = 
# 278 "./src/main/rx/xbus.c" 3 4
                          0
# 278 "./src/main/rx/xbus.c"
                               ;
        xBusFramePosition = 0;
        baudRate = 250000;
        xBusFrameLength = 33;
    ...
    default:
        return 
# 286 "./src/main/rx/xbus.c" 3 4
              0
# 286 "./src/main/rx/xbus.c"
                   ;
        break;
    }
    ...
    if (!portConfig) {
        return 
# 297 "./src/main/rx/xbus.c" 3 4
              0
# 297 "./src/main/rx/xbus.c"
                   ;
    }


    
# 301 "./src/main/rx/xbus.c" 3 4
   _Bool 
# 301 "./src/main/rx/xbus.c"
...
# 309 "./src/main/rx/xbus.c" 3 4
       ((void *)0)
# 309 "./src/main/rx/xbus.c"
           ,
        baudRate,
    ...
    return xBusPort != 
# 321 "./src/main/rx/xbus.c" 3 4
                      ((void *)0)
# 321 "./src/main/rx/xbus.c"
                          ;
}
