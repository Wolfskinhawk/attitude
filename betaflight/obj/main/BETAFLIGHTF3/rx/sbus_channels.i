...
# 20 "./src/main/rx/sbus_channels.c" 2
...
# 21 "./src/main/rx/sbus_channels.c" 2
...
# 23 "./src/main/rx/sbus_channels.c" 2
...
# 29 "./src/main/rx/sbus_channels.c" 2
...
# 30 "./src/main/rx/sbus_channels.c" 2
# 39 "./src/main/rx/sbus_channels.c"
uint8_t sbusChannelsDecode(rxRuntimeConfig_t *rxRuntimeConfig, const sbusChannels_t *channels)
{
    ...
    if (channels->flags & (1 << 0)) {
        sbusChannelData[16] = 1812;
    } else {
        sbusChannelData[16] = 173;
    }

    if (channels->flags & (1 << 1)) {
        sbusChannelData[17] = 1812;
    } else {
        sbusChannelData[17] = 173;
    }

    if (channels->flags & (1 << 2)) {
    }
    if (channels->flags & (1 << 3)) {
