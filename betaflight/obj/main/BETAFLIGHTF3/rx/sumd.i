...
# 50 "./src/main/rx/sumd.c"
static 
# 50 "./src/main/rx/sumd.c" 3 4
      _Bool 
# 50 "./src/main/rx/sumd.c"
           sumdFrameDone = 
# 50 "./src/main/rx/sumd.c" 3 4
...
# 50 "./src/main/rx/sumd.c"
                                ;
static uint16_t sumdChannels[16];
static uint16_t crc;

static uint8_t sumd[(16 * 2 + 5)] = { 0, };
...
static void sumdDataReceive(uint16_t c, void *data)
{
    ...
    if (sumdIndex == 0) {
        ...
        {
            sumdFrameDone = 
# 76 "./src/main/rx/sumd.c" 3 4
                           0
# 76 "./src/main/rx/sumd.c"
                                ;
            crc = 0;
        }
    }
    ...
    if (sumdIndex < sumdChannelCount * 2 + 4)
        ...
        if (sumdIndex == sumdChannelCount * 2 + 5) {
            sumdIndex = 0;
            sumdFrameDone = 
# 90 "./src/main/rx/sumd.c" 3 4
                           1
# 90 "./src/main/rx/sumd.c"
                               ;
        }
}
# 102 "./src/main/rx/sumd.c"
static uint8_t sumdFrameStatus(rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    sumdFrameDone = 
# 114 "./src/main/rx/sumd.c" 3 4
                   0
# 114 "./src/main/rx/sumd.c"
                        ;


    if (crc != ((sumd[2 * sumdChannelCount + 3] << 8) |
            (sumd[2 * sumdChannelCount + 4])))
        return frameStatus;
...
# 150 "./src/main/rx/sumd.c" 3 4
_Bool 
# 150 "./src/main/rx/sumd.c"
    sumdInit(const rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig)
{
    (void)(rxConfig);
    ...
    if (!portConfig) {
        return 
# 162 "./src/main/rx/sumd.c" 3 4
              0
# 162 "./src/main/rx/sumd.c"
                   ;
    }


    
# 166 "./src/main/rx/sumd.c" 3 4
   _Bool 
# 166 "./src/main/rx/sumd.c"
...
# 174 "./src/main/rx/sumd.c" 3 4
       ((void *)0)
# 174 "./src/main/rx/sumd.c"
           ,
        115200,
    ...
    return sumdPort != 
# 186 "./src/main/rx/sumd.c" 3 4
                      ((void *)0)
# 186 "./src/main/rx/sumd.c"
                          ;
}
