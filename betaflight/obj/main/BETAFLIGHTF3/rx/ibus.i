...
# 46 "./src/main/rx/ibus.c" 2
# 1 "./src/main/telemetry/ibus.h" 1
# 18 "./src/main/telemetry/ibus.h"
...
# 23 "./src/main/telemetry/ibus.h" 3 4
_Bool 
# 23 "./src/main/telemetry/ibus.h"
    checkIbusTelemetryState(void);

void configureIbusTelemetryPort(void);
void freeIbusTelemetryPort(void);
# 47 "./src/main/rx/ibus.c" 2
# 59 "./src/main/rx/ibus.c"
...
static 
# 66 "./src/main/rx/ibus.c" 3 4
      _Bool 
# 66 "./src/main/rx/ibus.c"
           ibusFrameDone = 
# 66 "./src/main/rx/ibus.c" 3 4
                           0
# 66 "./src/main/rx/ibus.c"
                                ;
static uint32_t ibusChannelData[14];

static uint8_t ibus[32] = { 0, };


static 
# 72 "./src/main/rx/ibus.c" 3 4
      _Bool 
# 72 "./src/main/rx/ibus.c"
           isValidIa6bIbusPacketLength(uint8_t length)
{
...
static void ibusDataReceive(uint16_t c, void *data)
{
    ...
    if (ibusFramePosition == ibusFrameSize - 1) {
        ibusFrameDone = 
# 120 "./src/main/rx/ibus.c" 3 4
                       1
# 120 "./src/main/rx/ibus.c"
                           ;
    } else {
        ibusFramePosition++;
    }
...
static 
# 127 "./src/main/rx/ibus.c" 3 4
      _Bool 
# 127 "./src/main/rx/ibus.c"
           isChecksumOkIa6(void)
{
    uint8_t offset;
    uint8_t i;
    ...
    for (i = 0, offset = ibusChannelOffset; i < 14; i++, offset += 2) {
...
static 
# 141 "./src/main/rx/ibus.c" 3 4
      _Bool 
# 141 "./src/main/rx/ibus.c"
           checksumIsOk(void) {
    if (ibusModel == 1 ) {
...
static uint8_t ibusFrameStatus(rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    ibusFrameDone = 
# 169 "./src/main/rx/ibus.c" 3 4
                   0
# 169 "./src/main/rx/ibus.c"
                        ;

    if (checksumIsOk()) {
        if (ibusModel == 1 || ibusSyncByte == 0x20) {
            updateChannelData();
...
# 195 "./src/main/rx/ibus.c" 3 4
_Bool 
# 195 "./src/main/rx/ibus.c"
    ibusInit(const rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig)
{
    (void)(rxConfig);
    ibusSyncByte = 0;

    rxRuntimeConfig->channelCount = 14;
    ...
    if (!portConfig) {
        return 
# 208 "./src/main/rx/ibus.c" 3 4
              0
# 208 "./src/main/rx/ibus.c"
                   ;
    }
...
# 213 "./src/main/rx/ibus.c" 3 4
   _Bool 
# 213 "./src/main/rx/ibus.c"
...
# 223 "./src/main/rx/ibus.c" 3 4
       ((void *)0)
# 223 "./src/main/rx/ibus.c"
           ,
        115200,
    ...
    return ibusPort != 
# 235 "./src/main/rx/ibus.c" 3 4
                      ((void *)0)
# 235 "./src/main/rx/ibus.c"
                          ;
}
