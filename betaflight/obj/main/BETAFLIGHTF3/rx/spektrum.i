# 1 "./src/main/rx/spektrum.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/rx/spektrum.c"
# 18 "./src/main/rx/spektrum.c"
...
# 21 "./src/main/drivers/light_led.h" 2
...
# 37 "./src/main/rx/spektrum.c" 2

# 1 "./src/main/io/spektrum_rssi.h" 1
# 28 "./src/main/io/spektrum_rssi.h"
...
# 39 "./src/main/rx/spektrum.c" 2
# 1 "./src/main/io/spektrum_vtx_control.h" 1
# 78 "./src/main/io/spektrum_vtx_control.h"
typedef struct
{
    uint8_t band;
    uint8_t channel;
...
# 47 "./src/main/rx/spektrum.c" 2




# 50 "./src/main/rx/spektrum.c" 3 4
_Bool 
# 50 "./src/main/rx/spektrum.c"
    srxlEnabled = 
# 50 "./src/main/rx/spektrum.c" 3 4
                  0
# 50 "./src/main/rx/spektrum.c"
...
static 
# 56 "./src/main/rx/spektrum.c" 3 4
      _Bool 
# 56 "./src/main/rx/spektrum.c"
           rcFrameComplete = 
# 56 "./src/main/rx/spektrum.c" 3 4
                             0
# 56 "./src/main/rx/spektrum.c"
                                  ;
static 
# 57 "./src/main/rx/spektrum.c" 3 4
      _Bool 
# 57 "./src/main/rx/spektrum.c"
           spekHiRes = 
# 57 "./src/main/rx/spektrum.c" 3 4
                       0
# 57 "./src/main/rx/spektrum.c"
...
static volatile uint8_t spekFrame[16];
...
static void spektrumDataReceive(uint16_t c, void *data)
{
    ...
    if (spekFramePosition < 16) {
        spekFrame[spekFramePosition++] = (uint8_t)c;
        if (spekFramePosition < 16) {
            rcFrameComplete = 
# 89 "./src/main/rx/spektrum.c" 3 4
                             0
# 89 "./src/main/rx/spektrum.c"
                                  ;
        } else {
            rcFrameComplete = 
# 91 "./src/main/rx/spektrum.c" 3 4
                             1
# 91 "./src/main/rx/spektrum.c"
                                 ;
        }
    }
}
...
static uint8_t spektrumFrameStatus(rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    rcFrameComplete = 
# 108 "./src/main/rx/spektrum.c" 3 4
                     0
# 108 "./src/main/rx/spektrum.c"
                          ;
    ...
    for (int b = 3; b < 16; b += 2) {
        ...
        if (spekChannel < rxRuntimeConfigPtr->channelCount && spekChannel < 12) {
    ...
    uint32_t vtxControl = ((spekFrame[(16 - 4)] << 24) |
                           (spekFrame[(16 - 3)] << 16) |
                           (spekFrame[(16 - 2)] << 8) |
                           (spekFrame[(16 - 1)] << 0) );
    ...
    if (srxlEnabled && telemetryBufLen && (spekFrame[2] & 0x80)) {
        dispatchAdd(&srxlTelemetryDispatch, 1000);
    }
...
# 164 "./src/main/rx/spektrum.c" 3 4
_Bool 
# 164 "./src/main/rx/spektrum.c"
    spekShouldBind(uint8_t spektrum_sat_bind)
{
    ...
    if (BindPlug) {
        ...
        IOConfigGPIO(BindPlug, ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_UP) << 5)));


        delayMicroseconds(10);
        if (IORead(BindPlug)) {
            return 
# 176 "./src/main/rx/spektrum.c" 3 4
                  0
# 176 "./src/main/rx/spektrum.c"
                       ;
        }
    }
...
void spektrumBind(rxConfig_t *rxConfig)
{
    ...
    if (rxConfig->spektrum_bind_pin_override_ioTag) {
        ...
        int index = (((portConfig->identifier) <= SERIAL_PORT_USART8) ? (portConfig->identifier) : (10 + ((portConfig->identifier) - SERIAL_PORT_SOFTSERIAL1)));
    ...
    IOConfigGPIO(bindIO, ((GPIO_Mode_OUT) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)));

    ledSet(1, 
# 239 "./src/main/rx/spektrum.c" 3 4
   1
# 239 "./src/main/rx/spektrum.c"
   );


    IOWrite(bindIO, 
# 242 "./src/main/rx/spektrum.c" 3 4
                   1
# 242 "./src/main/rx/spektrum.c"
                       );


    delay(60);
    ledSet(1, 
# 246 "./src/main/rx/spektrum.c" 3 4
   0
# 246 "./src/main/rx/spektrum.c"
   );

    for (int i = 0; i < rxConfig->spektrum_sat_bind; i++) {
        ledSet(0, 
# 249 "./src/main/rx/spektrum.c" 3 4
       0
# 249 "./src/main/rx/spektrum.c"
       );
        ledSet(2, 
# 250 "./src/main/rx/spektrum.c" 3 4
       0
# 250 "./src/main/rx/spektrum.c"
       );

        IOWrite(bindIO, 
# 252 "./src/main/rx/spektrum.c" 3 4
                       0
# 252 "./src/main/rx/spektrum.c"
                            );
        delayMicroseconds(120);

        ledSet(0, 
# 255 "./src/main/rx/spektrum.c" 3 4
       1
# 255 "./src/main/rx/spektrum.c"
       );
        ledSet(2, 
# 256 "./src/main/rx/spektrum.c" 3 4
       1
# 256 "./src/main/rx/spektrum.c"
       );

        IOWrite(bindIO, 
# 258 "./src/main/rx/spektrum.c" 3 4
                       1
# 258 "./src/main/rx/spektrum.c"
                           );
        delayMicroseconds(120);
    ...
    if (rxConfig->spektrum_bind_pin_override_ioTag) {
        delay(50);
        IOConfigGPIO(bindIO, ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
    }
...
# 284 "./src/main/rx/spektrum.c" 3 4
_Bool 
# 284 "./src/main/rx/spektrum.c"
    spektrumInit(const rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    if (!portConfig) {
        return 
# 290 "./src/main/rx/spektrum.c" 3 4
              0
# 290 "./src/main/rx/spektrum.c"
                   ;
    }

    srxlEnabled = 
# 293 "./src/main/rx/spektrum.c" 3 4
                 0
# 293 "./src/main/rx/spektrum.c"
                      ;

    
# 295 "./src/main/rx/spektrum.c" 3 4
   _Bool 
# 295 "./src/main/rx/spektrum.c"
        portShared = telemetryCheckRxPortShared(portConfig);
    ...
    case SERIALRX_SPEKTRUM2048:
        ...
        spek_chan_mask = 0x07;
        spekHiRes = 
# 310 "./src/main/rx/spektrum.c" 3 4
                   1
# 310 "./src/main/rx/spektrum.c"
                       ;
        resolution = 2048;
    ...
    case SERIALRX_SPEKTRUM1024:
        ...
        spek_chan_mask = 0x03;
        spekHiRes = 
# 319 "./src/main/rx/spektrum.c" 3 4
                   0
# 319 "./src/main/rx/spektrum.c"
                        ;
        resolution = 1024;
        rxRuntimeConfig->channelCount = 7;
...
# 332 "./src/main/rx/spektrum.c"
    ...
    return serialPort != 
# 352 "./src/main/rx/spektrum.c" 3 4
                        ((void *)0)
# 352 "./src/main/rx/spektrum.c"
                            ;
}
...
# 372 "./src/main/rx/spektrum.c" 3 4
_Bool 
# 372 "./src/main/rx/spektrum.c"
    srxlRxIsActive(void)
{
    return serialPort != 
# 374 "./src/main/rx/spektrum.c" 3 4
                        ((void *)0)
# 374 "./src/main/rx/spektrum.c"
                            ;
}
