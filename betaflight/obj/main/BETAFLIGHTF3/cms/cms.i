...
# 41 "./src/main/cms/cms.c" 2
# 1 "./src/main/cms/cms_menu_builtin.h" 1
# 18 "./src/main/cms/cms_menu_builtin.h"
...
# 21 "./src/main/cms/cms_menu_builtin.h" 2

extern CMS_Menu menuMain;
# 42 "./src/main/cms/cms.c" 2
...
static displayPort_t *cmsDisplayPorts[4];
static int cmsDeviceCount;
static int cmsCurrentDevice = -1;


# 80 "./src/main/cms/cms.c" 3 4
_Bool 
# 80 "./src/main/cms/cms.c"
    cmsDisplayPortRegister(displayPort_t *pDisplay)
{
    if (cmsDeviceCount == 4)
        return 
# 83 "./src/main/cms/cms.c" 3 4
              0
# 83 "./src/main/cms/cms.c"
                   ;

    cmsDisplayPorts[cmsDeviceCount++] = pDisplay;

    return 
# 87 "./src/main/cms/cms.c" 3 4
          1
# 87 "./src/main/cms/cms.c"
              ;
}
...
static displayPort_t *cmsDisplayPortSelectCurrent(void)
{
    if (cmsDeviceCount == 0)
        return 
# 93 "./src/main/cms/cms.c" 3 4
              ((void *)0)
# 93 "./src/main/cms/cms.c"
                  ;
...
static displayPort_t *cmsDisplayPortSelectNext(void)
{
    if (cmsDeviceCount == 0)
        return 
# 104 "./src/main/cms/cms.c" 3 4
              ((void *)0)
# 104 "./src/main/cms/cms.c"
                  ;

    cmsCurrentDevice = (cmsCurrentDevice + 1) % cmsDeviceCount;

    return cmsDisplayPorts[cmsCurrentDevice];
}
# 136 "./src/main/cms/cms.c"
static 
# 136 "./src/main/cms/cms.c" 3 4
      _Bool 
# 136 "./src/main/cms/cms.c"
              smallScreen;
...
# 142 "./src/main/cms/cms.c" 3 4
_Bool 
# 142 "./src/main/cms/cms.c"
    cmsInMenu = 
# 142 "./src/main/cms/cms.c" 3 4
                0
# 142 "./src/main/cms/cms.c"
...
static int8_t pageCount;
static OSD_Entry *pageTop;
static uint8_t pageMaxRow;

static cmsCtx_t currentCtx;
# 190 "./src/main/cms/cms.c"
...
static void cmsFormatFloat(int32_t value, char *floatString)
{
    ...
    itoa(100000 + value, floatString, 10);
...
static int cmsDrawMenuEntry(displayPort_t *pDisplay, OSD_Entry *p, uint8_t row)
{
    ...
    switch (p->type) {
    case OME_String:
        if (((p)->flags & 0x01) && p->data) {
            strncpy(buff, p->data, 12);
            cnt = cmsDrawMenuItemValue(pDisplay, buff, row, 12);
            { (p)->flags &= ~0x01; };
        }
        break;
    ...
    case OME_Funcall:
        if (((p)->flags & 0x01)) {
            ...
            if ((p->type == OME_Submenu) && p->func && (p->flags & 0x08)) {
    ...
    case OME_UINT8:
        if (((p)->flags & 0x01) && p->data) {
            ...
            cnt = cmsDrawMenuItemValue(pDisplay, buff, row, 5);
            { (p)->flags &= ~0x01; };
        }
        break;
...
# 491 "./src/main/cms/cms.c" 3 4
   _Bool 
# 491 "./src/main/cms/cms.c"
        drawPolled = 
# 491 "./src/main/cms/cms.c" 3 4
                     0
# 491 "./src/main/cms/cms.c"
    ...
    if (currentTimeUs > lastPolledUs + 100000) {
        drawPolled = 
# 495 "./src/main/cms/cms.c" 3 4
                    1
# 495 "./src/main/cms/cms.c"
                        ;
    ...
    if (pDisplay->cleared) {
        ...
        pDisplay->cleared = 
# 506 "./src/main/cms/cms.c" 3 4
                           0
# 506 "./src/main/cms/cms.c"
                                ;
    } else if (drawPolled) {
    ...
    while ((pageTop + currentCtx.cursorRow)->type == OME_Label)
...
# 590 "./src/main/cms/cms.c"
    if (pMenu != currentCtx.menu) {
        ...
        if (pMenu->onEnter && (pMenu->onEnter() == (-1))) {
...
static void cmsMenuOpen(void)
{
    if (!cmsInMenu) {
        ...
        if (!pCurrentDisplay)
            return;
        cmsInMenu = 
# 648 "./src/main/cms/cms.c" 3 4
                   1
# 648 "./src/main/cms/cms.c"
                       ;
    ...
    if ( pCurrentDisplay->cols < 18) {
      smallScreen = 
# 667 "./src/main/cms/cms.c" 3 4
                         1
# 667 "./src/main/cms/cms.c"
                             ;
      linesPerMenuItem = 2;
      leftMenuColumn = 0;
      ...
      smallScreen = 
# 673 "./src/main/cms/cms.c" 3 4
                         0
# 673 "./src/main/cms/cms.c"
                              ;
      linesPerMenuItem = 1;
      leftMenuColumn = 2;
...
long cmsMenuExit(displayPort_t *pDisplay, const void *ptr)
{
    ...
    case (2):
        ...
        if (currentCtx.menu->onExit)
            currentCtx.menu->onExit((OSD_Entry *)
# 707 "./src/main/cms/cms.c" 3 4
                                                ((void *)0)
# 707 "./src/main/cms/cms.c"
                                                    );
    ...
    cmsInMenu = 
# 716 "./src/main/cms/cms.c" 3 4
               0
# 716 "./src/main/cms/cms.c"
                    ;

    displayRelease(pDisplay);
    currentCtx.menu = 
# 719 "./src/main/cms/cms.c" 3 4
                     ((void *)0)
# 719 "./src/main/cms/cms.c"
                         ;
...
void cmsUpdate(uint32_t currentTimeUs)
{
    ...
    if (!cmsInMenu) {
        ...
        if ((rcData[THROTTLE] > 1250 && rcData[THROTTLE] < 1750) && (rcData[YAW] < 1250) && (rcData[PITCH] > 1750) && !(armingFlags & (ARMED))) {
            cmsMenuOpen();
            rcDelayMs = 500;
        }
    } else {
        ...
        else if ((rcData[PITCH] > 1750)) {
            key = 1;
        }
        else if ((rcData[PITCH] < 1250)) {
            key = 2;
        }
        else if ((rcData[ROLL] < 1250)) {
            key = 3;
        }
        else if ((rcData[ROLL] > 1750)) {
            key = 4;
        }
        else if ((rcData[YAW] > 1750) || (rcData[YAW] < 1250))
        {
            key = 5;
        }
...
# 1049 "./src/main/cms/cms.c"
            if (((key == 3) || (key == 4)) && (holdCount > 20)) {
...
void cmsHandler(timeUs_t currentTimeUs)
{
    ...
    if (currentTimeUs >= lastCalledUs + 50000) {
