# 1 "./src/main/cms/cms_menu_vtx_tramp.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/cms/cms_menu_vtx_tramp.c"
# 18 "./src/main/cms/cms_menu_vtx_tramp.c"
# 1 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\lib\\gcc\\arm-none-eabi\\7.2.1\\include\\stdbool.h" 1 3 4
# 19 "./src/main/cms/cms_menu_vtx_tramp.c" 2
...
# 20 "./src/main/cms/cms_menu_vtx_tramp.c" 2
...
int toupper (int __c);
int isblank (int __c);
# 21 "./src/main/cms/cms_menu_vtx_tramp.c" 2
...
# 23 "./src/main/cms/cms_menu_vtx_tramp.c" 2
...
# 27 "./src/main/cms/cms_menu_vtx_tramp.c" 2
...
# 30 "./src/main/cms/cms_menu_vtx_tramp.c" 2
...
# 31 "./src/main/cms/cms_menu_vtx_tramp.c" 2
...
# 33 "./src/main/cms/cms_menu_vtx_tramp.c" 2
...
# 35 "./src/main/cms/cms_menu_vtx_tramp.c" 2
...
# 37 "./src/main/cms/cms_menu_vtx_tramp.c" 2
...
# 38 "./src/main/cms/cms_menu_vtx_tramp.c" 2
...
# 39 "./src/main/cms/cms_menu_vtx_tramp.c" 2
...
static OSD_TAB_t trampCmsEntBand = { &trampCmsBand, (5 - 1 + 1), vtx58BandNames };

static OSD_TAB_t trampCmsEntChan = { &trampCmsChan, (8 - 1 + 1), vtx58ChannelNames };
...
static OSD_Entry trampCmsMenuCommenceEntries[] = {
    { "CONFIRM", OME_Label, 
# 195 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                             ((void *)0)
# 195 "./src/main/cms/cms_menu_vtx_tramp.c"
                                 , 
# 195 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                                            ((void *)0)
# 195 "./src/main/cms/cms_menu_vtx_tramp.c"
                                                , 0 },
    { "YES", OME_Funcall, trampCmsCommence, 
# 196 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                                               ((void *)0)
# 196 "./src/main/cms/cms_menu_vtx_tramp.c"
                                                   , 0 },
    { "BACK", OME_Back, 
# 197 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                          ((void *)0)
# 197 "./src/main/cms/cms_menu_vtx_tramp.c"
                              , 
# 197 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                                ((void *)0)
# 197 "./src/main/cms/cms_menu_vtx_tramp.c"
                                    , 0 },
    { 
# 198 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
     ((void *)0)
# 198 "./src/main/cms/cms_menu_vtx_tramp.c"
         , OME_END, 
# 198 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                         ((void *)0)
# 198 "./src/main/cms/cms_menu_vtx_tramp.c"
...
static CMS_Menu trampCmsMenuCommence = {
    ...
    .onEnter = 
# 206 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
              ((void *)0)
# 206 "./src/main/cms/cms_menu_vtx_tramp.c"
                  ,
    .onExit = 
# 207 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
             ((void *)0)
# 207 "./src/main/cms/cms_menu_vtx_tramp.c"
                 ,
...
{
    { "- TRAMP -", OME_Label, 
# 213 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                             ((void *)0)
# 213 "./src/main/cms/cms_menu_vtx_tramp.c"
                                 , 
# 213 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                                   ((void *)0)
# 213 "./src/main/cms/cms_menu_vtx_tramp.c"
    ...
    { "", OME_Label, 
# 215 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                            ((void *)0)
# 215 "./src/main/cms/cms_menu_vtx_tramp.c"
                                , trampCmsStatusString, 0x04 },
    ...
    { "(FREQ)", OME_UINT16, 
# 219 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                            ((void *)0)
# 219 "./src/main/cms/cms_menu_vtx_tramp.c"
                                , &trampCmsEntFreqRef, 0x04 },
    { "POWER", OME_TAB, trampCmsConfigPower, &trampCmsEntPower, 0 },
    { "T(C)", OME_INT16, 
# 221 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                            ((void *)0)
# 221 "./src/main/cms/cms_menu_vtx_tramp.c"
                                , &trampCmsEntTemp, 0x04 },
    { "SET", OME_Submenu, cmsMenuChange, &trampCmsMenuCommence, 0 },

    { "BACK", OME_Back, 
# 224 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                         ((void *)0)
# 224 "./src/main/cms/cms_menu_vtx_tramp.c"
                             , 
# 224 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                               ((void *)0)
# 224 "./src/main/cms/cms_menu_vtx_tramp.c"
                                   , 0 },
    { 
# 225 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
     ((void *)0)
# 225 "./src/main/cms/cms_menu_vtx_tramp.c"
         , OME_END, 
# 225 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                        ((void *)0)
# 225 "./src/main/cms/cms_menu_vtx_tramp.c"
...
CMS_Menu cmsx_menuVtxTramp = {
    ...
    .onExit = 
# 234 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
             ((void *)0)
# 234 "./src/main/cms/cms_menu_vtx_tramp.c"
                 ,
