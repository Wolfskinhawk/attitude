# 1 "./src/main/cms/cms_menu_blackbox.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/cms/cms_menu_blackbox.c"
# 22 "./src/main/cms/cms_menu_blackbox.c"
# 1 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\lib\\gcc\\arm-none-eabi\\7.2.1\\include\\stdbool.h" 1 3 4
# 23 "./src/main/cms/cms_menu_blackbox.c" 2
...
# 24 "./src/main/cms/cms_menu_blackbox.c" 2
...
# 25 "./src/main/cms/cms_menu_blackbox.c" 2
...
int toupper (int __c);
int isblank (int __c);
# 26 "./src/main/cms/cms_menu_blackbox.c" 2
...
# 28 "./src/main/cms/cms_menu_blackbox.c" 2
...
# 34 "./src/main/cms/cms_menu_blackbox.c" 2
...
# 35 "./src/main/cms/cms_menu_blackbox.c" 2
...
# 37 "./src/main/cms/cms_menu_blackbox.c" 2
...
# 38 "./src/main/cms/cms_menu_blackbox.c" 2
# 1 "./src/main/cms/cms_menu_blackbox.h" 1
# 18 "./src/main/cms/cms_menu_blackbox.h"
       

extern CMS_Menu cmsx_menuBlackbox;
# 39 "./src/main/cms/cms_menu_blackbox.c" 2
...
# 41 "./src/main/cms/cms_menu_blackbox.c" 2
...
# 44 "./src/main/cms/cms_menu_blackbox.c" 2
...
# 46 "./src/main/cms/cms_menu_blackbox.c" 2
...
# 47 "./src/main/cms/cms_menu_blackbox.c" 2
...
# 48 "./src/main/cms/cms_menu_blackbox.c" 2
...
# 50 "./src/main/cms/cms_menu_blackbox.c" 2
...
# 52 "./src/main/cms/cms_menu_blackbox.c" 2
...
# 51 "./src/main/io/flashfs.h"
    flashfsIsEOF(void);
# 53 "./src/main/cms/cms_menu_blackbox.c" 2
...
# 64 "./src/main/io/beeper.h"
    isBeeperOn(void);
# 54 "./src/main/cms/cms_menu_blackbox.c" 2
...
static char cmsx_BlackboxStatus[8];
static char cmsx_BlackboxDeviceStorageUsed[8];
static char cmsx_BlackboxDeviceStorageFree[8];
...
# 78 "./src/main/cms/cms_menu_blackbox.c" 3 4
   _Bool 
# 78 "./src/main/cms/cms_menu_blackbox.c"
    ...
    case BLACKBOX_DEVICE_SDCARD:
        ...
        if (!sdcard_isInserted()) {
            ...
            case AFATFS_FILESYSTEM_STATE_READY:
                ...
                storageDeviceIsWorking = 
# 97 "./src/main/cms/cms_menu_blackbox.c" 3 4
                                        1
# 97 "./src/main/cms/cms_menu_blackbox.c"
                                            ;
                break;
        ...
        break;
# 136 "./src/main/cms/cms_menu_blackbox.c"
    default:
...
# 170 "./src/main/cms/cms_menu_blackbox.c"
...
{
    { "-- BLACKBOX --", OME_Label, 
# 193 "./src/main/cms/cms_menu_blackbox.c" 3 4
                                  ((void *)0)
# 193 "./src/main/cms/cms_menu_blackbox.c"
                                      , 
# 193 "./src/main/cms/cms_menu_blackbox.c" 3 4
                                        ((void *)0)
# 193 "./src/main/cms/cms_menu_blackbox.c"
                                            , 0},
    { "DEVICE", OME_TAB, 
# 194 "./src/main/cms/cms_menu_blackbox.c" 3 4
                                 ((void *)0)
# 194 "./src/main/cms/cms_menu_blackbox.c"
                                     , &cmsx_BlackboxDeviceTable, 0 },
    { "(STATUS)", OME_String, 
# 195 "./src/main/cms/cms_menu_blackbox.c" 3 4
                                 ((void *)0)
# 195 "./src/main/cms/cms_menu_blackbox.c"
                                     , &cmsx_BlackboxStatus, 0 },
    { "(USED)", OME_String, 
# 196 "./src/main/cms/cms_menu_blackbox.c" 3 4
                                 ((void *)0)
# 196 "./src/main/cms/cms_menu_blackbox.c"
                                     , &cmsx_BlackboxDeviceStorageUsed, 0 },
    { "(FREE)", OME_String, 
# 197 "./src/main/cms/cms_menu_blackbox.c" 3 4
                                 ((void *)0)
# 197 "./src/main/cms/cms_menu_blackbox.c"
                                     , &cmsx_BlackboxDeviceStorageFree, 0 },
    { "P DENOM", OME_UINT16, 
# 198 "./src/main/cms/cms_menu_blackbox.c" 3 4
                                 ((void *)0)
# 198 "./src/main/cms/cms_menu_blackbox.c"
                                     , &(OSD_UINT16_t){ &blackboxConfig_p_denom, 1, 
# 198 "./src/main/cms/cms_menu_blackbox.c" 3 4
                                                                                               (0x7fff)
# 198 "./src/main/cms/cms_menu_blackbox.c"
                                                                                                        , 1 },0 },
    ...
    { "BACK", OME_Back, 
# 204 "./src/main/cms/cms_menu_blackbox.c" 3 4
                       ((void *)0)
# 204 "./src/main/cms/cms_menu_blackbox.c"
                           , 
# 204 "./src/main/cms/cms_menu_blackbox.c" 3 4
                             ((void *)0)
# 204 "./src/main/cms/cms_menu_blackbox.c"
                                 , 0 },
    { 
# 205 "./src/main/cms/cms_menu_blackbox.c" 3 4
     ((void *)0)
# 205 "./src/main/cms/cms_menu_blackbox.c"
         , OME_END, 
# 205 "./src/main/cms/cms_menu_blackbox.c" 3 4
                    ((void *)0)
# 205 "./src/main/cms/cms_menu_blackbox.c"
