...
# 19 "./src/main/cms/cms_menu_misc.c" 2
...
# 20 "./src/main/cms/cms_menu_misc.c" 2
...
# 21 "./src/main/cms/cms_menu_misc.c" 2
...
int toupper (int __c);
int isblank (int __c);
# 22 "./src/main/cms/cms_menu_misc.c" 2
...
# 24 "./src/main/cms/cms_menu_misc.c" 2
...
# 28 "./src/main/cms/cms_menu_misc.c" 2
...
# 31 "./src/main/cms/cms_menu_misc.c" 2
...
# 33 "./src/main/cms/cms_menu_misc.c" 2
...
# 34 "./src/main/cms/cms_menu_misc.c" 2
# 1 "./src/main/cms/cms_menu_ledstrip.h" 1
# 18 "./src/main/cms/cms_menu_ledstrip.h"
       

extern CMS_Menu cmsx_menuLedstrip;
# 35 "./src/main/cms/cms_menu_misc.c" 2
...
# 39 "./src/main/cms/cms_menu_misc.c" 2

# 1 "./src/main/pg/pg_ids.h" 1
# 18 "./src/main/pg/pg_ids.h"
       
# 41 "./src/main/cms/cms_menu_misc.c" 2
...
# 43 "./src/main/cms/cms_menu_misc.c" 2
...
# 44 "./src/main/cms/cms_menu_misc.c" 2
...
# 46 "./src/main/cms/cms_menu_misc.c" 2
...
# 48 "./src/main/cms/cms_menu_misc.c" 2
...
{
    { "-- RC PREV --", OME_Label, 
# 68 "./src/main/cms/cms_menu_misc.c" 3 4
                                 ((void *)0)
# 68 "./src/main/cms/cms_menu_misc.c"
                                     , 
# 68 "./src/main/cms/cms_menu_misc.c" 3 4
                                       ((void *)0)
# 68 "./src/main/cms/cms_menu_misc.c"
    ...
    { "ROLL", OME_INT16, 
# 70 "./src/main/cms/cms_menu_misc.c" 3 4
                         ((void *)0)
# 70 "./src/main/cms/cms_menu_misc.c"
                             , &(OSD_INT16_t){ &rcData[ROLL], 1, 2500, 0 }, 0x04 },
    { "PITCH", OME_INT16, 
# 71 "./src/main/cms/cms_menu_misc.c" 3 4
                         ((void *)0)
# 71 "./src/main/cms/cms_menu_misc.c"
                             , &(OSD_INT16_t){ &rcData[PITCH], 1, 2500, 0 }, 0x04 },
    { "THR", OME_INT16, 
# 72 "./src/main/cms/cms_menu_misc.c" 3 4
                         ((void *)0)
# 72 "./src/main/cms/cms_menu_misc.c"
                             , &(OSD_INT16_t){ &rcData[THROTTLE], 1, 2500, 0 }, 0x04 },
    { "YAW", OME_INT16, 
# 73 "./src/main/cms/cms_menu_misc.c" 3 4
                         ((void *)0)
# 73 "./src/main/cms/cms_menu_misc.c"
                             , &(OSD_INT16_t){ &rcData[YAW], 1, 2500, 0 }, 0x04 },

    { "AUX1", OME_INT16, 
# 75 "./src/main/cms/cms_menu_misc.c" 3 4
                         ((void *)0)
# 75 "./src/main/cms/cms_menu_misc.c"
                             , &(OSD_INT16_t){ &rcData[AUX1], 1, 2500, 0 }, 0x04 },
    { "AUX2", OME_INT16, 
# 76 "./src/main/cms/cms_menu_misc.c" 3 4
                         ((void *)0)
# 76 "./src/main/cms/cms_menu_misc.c"
                             , &(OSD_INT16_t){ &rcData[AUX2], 1, 2500, 0 }, 0x04 },
    { "AUX3", OME_INT16, 
# 77 "./src/main/cms/cms_menu_misc.c" 3 4
                         ((void *)0)
# 77 "./src/main/cms/cms_menu_misc.c"
                             , &(OSD_INT16_t){ &rcData[AUX3], 1, 2500, 0 }, 0x04 },
    { "AUX4", OME_INT16, 
# 78 "./src/main/cms/cms_menu_misc.c" 3 4
                         ((void *)0)
# 78 "./src/main/cms/cms_menu_misc.c"
                             , &(OSD_INT16_t){ &rcData[AUX4], 1, 2500, 0 }, 0x04 },

    { "BACK", OME_Back, 
# 80 "./src/main/cms/cms_menu_misc.c" 3 4
                        ((void *)0)
# 80 "./src/main/cms/cms_menu_misc.c"
                            , 
# 80 "./src/main/cms/cms_menu_misc.c" 3 4
                              ((void *)0)
# 80 "./src/main/cms/cms_menu_misc.c"
                                  , 0},
    {
# 81 "./src/main/cms/cms_menu_misc.c" 3 4
    ((void *)0)
# 81 "./src/main/cms/cms_menu_misc.c"
        , OME_END, 
# 81 "./src/main/cms/cms_menu_misc.c" 3 4
                   ((void *)0)
# 81 "./src/main/cms/cms_menu_misc.c"
...
CMS_Menu cmsx_menuRcPreview = {
    ...
    .onEnter = 
# 89 "./src/main/cms/cms_menu_misc.c" 3 4
              ((void *)0)
# 89 "./src/main/cms/cms_menu_misc.c"
                  ,
...
{
    { "-- MISC --", OME_Label, 
# 126 "./src/main/cms/cms_menu_misc.c" 3 4
                              ((void *)0)
# 126 "./src/main/cms/cms_menu_misc.c"
                                  , 
# 126 "./src/main/cms/cms_menu_misc.c" 3 4
                                    ((void *)0)
# 126 "./src/main/cms/cms_menu_misc.c"
    ...
    { "MIN THR", OME_UINT16, 
# 128 "./src/main/cms/cms_menu_misc.c" 3 4
                                  ((void *)0)
# 128 "./src/main/cms/cms_menu_misc.c"
                                      , &(OSD_UINT16_t){ &motorConfig_minthrottle, 1000, 2000, 1 }, 0 },
    { "DIGITAL IDLE", OME_UINT8, 
# 129 "./src/main/cms/cms_menu_misc.c" 3 4
                                  ((void *)0)
# 129 "./src/main/cms/cms_menu_misc.c"
                                      , &(OSD_UINT8_t) { &motorConfig_digitalIdleOffsetValue, 0, 200, 1 }, 0 },
    { "VBAT SCALE", OME_UINT8, 
# 130 "./src/main/cms/cms_menu_misc.c" 3 4
                                  ((void *)0)
# 130 "./src/main/cms/cms_menu_misc.c"
                                      , &(OSD_UINT8_t) { &voltageSensorADCConfig_vbatscale, 1, 250, 1 }, 0 },
    { "VBAT CLMAX", OME_UINT8, 
# 131 "./src/main/cms/cms_menu_misc.c" 3 4
                                  ((void *)0)
# 131 "./src/main/cms/cms_menu_misc.c"
                                      , &(OSD_UINT8_t) { &batteryConfig_vbatmaxcellvoltage, 10, 50, 1 }, 0 },
    { "DEBUG MODE", OME_TAB, 
# 132 "./src/main/cms/cms_menu_misc.c" 3 4
                                  ((void *)0)
# 132 "./src/main/cms/cms_menu_misc.c"
                                      , &(OSD_TAB_t) { &systemConfig_debug_mode, DEBUG_COUNT - 1, debugModeNames }, 0 },
    { "RC PREV", OME_Submenu, cmsMenuChange, &cmsx_menuRcPreview, 0},

    { "BACK", OME_Back, 
# 135 "./src/main/cms/cms_menu_misc.c" 3 4
                       ((void *)0)
# 135 "./src/main/cms/cms_menu_misc.c"
                           , 
# 135 "./src/main/cms/cms_menu_misc.c" 3 4
                             ((void *)0)
# 135 "./src/main/cms/cms_menu_misc.c"
                                 , 0},
    { 
# 136 "./src/main/cms/cms_menu_misc.c" 3 4
     ((void *)0)
# 136 "./src/main/cms/cms_menu_misc.c"
         , OME_END, 
# 136 "./src/main/cms/cms_menu_misc.c" 3 4
                    ((void *)0)
# 136 "./src/main/cms/cms_menu_misc.c"
