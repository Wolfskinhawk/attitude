...
# 20 "./src/main/cms/cms_menu_osd.c" 2
...
# 21 "./src/main/cms/cms_menu_osd.c" 2
...
int toupper (int __c);
int isblank (int __c);
# 22 "./src/main/cms/cms_menu_osd.c" 2
...
# 24 "./src/main/cms/cms_menu_osd.c" 2
...
# 30 "./src/main/cms/cms_menu_osd.c" 2
...
# 31 "./src/main/cms/cms_menu_osd.c" 2
# 1 "./src/main/cms/cms_menu_osd.h" 1
# 18 "./src/main/cms/cms_menu_osd.h"
       

extern CMS_Menu cmsx_menuOsd;
# 32 "./src/main/cms/cms_menu_osd.c" 2
...
# 36 "./src/main/cms/cms_menu_osd.c" 2

# 1 "./src/main/pg/pg_ids.h" 1
# 18 "./src/main/pg/pg_ids.h"
       
# 38 "./src/main/cms/cms_menu_osd.c" 2
...
# 40 "./src/main/cms/cms_menu_osd.c" 2
...
# 41 "./src/main/cms/cms_menu_osd.c" 2
...
# 61 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 61 "./src/main/cms/cms_menu_osd.c"
                                           , 
# 61 "./src/main/cms/cms_menu_osd.c" 3 4
                                             ((void *)0)
# 61 "./src/main/cms/cms_menu_osd.c"
...
# 62 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_RSSI_VALUE], 0},
    {"BATTERY VOLTAGE", OME_VISIBLE, 
# 63 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 63 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_MAIN_BATT_VOLTAGE], 0},
    {"BATTERY USAGE", OME_VISIBLE, 
# 64 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 64 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_MAIN_BATT_USAGE], 0},
    {"AVG CELL VOLTAGE", OME_VISIBLE, 
# 65 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 65 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_AVG_CELL_VOLTAGE], 0},
    {"CROSSHAIRS", OME_VISIBLE, 
# 66 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 66 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_CROSSHAIRS], 0},
    {"HORIZON", OME_VISIBLE, 
# 67 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 67 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_ARTIFICIAL_HORIZON], 0},
    {"HORIZON SIDEBARS", OME_VISIBLE, 
# 68 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 68 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_HORIZON_SIDEBARS], 0},
    {"TIMER 1", OME_VISIBLE, 
# 69 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 69 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_ITEM_TIMER_1], 0},
    {"TIMER 2", OME_VISIBLE, 
# 70 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 70 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_ITEM_TIMER_2], 0},
    {"REMAINING TIME ESTIMATE", OME_VISIBLE, 
# 71 "./src/main/cms/cms_menu_osd.c" 3 4
                                                  ((void *)0)
# 71 "./src/main/cms/cms_menu_osd.c"
                                                      , &osdConfig_item_pos[OSD_REMAINING_TIME_ESTIMATE], 0},
    {"FLY MODE", OME_VISIBLE, 
# 72 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 72 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_FLYMODE], 0},
    {"NAME", OME_VISIBLE, 
# 73 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 73 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_CRAFT_NAME], 0},
    {"THROTTLE", OME_VISIBLE, 
# 74 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 74 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_THROTTLE_POS], 0},

    {"VTX CHAN", OME_VISIBLE, 
# 76 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 76 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_VTX_CHANNEL], 0},

    {"CURRENT (A)", OME_VISIBLE, 
# 78 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 78 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_CURRENT_DRAW], 0},
    {"USED MAH", OME_VISIBLE, 
# 79 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 79 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_MAH_DRAWN], 0},
# 88 "./src/main/cms/cms_menu_osd.c"
    {"COMPASS BAR", OME_VISIBLE, 
# 88 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 88 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_COMPASS_BAR], 0},
    {"ALTITUDE", OME_VISIBLE, 
# 89 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 89 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_ALTITUDE], 0},
    {"POWER", OME_VISIBLE, 
# 90 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 90 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_POWER], 0},
    {"ROLL PID", OME_VISIBLE, 
# 91 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 91 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_ROLL_PIDS], 0},
    {"PITCH PID", OME_VISIBLE, 
# 92 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 92 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_PITCH_PIDS], 0},
    {"YAW PID", OME_VISIBLE, 
# 93 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 93 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_YAW_PIDS], 0},
    {"PROFILES", OME_VISIBLE, 
# 94 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 94 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_PIDRATE_PROFILE], 0},
    {"DEBUG", OME_VISIBLE, 
# 95 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 95 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_DEBUG], 0},
    {"WARNINGS", OME_VISIBLE, 
# 96 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 96 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_WARNINGS], 0},
    {"DISARMED", OME_VISIBLE, 
# 97 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 97 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_DISARMED], 0},
    {"PIT ANG", OME_VISIBLE, 
# 98 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 98 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_PITCH_ANGLE], 0},
    {"ROL ANG", OME_VISIBLE, 
# 99 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 99 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_ROLL_ANGLE], 0},
    {"HEADING", OME_VISIBLE, 
# 100 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 100 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_NUMERICAL_HEADING], 0},
    {"VARIO", OME_VISIBLE, 
# 101 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 101 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_NUMERICAL_VARIO], 0},
    {"BACK", OME_Back, 
...
# 102 "./src/main/cms/cms_menu_osd.c"
                                                 , 0},
    {
# 103 "./src/main/cms/cms_menu_osd.c" 3 4
    ((void *)0)
# 103 "./src/main/cms/cms_menu_osd.c"
        , OME_END, 
# 103 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 103 "./src/main/cms/cms_menu_osd.c"
...
# 145 "./src/main/cms/cms_menu_osd.c"
    ...
    {"BACK", OME_Back, 
# 146 "./src/main/cms/cms_menu_osd.c" 3 4
                      ((void *)0)
# 146 "./src/main/cms/cms_menu_osd.c"
                          , 
# 146 "./src/main/cms/cms_menu_osd.c" 3 4
                            ((void *)0)
# 146 "./src/main/cms/cms_menu_osd.c"
...
{
    {"--- TIMERS ---", OME_Label, 
# 191 "./src/main/cms/cms_menu_osd.c" 3 4
                                 ((void *)0)
# 191 "./src/main/cms/cms_menu_osd.c"
                                     , 
# 191 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 191 "./src/main/cms/cms_menu_osd.c"
                                           , 0},
    {"1 SRC", OME_TAB, 
# 192 "./src/main/cms/cms_menu_osd.c" 3 4
                                 ((void *)0)
# 192 "./src/main/cms/cms_menu_osd.c"
                                     , &(OSD_TAB_t){&timerSource[OSD_TIMER_1], OSD_TIMER_SRC_COUNT - 1, osdTimerSourceNames}, 0 },
    {"1 PREC", OME_TAB, 
# 193 "./src/main/cms/cms_menu_osd.c" 3 4
                                 ((void *)0)
# 193 "./src/main/cms/cms_menu_osd.c"
                                     , &(OSD_TAB_t){&timerPrecision[OSD_TIMER_1], OSD_TIMER_PREC_COUNT - 1, osdTimerPrecisionNames}, 0},
    {"1 ALARM", OME_UINT8, 
# 194 "./src/main/cms/cms_menu_osd.c" 3 4
                                 ((void *)0)
# 194 "./src/main/cms/cms_menu_osd.c"
                                     , &(OSD_UINT8_t){&timerAlarm[OSD_TIMER_1], 0, 0xFF, 1}, 0},
    {"2 SRC", OME_TAB, 
# 195 "./src/main/cms/cms_menu_osd.c" 3 4
                                 ((void *)0)
# 195 "./src/main/cms/cms_menu_osd.c"
                                     , &(OSD_TAB_t){&timerSource[OSD_TIMER_2], OSD_TIMER_SRC_COUNT - 1, osdTimerSourceNames}, 0 },
    {"2 PREC", OME_TAB, 
# 196 "./src/main/cms/cms_menu_osd.c" 3 4
                                 ((void *)0)
# 196 "./src/main/cms/cms_menu_osd.c"
                                     , &(OSD_TAB_t){&timerPrecision[OSD_TIMER_2], OSD_TIMER_PREC_COUNT - 1, osdTimerPrecisionNames}, 0},
    {"2 ALARM", OME_UINT8, 
# 197 "./src/main/cms/cms_menu_osd.c" 3 4
                                 ((void *)0)
# 197 "./src/main/cms/cms_menu_osd.c"
                                     , &(OSD_UINT8_t){&timerAlarm[OSD_TIMER_2], 0, 0xFF, 1}, 0},
    {"BACK", OME_Back, 
# 198 "./src/main/cms/cms_menu_osd.c" 3 4
                      ((void *)0)
# 198 "./src/main/cms/cms_menu_osd.c"
                          , 
# 198 "./src/main/cms/cms_menu_osd.c" 3 4
                            ((void *)0)
# 198 "./src/main/cms/cms_menu_osd.c"
                                , 0},
    {
# 199 "./src/main/cms/cms_menu_osd.c" 3 4
    ((void *)0)
# 199 "./src/main/cms/cms_menu_osd.c"
        , OME_END, 
# 199 "./src/main/cms/cms_menu_osd.c" 3 4
                   ((void *)0)
# 199 "./src/main/cms/cms_menu_osd.c"
...
static 
# 214 "./src/main/cms/cms_menu_osd.c" 3 4
      _Bool 
# 214 "./src/main/cms/cms_menu_osd.c"
...
# 245 "./src/main/cms/cms_menu_osd.c"
    ...
    {"INVERT", OME_Bool, 
# 252 "./src/main/cms/cms_menu_osd.c" 3 4
                            ((void *)0)
# 252 "./src/main/cms/cms_menu_osd.c"
                                , &displayPortProfileMax7456_invert, 0},
    {"BRT BLACK", OME_UINT8, 
# 253 "./src/main/cms/cms_menu_osd.c" 3 4
                            ((void *)0)
# 253 "./src/main/cms/cms_menu_osd.c"
                                , &(OSD_UINT8_t){&displayPortProfileMax7456_blackBrightness, 0, 3, 1}, 0},
    {"BRT WHITE", OME_UINT8, 
# 254 "./src/main/cms/cms_menu_osd.c" 3 4
                            ((void *)0)
# 254 "./src/main/cms/cms_menu_osd.c"
                                , &(OSD_UINT8_t){&displayPortProfileMax7456_whiteBrightness, 0, 3, 1}, 0},

    {"BACK", OME_Back, 
# 256 "./src/main/cms/cms_menu_osd.c" 3 4
                      ((void *)0)
# 256 "./src/main/cms/cms_menu_osd.c"
                          , 
# 256 "./src/main/cms/cms_menu_osd.c" 3 4
                            ((void *)0)
# 256 "./src/main/cms/cms_menu_osd.c"
                                , 0},
    {
# 257 "./src/main/cms/cms_menu_osd.c" 3 4
    ((void *)0)
# 257 "./src/main/cms/cms_menu_osd.c"
        , OME_END, 
# 257 "./src/main/cms/cms_menu_osd.c" 3 4
                      ((void *)0)
# 257 "./src/main/cms/cms_menu_osd.c"
