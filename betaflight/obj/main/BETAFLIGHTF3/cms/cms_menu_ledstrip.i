# 1 "./src/main/cms/cms_menu_ledstrip.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/cms/cms_menu_ledstrip.c"
# 18 "./src/main/cms/cms_menu_ledstrip.c"
# 1 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\lib\\gcc\\arm-none-eabi\\7.2.1\\include\\stdbool.h" 1 3 4
# 19 "./src/main/cms/cms_menu_ledstrip.c" 2
...
# 20 "./src/main/cms/cms_menu_ledstrip.c" 2
...
# 21 "./src/main/cms/cms_menu_ledstrip.c" 2
...
int toupper (int __c);
int isblank (int __c);
# 22 "./src/main/cms/cms_menu_ledstrip.c" 2
...
# 24 "./src/main/cms/cms_menu_ledstrip.c" 2
...
# 30 "./src/main/cms/cms_menu_ledstrip.c" 2
...
# 34 "./src/main/cms/cms_menu_ledstrip.c" 2

# 1 "./src/main/pg/pg_ids.h" 1
# 18 "./src/main/pg/pg_ids.h"
       
# 36 "./src/main/cms/cms_menu_ledstrip.c" 2
...
# 38 "./src/main/cms/cms_menu_ledstrip.c" 2




static 
# 42 "./src/main/cms/cms_menu_ledstrip.c" 3 4
      _Bool 
# 42 "./src/main/cms/cms_menu_ledstrip.c"
           featureRead = 
# 42 "./src/main/cms/cms_menu_ledstrip.c" 3 4
                         0
# 42 "./src/main/cms/cms_menu_ledstrip.c"
...
static long cmsx_Ledstrip_FeatureRead(void)
{
    if (!featureRead) {
        ...
        featureRead = 
# 49 "./src/main/cms/cms_menu_ledstrip.c" 3 4
                     1
# 49 "./src/main/cms/cms_menu_ledstrip.c"
                         ;
    }
...
{
    { "-- LED STRIP --", OME_Label, 
# 70 "./src/main/cms/cms_menu_ledstrip.c" 3 4
                                   ((void *)0)
# 70 "./src/main/cms/cms_menu_ledstrip.c"
                                       , 
# 70 "./src/main/cms/cms_menu_ledstrip.c" 3 4
                                         ((void *)0)
# 70 "./src/main/cms/cms_menu_ledstrip.c"
                                             , 0 },
    { "ENABLED", OME_Bool, 
# 71 "./src/main/cms/cms_menu_ledstrip.c" 3 4
                                   ((void *)0)
# 71 "./src/main/cms/cms_menu_ledstrip.c"
                                       , &cmsx_FeatureLedstrip, 0 },

    { "BACK", OME_Back, 
# 73 "./src/main/cms/cms_menu_ledstrip.c" 3 4
                       ((void *)0)
# 73 "./src/main/cms/cms_menu_ledstrip.c"
                           , 
# 73 "./src/main/cms/cms_menu_ledstrip.c" 3 4
                             ((void *)0)
# 73 "./src/main/cms/cms_menu_ledstrip.c"
                                 , 0 },
    { 
# 74 "./src/main/cms/cms_menu_ledstrip.c" 3 4
     ((void *)0)
# 74 "./src/main/cms/cms_menu_ledstrip.c"
         , OME_END, 
# 74 "./src/main/cms/cms_menu_ledstrip.c" 3 4
                    ((void *)0)
# 74 "./src/main/cms/cms_menu_ledstrip.c"
