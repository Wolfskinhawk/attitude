...
# 23 "./src/main/cms/cms_menu_imu.c" 2
...
# 24 "./src/main/cms/cms_menu_imu.c" 2
...
int toupper (int __c);
int isblank (int __c);
# 25 "./src/main/cms/cms_menu_imu.c" 2
...
# 27 "./src/main/cms/cms_menu_imu.c" 2
...
# 33 "./src/main/cms/cms_menu_imu.c" 2
...
# 34 "./src/main/cms/cms_menu_imu.c" 2
# 1 "./src/main/cms/cms_menu_imu.h" 1
# 18 "./src/main/cms/cms_menu_imu.h"
       

extern CMS_Menu cmsx_menuImu;
# 35 "./src/main/cms/cms_menu_imu.c" 2
...
# 39 "./src/main/cms/cms_menu_imu.c" 2
...
# 42 "./src/main/cms/cms_menu_imu.c" 2
...
# 43 "./src/main/cms/cms_menu_imu.c" 2
...
# 44 "./src/main/cms/cms_menu_imu.c" 2
...
void mwDisarm(void);
# 45 "./src/main/cms/cms_menu_imu.c" 2
...
# 47 "./src/main/cms/cms_menu_imu.c" 2
...
# 49 "./src/main/cms/cms_menu_imu.c" 2
...
{
    { "-- PID --", OME_Label, 
# 145 "./src/main/cms/cms_menu_imu.c" 3 4
                             ((void *)0)
# 145 "./src/main/cms/cms_menu_imu.c"
                                 , pidProfileIndexString, 0},

    { "ROLL  P", OME_UINT8, 
# 147 "./src/main/cms/cms_menu_imu.c" 3 4
                           ((void *)0)
# 147 "./src/main/cms/cms_menu_imu.c"
                               , &(OSD_UINT8_t){ &tempPid[PID_ROLL][0], 0, 200, 1 }, 0 },
    { "ROLL  I", OME_UINT8, 
# 148 "./src/main/cms/cms_menu_imu.c" 3 4
                           ((void *)0)
# 148 "./src/main/cms/cms_menu_imu.c"
                               , &(OSD_UINT8_t){ &tempPid[PID_ROLL][1], 0, 200, 1 }, 0 },
    { "ROLL  D", OME_UINT8, 
# 149 "./src/main/cms/cms_menu_imu.c" 3 4
                           ((void *)0)
# 149 "./src/main/cms/cms_menu_imu.c"
                               , &(OSD_UINT8_t){ &tempPid[PID_ROLL][2], 0, 200, 1 }, 0 },

    { "PITCH P", OME_UINT8, 
# 151 "./src/main/cms/cms_menu_imu.c" 3 4
                           ((void *)0)
# 151 "./src/main/cms/cms_menu_imu.c"
                               , &(OSD_UINT8_t){ &tempPid[PID_PITCH][0], 0, 200, 1 }, 0 },
    { "PITCH I", OME_UINT8, 
# 152 "./src/main/cms/cms_menu_imu.c" 3 4
                           ((void *)0)
# 152 "./src/main/cms/cms_menu_imu.c"
                               , &(OSD_UINT8_t){ &tempPid[PID_PITCH][1], 0, 200, 1 }, 0 },
    { "PITCH D", OME_UINT8, 
# 153 "./src/main/cms/cms_menu_imu.c" 3 4
                           ((void *)0)
# 153 "./src/main/cms/cms_menu_imu.c"
                               , &(OSD_UINT8_t){ &tempPid[PID_PITCH][2], 0, 200, 1 }, 0 },

    { "YAW   P", OME_UINT8, 
# 155 "./src/main/cms/cms_menu_imu.c" 3 4
                           ((void *)0)
# 155 "./src/main/cms/cms_menu_imu.c"
                               , &(OSD_UINT8_t){ &tempPid[PID_YAW][0], 0, 200, 1 }, 0 },
    { "YAW   I", OME_UINT8, 
# 156 "./src/main/cms/cms_menu_imu.c" 3 4
                           ((void *)0)
# 156 "./src/main/cms/cms_menu_imu.c"
                               , &(OSD_UINT8_t){ &tempPid[PID_YAW][1], 0, 200, 1 }, 0 },
    { "YAW   D", OME_UINT8, 
# 157 "./src/main/cms/cms_menu_imu.c" 3 4
                           ((void *)0)
# 157 "./src/main/cms/cms_menu_imu.c"
                               , &(OSD_UINT8_t){ &tempPid[PID_YAW][2], 0, 200, 1 }, 0 },

    { "BACK", OME_Back, 
# 159 "./src/main/cms/cms_menu_imu.c" 3 4
                       ((void *)0)
# 159 "./src/main/cms/cms_menu_imu.c"
                           , 
# 159 "./src/main/cms/cms_menu_imu.c" 3 4
                             ((void *)0)
# 159 "./src/main/cms/cms_menu_imu.c"
                                 , 0 },
    { 
# 160 "./src/main/cms/cms_menu_imu.c" 3 4
     ((void *)0)
# 160 "./src/main/cms/cms_menu_imu.c"
         , OME_END, 
# 160 "./src/main/cms/cms_menu_imu.c" 3 4
                    ((void *)0)
# 160 "./src/main/cms/cms_menu_imu.c"
...
{
    { "-- RATE --", OME_Label, 
# 204 "./src/main/cms/cms_menu_imu.c" 3 4
                              ((void *)0)
# 204 "./src/main/cms/cms_menu_imu.c"
                                  , rateProfileIndexString, 0 },

    { "RC R RATE", OME_FLOAT, 
# 206 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 206 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_FLOAT_t) { &rateProfile.rcRates[FD_ROLL], 0, 255, 1, 10 }, 0 },
    { "RC P RATE", OME_FLOAT, 
# 207 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 207 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_FLOAT_t) { &rateProfile.rcRates[FD_PITCH], 0, 255, 1, 10 }, 0 },
    { "RC Y RATE", OME_FLOAT, 
# 208 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 208 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_FLOAT_t) { &rateProfile.rcRates[FD_YAW], 0, 255, 1, 10 }, 0 },

    { "ROLL SUPER", OME_FLOAT, 
# 210 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 210 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_FLOAT_t) { &rateProfile.rates[FD_ROLL], 0, 100, 1, 10 }, 0 },
    { "PITCH SUPER", OME_FLOAT, 
# 211 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 211 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_FLOAT_t) { &rateProfile.rates[FD_PITCH], 0, 100, 1, 10 }, 0 },
    { "YAW SUPER", OME_FLOAT, 
# 212 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 212 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_FLOAT_t) { &rateProfile.rates[FD_YAW], 0, 100, 1, 10 }, 0 },

    { "RC R EXPO", OME_FLOAT, 
# 214 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 214 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_FLOAT_t) { &rateProfile.rcExpo[FD_ROLL], 0, 100, 1, 10 }, 0 },
    { "RC P EXPO", OME_FLOAT, 
# 215 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 215 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_FLOAT_t) { &rateProfile.rcExpo[FD_PITCH], 0, 100, 1, 10 }, 0 },
    { "RC Y EXPO", OME_FLOAT, 
# 216 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 216 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_FLOAT_t) { &rateProfile.rcExpo[FD_YAW], 0, 100, 1, 10 }, 0 },

    { "THR MID", OME_UINT8, 
# 218 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 218 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT8_t) { &rateProfile.thrMid8, 0, 100, 1}, 0 },
    { "THR EXPO", OME_UINT8, 
# 219 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 219 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT8_t) { &rateProfile.thrExpo8, 0, 100, 1}, 0 },
    { "THRPID ATT", OME_FLOAT, 
# 220 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 220 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_FLOAT_t) { &rateProfile.dynThrPID, 0, 100, 1, 10}, 0 },
    { "TPA BRKPT", OME_UINT16, 
# 221 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 221 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT16_t){ &rateProfile.tpa_breakpoint, 1000, 2000, 10}, 0 },

    { "BACK", OME_Back, 
# 223 "./src/main/cms/cms_menu_imu.c" 3 4
                       ((void *)0)
# 223 "./src/main/cms/cms_menu_imu.c"
                           , 
# 223 "./src/main/cms/cms_menu_imu.c" 3 4
                             ((void *)0)
# 223 "./src/main/cms/cms_menu_imu.c"
                                 , 0 },
    { 
# 224 "./src/main/cms/cms_menu_imu.c" 3 4
     ((void *)0)
# 224 "./src/main/cms/cms_menu_imu.c"
         , OME_END, 
# 224 "./src/main/cms/cms_menu_imu.c" 3 4
                    ((void *)0)
# 224 "./src/main/cms/cms_menu_imu.c"
...
static OSD_Entry cmsx_menuProfileOtherEntries[] = {
    { "-- OTHER PP --", OME_Label, 
# 283 "./src/main/cms/cms_menu_imu.c" 3 4
                                  ((void *)0)
# 283 "./src/main/cms/cms_menu_imu.c"
                                      , pidProfileIndexString, 0 },

    { "D SETPT WT", OME_FLOAT, 
# 285 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 285 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_FLOAT_t) { &cmsx_dtermSetpointWeight, 0, 255, 1, 10 }, 0 },
    { "SETPT TRS", OME_FLOAT, 
# 286 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 286 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_FLOAT_t) { &cmsx_setpointRelaxRatio, 1, 100, 1, 10 }, 0 },
    { "ANGLE STR", OME_UINT8, 
# 287 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 287 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT8_t) { &cmsx_angleStrength, 0, 200, 1 } , 0 },
    { "HORZN STR", OME_UINT8, 
# 288 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 288 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT8_t) { &cmsx_horizonStrength, 0, 200, 1 } , 0 },
    { "HORZN TRS", OME_UINT8, 
# 289 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 289 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT8_t) { &cmsx_horizonTransition, 0, 200, 1 } , 0 },
    { "AG GAIN", OME_UINT16, 
# 290 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 290 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT16_t) { &cmsx_itermAcceleratorGain, 1000, 30000, 1 } , 0 },
    { "AG THR", OME_UINT16, 
# 291 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 291 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT16_t) { &cmsx_itermThrottleThreshold, 20, 1000, 1 } , 0 },

    { "BACK", OME_Back, 
# 293 "./src/main/cms/cms_menu_imu.c" 3 4
                       ((void *)0)
# 293 "./src/main/cms/cms_menu_imu.c"
                           , 
# 293 "./src/main/cms/cms_menu_imu.c" 3 4
                             ((void *)0)
# 293 "./src/main/cms/cms_menu_imu.c"
                                 , 0 },
    { 
# 294 "./src/main/cms/cms_menu_imu.c" 3 4
     ((void *)0)
# 294 "./src/main/cms/cms_menu_imu.c"
         , OME_END, 
# 294 "./src/main/cms/cms_menu_imu.c" 3 4
                    ((void *)0)
# 294 "./src/main/cms/cms_menu_imu.c"
...
{
    { "-- FILTER GLB  --", OME_Label, 
# 339 "./src/main/cms/cms_menu_imu.c" 3 4
                                     ((void *)0)
# 339 "./src/main/cms/cms_menu_imu.c"
                                         , 
# 339 "./src/main/cms/cms_menu_imu.c" 3 4
                                           ((void *)0)
# 339 "./src/main/cms/cms_menu_imu.c"
    ...
    { "GYRO LPF", OME_UINT8, 
# 341 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 341 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT8_t) { &gyroConfig_gyro_soft_lpf_hz, 0, 255, 1 }, 0 },
    { "GYRO NF1", OME_UINT16, 
# 342 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 342 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t) { &gyroConfig_gyro_soft_notch_hz_1, 0, 500, 1 }, 0 },
    { "GYRO NF1C", OME_UINT16, 
# 343 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 343 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t) { &gyroConfig_gyro_soft_notch_cutoff_1, 0, 500, 1 }, 0 },
    { "GYRO NF2", OME_UINT16, 
# 344 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 344 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t) { &gyroConfig_gyro_soft_notch_hz_2, 0, 500, 1 }, 0 },
    { "GYRO NF2C", OME_UINT16, 
# 345 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 345 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t) { &gyroConfig_gyro_soft_notch_cutoff_2, 0, 500, 1 }, 0 },

    { "BACK", OME_Back, 
# 347 "./src/main/cms/cms_menu_imu.c" 3 4
                       ((void *)0)
# 347 "./src/main/cms/cms_menu_imu.c"
                           , 
# 347 "./src/main/cms/cms_menu_imu.c" 3 4
                             ((void *)0)
# 347 "./src/main/cms/cms_menu_imu.c"
                                 , 0 },
    { 
# 348 "./src/main/cms/cms_menu_imu.c" 3 4
     ((void *)0)
# 348 "./src/main/cms/cms_menu_imu.c"
         , OME_END, 
# 348 "./src/main/cms/cms_menu_imu.c" 3 4
                    ((void *)0)
# 348 "./src/main/cms/cms_menu_imu.c"
...
{
    { "-- FILTER PP  --", OME_Label, 
# 392 "./src/main/cms/cms_menu_imu.c" 3 4
                                    ((void *)0)
# 392 "./src/main/cms/cms_menu_imu.c"
                                        , 
# 392 "./src/main/cms/cms_menu_imu.c" 3 4
                                          ((void *)0)
# 392 "./src/main/cms/cms_menu_imu.c"
    ...
    { "DTERM LPF", OME_UINT16, 
# 394 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 394 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t){ &cmsx_dterm_lpf_hz, 0, 500, 1 }, 0 },
    { "DTERM NF", OME_UINT16, 
# 395 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 395 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t){ &cmsx_dterm_notch_hz, 0, 500, 1 }, 0 },
    { "DTERM NFCO", OME_UINT16, 
# 396 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 396 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t){ &cmsx_dterm_notch_cutoff, 0, 500, 1 }, 0 },
    { "YAW LPF", OME_UINT16, 
# 397 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 397 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t){ &cmsx_yaw_lpf_hz, 0, 500, 1 }, 0 },

    { "BACK", OME_Back, 
# 399 "./src/main/cms/cms_menu_imu.c" 3 4
                       ((void *)0)
# 399 "./src/main/cms/cms_menu_imu.c"
                           , 
# 399 "./src/main/cms/cms_menu_imu.c" 3 4
                             ((void *)0)
# 399 "./src/main/cms/cms_menu_imu.c"
                                 , 0 },
    { 
# 400 "./src/main/cms/cms_menu_imu.c" 3 4
     ((void *)0)
# 400 "./src/main/cms/cms_menu_imu.c"
         , OME_END, 
# 400 "./src/main/cms/cms_menu_imu.c" 3 4
                    ((void *)0)
# 400 "./src/main/cms/cms_menu_imu.c"
...
# 462 "./src/main/cms/cms_menu_imu.c" 3 4
                                      ((void *)0)
# 462 "./src/main/cms/cms_menu_imu.c"
                                          , 
# 462 "./src/main/cms/cms_menu_imu.c" 3 4
                                            ((void *)0)
# 462 "./src/main/cms/cms_menu_imu.c"
...
# 464 "./src/main/cms/cms_menu_imu.c" 3 4
                                        ((void *)0)
# 464 "./src/main/cms/cms_menu_imu.c"
                                            , &cmsx_PidProfileTable, 0 },
    { "COPY PP", OME_Funcall, cmsx_CopyPidProfile, 
# 465 "./src/main/cms/cms_menu_imu.c" 3 4
                                                                     ((void *)0)
# 465 "./src/main/cms/cms_menu_imu.c"
                                                                         , 0 },
    { "CPY RATE PROF TO", OME_TAB, 
# 466 "./src/main/cms/cms_menu_imu.c" 3 4
                                        ((void *)0)
# 466 "./src/main/cms/cms_menu_imu.c"
                                            , &cmsx_ControlRateProfileTable, 0 },
    { "COPY RP", OME_Funcall, cmsx_CopyControlRateProfile, 
# 467 "./src/main/cms/cms_menu_imu.c" 3 4
                                                                     ((void *)0)
# 467 "./src/main/cms/cms_menu_imu.c"
                                                                         , 0 },

    { "BACK", OME_Back, 
# 469 "./src/main/cms/cms_menu_imu.c" 3 4
                       ((void *)0)
# 469 "./src/main/cms/cms_menu_imu.c"
                           , 
# 469 "./src/main/cms/cms_menu_imu.c" 3 4
                             ((void *)0)
# 469 "./src/main/cms/cms_menu_imu.c"
                                 , 0 },
    { 
# 470 "./src/main/cms/cms_menu_imu.c" 3 4
     ((void *)0)
# 470 "./src/main/cms/cms_menu_imu.c"
         , OME_END, 
# 470 "./src/main/cms/cms_menu_imu.c" 3 4
                    ((void *)0)
# 470 "./src/main/cms/cms_menu_imu.c"
...
CMS_Menu cmsx_menuCopyProfile = {
    ...
    .onExit = 
# 479 "./src/main/cms/cms_menu_imu.c" 3 4
             ((void *)0)
# 479 "./src/main/cms/cms_menu_imu.c"
                 ,
...
{
    { "-- IMU --", OME_Label, 
# 487 "./src/main/cms/cms_menu_imu.c" 3 4
                             ((void *)0)
# 487 "./src/main/cms/cms_menu_imu.c"
                                 , 
# 487 "./src/main/cms/cms_menu_imu.c" 3 4
                                   ((void *)0)
# 487 "./src/main/cms/cms_menu_imu.c"
    ...
    {"PID PROF", OME_UINT8, cmsx_profileIndexOnChange, &(OSD_UINT8_t){ &tmpPidProfileIndex, 1, 3, 1}, 0},
    ...
    {"RATE PROF", OME_UINT8, cmsx_rateProfileIndexOnChange, &(OSD_UINT8_t){ &tmpRateProfileIndex, 1, 3, 1}, 0},
    ...
    {"BACK", OME_Back, 
# 502 "./src/main/cms/cms_menu_imu.c" 3 4
                      ((void *)0)
# 502 "./src/main/cms/cms_menu_imu.c"
                          , 
# 502 "./src/main/cms/cms_menu_imu.c" 3 4
                            ((void *)0)
# 502 "./src/main/cms/cms_menu_imu.c"
                                , 0},
    {
# 503 "./src/main/cms/cms_menu_imu.c" 3 4
    ((void *)0)
# 503 "./src/main/cms/cms_menu_imu.c"
        , OME_END, 
# 503 "./src/main/cms/cms_menu_imu.c" 3 4
                   ((void *)0)
# 503 "./src/main/cms/cms_menu_imu.c"
