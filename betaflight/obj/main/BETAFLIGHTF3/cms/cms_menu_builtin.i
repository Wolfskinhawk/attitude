# 1 "./src/main/cms/cms_menu_builtin.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/cms/cms_menu_builtin.c"
# 22 "./src/main/cms/cms_menu_builtin.c"
# 1 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\lib\\gcc\\arm-none-eabi\\7.2.1\\include\\stdbool.h" 1 3 4
# 23 "./src/main/cms/cms_menu_builtin.c" 2
...
# 24 "./src/main/cms/cms_menu_builtin.c" 2
...
# 25 "./src/main/cms/cms_menu_builtin.c" 2
...
int toupper (int __c);
int isblank (int __c);
# 26 "./src/main/cms/cms_menu_builtin.c" 2
...
# 28 "./src/main/cms/cms_menu_builtin.c" 2
...
# 34 "./src/main/cms/cms_menu_builtin.c" 2
...
# 36 "./src/main/cms/cms_menu_builtin.c" 2
...
# 37 "./src/main/cms/cms_menu_builtin.c" 2
...
# 38 "./src/main/cms/cms_menu_builtin.c" 2
...
# 50 "./src/main/cms/cms_menu_builtin.c" 2
...
# 51 "./src/main/cms/cms_menu_builtin.c" 2
...
# 52 "./src/main/cms/cms_menu_builtin.c" 2




static char infoGitRev[7 + 1];
static char infoTargetName[] = "BETAFLIGHTF3";

# 1 "./src/main/interface/msp_protocol.h" 1
# 53 "./src/main/interface/msp_protocol.h"
       
# 60 "./src/main/cms/cms_menu_builtin.c" 2
...
static OSD_Entry menuInfoEntries[] = {
    { "--- INFO ---", OME_Label, 
# 76 "./src/main/cms/cms_menu_builtin.c" 3 4
                                ((void *)0)
# 76 "./src/main/cms/cms_menu_builtin.c"
                                    , 
# 76 "./src/main/cms/cms_menu_builtin.c" 3 4
                                      ((void *)0)
# 76 "./src/main/cms/cms_menu_builtin.c"
                                          , 0 },
    { "FWID", OME_String, 
# 77 "./src/main/cms/cms_menu_builtin.c" 3 4
                         ((void *)0)
# 77 "./src/main/cms/cms_menu_builtin.c"
                             , "BTFL", 0 },
    { "FWVER", OME_String, 
# 78 "./src/main/cms/cms_menu_builtin.c" 3 4
                          ((void *)0)
# 78 "./src/main/cms/cms_menu_builtin.c"
                              , "3" "." "3" "." "0", 0 },
    { "GITREV", OME_String, 
# 79 "./src/main/cms/cms_menu_builtin.c" 3 4
                           ((void *)0)
# 79 "./src/main/cms/cms_menu_builtin.c"
                               , infoGitRev, 0 },
    { "TARGET", OME_String, 
# 80 "./src/main/cms/cms_menu_builtin.c" 3 4
                           ((void *)0)
# 80 "./src/main/cms/cms_menu_builtin.c"
                               , infoTargetName, 0 },
    { "BACK", OME_Back, 
# 81 "./src/main/cms/cms_menu_builtin.c" 3 4
                       ((void *)0)
# 81 "./src/main/cms/cms_menu_builtin.c"
                           , 
# 81 "./src/main/cms/cms_menu_builtin.c" 3 4
                             ((void *)0)
# 81 "./src/main/cms/cms_menu_builtin.c"
                                 , 0 },
    { 
# 82 "./src/main/cms/cms_menu_builtin.c" 3 4
     ((void *)0)
# 82 "./src/main/cms/cms_menu_builtin.c"
         , OME_END, 
# 82 "./src/main/cms/cms_menu_builtin.c" 3 4
                    ((void *)0)
# 82 "./src/main/cms/cms_menu_builtin.c"
...
static CMS_Menu menuInfo = {
    ...
    .onExit = 
# 91 "./src/main/cms/cms_menu_builtin.c" 3 4
             ((void *)0)
# 91 "./src/main/cms/cms_menu_builtin.c"
                 ,
...
{
    {"--- FEATURES ---", OME_Label, 
# 99 "./src/main/cms/cms_menu_builtin.c" 3 4
                                   ((void *)0)
# 99 "./src/main/cms/cms_menu_builtin.c"
                                       , 
# 99 "./src/main/cms/cms_menu_builtin.c" 3 4
                                         ((void *)0)
# 99 "./src/main/cms/cms_menu_builtin.c"
    ...
    {"BACK", OME_Back, 
# 118 "./src/main/cms/cms_menu_builtin.c" 3 4
                      ((void *)0)
# 118 "./src/main/cms/cms_menu_builtin.c"
                          , 
# 118 "./src/main/cms/cms_menu_builtin.c" 3 4
                            ((void *)0)
# 118 "./src/main/cms/cms_menu_builtin.c"
                                , 0},
    {
# 119 "./src/main/cms/cms_menu_builtin.c" 3 4
    ((void *)0)
# 119 "./src/main/cms/cms_menu_builtin.c"
        , OME_END, 
# 119 "./src/main/cms/cms_menu_builtin.c" 3 4
                   ((void *)0)
# 119 "./src/main/cms/cms_menu_builtin.c"
...
static CMS_Menu menuFeatures = {
    ...
    .onEnter = 
# 127 "./src/main/cms/cms_menu_builtin.c" 3 4
              ((void *)0)
# 127 "./src/main/cms/cms_menu_builtin.c"
                  ,
    .onExit = 
# 128 "./src/main/cms/cms_menu_builtin.c" 3 4
             ((void *)0)
# 128 "./src/main/cms/cms_menu_builtin.c"
                 ,
...
{
    {"-- MAIN --", OME_Label, 
# 136 "./src/main/cms/cms_menu_builtin.c" 3 4
                              ((void *)0)
# 136 "./src/main/cms/cms_menu_builtin.c"
                                  , 
# 136 "./src/main/cms/cms_menu_builtin.c" 3 4
                                    ((void *)0)
# 136 "./src/main/cms/cms_menu_builtin.c"
    ...
    {"SAVE&EXIT", OME_OSD_Exit, cmsMenuExit, (void *)(1), 0},
    {"SAVE&REBOOT", OME_OSD_Exit, cmsMenuExit, (void *)(2), 0},




    {
# 152 "./src/main/cms/cms_menu_builtin.c" 3 4
    ((void *)0)
# 152 "./src/main/cms/cms_menu_builtin.c"
        ,OME_END, 
# 152 "./src/main/cms/cms_menu_builtin.c" 3 4
                  ((void *)0)
# 152 "./src/main/cms/cms_menu_builtin.c"
...
CMS_Menu menuMain = {
    ...
    .onEnter = 
# 160 "./src/main/cms/cms_menu_builtin.c" 3 4
              ((void *)0)
# 160 "./src/main/cms/cms_menu_builtin.c"
                  ,
    .onExit = 
# 161 "./src/main/cms/cms_menu_builtin.c" 3 4
             ((void *)0)
# 161 "./src/main/cms/cms_menu_builtin.c"
                 ,
