# 1 "./src/main/sensors/esc_sensor.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/sensors/esc_sensor.c"
# 18 "./src/main/sensors/esc_sensor.c"
# 1 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\lib\\gcc\\arm-none-eabi\\7.2.1\\include\\stdbool.h" 1 3 4
# 19 "./src/main/sensors/esc_sensor.c" 2
...
# 20 "./src/main/sensors/esc_sensor.c" 2
...
# 21 "./src/main/sensors/esc_sensor.c" 2
...
# 23 "./src/main/sensors/esc_sensor.c" 2
...
# 27 "./src/main/sensors/esc_sensor.c" 2
...
# 29 "./src/main/sensors/esc_sensor.c" 2

# 1 "./src/main/pg/pg_ids.h" 1
# 18 "./src/main/pg/pg_ids.h"
       
# 31 "./src/main/sensors/esc_sensor.c" 2
...
# 33 "./src/main/sensors/esc_sensor.c" 2
...
# 36 "./src/main/sensors/esc_sensor.c" 2
...
# 37 "./src/main/sensors/esc_sensor.c" 2
...
# 38 "./src/main/sensors/esc_sensor.c" 2
...
# 21 "./src/main/sensors/esc_sensor.h" 2
...
# 40 "./src/main/sensors/esc_sensor.c" 2
...
# 42 "./src/main/sensors/esc_sensor.c" 2
...
# 44 "./src/main/sensors/esc_sensor.c" 2
...
# 46 "./src/main/sensors/esc_sensor.c" 2
# 66 "./src/main/sensors/esc_sensor.c"
extern const escSensorConfig_t pgResetTemplate_escSensorConfig; escSensorConfig_t escSensorConfig_System; escSensorConfig_t escSensorConfig_Copy; extern const pgRegistry_t escSensorConfig_Registry; const pgRegistry_t escSensorConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 517 | (0 << 12), .size = sizeof(escSensorConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&escSensorConfig_System, .copy = (uint8_t*)&escSensorConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_escSensorConfig}, };

const escSensorConfig_t pgResetTemplate_escSensorConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .halfDuplex = 0 }

 ;
# 80 "./src/main/sensors/esc_sensor.c"
enum {
...
static uint8_t telemetryBuffer[10] = { 0, };

static volatile uint8_t *buffer;
static volatile uint8_t bufferSize = 0;
static volatile uint8_t bufferPosition = 0;

static serialPort_t *escSensorPort = 
# 110 "./src/main/sensors/esc_sensor.c" 3 4
                                    ((void *)0)
# 110 "./src/main/sensors/esc_sensor.c"
                                        ;

static escSensorData_t escSensorData[8];
...
static 
# 119 "./src/main/sensors/esc_sensor.c" 3 4
      _Bool 
# 119 "./src/main/sensors/esc_sensor.c"
           combinedDataNeedsUpdate = 
# 119 "./src/main/sensors/esc_sensor.c" 3 4
                                     1
# 119 "./src/main/sensors/esc_sensor.c"
                                         ;
...
static 
# 136 "./src/main/sensors/esc_sensor.c" 3 4
      _Bool 
# 136 "./src/main/sensors/esc_sensor.c"
           isFrameComplete(void)
{
    return bufferPosition == bufferSize;
}


# 141 "./src/main/sensors/esc_sensor.c" 3 4
_Bool 
# 141 "./src/main/sensors/esc_sensor.c"
    isEscSensorActive(void)
{
    return escSensorPort != 
# 143 "./src/main/sensors/esc_sensor.c" 3 4
                           ((void *)0)
# 143 "./src/main/sensors/esc_sensor.c"
                               ;
}
    ...
    if (motorNumber < getMotorCount()) {
        ...
        if (combinedDataNeedsUpdate) {
            ...
            for (int i = 0; i < getMotorCount(); i = i + 1) {
                combinedEscSensorData.dataAge = __extension__ ({ __typeof__ (combinedEscSensorData.dataAge) _a = (combinedEscSensorData.dataAge); __typeof__ (escSensorData[i].dataAge) _b = (escSensorData[i].dataAge); _a > _b ? _a : _b; });
                combinedEscSensorData.temperature = __extension__ ({ __typeof__ (combinedEscSensorData.temperature) _a = (combinedEscSensorData.temperature); __typeof__ (escSensorData[i].temperature) _b = (escSensorData[i].temperature); _a > _b ? _a : _b; });
            ...
            combinedDataNeedsUpdate = 
# 171 "./src/main/sensors/esc_sensor.c" 3 4
                                     0
# 171 "./src/main/sensors/esc_sensor.c"
                                          ;

            {if (debugMode == (DEBUG_ESC_SENSOR)) {debug[(DEBUG_ESC_DATA_AGE)] = (combinedEscSensorData.dataAge);}};
        }

        return &combinedEscSensorData;
    } else {
        return 
# 178 "./src/main/sensors/esc_sensor.c" 3 4
              ((void *)0)
# 178 "./src/main/sensors/esc_sensor.c"
                  ;
    }
}
...
# 197 "./src/main/sensors/esc_sensor.c" 3 4
_Bool 
# 197 "./src/main/sensors/esc_sensor.c"
    escSensorInit(void)
{
    serialPortConfig_t *portConfig = findSerialPortConfig(FUNCTION_ESC_SENSOR);
    if (!portConfig) {
        return 
# 201 "./src/main/sensors/esc_sensor.c" 3 4
              0
# 201 "./src/main/sensors/esc_sensor.c"
                   ;
    }
    ...
    escSensorPort = openSerialPort(portConfig->identifier, FUNCTION_ESC_SENSOR, escSensorDataReceive, 
# 207 "./src/main/sensors/esc_sensor.c" 3 4
                                                                                                     ((void *)0)
# 207 "./src/main/sensors/esc_sensor.c"
                                                                                                         , 115200, MODE_RX, options);

    for (int i = 0; i < 8; i = i + 1) {
        escSensorData[i].dataAge = 255;
    }

    return escSensorPort != 
# 213 "./src/main/sensors/esc_sensor.c" 3 4
                           ((void *)0)
# 213 "./src/main/sensors/esc_sensor.c"
                               ;
}
...
static uint8_t decodeEscFrame(void)
{
    ...
    uint16_t chksum = calculateCrc8(telemetryBuffer, 10 - 1);
    uint16_t tlmsum = telemetryBuffer[10 - 1];
    uint8_t frameStatus;
    if (chksum == tlmsum) {
        ...
        combinedDataNeedsUpdate = 
# 256 "./src/main/sensors/esc_sensor.c" 3 4
                                 1
# 256 "./src/main/sensors/esc_sensor.c"
                                     ;

        frameStatus = ESC_SENSOR_FRAME_COMPLETE;

        {if (debugMode == (DEBUG_ESC_SENSOR_RPM)) {debug[(escSensorMotor)] = (escSensorData[escSensorMotor].rpm);}};
        {if (debugMode == (DEBUG_ESC_SENSOR_TMP)) {debug[(escSensorMotor)] = (escSensorData[escSensorMotor].temperature);}};
    } else {
...
{
    if (escSensorData[escSensorMotor].dataAge < 255) {
        escSensorData[escSensorMotor].dataAge++;

        combinedDataNeedsUpdate = 
# 274 "./src/main/sensors/esc_sensor.c" 3 4
                                 1
# 274 "./src/main/sensors/esc_sensor.c"
                                     ;
    }
}
...
void escSensorProcess(timeUs_t currentTimeUs)
{
    ...
    switch (escSensorTriggerState) {
        ...
        case ESC_SENSOR_TRIGGER_READY:
            ...
            startEscDataRead(telemetryBuffer, 10);
            motorDmaOutput_t * const motor = getMotorDmaOutput(escSensorMotor);
            motor->requestTelemetry = 
# 307 "./src/main/sensors/esc_sensor.c" 3 4
                                     1
# 307 "./src/main/sensors/esc_sensor.c"
                                         ;
            escSensorTriggerState = ESC_SENSOR_TRIGGER_PENDING;

            {if (debugMode == (DEBUG_ESC_SENSOR)) {debug[(DEBUG_ESC_MOTOR_INDEX)] = (escSensorMotor + 1);}};

            break;
        case ESC_SENSOR_TRIGGER_PENDING:
            if (currentTimeMs < escTriggerTimestamp + 100) {
                ...
                switch (state) {
                    ...
                    case ESC_SENSOR_FRAME_FAILED:
                        ...
                        {if (debugMode == (DEBUG_ESC_SENSOR)) {debug[(DEBUG_ESC_NUM_CRC_ERRORS)] = (++totalCrcErrorCount);}};
                        break;
                ...
                {if (debugMode == (DEBUG_ESC_SENSOR)) {debug[(DEBUG_ESC_NUM_TIMEOUTS)] = (++totalTimeoutCount);}};
            }
