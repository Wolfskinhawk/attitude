# 1 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_int.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_int.c"
# 29 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_int.c"
...
# 30 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_int.c" 2
...
# 53 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_int.c"
void CTR_LP(void)
{
  volatile uint16_t wEPVal = 0;

  while (((wIstr = ((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x44)))) & (0x8000)) != 0)
  {
    ...
    if (EPindex == 0)
    {
     ...
     SaveRState = ((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + ((uint8_t)0))));
     SaveTState = SaveRState & (0x0030);
     SaveRState &= (0x3000);

     { register uint32_t _wRegVal; _wRegVal = ((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + ((uint8_t)0)))) & (((0x3000)|((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))) |(0x0030)) ; if(((0x1000) & (0x2000))!= 0) _wRegVal ^= (0x1000); if(((0x2000) & (0x2000))!= 0) _wRegVal ^= (0x2000); if(((0x0010) & (0x0020))!= 0) _wRegVal ^= (0x0010); if(((0x0020) & (0x0020))!= 0) _wRegVal ^= (0x0020); (*(((volatile unsigned *)((0x40005C00L))) + ((uint8_t)0))= (uint16_t)_wRegVal | (0x8000)|(0x0080)); };
      ...
      if ((wIstr & (0x0010)) == 0)
      {
        ...
        ((*(((volatile unsigned *)((0x40005C00L))) + ((uint8_t)0))= (uint16_t)((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + ((uint8_t)0)))) & 0xFF7F & ((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))));
        In0_Process();



            { register uint32_t _wRegVal; _wRegVal = ((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + ((uint8_t)0)))) & (((0x3000)|((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))) |(0x0030)) ; if(((0x1000) & SaveRState)!= 0) _wRegVal ^= (0x1000); if(((0x2000) & SaveRState)!= 0) _wRegVal ^= (0x2000); if(((0x0010) & SaveTState)!= 0) _wRegVal ^= (0x0010); if(((0x0020) & SaveTState)!= 0) _wRegVal ^= (0x0020); (*(((volatile unsigned *)((0x40005C00L))) + ((uint8_t)0))= (uint16_t)_wRegVal | (0x8000)|(0x0080)); };
    return;
      }
      else
      {
        ...
        wEPVal = ((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + ((uint8_t)0))));

        if ((wEPVal &(0x0800)) != 0)
        {
          ((*(((volatile unsigned *)((0x40005C00L))) + ((uint8_t)0))= (uint16_t)((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + ((uint8_t)0)))) & 0x7FFF & ((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))));
          Setup0_Process();
    ...
    else
    {
      ...
      wEPVal = ((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + EPindex)));
      if ((wEPVal & (0x8000)) != 0)
      {

        ((*(((volatile unsigned *)((0x40005C00L))) + EPindex)= (uint16_t)((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + EPindex))) & 0x7FFF & ((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))));
      ...
      if ((wEPVal & (0x0080)) != 0)
      {
        ...
        ((*(((volatile unsigned *)((0x40005C00L))) + EPindex)= (uint16_t)((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + EPindex))) & 0xFF7F & ((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))));
...
# 161 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_int.c"
void CTR_HP(void)
{
  uint32_t wEPVal = 0;
