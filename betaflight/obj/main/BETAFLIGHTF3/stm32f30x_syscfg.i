# 1 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_syscfg.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_syscfg.c"
# 49 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_syscfg.c"
# 1 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/inc/stm32f30x_syscfg.h" 1
# 38 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/inc/stm32f30x_syscfg.h"
...
# 39 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/inc/stm32f30x_syscfg.h" 2
...
# 50 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_syscfg.c" 2
# 108 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_syscfg.c"
void SYSCFG_DeInit(void)
{

  ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000000))->CFGR1 &= ((uint32_t)0x00000003);

  ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000000))->CFGR1 |= 0x7C000000;

  ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000000))->RCR = 0x00000000;

  ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000000))->EXTICR[0] = 0;
  ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000000))->EXTICR[1] = 0;
  ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000000))->EXTICR[2] = 0;
  ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000000))->EXTICR[3] = 0;

  ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000000))->CFGR2 = 0;

  ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000000))->CFGR3 = 0;
}
# 136 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_syscfg.c"
void SYSCFG_MemoryRemapConfig(uint32_t SYSCFG_MemoryRemap)
{
  uint32_t tmpcfgr1 = 0;
  ...
  tmpcfgr1 = ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000000))->CFGR1;


  tmpcfgr1 &= (uint32_t) (~((uint32_t)0x00000003));


  tmpcfgr1 |= (uint32_t) SYSCFG_MemoryRemap;


  ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000000))->CFGR1 = tmpcfgr1;
}
# 192 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_syscfg.c"
void SYSCFG_DMAChannelRemapConfig(uint32_t SYSCFG_DMARemap, FunctionalState NewState)
{
  ...
  if ((SYSCFG_DMARemap & 0x80000000)!= 0x80000000)
  {
    if (NewState != DISABLE)
    {
      ...
      ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000000))->CFGR1 |= (uint32_t)SYSCFG_DMARemap;
    }
    else
    {
  ...
  else
  {
    if (NewState != DISABLE)
    {
      ...
      ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000000))->CFGR3 |= (uint32_t)SYSCFG_DMARemap;
    }
    else
    {
...
# 240 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_syscfg.c"
void SYSCFG_TriggerRemapConfig(uint32_t SYSCFG_TriggerRemap, FunctionalState NewState)
{
  ...
  if ((SYSCFG_TriggerRemap & 0x80000000)!= 0x80000000)
  {
    if (NewState != DISABLE)
    {
      ...
      ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000000))->CFGR1 |= (uint32_t)SYSCFG_TriggerRemap;
    }
    else
    {
  ...
  else
  {
    if (NewState != DISABLE)
    {
      ...
      ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000000))->CFGR3 |= (uint32_t)SYSCFG_TriggerRemap;
    }
    else
    {
...
# 286 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_syscfg.c"
void SYSCFG_EncoderRemapConfig(uint32_t SYSCFG_EncoderRemap)
{
  ...
  ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000000))->CFGR1 &= (uint32_t)(~((uint32_t)0x00C00000));


  ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000000))->CFGR1 |= (uint32_t)(SYSCFG_EncoderRemap);
}
# 312 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_syscfg.c"
void SYSCFG_USBInterruptLineRemapCmd(FunctionalState NewState)
{
  ...
  *(volatile uint32_t *) (((uint32_t)0x42000000) + (((((((uint32_t)0x40000000) + 0x00010000) + 0x00000000) - ((uint32_t)0x40000000)) + 0x00) * 32) + (0x05 * 4)) = (uint32_t)NewState;
}
# 344 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_syscfg.c"
void SYSCFG_I2CFastModePlusConfig(uint32_t SYSCFG_I2CFastModePlus, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000000))->CFGR1 |= (uint32_t)SYSCFG_I2CFastModePlus;
  }
  else
  {
...
# 376 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_syscfg.c"
void SYSCFG_ITConfig(uint32_t SYSCFG_IT, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000000))->CFGR1 |= SYSCFG_IT;
  }
  else
  {

    ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000000))->CFGR1 &= ((uint32_t)~SYSCFG_IT);
  }
}
# 402 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_syscfg.c"
void SYSCFG_EXTILineConfig(uint8_t EXTI_PortSourceGPIOx, uint8_t EXTI_PinSourcex)
{
  uint32_t tmp = 0x00;
  ...
  ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000000))->EXTICR[EXTI_PinSourcex >> 0x02] &= ~tmp;
  ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000000))->EXTICR[EXTI_PinSourcex >> 0x02] |= (((uint32_t)EXTI_PortSourceGPIOx) << (0x04 * (EXTI_PinSourcex & (uint8_t)0x03)));
}
# 426 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_syscfg.c"
void SYSCFG_BreakConfig(uint32_t SYSCFG_Break)
{

  ((void)0);

  ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000000))->CFGR2 |= (uint32_t) SYSCFG_Break;
}
# 441 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_syscfg.c"
void SYSCFG_BypassParityCheckDisable(void)
{

  *(volatile uint32_t *) (((uint32_t)0x42000000) + (((((((uint32_t)0x40000000) + 0x00010000) + 0x00000000) - ((uint32_t)0x40000000)) + 0x18) * 32) + (0x04 * 4)) = (uint32_t)0x00000001;
}
# 454 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_syscfg.c"
void SYSCFG_SRAMWRPEnable(uint32_t SYSCFG_SRAMWRP)
{
  ...
  ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000000))->RCR |= (uint32_t)SYSCFG_SRAMWRP;
}
# 470 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_syscfg.c"
FlagStatus SYSCFG_GetFlagStatus(uint32_t SYSCFG_Flag)
{
    (void)SYSCFG_Flag;
  ...
  if ((((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000000))->CFGR2 & ((uint32_t)0x00000100)) != (uint32_t)RESET)
  {
...
# 500 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_syscfg.c"
void SYSCFG_ClearFlag(uint32_t SYSCFG_Flag)
{

  ((void)0);

  ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000000))->CFGR2 |= (uint32_t) SYSCFG_Flag;
}
