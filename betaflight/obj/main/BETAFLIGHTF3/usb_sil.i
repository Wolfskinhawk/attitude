# 1 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_sil.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_sil.c"
# 31 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_sil.c"
...
# 32 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_sil.c" 2
# 48 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_sil.c"
uint32_t USB_SIL_Init(void)
{


  (*((volatile unsigned *)((0x40005C00L) + 0x44)) = (uint16_t)0);
  wInterrupt_Mask = ((0x8000) | (0x1000) | (0x0200) | (0x0400) );

  (*((volatile unsigned *)((0x40005C00L) + 0x40)) = (uint16_t)wInterrupt_Mask);
  return 0;
}
# 69 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_sil.c"
uint32_t USB_SIL_Write(uint8_t bEpAddr, uint8_t* pBufferPointer, uint32_t wBufferSize)
{
...
# 89 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_sil.c"
uint32_t USB_SIL_Read(uint8_t bEpAddr, uint8_t* pBufferPointer)
{
