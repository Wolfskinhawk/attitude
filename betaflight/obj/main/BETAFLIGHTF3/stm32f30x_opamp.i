# 1 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_opamp.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_opamp.c"
# 96 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_opamp.c"
# 1 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/inc/stm32f30x_opamp.h" 1
# 38 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/inc/stm32f30x_opamp.h"
...
# 39 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/inc/stm32f30x_opamp.h" 2
...
# 97 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_opamp.c" 2
# 144 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_opamp.c"
void OPAMP_DeInit(uint32_t OPAMP_Selection)
{

  *(volatile uint32_t *) (((((uint32_t)0x40000000) + 0x00010000) + 0x00000038) + OPAMP_Selection) = ((uint32_t)0x00000000);
}
# 164 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_opamp.c"
void OPAMP_Init(uint32_t OPAMP_Selection, OPAMP_InitTypeDef* OPAMP_InitStruct)
{
  uint32_t tmpreg = 0;
  ...
  tmpreg = *(volatile uint32_t *) (((((uint32_t)0x40000000) + 0x00010000) + 0x00000038) + OPAMP_Selection);


  tmpreg &= (uint32_t) (((uint32_t)0xFFFFFF93));


  tmpreg |= (uint32_t)(OPAMP_InitStruct->OPAMP_InvertingInput | OPAMP_InitStruct->OPAMP_NonInvertingInput);


  *(volatile uint32_t *) (((((uint32_t)0x40000000) + 0x00010000) + 0x00000038) + OPAMP_Selection) = tmpreg;
}
...
void OPAMP_StructInit(OPAMP_InitTypeDef* OPAMP_InitStruct)
{
  OPAMP_InitStruct->OPAMP_NonInvertingInput = ((uint32_t)0x00000000);
  OPAMP_InitStruct->OPAMP_InvertingInput = ((uint32_t)0x00000000);
}
# 209 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_opamp.c"
void OPAMP_PGAConfig(uint32_t OPAMP_Selection, uint32_t OPAMP_PGAGain, uint32_t OPAMP_PGAConnect)
{
  ...
  *(volatile uint32_t *) (((((uint32_t)0x40000000) + 0x00010000) + 0x00000038) + OPAMP_Selection) &= (uint32_t)(~((uint32_t)0x0003C000));


  *(volatile uint32_t *) (((((uint32_t)0x40000000) + 0x00010000) + 0x00000038) + OPAMP_Selection) |= (uint32_t) (OPAMP_PGAGain | OPAMP_PGAConnect);
}
# 239 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_opamp.c"
void OPAMP_VrefConfig(uint32_t OPAMP_Selection, uint32_t OPAMP_Vref)
{
  uint32_t tmpreg = 0;
  ...
  tmpreg &= (uint32_t) (~((uint32_t)0x00003000));
...
# 271 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_opamp.c"
void OPAMP_VrefConnectNonInvertingInput(uint32_t OPAMP_Selection, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    *(volatile uint32_t *) (((((uint32_t)0x40000000) + 0x00010000) + 0x00000038) + OPAMP_Selection) |= (uint32_t) (((uint32_t)0x00000002));
  }
  else
  {
...
# 297 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_opamp.c"
void OPAMP_VrefConnectADCCmd(uint32_t OPAMP_Selection, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    *(volatile uint32_t *) (((((uint32_t)0x40000000) + 0x00010000) + 0x00000038) + OPAMP_Selection) |= (uint32_t) (((uint32_t)0x20000000));
  }
  else
  {
...
# 331 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_opamp.c"
void OPAMP_TimerControlledMuxConfig(uint32_t OPAMP_Selection, OPAMP_InitTypeDef* OPAMP_InitStruct)
{
  uint32_t tmpreg = 0;
  ...
  tmpreg &= (uint32_t) (((uint32_t)0xFFFFF8FF));
...
# 364 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_opamp.c"
void OPAMP_TimerControlledMuxCmd(uint32_t OPAMP_Selection, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    *(volatile uint32_t *) (((((uint32_t)0x40000000) + 0x00010000) + 0x00000038) + OPAMP_Selection) |= (uint32_t) (((uint32_t)0x00000080));
  }
  else
  {
...
# 393 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_opamp.c"
void OPAMP_Cmd(uint32_t OPAMP_Selection, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    *(volatile uint32_t *) (((((uint32_t)0x40000000) + 0x00010000) + 0x00000038) + OPAMP_Selection) |= (uint32_t) (((uint32_t)0x00000001));
  }
  else
  {
...
# 424 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_opamp.c"
uint32_t OPAMP_GetOutputLevel(uint32_t OPAMP_Selection)
{
  ...
  if ((*(volatile uint32_t *) (((((uint32_t)0x40000000) + 0x00010000) + 0x00000038) + OPAMP_Selection) & (((uint32_t)0x40000000))) != 0)
  {
    opampout = ((uint32_t)0x40000000);
  }
  else
  {
    opampout = ((uint32_t)0x00000000);
  }


  return (uint32_t)(opampout);
}
# 458 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_opamp.c"
void OPAMP_OffsetTrimModeSelect(uint32_t OPAMP_Selection, uint32_t OPAMP_Trimming)
{
  ...
  *(volatile uint32_t *) (((((uint32_t)0x40000000) + 0x00010000) + 0x00000038) + OPAMP_Selection) &= (~(uint32_t) (((uint32_t)0x00040000)));


  *(volatile uint32_t *) (((((uint32_t)0x40000000) + 0x00010000) + 0x00000038) + OPAMP_Selection) |= OPAMP_Trimming;
}
# 484 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_opamp.c"
void OPAMP_OffsetTrimConfig(uint32_t OPAMP_Selection, uint32_t OPAMP_Input, uint32_t OPAMP_TrimValue)
{
  uint32_t tmpreg = 0;
  ...
  tmpreg &= ((uint32_t)~(((uint32_t)0x0000001F)<<OPAMP_Input));
...
# 517 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_opamp.c"
void OPAMP_StartCalibration(uint32_t OPAMP_Selection, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    *(volatile uint32_t *) (((((uint32_t)0x40000000) + 0x00010000) + 0x00000038) + OPAMP_Selection) |= (uint32_t) (((uint32_t)0x00000800));
  }
  else
  {
...
# 562 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_opamp.c"
void OPAMP_LockConfig(uint32_t OPAMP_Selection)
{
  ...
  *(volatile uint32_t *) (((((uint32_t)0x40000000) + 0x00010000) + 0x00000038) + OPAMP_Selection) |= (uint32_t) (((uint32_t)0x80000000));
}
