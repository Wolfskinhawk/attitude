# 1 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_mem.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_mem.c"
# 29 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_mem.c"
...
# 30 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_mem.c" 2
# 48 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_mem.c"
void UserToPMABufferCopy(const uint8_t *pbUsrBuf, uint16_t wPMABufAddr, uint16_t wNBytes)
{
  uint32_t n = (wNBytes + 1) >> 1;
  uint32_t i, temp1, temp2;
  uint16_t *pdwVal;
  pdwVal = (uint16_t *)(wPMABufAddr * 2 + (0x40006000L));
  for (i = n; i != 0; i--)
  {
...
# 74 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_mem.c"
void PMAToUserBufferCopy(uint8_t *pbUsrBuf, uint16_t wPMABufAddr, uint16_t wNBytes)
{
  uint32_t n = (wNBytes + 1) >> 1;
  uint32_t i;
  uint32_t *pdwVal;
  pdwVal = (uint32_t *)(wPMABufAddr * 2 + (0x40006000L));
  for (i = n; i != 0; i--)
  {
