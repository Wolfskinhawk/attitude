...
# 64 "./src/main/io/beeper.h"
    isBeeperOn(void);
# 51 "./src/main/io/beeper.c" 2
# 89 "./src/main/io/beeper.c"
...
static uint8_t beep_multiBeeps[64 + 1];
# 169 "./src/main/io/beeper.c"
...
typedef struct beeperTableEntry_s {
    ...
    { BEEPER_RX_LOST_LANDING,2,beep_sos,"RX_LOST_LANDING" },
    { BEEPER_DISARMING,3,beep_disarmBeep,"DISARMING" },
    { BEEPER_ARMING,4,beep_armingBeep,"ARMING" },
    { BEEPER_ARMING_GPS_FIX,5,beep_armedGpsFix,"ARMING_GPS_FIX" },
    { BEEPER_BAT_CRIT_LOW,6,beep_critBatteryBeep,"BAT_CRIT_LOW" },
    { BEEPER_BAT_LOW,7,beep_lowBatteryBeep,"BAT_LOW" },
    { BEEPER_GPS_STATUS,8,beep_multiBeeps,"GPS_STATUS" },
    { BEEPER_RX_SET,9,beep_shortBeep,"RX_SET" },
    ...
    { BEEPER_MULTI_BEEPS,13,beep_multiBeeps,"MULTI_BEEPS" },
    { BEEPER_DISARM_REPEAT,14,beep_disarmRepeatBeep,"DISARM_REPEAT" },
    { BEEPER_ARMED,15,beep_armedBeep,"ARMED" },
    { BEEPER_SYSTEM_INIT,16,
# 212 "./src/main/io/beeper.c" 3 4
     ((void *)0)
# 212 "./src/main/io/beeper.c"
     ,"SYSTEM_INIT" },
    { BEEPER_USB,17,
# 213 "./src/main/io/beeper.c" 3 4
     ((void *)0)
# 213 "./src/main/io/beeper.c"
     ,"ON_USB" },
    { BEEPER_BLACKBOX_ERASE,18,beep_2shortBeeps,"BLACKBOX_ERASE" },
    { BEEPER_CRASH_FLIP_MODE,19,beep_2longerBeeps,"CRASH FLIP" },
    { BEEPER_CAM_CONNECTION_OPEN,20,beep_camOpenBeep,"CAM_CONNECTION_OPEN" },
    { BEEPER_CAM_CONNECTION_CLOSE,21,beep_camCloseBeep,"CAM_CONNECTION_CLOSED" },
    { BEEPER_ALL,22,
# 218 "./src/main/io/beeper.c" 3 4
     ((void *)0)
# 218 "./src/main/io/beeper.c"
     ,"ALL" },
    { BEEPER_PREFERENCE,23,
# 219 "./src/main/io/beeper.c" 3 4
     ((void *)0)
# 219 "./src/main/io/beeper.c"
     ,"PREFERRED" },
};

static const beeperTableEntry_t *currentBeeperEntry = 
# 222 "./src/main/io/beeper.c" 3 4
                                                     ((void *)0)
# 222 "./src/main/io/beeper.c"
                                                         ;
...
void beeper(beeperMode_e mode)
{
    ...
    const beeperTableEntry_t *selectedCandidate = 
# 242 "./src/main/io/beeper.c" 3 4
                                                 ((void *)0)
# 242 "./src/main/io/beeper.c"
                                                     ;
    for (uint32_t i = 0; i < (sizeof(beeperTable) / sizeof(beeperTableEntry_t)); i++) {
...
{
    systemBeep(
# 273 "./src/main/io/beeper.c" 3 4
   0
# 273 "./src/main/io/beeper.c"
   );
    warningLedDisable();
    warningLedRefresh();
    ...
    currentBeeperEntry = 
# 283 "./src/main/io/beeper.c" 3 4
                        ((void *)0)
# 283 "./src/main/io/beeper.c"
                            ;
}
...
void beeperWarningBeeps(uint8_t beepCount)
{
    uint8_t longBeepCount = beepCount / 5;
    uint8_t shortBeepCount = beepCount % 5;

    unsigned i = 0;

    unsigned count = 0;
    while (i < 64 - 1 && count < 5) {
        beep_multiBeeps[i++] = 50 / 10;
        if (++count < 5) {
            beep_multiBeeps[i++] = 50 / 10;
        } else {
            beep_multiBeeps[i++] = 500 / 10;
        }
    }

    while (i < 64 - 1 && longBeepCount > 0) {
        beep_multiBeeps[i++] = 250 / 10;
        if (--longBeepCount > 0) {
            beep_multiBeeps[i++] = 250 / 10;
        } else {
            beep_multiBeeps[i++] = 500 / 10;
...
void beeperUpdate(timeUs_t currentTimeUs)
{
    ...
    if (currentBeeperEntry == 
# 381 "./src/main/io/beeper.c" 3 4
                             ((void *)0)
# 381 "./src/main/io/beeper.c"
                                 ) {
        return;
    }
    ...
    if (!beeperIsOn) {
        ...
        if (!areMotorsRunning() && beeperConfig()->dshotBeaconTone && (beeperConfig()->dshotBeaconTone <= DSHOT_CMD_BEACON5) && (currentBeeperEntry->mode == BEEPER_RX_SET || currentBeeperEntry->mode == BEEPER_RX_LOST)) {
            ...
            pwmWriteDshotCommand(255, getMotorCount(), beeperConfig()->dshotBeaconTone);
        ...
        if (currentBeeperEntry->sequence[beeperPos] != 0) {
            if (!(getBeeperOffMask() & (1 << (currentBeeperEntry->mode - 1))))
                systemBeep(
# 405 "./src/main/io/beeper.c" 3 4
               1
# 405 "./src/main/io/beeper.c"
               );
            warningLedEnable();
            warningLedRefresh();
        ...
        if (currentBeeperEntry->sequence[beeperPos] != 0) {
            systemBeep(
# 419 "./src/main/io/beeper.c" 3 4
           0
# 419 "./src/main/io/beeper.c"
           );
            warningLedDisable();
            warningLedRefresh();
        }
...
static void beeperProcessCommand(timeUs_t currentTimeUs)
{
    if (currentBeeperEntry->sequence[beeperPos] == 0xFE) {
        beeperPos = 0;
    } else if (currentBeeperEntry->sequence[beeperPos] == 0xFF) {
        beeperSilence();
    } else {
...
beeperMode_e beeperModeForTableIndex(int idx)
{
    return (idx >= 0 && idx < (int)(sizeof(beeperTable) / sizeof(beeperTableEntry_t))) ? beeperTable[idx].mode : BEEPER_SILENCE;
}
...
const char *beeperNameForTableIndex(int idx)
{
    ...
    return (idx >= 0 && idx < (int)(sizeof(beeperTable) / sizeof(beeperTableEntry_t))) ? beeperTable[idx].name : 
# 483 "./src/main/io/beeper.c" 3 4
                                                                                      ((void *)0)
# 483 "./src/main/io/beeper.c"
                                                                                          ;
...
int beeperTableEntryCount(void)
{
    return (int)(sizeof(beeperTable) / sizeof(beeperTableEntry_t));
}
...
# 498 "./src/main/io/beeper.c" 3 4
_Bool 
# 498 "./src/main/io/beeper.c"
    isBeeperOn(void)
{
    return beeperIsOn;
}
