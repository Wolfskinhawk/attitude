...
# 14 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\arm-none-eabi\\include\\newlib.h" 3
# 1 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\arm-none-eabi\\include\\_newlib_version.h" 1 3
# 15 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\arm-none-eabi\\include\\newlib.h" 2 3
...
# 1 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\arm-none-eabi\\include\\sys\\features.h" 1 3
# 6 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\arm-none-eabi\\include\\sys\\config.h" 2 3
...
# 1 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\arm-none-eabi\\include\\machine\\_default_types.h" 1 3
# 41 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\arm-none-eabi\\include\\machine\\_default_types.h" 3
typedef signed char __int8_t;

typedef unsigned char __uint8_t;
# 55 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\arm-none-eabi\\include\\machine\\_default_types.h" 3
typedef short int __int16_t;

typedef short unsigned int __uint16_t;
# 77 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\arm-none-eabi\\include\\machine\\_default_types.h" 3
typedef long int __int32_t;

typedef long unsigned int __uint32_t;
# 103 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\arm-none-eabi\\include\\machine\\_default_types.h" 3
typedef long long int __int64_t;

typedef long long unsigned int __uint64_t;
# 134 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\arm-none-eabi\\include\\machine\\_default_types.h" 3
typedef signed char __int_least8_t;

typedef unsigned char __uint_least8_t;
# 160 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\arm-none-eabi\\include\\machine\\_default_types.h" 3
typedef short int __int_least16_t;

typedef short unsigned int __uint_least16_t;
# 182 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\arm-none-eabi\\include\\machine\\_default_types.h" 3
typedef long int __int_least32_t;

typedef long unsigned int __uint_least32_t;
# 200 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\arm-none-eabi\\include\\machine\\_default_types.h" 3
typedef long long int __int_least64_t;

typedef long long unsigned int __uint_least64_t;
# 214 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\arm-none-eabi\\include\\machine\\_default_types.h" 3
...
# 8 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\arm-none-eabi\\include\\machine\\_types.h" 2 3
...
# 13 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\arm-none-eabi\\include\\stdint.h" 3 4
...
# 38 "./src/main/io/ledstrip.c" 2

# 1 "./src/main/pg/pg_ids.h" 1
# 18 "./src/main/pg/pg_ids.h"
       
# 40 "./src/main/io/ledstrip.c" 2
...
# 21 "./src/main/drivers/light_ws2811strip.h" 2
# 34 "./src/main/drivers/light_ws2811strip.h"
...
# 50 "./src/main/drivers/light_ws2811strip.h" 3 4
_Bool 
# 50 "./src/main/drivers/light_ws2811strip.h"
...
# 26 "./src/main/drivers/vtx_common.h" 2
...
# 74 "./src/main/io/ledstrip.c" 2

extern void pgResetFn_ledStripConfig(ledStripConfig_t *); ledStripConfig_t ledStripConfig_System; ledStripConfig_t ledStripConfig_Copy; extern const pgRegistry_t ledStripConfig_Registry; const pgRegistry_t ledStripConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 27 | (0 << 12), .size = sizeof(ledStripConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&ledStripConfig_System, .copy = (uint8_t*)&ledStripConfig_Copy, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_ledStripConfig }, };

static 
# 77 "./src/main/io/ledstrip.c" 3 4
      _Bool 
# 77 "./src/main/io/ledstrip.c"
           ledStripInitialised = 
# 77 "./src/main/io/ledstrip.c" 3 4
                                 0
# 77 "./src/main/io/ledstrip.c"
                                      ;
static 
# 78 "./src/main/io/ledstrip.c" 3 4
      _Bool 
# 78 "./src/main/io/ledstrip.c"
           ledStripEnabled = 
# 78 "./src/main/io/ledstrip.c" 3 4
                             1
# 78 "./src/main/io/ledstrip.c"
...
{
    memset(ledStripConfig->ledConfigs, 0, 32 * sizeof(ledConfig_t));

    memset(ledStripConfig->colors, 0, (sizeof(hsv) / sizeof((hsv)[0])) * sizeof(hsvColor_t));
    ((void)sizeof(char[1 - 2*!!(16 < (sizeof(hsv) / sizeof((hsv)[0])))]));
    for (unsigned colorIndex = 0; colorIndex < (sizeof(hsv) / sizeof((hsv)[0])); colorIndex++) {
...
static void updateDimensions(void)
{
    ...
    for (int ledIndex = 0; ledIndex < ledCounts.count; ledIndex++) {
        ...
        maxX = __extension__ ({ __typeof__ (ledX) _a = (ledX); __typeof__ (maxX) _b = (maxX); _a > _b ? _a : _b; });
        minX = __extension__ ({ __typeof__ (ledX) _a = (ledX); __typeof__ (minX) _b = (minX); _a < _b ? _a : _b; });
        int ledY = ledGetY(ledConfig);
        maxY = __extension__ ({ __typeof__ (ledY) _a = (ledY); __typeof__ (maxY) _b = (maxY); _a > _b ? _a : _b; });
        minY = __extension__ ({ __typeof__ (ledY) _a = (ledY); __typeof__ (minY) _b = (minY); _a < _b ? _a : _b; });
    }
...
static void updateLedCount(void)
{
    ...
    for (int ledIndex = 0; ledIndex < 32; ledIndex++) {
        const ledConfig_t *ledConfig = &ledStripConfig()->ledConfigs[ledIndex];
...
static const char directionCodes[6] = { 'N', 'E', 'S', 'W', 'U', 'D' };
static const char baseFunctionCodes[7] = { 'C', 'F', 'A', 'L', 'S', 'G', 'R' };
static const char overlayCodes[6] = { 'T', 'O', 'B', 'V', 'I', 'W' };




# 268 "./src/main/io/ledstrip.c" 3 4
_Bool 
# 268 "./src/main/io/ledstrip.c"
    parseLedStripConfig(int ledIndex, const char *config)
{
    if (ledIndex >= 32)
        return 
# 271 "./src/main/io/ledstrip.c" 3 4
              0
# 271 "./src/main/io/ledstrip.c"
                   ;
    ...
    for (enum parseState_e parseState = 0; parseState < PARSE_STATE_COUNT; parseState++) {
        char chunk[11];
        {
            ...
            int chunkIndex = 0;
            while (*config && *config != chunkSeparator && chunkIndex < (11 - 1)) {
                chunk[chunkIndex++] = *config++;
            }
            chunk[chunkIndex++] = 0;
            if (*config != chunkSeparator) {
                return 
# 301 "./src/main/io/ledstrip.c" 3 4
                      0
# 301 "./src/main/io/ledstrip.c"
                           ;
            }
            config++;
        }
        switch (parseState) {
            ...
            case DIRECTIONS:
                for (char *ch = chunk; *ch; ch++) {
                    for (ledDirectionId_e dir = 0; dir < 6; dir++) {
                        if (directionCodes[dir] == *ch) {
                            direction_flags |= (1 << (dir));
                            break;
                        }
                    }
                }
            ...
            case FUNCTIONS:
                for (char *ch = chunk; *ch; ch++) {
                    for (ledBaseFunctionId_e fn = 0; fn < 7; fn++) {
                    ...
                    for (ledOverlayId_e ol = 0; ol < 6; ol++) {
            ...
            case RING_COLORS:
                ...
                if (color >= 16)
                    color = 0;
                break;
            case PARSE_STATE_COUNT:;
        }
    }

    *ledConfig = (((((((x) & 0x0F) << 4) | (((y) & 0x0F) << 0))) << 0) | ((color) << 18) | ((direction_flags) << 22) | ((baseFunction) << 8) | ((overlay_flags) << 12) | ((0) << 28));

    reevaluateLedConfig();

    return 
# 352 "./src/main/io/ledstrip.c" 3 4
          1
# 352 "./src/main/io/ledstrip.c"
              ;
}
...
static hsvColor_t* getDirectionalModeColor(const int ledIndex, const modeColorIndexes_t *modeColors)
{
    ...
    return 
# 423 "./src/main/io/ledstrip.c" 3 4
          ((void *)0)
# 423 "./src/main/io/ledstrip.c"
              ;
}
...
static void applyLedFixedLayers(void)
{
    for (int ledIndex = 0; ledIndex < ledCounts.count; ledIndex++) {
        ...
        case LED_FUNCTION_COLOR:
            ...
            hsvColor_t nextColor = ledStripConfig()->colors[(ledGetColor(ledConfig) + 1 + 16) % 16];
            hsvColor_t previousColor = ledStripConfig()->colors[(ledGetColor(ledConfig) - 1 + 16) % 16];

            if (ledGetOverlayBit(ledConfig, LED_OVERLAY_THROTTLE)) {
                int centerPWM = (1000 + 2000) / 2;
                if (auxInput < centerPWM) {
                    ...
                    color.s = scaleRange(auxInput, centerPWM, 2000, color.s, nextColor.s);
                    color.v = scaleRange(auxInput, centerPWM, 2000, color.v, nextColor.v);
                }
            }
        ...
        case LED_FUNCTION_FLIGHT_MODE:
            for (unsigned i = 0; i < (sizeof(flightModeToLed) / sizeof((flightModeToLed)[0])); i++)
                if (!flightModeToLed[i].flightMode || (flightModeFlags & (flightModeToLed[i].flightMode))) {
        ...
        case LED_FUNCTION_ARM_STATE:
            color = (armingFlags & (ARMED)) ? *getSC(LED_SCOLOR_ARMED) : *getSC(LED_SCOLOR_DISARMED);
            break;
        ...
        if ((fn != LED_FUNCTION_COLOR) && ledGetOverlayBit(ledConfig, LED_OVERLAY_THROTTLE)) {
            hOffset += scaleRange(auxInput, 1000, 2000, 0, 359 + 1);
        }
...
static void applyLedWarningLayer(
# 529 "./src/main/io/ledstrip.c" 3 4
                                _Bool 
# 529 "./src/main/io/ledstrip.c"
                                     updateNow, timeUs_t *timer)
{
    static uint8_t warningFlashCounter = 0;
    static uint8_t warningFlags = 0;
    ...
    if (updateNow) {
        ...
        if (warningFlashCounter == 0) {
            ...
            if (!(armingFlags & (ARMED)) && isArmingDisabled())
                warningFlags |= 1 << WARNING_ARMING_DISABLED;
        }
        *timer += ((int32_t)((1000 * 1000) / (10)));
    }

    const hsvColor_t *warningColor = 
# 551 "./src/main/io/ledstrip.c" 3 4
                                    ((void *)0)
# 551 "./src/main/io/ledstrip.c"
                                        ;

    if (warningFlags) {
        
# 554 "./src/main/io/ledstrip.c" 3 4
       _Bool 
# 554 "./src/main/io/ledstrip.c"
            colorOn = (warningFlashCounter % 2) == 0;
        warningFlags_e warningId = warningFlashCounter / 4;
        if (warningFlags & (1 << warningId)) {
            switch (warningId) {
                case WARNING_ARMING_DISABLED:
                    warningColor = colorOn ? &(hsv[COLOR_GREEN]) : &(hsv[COLOR_BLACK]);
                    break;
                case WARNING_LOW_BATTERY:
                    warningColor = colorOn ? &(hsv[COLOR_RED]) : &(hsv[COLOR_BLACK]);
                    break;
                case WARNING_FAILSAFE:
                    warningColor = colorOn ? &(hsv[COLOR_YELLOW]) : &(hsv[COLOR_BLUE]);
                    break;
                default:;
            }
        }
...
# 582 "./src/main/io/ledstrip.c" 3 4
                            _Bool 
# 582 "./src/main/io/ledstrip.c"
                                 updateNow, timeUs_t *timer)
{
...
# 587 "./src/main/io/ledstrip.c" 3 4
                                 0
# 587 "./src/main/io/ledstrip.c"
                                      ;
    static uint16_t lastCheck = 0;
    static 
# 589 "./src/main/io/ledstrip.c" 3 4
          _Bool 
# 589 "./src/main/io/ledstrip.c"
               blink = 
# 589 "./src/main/io/ledstrip.c" 3 4
                       0
# 589 "./src/main/io/ledstrip.c"
    ...
    if (updateNow) {
        ...
        frequency = vtx58frequencyTable[band - 1][channel - 1];
    ...
    if (showSettings) {
        ...
        for (int i = 0; i < ledCounts.count && vtxLedCount < 6; ++i) {
            ...
            if (ledGetOverlayBit(ledConfig, LED_OVERLAY_VTX)) {
                ...
                else if (vtxLedCount > 0 && power >= vtxLedCount && !pit) {
...
# 674 "./src/main/io/ledstrip.c" 3 4
                                _Bool 
# 674 "./src/main/io/ledstrip.c"
                                     updateNow, timeUs_t *timer)
{
    static 
# 676 "./src/main/io/ledstrip.c" 3 4
          _Bool 
# 676 "./src/main/io/ledstrip.c"
               flash = 
# 676 "./src/main/io/ledstrip.c" 3 4
                       0
# 676 "./src/main/io/ledstrip.c"
    ...
    int timerDelayUs = ((int32_t)((1000 * 1000) / (1)));
    ...
    if (updateNow) {
        ...
        switch (getBatteryState()) {
            case BATTERY_OK:
                flash = 
# 684 "./src/main/io/ledstrip.c" 3 4
                       1
# 684 "./src/main/io/ledstrip.c"
                           ;
                timerDelayUs = ((int32_t)((1000 * 1000) / (1)));

                break;
            case BATTERY_WARNING:
                flash = !flash;
                timerDelayUs = ((int32_t)((1000 * 1000) / (2)));

                break;
            default:
                flash = !flash;
                timerDelayUs = ((int32_t)((1000 * 1000) / (8)));
    ...
    *timer += timerDelayUs;
    ...
    if (!flash) {
       ...
       applyLedHsv(((LED_FUNCTION_BATTERY) << 8), bgc);
    }
}

static void applyLedRssiLayer(
# 709 "./src/main/io/ledstrip.c" 3 4
                             _Bool 
# 709 "./src/main/io/ledstrip.c"
                                  updateNow, timeUs_t *timer)
{
    static 
# 711 "./src/main/io/ledstrip.c" 3 4
          _Bool 
# 711 "./src/main/io/ledstrip.c"
               flash = 
# 711 "./src/main/io/ledstrip.c" 3 4
                       0
# 711 "./src/main/io/ledstrip.c"
    ...
    int timerDelay = ((int32_t)((1000 * 1000) / (1)));
    ...
    if (updateNow) {
        ...
        if (state > 50) {
            flash = 
# 719 "./src/main/io/ledstrip.c" 3 4
                   1
# 719 "./src/main/io/ledstrip.c"
                       ;
            timerDelay = ((int32_t)((1000 * 1000) / (1)));
        } else if (state > 20) {
            flash = !flash;
            timerDelay = ((int32_t)((1000 * 1000) / (2)));
        } else {
            flash = !flash;
            timerDelay = ((int32_t)((1000 * 1000) / (8)));
        }
    }
...
# 779 "./src/main/io/ledstrip.c"
static void applyLedIndicatorLayer(
# 779 "./src/main/io/ledstrip.c" 3 4
                                  _Bool 
# 779 "./src/main/io/ledstrip.c"
                                       updateNow, timeUs_t *timer)
{
    static 
# 781 "./src/main/io/ledstrip.c" 3 4
          _Bool 
# 781 "./src/main/io/ledstrip.c"
               flash = 0;

    if (updateNow) {
        if (rxIsReceivingSignal()) {

            int scale = __extension__ ({ __typeof__ (__extension__ ({ __typeof__ (rcCommand[ROLL]) _x = (rcCommand[ROLL]); _x > 0 ? _x : -_x; })) _a = (__extension__ ({ __typeof__ (rcCommand[ROLL]) _x = (rcCommand[ROLL]); _x > 0 ? _x : -_x; })); __typeof__ (__extension__ ({ __typeof__ (rcCommand[PITCH]) _x = (rcCommand[PITCH]); _x > 0 ? _x : -_x; })) _b = (__extension__ ({ __typeof__ (rcCommand[PITCH]) _x = (rcCommand[PITCH]); _x > 0 ? _x : -_x; })); _a > _b ? _a : _b; });
            scale = scale - 25;
            *timer += ((int32_t)((1000 * 1000) / (5 + (45 * scale) / (500 - 25))));
    ...
    const hsvColor_t *flashColor = &(hsv[COLOR_ORANGE]);

    quadrant_e quadrants = 0;
    if (rcCommand[ROLL] > 25) {
        quadrants |= QUADRANT_EAST;
    } else if (rcCommand[ROLL] < -25) {
        quadrants |= QUADRANT_WEST;
    }
    if (rcCommand[PITCH] > 25) {
        quadrants |= QUADRANT_NORTH;
    } else if (rcCommand[PITCH] < -25) {
...
static void updateLedRingCounts(void)
{
    ...
    if ((ledCounts.ring % 6) == 0) {
        seqLen = 6;
    } else {
        seqLen = ledCounts.ring;


        while ((seqLen > 6) && ((seqLen % 2) == 0)) {
            seqLen /= 2;
        }
    }
...
static void applyLedThrustRingLayer(
# 842 "./src/main/io/ledstrip.c" 3 4
                                   _Bool 
# 842 "./src/main/io/ledstrip.c"
                                        updateNow, timeUs_t *timer)
{
    ...
    if (updateNow) {
        ...
        *timer += ((int32_t)((1000 * 1000) / (5 + (45 * scaledThrottle) / 100)));
    }
...
# 857 "./src/main/io/ledstrip.c" 3 4
           _Bool 
# 857 "./src/main/io/ledstrip.c"
                applyColor;
            if ((armingFlags & (ARMED))) {
                applyColor = (ledRingIndex + rotationPhase) % ledCounts.ringSeqLen < 2;
            } else {
                applyColor = !(ledRingIndex % 2);
            }
...
static int brightnessForLarsonIndex(larsonParameters_t *larsonParameters, uint8_t larsonIndex)
{
    ...
    if (__extension__ ({ __typeof__ (offset) _x = (offset); _x > 0 ? _x : -_x; }) > 1)
...
static void applyLarsonScannerLayer(
# 912 "./src/main/io/ledstrip.c" 3 4
                                   _Bool 
# 912 "./src/main/io/ledstrip.c"
                                        updateNow, timeUs_t *timer)
{
...
static void applyLedBlinkLayer(
# 937 "./src/main/io/ledstrip.c" 3 4
                              _Bool 
# 937 "./src/main/io/ledstrip.c"
                                   updateNow, timeUs_t *timer)
{
    const uint16_t blinkPattern = 0x8005;
...
# 950 "./src/main/io/ledstrip.c" 3 4
   _Bool 
# 950 "./src/main/io/ledstrip.c"
        ledOn = (blinkMask & 1);
    if (!ledOn) {
...
typedef void applyLayerFn_timed(
# 1021 "./src/main/io/ledstrip.c" 3 4
                               _Bool 
# 1021 "./src/main/io/ledstrip.c"
                                    updateNow, timeUs_t *timer);
...
void ledStripUpdate(timeUs_t currentTimeUs)
{
    ...
    if (IS_RC_MODE_ACTIVE(BOXLEDLOW) && !(ledStripConfig()->ledstrip_visual_beeper && isBeeperOn())) {
        if (ledStripEnabled) {
            ledStripDisable();
            ledStripEnabled = 
# 1051 "./src/main/io/ledstrip.c" 3 4
                             0
# 1051 "./src/main/io/ledstrip.c"
                                  ;
        }
        return;
    }
    ledStripEnabled = 
# 1055 "./src/main/io/ledstrip.c" 3 4
                     1
# 1055 "./src/main/io/ledstrip.c"
                         ;
    ...
    scaledThrottle = (armingFlags & (ARMED)) ? scaleRange(rcData[THROTTLE], 1000, 2000, 0, 100) : 0;
    auxInput = rcData[ledStripConfig()->ledstrip_aux_channel];

    applyLedFixedLayers();

    for (timId_e timId = 0; timId < (sizeof(layerTable) / sizeof((layerTable)[0])); timId++) {
        uint32_t *timer = &timerVal[timId];
        
# 1085 "./src/main/io/ledstrip.c" 3 4
       _Bool 
# 1085 "./src/main/io/ledstrip.c"
            updateNow = timActive & (1 << timId);
...
# 1091 "./src/main/io/ledstrip.c" 3 4
_Bool 
# 1091 "./src/main/io/ledstrip.c"
    parseColor(int index, const char *colorConfig)
{
...
# 1097 "./src/main/io/ledstrip.c" 3 4
   _Bool 
# 1097 "./src/main/io/ledstrip.c"
        result = 
# 1097 "./src/main/io/ledstrip.c" 3 4
                 1
# 1097 "./src/main/io/ledstrip.c"
                     ;
    static const uint16_t hsv_limit[(HSV_VALUE + 1)] = {
        [HSV_HUE] = 359,
        [HSV_SATURATION] = 255,
        [HSV_VALUE] = 255,
    };
    for (int componentIndex = 0; result && componentIndex < (HSV_VALUE + 1); componentIndex++) {
        int val = atoi(remainingCharacters);
        if (val > hsv_limit[componentIndex]) {
            result = 
# 1106 "./src/main/io/ledstrip.c" 3 4
                    0
# 1106 "./src/main/io/ledstrip.c"
                         ;
            break;
        }
        ...
        if (remainingCharacters) {
            ...
            if (componentIndex < (HSV_VALUE + 1) - 1) {
                result = 
# 1125 "./src/main/io/ledstrip.c" 3 4
                        0
# 1125 "./src/main/io/ledstrip.c"
                             ;
            }
        }
    }
...
# 1140 "./src/main/io/ledstrip.c" 3 4
_Bool 
# 1140 "./src/main/io/ledstrip.c"
    setModeColor(ledModeIndex_e modeIndex, int modeColorIndex, int colorIndex)
{

    if (colorIndex < 0 || colorIndex >= 16)
        return 
# 1144 "./src/main/io/ledstrip.c" 3 4
              0
# 1144 "./src/main/io/ledstrip.c"
                   ;
    if (modeIndex < 6) {
        if (modeColorIndex < 0 || modeColorIndex >= 6)
            return 
# 1147 "./src/main/io/ledstrip.c" 3 4
                  0
# 1147 "./src/main/io/ledstrip.c"
                       ;
        ledStripConfigMutable()->modeColors[modeIndex].color[modeColorIndex] = colorIndex;
    } else if (modeIndex == LED_SPECIAL) {
        if (modeColorIndex < 0 || modeColorIndex >= 11)
            return 
# 1151 "./src/main/io/ledstrip.c" 3 4
                  0
# 1151 "./src/main/io/ledstrip.c"
                       ;
        ...
        if (modeColorIndex < 0 || modeColorIndex >= 1)
            return 
# 1155 "./src/main/io/ledstrip.c" 3 4
                  0
# 1155 "./src/main/io/ledstrip.c"
                       ;
        ledStripConfigMutable()->ledstrip_aux_channel = colorIndex;
    } else {
        return 
# 1158 "./src/main/io/ledstrip.c" 3 4
              0
# 1158 "./src/main/io/ledstrip.c"
                   ;
    }
    return 
# 1160 "./src/main/io/ledstrip.c" 3 4
          1
# 1160 "./src/main/io/ledstrip.c"
              ;
}
...
void ledStripInit(void)
{
    ...
    ledStripInitialised = 
# 1168 "./src/main/io/ledstrip.c" 3 4
                         0
# 1168 "./src/main/io/ledstrip.c"
                              ;
}
...
void ledStripEnable(void)
{
    reevaluateLedConfig();
    ledStripInitialised = 
# 1174 "./src/main/io/ledstrip.c" 3 4
                         1
# 1174 "./src/main/io/ledstrip.c"
                             ;
