...
# 57 "./src/main/io/vtx_string.c" 3 4
_Bool 
# 57 "./src/main/io/vtx_string.c"
    vtx58_Freq2Bandchan(uint16_t freq, uint8_t *pBand, uint8_t *pChannel)
{


    for (int band = 5 - 1 ; band >= 0 ; band--) {
        for (int channel = 0 ; channel < 8 ; channel++) {
            if (vtx58frequencyTable[band][channel] == freq) {
                *pBand = band + 1;
                *pChannel = channel + 1;
                return 
# 66 "./src/main/io/vtx_string.c" 3 4
                      1
# 66 "./src/main/io/vtx_string.c"
                          ;
            }
        }
    }
    ...
    *pChannel = 0;
    ...
    return 
# 74 "./src/main/io/vtx_string.c" 3 4
          0
# 74 "./src/main/io/vtx_string.c"
               ;
}
