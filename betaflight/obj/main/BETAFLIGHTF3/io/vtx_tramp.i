...
# 32 "./src/main/io/vtx_tramp.c" 2


# 1 "./src/main/cms/cms_menu_vtx_tramp.h" 1
# 18 "./src/main/cms/cms_menu_vtx_tramp.h"
...
# 21 "./src/main/cms/cms_menu_vtx_tramp.h" 2
...
const char * const trampPowerNames[5 +1] = {
    "---", "25 ", "100", "200", "400", "600"
};
...
static serialPort_t *trampSerialPort = 
# 67 "./src/main/io/vtx_tramp.c" 3 4
                                      ((void *)0)
# 67 "./src/main/io/vtx_tramp.c"
                                          ;
...
# 86 "./src/main/io/vtx_tramp.c" 3 4
_Bool 
# 86 "./src/main/io/vtx_tramp.c"
    trampSetByFreqFlag = 
# 86 "./src/main/io/vtx_tramp.c" 3 4
                         0
# 86 "./src/main/io/vtx_tramp.c"
...
void trampCmdU16(uint8_t cmd, uint16_t param)
{
    ...
    memset(trampReqBuffer, 0, (sizeof(trampReqBuffer) / sizeof((trampReqBuffer)[0])));
    trampReqBuffer[0] = 15;
...
static 
# 135 "./src/main/io/vtx_tramp.c" 3 4
      _Bool 
# 135 "./src/main/io/vtx_tramp.c"
           trampValidateFreq(uint16_t freq)
{
...
{
    trampSetByFreqFlag = 
# 150 "./src/main/io/vtx_tramp.c" 3 4
                        1
# 150 "./src/main/io/vtx_tramp.c"
                            ;
...
static 
# 159 "./src/main/io/vtx_tramp.c" 3 4
      _Bool 
# 159 "./src/main/io/vtx_tramp.c"
           trampValidateBandAndChannel(uint8_t band, uint8_t channel)
{
...
{
    trampSetByFreqFlag = 
# 172 "./src/main/io/vtx_tramp.c" 3 4
                        0
# 172 "./src/main/io/vtx_tramp.c"
                             ;
...
# 190 "./src/main/io/vtx_tramp.c" 3 4
_Bool 
# 190 "./src/main/io/vtx_tramp.c"
    trampCommitChanges(void)
{
    if (trampStatus != TRAMP_STATUS_ONLINE) {
        return 
# 193 "./src/main/io/vtx_tramp.c" 3 4
              0
# 193 "./src/main/io/vtx_tramp.c"
                   ;
    }

    trampStatus = TRAMP_STATUS_SET_FREQ_PW;
    return 
# 197 "./src/main/io/vtx_tramp.c" 3 4
          1
# 197 "./src/main/io/vtx_tramp.c"
              ;
}


static 
# 201 "./src/main/io/vtx_tramp.c" 3 4
      _Bool 
# 201 "./src/main/io/vtx_tramp.c"
           trampDevSetPowerByIndex(uint8_t index)
{
    if (index > 0 && index <= sizeof(trampPowerTable)) {
        trampSetRFPower(trampPowerTable[index - 1]);
        trampCommitChanges();
        return 
# 206 "./src/main/io/vtx_tramp.c" 3 4
              1
# 206 "./src/main/io/vtx_tramp.c"
                  ;
    }
    return 
# 208 "./src/main/io/vtx_tramp.c" 3 4
          0
# 208 "./src/main/io/vtx_tramp.c"
               ;
}
    ...
    case 'v':
        {
            ...
            if (freq != 0) {
                ...
                if (!vtx58_Freq2Bandchan(trampCurFreq, &trampBand, &trampChannel)) {
                    trampSetByFreqFlag = 
# 247 "./src/main/io/vtx_tramp.c" 3 4
                                        1
# 247 "./src/main/io/vtx_tramp.c"
                                            ;
                }
...
static 
# 288 "./src/main/io/vtx_tramp.c" 3 4
      _Bool 
# 288 "./src/main/io/vtx_tramp.c"
           trampIsValidResponseCode(uint8_t code)
{
    if (code == 'r' || code == 'v' || code == 's') {
        return 
# 291 "./src/main/io/vtx_tramp.c" 3 4
              1
# 291 "./src/main/io/vtx_tramp.c"
                  ;
    } else {
        return 
# 293 "./src/main/io/vtx_tramp.c" 3 4
              0
# 293 "./src/main/io/vtx_tramp.c"
                   ;
    }
}
...
void vtxTrampProcess(timeUs_t currentTimeUs)
{
    ...
    static 
# 372 "./src/main/io/vtx_tramp.c" 3 4
          _Bool 
# 372 "./src/main/io/vtx_tramp.c"
               initSettingsDoneFlag = 
# 372 "./src/main/io/vtx_tramp.c" 3 4
                                      0
# 372 "./src/main/io/vtx_tramp.c"
                                           ;
    ...
    case 'r':
        if (trampStatus <= TRAMP_STATUS_OFFLINE) {
            ...
            if (!initSettingsDoneFlag) {
                initSettingsDoneFlag = 
# 396 "./src/main/io/vtx_tramp.c" 3 4
                                      1
# 396 "./src/main/io/vtx_tramp.c"
                                          ;
    ...
    case TRAMP_STATUS_ONLINE:
        if (cmp32(currentTimeUs, lastQueryTimeUs) > 1000 * 1000) {
...
# 432 "./src/main/io/vtx_tramp.c" 3 4
           _Bool 
# 432 "./src/main/io/vtx_tramp.c"
                done = 
# 432 "./src/main/io/vtx_tramp.c" 3 4
                       1
# 432 "./src/main/io/vtx_tramp.c"
...
# 439 "./src/main/io/vtx_tramp.c" 3 4
                      0
# 439 "./src/main/io/vtx_tramp.c"
                           ;
...
# 446 "./src/main/io/vtx_tramp.c" 3 4
                      0
# 446 "./src/main/io/vtx_tramp.c"
                           ;
            }
...
# 497 "./src/main/io/vtx_tramp.c" 3 4
_Bool 
# 497 "./src/main/io/vtx_tramp.c"
    vtxTrampIsReady(void)
{
...
# 528 "./src/main/io/vtx_tramp.c" 3 4
_Bool 
# 528 "./src/main/io/vtx_tramp.c"
    vtxTrampGetBandAndChannel(uint8_t *pBand, uint8_t *pChannel)
{
    if (!vtxTrampIsReady()) {
        return 
# 531 "./src/main/io/vtx_tramp.c" 3 4
              0
# 531 "./src/main/io/vtx_tramp.c"
                   ;
    }
    ...
    *pChannel = trampChannel;
    return 
# 537 "./src/main/io/vtx_tramp.c" 3 4
          1
# 537 "./src/main/io/vtx_tramp.c"
              ;
}


# 540 "./src/main/io/vtx_tramp.c" 3 4
_Bool 
# 540 "./src/main/io/vtx_tramp.c"
    vtxTrampGetPowerIndex(uint8_t *pIndex)
{
    if (!vtxTrampIsReady()) {
        return 
# 543 "./src/main/io/vtx_tramp.c" 3 4
              0
# 543 "./src/main/io/vtx_tramp.c"
                   ;
    }
    ...
    return 
# 555 "./src/main/io/vtx_tramp.c" 3 4
          1
# 555 "./src/main/io/vtx_tramp.c"
              ;
}


# 558 "./src/main/io/vtx_tramp.c" 3 4
_Bool 
# 558 "./src/main/io/vtx_tramp.c"
    vtxTrampGetPitMode(uint8_t *pOnOff)
{
    if (!vtxTrampIsReady()) {
        return 
# 561 "./src/main/io/vtx_tramp.c" 3 4
              0
# 561 "./src/main/io/vtx_tramp.c"
                   ;
    }

    *pOnOff = trampPitMode;
    return 
# 565 "./src/main/io/vtx_tramp.c" 3 4
          1
# 565 "./src/main/io/vtx_tramp.c"
              ;
}


# 568 "./src/main/io/vtx_tramp.c" 3 4
_Bool 
# 568 "./src/main/io/vtx_tramp.c"
    vtxTrampGetFreq(uint16_t *pFreq)
{
    if (!vtxTrampIsReady()) {
        return 
# 571 "./src/main/io/vtx_tramp.c" 3 4
              0
# 571 "./src/main/io/vtx_tramp.c"
                   ;
    }

    *pFreq = trampCurFreq;
    return 
# 575 "./src/main/io/vtx_tramp.c" 3 4
          1
# 575 "./src/main/io/vtx_tramp.c"
              ;
}
...
# 594 "./src/main/io/vtx_tramp.c" 3 4
_Bool 
# 594 "./src/main/io/vtx_tramp.c"
    vtxTrampInit(void)
{
...
# 606 "./src/main/io/vtx_tramp.c" 3 4
                                                                                    ((void *)0)
# 606 "./src/main/io/vtx_tramp.c"
                                                                                        , 
# 606 "./src/main/io/vtx_tramp.c" 3 4
                                                                                          ((void *)0)
# 606 "./src/main/io/vtx_tramp.c"
                                                                                              , 9600, MODE_RXTX, portOptions);
    }

    if (!trampSerialPort) {
        return 
# 610 "./src/main/io/vtx_tramp.c" 3 4
              0
# 610 "./src/main/io/vtx_tramp.c"
                   ;
    }
    ...
    return 
# 617 "./src/main/io/vtx_tramp.c" 3 4
          1
# 617 "./src/main/io/vtx_tramp.c"
              ;
}
