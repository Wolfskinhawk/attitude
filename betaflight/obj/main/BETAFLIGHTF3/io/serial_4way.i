...
# 21 "./src/main/io/serial_4way.c" 2
...
# 22 "./src/main/io/serial_4way.c" 2
...
# 24 "./src/main/io/serial_4way.c" 2
...
# 28 "./src/main/io/serial_4way.c" 2
...
# 29 "./src/main/io/serial_4way.c" 2
...
# 22 "./src/main/drivers/serial.h" 2
...
# 30 "./src/main/io/serial_4way.c" 2
...
# 31 "./src/main/io/serial_4way.c" 2
...
# 32 "./src/main/io/serial_4way.c" 2
...
# 64 "./src/main/drivers/light_led.h"
                         state);
# 33 "./src/main/io/serial_4way.c" 2
...
# 35 "./src/main/io/serial_4way.c" 2
...
# 64 "./src/main/io/beeper.h"
    isBeeperOn(void);
# 37 "./src/main/io/serial_4way.c" 2
...
# 38 "./src/main/io/serial_4way.c" 2


# 1 "./src/main/io/serial_4way_avrootloader.h" 1
# 21 "./src/main/io/serial_4way_avrootloader.h"
...
# 1 "./src/main/io/serial_4way_stk500v2.h" 1
# 18 "./src/main/io/serial_4way_stk500v2.h"
...
# 44 "./src/main/io/serial_4way.c" 2
# 87 "./src/main/io/serial_4way.c"
static uint8_t escCount;

escHardware_t escHardware[8];
...
inline 
# 97 "./src/main/io/serial_4way.c" 3 4
      _Bool 
# 97 "./src/main/io/serial_4way.c"
           isMcuConnected(void)
{
...
inline 
# 102 "./src/main/io/serial_4way.c" 3 4
      _Bool 
# 102 "./src/main/io/serial_4way.c"
           isEscHi(uint8_t selEsc)
{
    return (IORead(escHardware[selEsc].io) != Bit_RESET);
}
inline 
# 106 "./src/main/io/serial_4way.c" 3 4
      _Bool 
# 106 "./src/main/io/serial_4way.c"
           isEscLo(uint8_t selEsc)
{
    return (IORead(escHardware[selEsc].io) == Bit_RESET);
}
...
{
    IOConfigGPIO(escHardware[selEsc].io, ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_UP) << 5)));
}

inline void setEscOutput(uint8_t selEsc)
{
    IOConfigGPIO(escHardware[selEsc].io, ((GPIO_Mode_OUT) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
}
...
void esc4wayRelease(void)
{
    while (escCount > 0) {
        escCount--;
        IOConfigGPIO(escHardware[escCount].io, ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
        setEscLo(escCount);
    }
    pwmEnableMotors();
}
# 309 "./src/main/io/serial_4way.c"
...
static uint8_t Connect(uint8_32_u *pDeviceInfo)
{
    for (uint8_t I = 0; I < 3; ++I) {
        ...
        if ((CurrentInterfaceMode != 4) && Stk_ConnectEx(pDeviceInfo) && ((pDeviceInfo->words[0] == 0x9307) || (pDeviceInfo->words[0] == 0x930A) || (pDeviceInfo->words[0] == 0x930F) || (pDeviceInfo->words[0] == 0x940B))) {
            CurrentInterfaceMode = 3;
            return 1;
        } else {
            if (BL_ConnectEx(pDeviceInfo)) {
                if ((pDeviceInfo->words[0] == 0xF310)||(pDeviceInfo->words[0] ==0xF330) || (pDeviceInfo->words[0] == 0xF410) || (pDeviceInfo->words[0] == 0xF390) || (pDeviceInfo->words[0] == 0xF850) || (pDeviceInfo->words[0] == 0xE8B1) || (pDeviceInfo->words[0] == 0xE8B2)) {
                    CurrentInterfaceMode = 1;
                    return 1;
                } else if ((pDeviceInfo->words[0] == 0x9307) || (pDeviceInfo->words[0] == 0x930A) || (pDeviceInfo->words[0] == 0x930F) || (pDeviceInfo->words[0] == 0x940B)) {
                    CurrentInterfaceMode = 2;
                    return 1;
                } else if ((pDeviceInfo->words[0] == 0x1F06) || (pDeviceInfo->words[0] == 0x3306) || (pDeviceInfo->words[0] == 0x3406) || (pDeviceInfo->words[0] == 0x3506)) {
                    CurrentInterfaceMode = 4;
                    return 1;
                }
            }
        }
# 377 "./src/main/io/serial_4way.c"
    }
    return 0;
}
...
# 433 "./src/main/io/serial_4way.c" 3 4
   _Bool 
# 433 "./src/main/io/serial_4way.c"
        isExitScheduled = 
# 433 "./src/main/io/serial_4way.c" 3 4
                          0
# 433 "./src/main/io/serial_4way.c"
    ...
    while (1) {
        ...
        ledSet(0, 
# 442 "./src/main/io/serial_4way.c" 3 4
       1
# 442 "./src/main/io/serial_4way.c"
       );
        ...
        ledSet(0, 
# 469 "./src/main/io/serial_4way.c" 3 4
       1
# 469 "./src/main/io/serial_4way.c"
       );
            ...
            switch (CMD) {
                ...
                case 0x30:
                {
                    if (isMcuConnected()) {
                        ...
                        if ( ACK_OUT != 0x00) DeviceInfo.words[0] = 0;
                    }
                    break;
                }
                case 0x31:
                ...
                case 0x32:
                {
                    ...
                    O_PARAM_LEN = strlen("m4wFCIntf");
                    O_PARAM = (uint8_t *)"m4wFCIntf";
                    break;
                }
                ...
                case 0x33:
                {
                    ...
                    O_PARAM_LEN = 2;
                    Dummy.bytes[0] = (uint8_t) ((uint16_t) ((20 * 1000) + ((uint8_t) 0 * 100) + (uint8_t) 02) / 100);
                    Dummy.bytes[1] = (uint8_t) ((uint16_t) ((20 * 1000) + ((uint8_t) 0 * 100) + (uint8_t) 02) % 100);
                    break;
                }
                case 0x34:
                {
                    isExitScheduled = 
# 539 "./src/main/io/serial_4way.c" 3 4
                                     1
# 539 "./src/main/io/serial_4way.c"
                                         ;
                    break;
                }
                case 0x3F:
                ...
                case 0x38:
                {
                    switch (CurrentInterfaceMode)
                    {
                        case 3:
                        {
                            if (!Stk_Chip_Erase()) ACK_OUT=0x0F;
                            break;
                        }
                        default:
                            ACK_OUT = 0x02;
                ...
                case 0x39:
                {
                    switch (CurrentInterfaceMode)
                    {
                        ...
                        case 4:
                        {
                            ...
                            if (!BL_PageErase(&ioMem)) ACK_OUT = 0x0F;
                            break;
                        }
                        default:
                            ACK_OUT = 0x02;
        ...
        ledSet(0, 
# 862 "./src/main/io/serial_4way.c" 3 4
       0
# 862 "./src/main/io/serial_4way.c"
       );
        ...
        ledSet(0, 
# 885 "./src/main/io/serial_4way.c" 3 4
       0
# 885 "./src/main/io/serial_4way.c"
       );
        if (isExitScheduled) {
            esc4wayRelease();
            return;
