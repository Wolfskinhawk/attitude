# 1 "./src/main/io/spektrum_vtx_control.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/io/spektrum_vtx_control.c"
# 19 "./src/main/io/spektrum_vtx_control.c"
...
# 20 "./src/main/io/spektrum_vtx_control.c" 2
...
# 23 "./src/main/io/spektrum_vtx_control.c" 2
...
# 25 "./src/main/io/spektrum_vtx_control.c" 2
...
# 26 "./src/main/io/spektrum_vtx_control.c" 2
...
# 27 "./src/main/io/spektrum_vtx_control.c" 2
...
# 28 "./src/main/io/spektrum_vtx_control.c" 2
...
# 30 "./src/main/io/spektrum_vtx_control.c" 2
# 46 "./src/main/io/spektrum_vtx_control.c"
...
# 87 "./src/main/io/spektrum_vtx_control.c"
...
static uint32_t vtxControl_ipc = ~(0xe000e000);
...
void spektrumVtxControl(void)
{
    ...
    if ((vtxControl_ipc & 0xf000f000) != 0xe000e000) return;

    uint32_t vtxControl = vtxControl_ipc;

    spektrumVtx_t vtx = {
        .pitMode = (vtxControl & 0x00000010) >> 4,
        .region = (vtxControl & 0x00000008) >> 3,
        .power = (vtxControl & 0x00000007) >> 0,
        .band = (vtxControl & 0x00e00000) >> 21,
        .channel = (vtxControl & 0x000f0000) >> 16,
    };
...
# 179 "./src/main/io/spektrum_vtx_control.c"
        uint8_t band = spek2commonBand[vtx.band];
        uint8_t channel = vtx.channel +1;
