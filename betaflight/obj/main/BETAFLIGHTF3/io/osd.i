...
# 55 "./src/main/io/osd.c" 2
# 1 "./src/main/drivers/max7456_symbols.h" 1
# 22 "./src/main/drivers/max7456_symbols.h"
       
# 56 "./src/main/io/osd.c" 2
...
# 21 "./src/main/drivers/barometer/barometer.h" 2
...
# 86 "./src/main/io/osd.c" 2
# 94 "./src/main/io/osd.c"
...
static 
# 102 "./src/main/io/osd.c" 3 4
      _Bool 
# 102 "./src/main/io/osd.c"
           blinkState = 
# 102 "./src/main/io/osd.c" 3 4
                        1
# 102 "./src/main/io/osd.c"
                            ;
static 
# 103 "./src/main/io/osd.c" 3 4
      _Bool 
# 103 "./src/main/io/osd.c"
           showVisualBeeper = 
# 103 "./src/main/io/osd.c" 3 4
                              0
# 103 "./src/main/io/osd.c"
...
extern void pgResetFn_osdConfig(osdConfig_t *); osdConfig_t osdConfig_System; osdConfig_t osdConfig_Copy; extern const pgRegistry_t osdConfig_Registry; const pgRegistry_t osdConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 501 | (2 << 12), .size = sizeof(osdConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&osdConfig_System, .copy = (uint8_t*)&osdConfig_Copy, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_osdConfig }, };
...
static char osdGetBatterySymbol(int cellVoltage)
{
    if (getBatteryState() == BATTERY_CRITICAL) {
        ...
        return 0x96 - constrain(symOffset, 0, 6);
    }
}
...
static int osdConvertTemperatureToSelectedUnit(int tempInDeciDegrees)
{
    switch (osdConfig()->units) {
    case OSD_UNIT_IMPERIAL:
...
# 232 "./src/main/io/osd.c" 3 4
                                                              _Bool 
# 232 "./src/main/io/osd.c"
                                                                   pad)
{
...
static uint8_t osdGetHeadingIntoDiscreteDirections(int heading, unsigned directions)
{
    ...
    int direction = (heading * directions + 360 / 2) / 360;
...
static void osdFormatTimer(char *buff, 
# 321 "./src/main/io/osd.c" 3 4
                                                  _Bool 
# 321 "./src/main/io/osd.c"
                                                       showSymbol, int timerIndex)
{
    const uint16_t timer = osdConfig()->timers[timerIndex];
    const uint8_t src = (timer & 0x0F);

    if (showSymbol) {
        *(buff++) = osdGetTimerSymbol(src);
    }

    osdFormatTime(buff, ((timer >> 4) & 0x0F), osdGetTimerValue(src));
}
# 362 "./src/main/io/osd.c"
static 
# 362 "./src/main/io/osd.c" 3 4
      _Bool 
# 362 "./src/main/io/osd.c"
           osdFormatRtcDateTime(char *buffer)
{
    dateTime_t dateTime;
    if (!rtcGetDateTime(&dateTime)) {
        ...
        return 
# 368 "./src/main/io/osd.c" 3 4
              0
# 368 "./src/main/io/osd.c"
                   ;
    }
    ...
    return 
# 373 "./src/main/io/osd.c" 3 4
          1
# 373 "./src/main/io/osd.c"
              ;
}
...
static 
# 387 "./src/main/io/osd.c" 3 4
      _Bool 
# 387 "./src/main/io/osd.c"
           osdDrawSingleElement(uint8_t item)
{
    if (!(osdConfig()->item_pos[item] & 0x0800) || ((blinkBits[(item) / 32] & (1 << ((item) % 32))) && blinkState)) {
        return 
# 390 "./src/main/io/osd.c" 3 4
              0
# 390 "./src/main/io/osd.c"
                   ;
    }

    uint8_t elemPosX = (osdConfig()->item_pos[item] & ((1 << 5) - 1));
    uint8_t elemPosY = ((osdConfig()->item_pos[item] >> 5) & ((1 << 5) - 1));
    ...
    case OSD_RSSI_VALUE:
        {
            ...
            tfp_sprintf(buff, "%c%2d", 0x01, osdRssi);
            break;
        }

    case OSD_MAIN_BATT_VOLTAGE:
        buff[0] = osdGetBatterySymbol(osdGetBatteryAverageCellVoltage());
        tfp_sprintf(buff + 1, "%2d.%1d%c", getBatteryVoltage() / 10, getBatteryVoltage() % 10, 0x06);
        break;

    case OSD_CURRENT_DRAW:
        {
            const int32_t amperage = getAmperage();
            tfp_sprintf(buff, "%3d.%02d%c", abs(amperage) / 100, abs(amperage) % 100, 0x9A);
            break;
        }

    case OSD_MAH_DRAWN:
        tfp_sprintf(buff, "%4d%c", getMAhDrawn(), 0x07);
        break;
# 477 "./src/main/io/osd.c"
    case OSD_COMPASS_BAR:
        memcpy(buff, compassBar + osdGetHeadingIntoDiscreteDirections((attitude.values.yaw / 10), 16), 9);
        buff[9] = 0;
        break;

    case OSD_ALTITUDE:
        osdFormatAltitudeString(buff, getEstimatedAltitude(), 
# 483 "./src/main/io/osd.c" 3 4
                                                             1
# 483 "./src/main/io/osd.c"
                                                                 );
        break;
    ...
    case OSD_ITEM_TIMER_2:
        osdFormatTimer(buff, 
# 488 "./src/main/io/osd.c" 3 4
                            1
# 488 "./src/main/io/osd.c"
                                , item - OSD_ITEM_TIMER_1);
        break;
    ...
    case OSD_FLYMODE:
        {
            ...
            if ((flightModeFlags & (FAILSAFE_MODE))) {
                p = "!FS!";
            } else if ((flightModeFlags & (ANGLE_MODE))) {
                p = "STAB";
            } else if ((flightModeFlags & (HORIZON_MODE))) {
                p = "HOR ";
            }

            displayWrite(osdDisplayPort, elemPosX, elemPosY, p);
            return 
# 523 "./src/main/io/osd.c" 3 4
                  1
# 523 "./src/main/io/osd.c"
                      ;
        }
    ...
    case OSD_THROTTLE_POS:
        buff[0] = 0x04;
        buff[1] = 0x05;
        tfp_sprintf(buff + 2, "%3d", (constrain(rcData[THROTTLE], 1000, 2000) - 1000) * 100 / (2000 - 1000));
        break;
    ...
    case OSD_CROSSHAIRS:
        elemPosX = 14 - 1;
        elemPosY = 6;
        if (displayScreenSize(osdDisplayPort) == 480) {
            ++elemPosY;
        }
        buff[0] = 0x26;
        buff[1] = 0x7E;
    ...
    case OSD_ARTIFICIAL_HORIZON:
        {
            ...
            pitchAngle = ((pitchAngle * 25) / maxPitch) - 41;

            for (int x = -4; x <= 4; x++) {
                const int y = ((-rollAngle * x) / 64) - pitchAngle;
                if (y >= 0 && y <= 81) {
                    displayWriteChar(osdDisplayPort, elemPosX + x, elemPosY + (y / 9), (0x80 + (y % 9)));
                }
            }
            ...
            return 
# 598 "./src/main/io/osd.c" 3 4
                  1
# 598 "./src/main/io/osd.c"
                      ;
        }
    ...
    case OSD_HORIZON_SIDEBARS:
        {
            ...
            const int8_t hudwidth = 7;
            const int8_t hudheight = 3;
            for (int y = -hudheight; y <= hudheight; y++) {
                displayWriteChar(osdDisplayPort, elemPosX - hudwidth, elemPosY + y, 0x13);
                displayWriteChar(osdDisplayPort, elemPosX + hudwidth, elemPosY + y, 0x13);
            }


            displayWriteChar(osdDisplayPort, elemPosX - hudwidth + 1, elemPosY, 0x03);
            displayWriteChar(osdDisplayPort, elemPosX + hudwidth - 1, elemPosY, 0x02);

            return 
# 621 "./src/main/io/osd.c" 3 4
                  1
# 621 "./src/main/io/osd.c"
                      ;
        }
    ...
    case OSD_WARNINGS:
        {
            ...
            if (enabledWarnings & OSD_WARNING_BATTERY_NOT_FULL && !(armingFlags & (WAS_EVER_ARMED)) && (getBatteryState() == BATTERY_OK)
            ...
            return 
# 693 "./src/main/io/osd.c" 3 4
                  1
# 693 "./src/main/io/osd.c"
                      ;
        }
    ...
    case OSD_AVG_CELL_VOLTAGE:
        {
            ...
            tfp_sprintf(buff + 1, "%d.%02d%c", cellV / 100, cellV % 100, 0x06);
            break;
        }
    ...
    case OSD_MAIN_BATT_USAGE:
        {
            ...
            const uint8_t mAhUsedProgress = ceil((value / (batteryConfig()->batteryCapacity / 11)));


            buff[0] = 0x8A;
            for (int i = 1; i <= 11; i++) {
                buff[i] = i <= mAhUsedProgress ? 0x8B : 0x8D;
            }
            buff[11 + 1] = 0x8F;
            if (mAhUsedProgress > 0 && mAhUsedProgress < 11) {
                buff[1 + mAhUsedProgress] = 0x8E;
            }
            buff[11 +2] = '\0';
            break;
        }
    ...
    case OSD_NUMERICAL_VARIO:
        {
            ...
            const char directionSymbol = verticalSpeed < 0 ? 0x60 : 0x68;
    ...
    case OSD_ESC_RPM:
        tfp_sprintf(buff, "%5d", escData == 
# 769 "./src/main/io/osd.c" 3 4
                                           ((void *)0) 
# 769 "./src/main/io/osd.c"
                                                ? 0 : escData->rpm);
        break;
    ...
    case OSD_RTC_DATETIME:
        ...
        break;
# 791 "./src/main/io/osd.c"
    default:
        return 
# 792 "./src/main/io/osd.c" 3 4
              0
# 792 "./src/main/io/osd.c"
                   ;
    }

    displayWrite(osdDisplayPort, elemPosX + elemOffsetX, elemPosY, buff);
    return 
# 796 "./src/main/io/osd.c" 3 4
          1
# 796 "./src/main/io/osd.c"
              ;
}
...
void pgResetFn_osdConfig(osdConfig_t *osdConfig)
{
    ...
    for (int i = 0; i < OSD_ITEM_COUNT; i++) {
        osdConfig->item_pos[i] = ((10 & ((1 << 5) - 1)) | ((7 & ((1 << 5) - 1)) << 5));
    }


    osdConfig->item_pos[OSD_WARNINGS] = ((9 & ((1 << 5) - 1)) | ((10 & ((1 << 5) - 1)) << 5)) | 0x0800;

    osdConfig->enabled_stats[OSD_STAT_MAX_SPEED] = 
# 882 "./src/main/io/osd.c" 3 4
                                                        1
# 882 "./src/main/io/osd.c"
                                                            ;
    osdConfig->enabled_stats[OSD_STAT_MIN_BATTERY] = 
# 883 "./src/main/io/osd.c" 3 4
                                                        1
# 883 "./src/main/io/osd.c"
                                                            ;
    osdConfig->enabled_stats[OSD_STAT_MIN_RSSI] = 
# 884 "./src/main/io/osd.c" 3 4
                                                        1
# 884 "./src/main/io/osd.c"
                                                            ;
    osdConfig->enabled_stats[OSD_STAT_MAX_CURRENT] = 
# 885 "./src/main/io/osd.c" 3 4
                                                        1
# 885 "./src/main/io/osd.c"
                                                            ;
    osdConfig->enabled_stats[OSD_STAT_USED_MAH] = 
# 886 "./src/main/io/osd.c" 3 4
                                                        1
# 886 "./src/main/io/osd.c"
                                                            ;
    osdConfig->enabled_stats[OSD_STAT_MAX_ALTITUDE] = 
# 887 "./src/main/io/osd.c" 3 4
                                                        0
# 887 "./src/main/io/osd.c"
                                                             ;
    osdConfig->enabled_stats[OSD_STAT_BLACKBOX] = 
# 888 "./src/main/io/osd.c" 3 4
                                                        1
# 888 "./src/main/io/osd.c"
                                                            ;
    osdConfig->enabled_stats[OSD_STAT_END_BATTERY] = 
# 889 "./src/main/io/osd.c" 3 4
                                                        0
# 889 "./src/main/io/osd.c"
                                                             ;
    osdConfig->enabled_stats[OSD_STAT_MAX_DISTANCE] = 
# 890 "./src/main/io/osd.c" 3 4
                                                        0
# 890 "./src/main/io/osd.c"
                                                             ;
    osdConfig->enabled_stats[OSD_STAT_BLACKBOX_NUMBER] = 
# 891 "./src/main/io/osd.c" 3 4
                                                        1
# 891 "./src/main/io/osd.c"
                                                            ;
    osdConfig->enabled_stats[OSD_STAT_TIMER_1] = 
# 892 "./src/main/io/osd.c" 3 4
                                                        0
# 892 "./src/main/io/osd.c"
                                                             ;
    osdConfig->enabled_stats[OSD_STAT_TIMER_2] = 
# 893 "./src/main/io/osd.c" 3 4
                                                        1
# 893 "./src/main/io/osd.c"
                                                            ;
    osdConfig->enabled_stats[OSD_STAT_RTC_DATE_TIME] = 
# 894 "./src/main/io/osd.c" 3 4
                                                        0
# 894 "./src/main/io/osd.c"
                                                             ;
...
# 899 "./src/main/io/osd.c" 3 4
                                (0xffff)
# 899 "./src/main/io/osd.c"
                                          ;

    osdConfig->timers[OSD_TIMER_1] = ((OSD_TIMER_SRC_ON & 0x0F) | ((OSD_TIMER_PREC_SECOND & 0x0F) << 4) | ((10 & 0xFF ) << 8));
    osdConfig->timers[OSD_TIMER_2] = ((OSD_TIMER_SRC_TOTAL_ARMED & 0x0F) | ((OSD_TIMER_PREC_SECOND & 0x0F) << 4) | ((10 & 0xFF ) << 8));

    osdConfig->rssi_alarm = 20;
    osdConfig->cap_alarm = 2200;
    osdConfig->alt_alarm = 100;

    osdConfig->ahMaxPitch = 20;
    osdConfig->ahMaxRoll = 40;
}
...
void osdInit(displayPort_t *osdDisplayPortToUse)
{
    ...
    ((void)sizeof(char[1 - 2*!!(0x3FF != ((31 & ((1 << 5) - 1)) | ((31 & ((1 << 5) - 1)) << 5)))]));
    ...
    tfp_sprintf(string_buffer, "V%s", "3" "." "3" "." "0");
    displayWrite(osdDisplayPort, 20, 6, string_buffer);

    displayWrite(osdDisplayPort, 7, 8, "MENU:THR MID");
    displayWrite(osdDisplayPort, 11, 9, "+ YAW LEFT");
    displayWrite(osdDisplayPort, 11, 10, "+ PITCH UP");
...
void osdUpdateAlarms(void)
{
    ...
    if (getBatteryState() == BATTERY_OK) {
        (blinkBits[(OSD_WARNINGS) / 32] &= ~(1 << ((OSD_WARNINGS) % 32)));
    ...
    for (int i = 0; i < OSD_TIMER_COUNT; i++) {
        ...
        const timeUs_t alarmTime = ((timer >> 8) & 0xFF) * 60000000;
        if (alarmTime != 0 && time >= alarmTime) {
            (blinkBits[(OSD_ITEM_TIMER_1 + i) / 32] |= (1 << ((OSD_ITEM_TIMER_1 + i) % 32)));
        } else {
            (blinkBits[(OSD_ITEM_TIMER_1 + i) / 32] &= ~(1 << ((OSD_ITEM_TIMER_1 + i) % 32)));
        }
    }
    ...
    if (getMAhDrawn() >= osdConfig()->cap_alarm) {
        (blinkBits[(OSD_MAH_DRAWN) / 32] |= (1 << ((OSD_MAH_DRAWN) % 32)));
        (blinkBits[(OSD_MAIN_BATT_USAGE) / 32] |= (1 << ((OSD_MAIN_BATT_USAGE) % 32)));
        (blinkBits[(OSD_REMAINING_TIME_ESTIMATE) / 32] |= (1 << ((OSD_REMAINING_TIME_ESTIMATE) % 32)));
    } else {
        (blinkBits[(OSD_MAH_DRAWN) / 32] &= ~(1 << ((OSD_MAH_DRAWN) % 32)));
        (blinkBits[(OSD_MAIN_BATT_USAGE) / 32] &= ~(1 << ((OSD_MAIN_BATT_USAGE) % 32)));
        (blinkBits[(OSD_REMAINING_TIME_ESTIMATE) / 32] &= ~(1 << ((OSD_REMAINING_TIME_ESTIMATE) % 32)));
...
void osdResetAlarms(void)
{
    ...
    (blinkBits[(OSD_AVG_CELL_VOLTAGE) / 32] &= ~(1 << ((OSD_AVG_CELL_VOLTAGE) % 32)));
    (blinkBits[(OSD_MAIN_BATT_USAGE) / 32] &= ~(1 << ((OSD_MAIN_BATT_USAGE) % 32)));
    (blinkBits[(OSD_ITEM_TIMER_1) / 32] &= ~(1 << ((OSD_ITEM_TIMER_1) % 32)));
    (blinkBits[(OSD_ITEM_TIMER_2) / 32] &= ~(1 << ((OSD_ITEM_TIMER_2) % 32)));
    (blinkBits[(OSD_REMAINING_TIME_ESTIMATE) / 32] &= ~(1 << ((OSD_REMAINING_TIME_ESTIMATE) % 32)));
}
...
# 1088 "./src/main/io/osd.c" 3 4
   _Bool 
# 1088 "./src/main/io/osd.c"
...
static 
# 1137 "./src/main/io/osd.c" 3 4
      _Bool 
# 1137 "./src/main/io/osd.c"
           isSomeStatEnabled(void)
{
    for (int i = 0; i < OSD_STAT_COUNT; i++) {
        if (osdConfig()->enabled_stats[i]) {
            return 
# 1141 "./src/main/io/osd.c" 3 4
                  1
# 1141 "./src/main/io/osd.c"
                      ;
        }
    }
    return 
# 1144 "./src/main/io/osd.c" 3 4
          0
# 1144 "./src/main/io/osd.c"
               ;
}
...
# 1156 "./src/main/io/osd.c" 3 4
       _Bool 
# 1156 "./src/main/io/osd.c"
            success = 
# 1156 "./src/main/io/osd.c" 3 4
                      0
# 1156 "./src/main/io/osd.c"
    ...
    if (osdConfig()->enabled_stats[OSD_STAT_TIMER_1]) {
        osdFormatTimer(buff, 
# 1168 "./src/main/io/osd.c" 3 4
                            0
# 1168 "./src/main/io/osd.c"
                                 , OSD_TIMER_1);
        osdDisplayStatisticLabel(top++, osdTimerSourceNames[(osdConfig()->timers[OSD_TIMER_1] & 0x0F)], buff);
    }

    if (osdConfig()->enabled_stats[OSD_STAT_TIMER_2]) {
        osdFormatTimer(buff, 
# 1173 "./src/main/io/osd.c" 3 4
                            0
# 1173 "./src/main/io/osd.c"
                                 , OSD_TIMER_2);
        osdDisplayStatisticLabel(top++, osdTimerSourceNames[(osdConfig()->timers[OSD_TIMER_2] & 0x0F)], buff);
    }

    if (osdConfig()->enabled_stats[OSD_STAT_MAX_SPEED] && (stateFlags & (GPS_FIX))) {
    ...
    if (osdConfig()->enabled_stats[OSD_STAT_MIN_BATTERY]) {
        tfp_sprintf(buff, "%d.%1d%c", stats.min_voltage / 10, stats.min_voltage % 10, 0x06);
        osdDisplayStatisticLabel(top++, "MIN BATTERY", buff);
    }

    if (osdConfig()->enabled_stats[OSD_STAT_END_BATTERY]) {
        tfp_sprintf(buff, "%d.%1d%c", getBatteryVoltage() / 10, getBatteryVoltage() % 10, 0x06);
    ...
    if (batteryConfig()->currentMeterSource != CURRENT_METER_NONE) {
        ...
        if (osdConfig()->enabled_stats[OSD_STAT_USED_MAH]) {
            tfp_sprintf(buff, "%d%c", getMAhDrawn(), 0x07);
...
# 1217 "./src/main/io/osd.c" 3 4
                                                         0
# 1217 "./src/main/io/osd.c"
                                                              );
...
static void osdRefresh(timeUs_t currentTimeUs)
{
    ...
    if (armState != (armingFlags & (ARMED))) {
        if ((armingFlags & (ARMED))) {
            osdResetStats();
            osdShowArmed();
            resumeRefreshAt = currentTimeUs + (1000 * 1000 / 2);
        } else if (isSomeStatEnabled()) {
            osdShowStats();
            resumeRefreshAt = currentTimeUs + (60 * 1000 * 1000);
        }
    ...
    if (resumeRefreshAt) {
        if (cmp32(currentTimeUs, resumeRefreshAt) < 0) {
            ...
            if ((rcData[THROTTLE] > 1750) || (rcData[PITCH] > 1750)) {
                resumeRefreshAt = 0;
            }
...
void osdUpdate(timeUs_t currentTimeUs)
{
    ...
    if (isBeeperOn()) {
        showVisualBeeper = 
# 1314 "./src/main/io/osd.c" 3 4
                          1
# 1314 "./src/main/io/osd.c"
                              ;
    }
# 1341 "./src/main/io/osd.c"
    if (counter % 5 == 0) {
        osdRefresh(currentTimeUs);
        showVisualBeeper = 
# 1343 "./src/main/io/osd.c" 3 4
                          0
# 1343 "./src/main/io/osd.c"
                               ;
    } else {
