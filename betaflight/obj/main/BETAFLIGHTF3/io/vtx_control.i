...
# 21 "./src/main/io/vtx_control.c" 2
...
# 23 "./src/main/io/vtx_control.c" 2
...
# 27 "./src/main/io/vtx_control.c" 2
...
# 29 "./src/main/io/vtx_control.c" 2
...
# 30 "./src/main/io/vtx_control.c" 2
# 1 "./src/main/pg/pg_ids.h" 1
# 18 "./src/main/pg/pg_ids.h"
       
# 31 "./src/main/io/vtx_control.c" 2
...
# 23 "./src/main/drivers/buttons.h"
    buttonBPressed(void);
# 33 "./src/main/io/vtx_control.c" 2
...
# 64 "./src/main/drivers/light_led.h"
                         state);
# 34 "./src/main/io/vtx_control.c" 2
...
# 35 "./src/main/io/vtx_control.c" 2
...
# 36 "./src/main/io/vtx_control.c" 2
...
# 38 "./src/main/io/vtx_control.c" 2
...
void mwDisarm(void);
# 39 "./src/main/io/vtx_control.c" 2
...
# 41 "./src/main/io/vtx_control.c" 2
...
# 42 "./src/main/io/vtx_control.c" 2
...
# 43 "./src/main/io/vtx_control.c" 2
...
# 45 "./src/main/io/vtx_control.c" 2



extern const vtxConfig_t pgResetTemplate_vtxConfig; vtxConfig_t vtxConfig_System; vtxConfig_t vtxConfig_Copy; extern const pgRegistry_t vtxConfig_Registry; const pgRegistry_t vtxConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 515 | (1 << 12), .size = sizeof(vtxConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&vtxConfig_System, .copy = (uint8_t*)&vtxConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_vtxConfig}, };

const vtxConfig_t pgResetTemplate_vtxConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .halfDuplex = 
# 50 "./src/main/io/vtx_control.c" 3 4
1 
# 50 "./src/main/io/vtx_control.c"
}
...
# 133 "./src/main/io/vtx_control.c" 3 4
       _Bool 
# 133 "./src/main/io/vtx_control.c"
            haveAllNeededInfo = vtxCommonGetBandAndChannel(&band, &channel) && vtxCommonGetDeviceCapability(&capability);
...
# 163 "./src/main/io/vtx_control.c" 3 4
       _Bool 
# 163 "./src/main/io/vtx_control.c"
            haveAllNeededInfo = vtxCommonGetPowerIndex(&power) && vtxCommonGetDeviceCapability(&capability);
        if (!haveAllNeededInfo) {
            return;
        }
...
# 195 "./src/main/io/vtx_control.c"
void handleVTXControlButton(void)
{
# 268 "./src/main/io/vtx_control.c"
}
