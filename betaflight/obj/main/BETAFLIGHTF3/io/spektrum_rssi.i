# 1 "./src/main/io/spektrum_rssi.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/io/spektrum_rssi.c"
# 18 "./src/main/io/spektrum_rssi.c"
...
# 19 "./src/main/io/spektrum_rssi.c" 2
...
# 23 "./src/main/io/spektrum_rssi.c" 2
...
# 25 "./src/main/io/spektrum_rssi.c" 2
...
# 27 "./src/main/io/spektrum_rssi.c" 2
...
# 28 "./src/main/io/spektrum_rssi.c" 2
...
# 30 "./src/main/io/spektrum_rssi.c" 2
...
# 53 "./src/main/rx/spektrum.h"
    srxlRxIsActive(void);
# 31 "./src/main/io/spektrum_rssi.c" 2
...
# 32 "./src/main/io/spektrum_rssi.c" 2




static 
# 36 "./src/main/io/spektrum_rssi.c" 3 4
      _Bool 
# 36 "./src/main/io/spektrum_rssi.c"
           spektrumSatInternal = 
# 36 "./src/main/io/spektrum_rssi.c" 3 4
                                 1
# 36 "./src/main/io/spektrum_rssi.c"
...
static uint32_t spek_fade_last_sec = 0;
static uint16_t spek_fade_last_sec_count = 0;
...
static const dbm_table_t dbmTable[] = {
    ...
    {-76, 63},
    {-77, 60},
# 83 "./src/main/io/spektrum_rssi.c"
    {(-92), 0}};
...
static int8_t dBm2range (int8_t dBm) {
    ...
    for ( uint8_t i = 1; i < (sizeof(dbmTable) / sizeof((dbmTable)[0])); i++ ) {
...
void spektrumHandleRSSI(volatile uint8_t spekFrame[]) {
    ...
    static int8_t spek_last_rssi = (-42);
...

    {
        ...
        const uint32_t current_secs = micros() / 1000 / (1000 / 2);
        uint16_t fade;
        uint8_t system;
        ...
        if (spektrumSatInternal) {
            ...
            if ( !( (system == 0x01) |
                    ...
                    (system == 0xb2) ) ){
                spektrumSatInternal =
# 163 "./src/main/io/spektrum_rssi.c" 3 4
                                    0
# 163 "./src/main/io/spektrum_rssi.c"
                                         ;
            }
        }
