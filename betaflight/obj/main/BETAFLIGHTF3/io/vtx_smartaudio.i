...
# 22 "./src/main/io/vtx_smartaudio.c" 2
...
# 23 "./src/main/io/vtx_smartaudio.c" 2
...
int toupper (int __c);
int isblank (int __c);
# 24 "./src/main/io/vtx_smartaudio.c" 2
...
# 26 "./src/main/io/vtx_smartaudio.c" 2
...
# 30 "./src/main/io/vtx_smartaudio.c" 2
...
# 31 "./src/main/io/vtx_smartaudio.c" 2
...
# 33 "./src/main/io/vtx_smartaudio.c" 2
...
# 34 "./src/main/io/vtx_smartaudio.c" 2
...
# 35 "./src/main/io/vtx_smartaudio.c" 2
...
# 37 "./src/main/io/vtx_smartaudio.c" 2
...
# 38 "./src/main/io/vtx_smartaudio.c" 2
...
# 42 "./src/main/io/vtx_smartaudio.c" 2
...
# 44 "./src/main/io/vtx_smartaudio.c" 2
...
# 45 "./src/main/io/vtx_smartaudio.c" 2
...
# 46 "./src/main/io/vtx_smartaudio.c" 2
...
# 48 "./src/main/io/vtx_smartaudio.c" 2
...
void mwDisarm(void);
# 49 "./src/main/io/vtx_smartaudio.c" 2
...
# 51 "./src/main/io/vtx_smartaudio.c" 2
...
# 53 "./src/main/io/vtx_smartaudio.c" 2
...
# 54 "./src/main/io/vtx_smartaudio.c" 2
...
# 55 "./src/main/io/vtx_smartaudio.c" 2
...
# 56 "./src/main/io/vtx_smartaudio.c" 2
...
# 57 "./src/main/io/vtx_smartaudio.c" 2
# 71 "./src/main/io/vtx_smartaudio.c"
static serialPort_t *smartAudioSerialPort = 
# 71 "./src/main/io/vtx_smartaudio.c" 3 4
                                           ((void *)0)
# 71 "./src/main/io/vtx_smartaudio.c"
                                               ;


const char * const saPowerNames[4 +1] = {
    "---", "25 ", "200", "500", "800",
};
...
static vtxDevice_t vtxSmartAudio = {
    .vTable = &saVTable,
    .capability.bandCount = (5 - 1 + 1),
    .capability.channelCount = (8 - 1 + 1),
...
enum {
    ...
    SA_CMD_SET_FREQ,
    SA_CMD_SET_MODE,
    SA_CMD_GET_SETTINGS_V2 = 0x09
} smartAudioCommand_e;
# 120 "./src/main/io/vtx_smartaudio.c"
...
static uint8_t saLockMode = 8;



# 156 "./src/main/io/vtx_smartaudio.c" 3 4
_Bool 
# 156 "./src/main/io/vtx_smartaudio.c"
    saDeferred = 
# 156 "./src/main/io/vtx_smartaudio.c" 3 4
                 1
# 156 "./src/main/io/vtx_smartaudio.c"
...
# 208 "./src/main/io/vtx_smartaudio.c"
int saDacToPowerIndex(int dac)
{
...
uint16_t sa_smartbaud = 4800;
static int sa_adjdir = 1;
...
static void saAutobaud(void)
{
    ...
    if ((sa_adjdir == 1) && (sa_smartbaud == 4950)) {
       sa_adjdir = -1;
       ;
    } else if ((sa_adjdir == -1 && sa_smartbaud == 4800)) {
       sa_adjdir = 1;
       ;
    }
...
static uint8_t sa_outstanding = SA_CMD_NONE;
...
static void saProcessResponse(uint8_t *buf, int len)
{
    ...
    case SA_CMD_SET_FREQ:
        ...
        if (freq & (1 << 14)) {
            saDevice.orfreq = freq & (~((1 << 14)|(1 << 15)));
            ;
        } else if (freq & (1 << 15)) {
            saDevice.orfreq = freq & (~((1 << 14)|(1 << 15)));
            ;
...
# 477 "./src/main/io/vtx_smartaudio.c"
...
static saCmdQueue_t sa_queue[6];
static uint8_t sa_qhead = 0;
static uint8_t sa_qtail = 0;
# 517 "./src/main/io/vtx_smartaudio.c"
static 
# 517 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 517 "./src/main/io/vtx_smartaudio.c"
           saQueueEmpty(void)
{
...
static 
# 522 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 522 "./src/main/io/vtx_smartaudio.c"
           saQueueFull(void)
{
    return ((sa_qhead + 1) % 6) == sa_qtail;
}
...
{
    static uint8_t bufGetSettings[5] = {0xAA, 0x55, (((SA_CMD_GET_SETTINGS) << 1) | 1), 0x00, 0x9F};

    saQueueCmd(bufGetSettings, 5);
}

static 
# 557 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 557 "./src/main/io/vtx_smartaudio.c"
           saValidateFreq(uint16_t freq)
{
    return (freq >= 5000 && freq <= 5999);
}

static void saDoDevSetFreq(uint16_t freq)
{
    static uint8_t buf[7] = { 0xAA, 0x55, (((SA_CMD_SET_FREQ) << 1) | 1), 2 };
    ...
    if ((saDevice.mode & 1) == 0 && freq == saDevice.freq) {
        memcpy(&switchBuf, &buf, sizeof(buf));
        const uint16_t switchFreq = freq + ((freq == 5999) ? -1 : 1);
...
void saSetPitFreq(uint16_t freq)
{
    saDoDevSetFreq(freq | (1 << 15));
}
# 612 "./src/main/io/vtx_smartaudio.c"
static 
# 612 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 612 "./src/main/io/vtx_smartaudio.c"
           saValidateBandAndChannel(uint8_t band, uint8_t channel)
{
    return (band >= 1 && band <= 5 &&
             channel >= 1 && channel <= 8);
}

static void saDevSetBandAndChannel(uint8_t band, uint8_t channel)
{
    static uint8_t buf[6] = { 0xAA, 0x55, (((SA_CMD_SET_CHAN) << 1) | 1), 1 };

    buf[4] = ((band) * (uint8_t)8 + (channel));
    buf[5] = CRC8(buf, 5);
...
void saSetMode(int mode)
{
    static uint8_t buf[6] = { 0xAA, 0x55, (((SA_CMD_SET_MODE) << 1) | 1), 1 };
...
{
    static uint8_t buf[6] = { 0xAA, 0x55, (((SA_CMD_SET_POWER) << 1) | 1), 1 };
...
# 668 "./src/main/io/vtx_smartaudio.c" 3 4
_Bool 
# 668 "./src/main/io/vtx_smartaudio.c"
    vtxSmartAudioInit(void)
{
# 680 "./src/main/io/vtx_smartaudio.c"
    ...
    if (portConfig) {
        ...
        smartAudioSerialPort = openSerialPort(portConfig->identifier, FUNCTION_VTX_SMARTAUDIO, 
# 689 "./src/main/io/vtx_smartaudio.c" 3 4
                                                                                              ((void *)0)
# 689 "./src/main/io/vtx_smartaudio.c"
                                                                                                  , 
# 689 "./src/main/io/vtx_smartaudio.c" 3 4
                                                                                                    ((void *)0)
# 689 "./src/main/io/vtx_smartaudio.c"
                                                                                                        , 4800, MODE_RXTX, portOptions);
    }

    if (!smartAudioSerialPort) {
        return 
# 693 "./src/main/io/vtx_smartaudio.c" 3 4
              0
# 693 "./src/main/io/vtx_smartaudio.c"
                   ;
    }
    ...
    return 
# 698 "./src/main/io/vtx_smartaudio.c" 3 4
          1
# 698 "./src/main/io/vtx_smartaudio.c"
              ;
}
...
void vtxSAProcess(timeUs_t currentTimeUs)
{
    ...
    if (smartAudioSerialPort == 
# 712 "./src/main/io/vtx_smartaudio.c" 3 4
                               ((void *)0)
# 712 "./src/main/io/vtx_smartaudio.c"
                                   ) {
        return;
    }
    ...
    static timeMs_t lastCommandSentMs = 0;

    if ((sa_outstanding != SA_CMD_NONE) && (nowMs - sa_lastTransmissionMs > 120)) {
    ...
    lastCommandSentMs = nowMs;
        ...
        saSendQueue();
    lastCommandSentMs = nowMs;
    } else if ((nowMs - lastCommandSentMs < 1000) && (nowMs - sa_lastTransmissionMs >= 150)) {
...
# 785 "./src/main/io/vtx_smartaudio.c" 3 4
_Bool 
# 785 "./src/main/io/vtx_smartaudio.c"
    vtxSAIsReady(void)
{
...
# 841 "./src/main/io/vtx_smartaudio.c" 3 4
_Bool 
# 841 "./src/main/io/vtx_smartaudio.c"
    vtxSAGetBandAndChannel(uint8_t *pBand, uint8_t *pChannel)
{
    if (!vtxSAIsReady()) {
        return 
# 844 "./src/main/io/vtx_smartaudio.c" 3 4
              0
# 844 "./src/main/io/vtx_smartaudio.c"
                   ;
    }


    *pBand = (saDevice.mode & 1) ? 0 :
        (((saDevice.channel) / (uint8_t)8) + 1);
    *pChannel = ((saDevice.channel) % (uint8_t)8) + 1;
    return 
# 851 "./src/main/io/vtx_smartaudio.c" 3 4
          1
# 851 "./src/main/io/vtx_smartaudio.c"
              ;
}


# 854 "./src/main/io/vtx_smartaudio.c" 3 4
_Bool 
# 854 "./src/main/io/vtx_smartaudio.c"
    vtxSAGetPowerIndex(uint8_t *pIndex)
{
    if (!vtxSAIsReady()) {
        return 
# 857 "./src/main/io/vtx_smartaudio.c" 3 4
              0
# 857 "./src/main/io/vtx_smartaudio.c"
                   ;
    }

    *pIndex = ((saDevice.version == 1) ? saDacToPowerIndex(saDevice.power) : saDevice.power) + 1;
    return 
# 861 "./src/main/io/vtx_smartaudio.c" 3 4
          1
# 861 "./src/main/io/vtx_smartaudio.c"
              ;
}


# 864 "./src/main/io/vtx_smartaudio.c" 3 4
_Bool 
# 864 "./src/main/io/vtx_smartaudio.c"
    vtxSAGetPitMode(uint8_t *pOnOff)
{
    if (!(vtxSAIsReady() && (saDevice.version == 2))) {
        return 
# 867 "./src/main/io/vtx_smartaudio.c" 3 4
              0
# 867 "./src/main/io/vtx_smartaudio.c"
                   ;
    }

    *pOnOff = (saDevice.mode & 2) ? 1 : 0;
    return 
# 871 "./src/main/io/vtx_smartaudio.c" 3 4
          1
# 871 "./src/main/io/vtx_smartaudio.c"
              ;
}


# 874 "./src/main/io/vtx_smartaudio.c" 3 4
_Bool 
# 874 "./src/main/io/vtx_smartaudio.c"
    vtxSAGetFreq(uint16_t *pFreq)
{
    if (!vtxSAIsReady()) {
        return 
# 877 "./src/main/io/vtx_smartaudio.c" 3 4
              0
# 877 "./src/main/io/vtx_smartaudio.c"
                   ;
    }


    *pFreq = (saDevice.mode & 1) ? saDevice.freq :
        vtx58_Bandchan2Freq(((saDevice.channel) / (uint8_t)8) + 1,
        ((saDevice.channel) % (uint8_t)8) + 1);
    return 
# 884 "./src/main/io/vtx_smartaudio.c" 3 4
          1
# 884 "./src/main/io/vtx_smartaudio.c"
              ;
}
