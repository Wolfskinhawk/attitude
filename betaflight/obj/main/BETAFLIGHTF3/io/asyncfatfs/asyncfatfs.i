...
# 33 "./src/main/io/asyncfatfs/asyncfatfs.c" 2
# 98 "./src/main/io/asyncfatfs/asyncfatfs.c"
typedef enum {
...
# 179 "./src/main/io/asyncfatfs/asyncfatfs.c"
    unsigned locked:1;
...
# 358 "./src/main/io/asyncfatfs/asyncfatfs.c"
    uint32_t logicalSize;
# 371 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 445 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
   _Bool 
# 445 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 459 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
   _Bool 
# 459 "./src/main/io/asyncfatfs/asyncfatfs.c"
        filesystemFull;
...
static 
# 507 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 507 "./src/main/io/asyncfatfs/asyncfatfs.c"
           isPowerOfTwo(unsigned int x)
{
    return ((x != 0) && ((x & (~x + 1)) == x));
}
# 519 "./src/main/io/asyncfatfs/asyncfatfs.c"
static 
# 519 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 519 "./src/main/io/asyncfatfs/asyncfatfs.c"
           afatfs_assert(
# 519 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
...
static 
# 534 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 534 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 605 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                                                                  _Bool 
# 605 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                                                                       locked)
{
...
static void afatfs_sdcardReadComplete(sdcardBlockOperation_e operation, uint32_t sectorIndex, uint8_t *buffer, uint32_t callbackData)
{
    ...
    for (int i = 0; i < 8; i++) {
        if (afatfs.cacheDescriptor[i].state != AFATFS_CACHE_STATE_EMPTY
            ...
            if (buffer == 
# 632 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                         ((void *)0)
# 632 "./src/main/io/asyncfatfs/asyncfatfs.c"
                             ) {
...
# 654 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                 0
# 654 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                      ;
    ...
    for (int i = 0; i < 8; i++) {
        ...
        if (afatfs.cacheDescriptor[i].sectorIndex == sectorIndex
            ...
            if (buffer == 
# 663 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                         ((void *)0)
# 663 "./src/main/io/asyncfatfs/asyncfatfs.c"
                             ) {
...
static void afatfs_cacheFlushSector(int cacheIndex)
{
    ...
    switch (sdcard_writeBlock(cacheDescriptor->sectorIndex, afatfs_cacheSectorGetMemory(cacheIndex), afatfs_sdcardWriteComplete, 0)) {
        case SDCARD_OPERATION_IN_PROGRESS:
            ...
            afatfs.cacheFlushInProgress = 
# 695 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                         1
# 695 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                             ;
            break;
...
static afatfsCacheBlockDescriptor_t* afatfs_findCacheSector(uint32_t sectorIndex)
{
    ...
    return 
# 723 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          ((void *)0)
# 723 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
# 737 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 802 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                                                   0
# 802 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                                                        );
    }
...
# 811 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 811 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_flush(void)
{
    if (afatfs.cacheDirtyEntries > 0) {
        ...
        if (earliestSectorIndex > -1) {
            ...
            return 
# 831 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  0
# 831 "./src/main/io/asyncfatfs/asyncfatfs.c"
                       ;
        }
    }

    return 
# 835 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          1
# 835 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
...
# 841 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 841 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_isFull(void)
{
...
# 898 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 933 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                            (0xffff)
# 933 "./src/main/io/asyncfatfs/asyncfatfs.c"
                            ) _b = ((uint32_t)
# 933 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                            (0xffff)
# 933 "./src/main/io/asyncfatfs/asyncfatfs.c"
        ...
        default:
            ...
            afatfs_assert(
# 963 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                         0
# 963 "./src/main/io/asyncfatfs/asyncfatfs.c"
                              );
            return AFATFS_OPERATION_FAILURE;
    }
}
...
static 
# 971 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 971 "./src/main/io/asyncfatfs/asyncfatfs.c"
           afatfs_parseMBR(const uint8_t *sector)
{

    if (sector[512 - 2] != 0x55 || sector[512 - 1] != 0xAA)
        return 
# 975 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 975 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    ...
    for (int i = 0; i < 4; i++) {
        if (
            ...
            return 
# 991 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  1
# 991 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
        }
    }

    return 
# 995 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          0
# 995 "./src/main/io/asyncfatfs/asyncfatfs.c"
               ;
}

static 
# 998 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 998 "./src/main/io/asyncfatfs/asyncfatfs.c"
           afatfs_parseVolumeID(const uint8_t *sector)
{
    ...
    if (volume->bytesPerSector != 512 || volume->numFATs != 2
        ...
        return 
# 1006 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 1006 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    }
    ...
    if (afatfs.sectorsPerCluster < 1 || afatfs.sectorsPerCluster > 128 || !isPowerOfTwo(afatfs.sectorsPerCluster)) {
        return 
# 1013 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 1013 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    }
    ...
    if (afatfs.numClusters <= 4084) {
        ...
        return 
# 1030 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 1030 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    ...
    return 
# 1048 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          1
# 1048 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
...
static 
# 1069 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 1069 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1091 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1119 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1186 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1192 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
   _Bool 
# 1192 "./src/main/io/asyncfatfs/asyncfatfs.c"
    ...
    switch (condition) {
        ...
        default:
            afatfs_assert(
# 1213 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                         0
# 1213 "./src/main/io/asyncfatfs/asyncfatfs.c"
                              );
            return AFATFS_FIND_CLUSTER_FATAL;
    }
...
# 1290 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1329 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1371 "./src/main/io/asyncfatfs/asyncfatfs.c"
        switch (pattern) {
...
# 1430 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1496 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1572 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                   1
# 1572 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                       ;
            return AFATFS_OPERATION_FAILURE;
        break;
    }
...
# 1601 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1638 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1661 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1726 "./src/main/io/asyncfatfs/asyncfatfs.c"
static afatfsOperationStatus_e afatfs_appendSupercluster(afatfsFilePtr_t file)
{
    ...
    if (afatfs.freeFile.logicalSize < superClusterSize) {
        afatfs.filesystemFull = 
# 1735 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                               1
# 1735 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                   ;
    }
...
static 
# 1778 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 1778 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
static uint8_t* afatfs_fileRetainCursorSectorForRead(afatfsFilePtr_t file)
{
    ...
    if (file->readRetainCacheIndex != -1) {
        if (!afatfs_assert(physicalSector == afatfs.cacheDescriptor[file->readRetainCacheIndex].sectorIndex)) {
            return 
# 1804 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 1804 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
        }
        ...
        if (afatfs_isEndOfAllocatedFile(file)) {
            return 
# 1810 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 1810 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
        }
        ...
        if (status != AFATFS_OPERATION_SUCCESS) {
            ...
            return 
# 1824 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 1824 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
        }
...
static uint8_t* afatfs_fileLockCursorSectorForWrite(afatfsFilePtr_t file)
{
    ...
    if (file->writeLockedCacheIndex != -1) {
        ...
        if (!afatfs_assert(physicalSector == afatfs.cacheDescriptor[file->writeLockedCacheIndex].sectorIndex)) {
            return 
# 1849 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 1849 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
        }
        ...
        if (afatfs_isEndOfAllocatedFile(file) && afatfs_appendFreeCluster(file) != AFATFS_OPERATION_SUCCESS) {
            ...
            return 
# 1859 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 1859 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
        }
        ...
        if (status != AFATFS_OPERATION_SUCCESS) {
            ...
            return 
# 1897 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 1897 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
        }
...
# 1918 "./src/main/io/asyncfatfs/asyncfatfs.c"
static 
# 1918 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 1918 "./src/main/io/asyncfatfs/asyncfatfs.c"
           afatfs_fseekAtomic(afatfsFilePtr_t file, int32_t offset)
{
    ...
    if (newSectorOffset < 512) {
        ...
        return 
# 1926 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              1
# 1926 "./src/main/io/asyncfatfs/asyncfatfs.c"
                  ;
    }
    ...
    if (file->type == AFATFS_FILE_TYPE_FAT16_ROOT_DIRECTORY) {
        ...
        return 
# 1936 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              1
# 1936 "./src/main/io/asyncfatfs/asyncfatfs.c"
                  ;
    }
    ...
    if (offset > (int32_t) clusterSizeBytes || offset < -(int32_t) offsetInCluster) {
        return 
# 1946 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 1946 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    }
    ...
    if (newOffsetInCluster >= clusterSizeBytes) {
        ...
        if (status == AFATFS_OPERATION_SUCCESS) {
            ...
            return 
# 1966 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  0
# 1966 "./src/main/io/asyncfatfs/asyncfatfs.c"
                       ;
        }
    }
    ...
    return 
# 1975 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          1
# 1975 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
...
static 
# 1981 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 1981 "./src/main/io/asyncfatfs/asyncfatfs.c"
           afatfs_fseekInternalContinue(afatfsFile_t *file)
{
    ...
    while (offsetInCluster + opState->seekOffset >= clusterSizeBytes && !afatfs_isEndOfAllocatedFile(file)) {
        ...
        if (status == AFATFS_OPERATION_SUCCESS) {
            ...
            return 
# 2007 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  0
# 2007 "./src/main/io/asyncfatfs/asyncfatfs.c"
                       ;
        }
    }
    ...
    return 
# 2024 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          1
# 2024 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
# 2038 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 2075 "./src/main/io/asyncfatfs/asyncfatfs.c"
afatfsOperationStatus_e afatfs_fseek(afatfsFilePtr_t file, int32_t offset, afatfsSeek_e whence)
{
...
# 2084 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                                                                      ((void *)0)
# 2084 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                                                                          );
            }
...
# 2113 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                                                ((void *)0)
# 2113 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                                                    );
}
...
# 2121 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 2121 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_ftell(afatfsFilePtr_t file, uint32_t *position)
{
    if (afatfs_fileIsBusy(file)) {
        return 
# 2124 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 2124 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    } else {
        *position = file->cursorOffset;
        return 
# 2127 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              1
# 2127 "./src/main/io/asyncfatfs/asyncfatfs.c"
                  ;
    }
}
# 2139 "./src/main/io/asyncfatfs/asyncfatfs.c"
afatfsOperationStatus_e afatfs_findNext(afatfsFilePtr_t directory, afatfsFinder_t *finder, fatDirectoryEntry_t **dirEntry)
{
    uint8_t *sector;
    ...
    if (sector) {
        ...
        *dirEntry = (fatDirectoryEntry_t*) sector + finder->entryIndex;
        ...
        if (afatfs_isEndOfAllocatedFile(directory)) {
            *dirEntry = 
# 2164 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                       ((void *)0)
# 2164 "./src/main/io/asyncfatfs/asyncfatfs.c"
                           ;
...
static afatfsOperationStatus_e afatfs_extendSubdirectoryContinue(afatfsFile_t *directory)
{
    ...
    switch (opState->phase) {
        ...
        case AFATFS_EXTEND_SUBDIRECTORY_PHASE_FAILURE:
            ...
            if (opState->callback) {
                opState->callback(
# 2272 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                 ((void *)0)
# 2272 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                     );
            }
            return AFATFS_OPERATION_FAILURE;
        break;
...
# 2292 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 2331 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 2349 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                         ((void *)0)
# 2349 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                             , 
# 2349 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                               ((void *)0)
# 2349 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
static afatfsFilePtr_t afatfs_allocateFileHandle(void)
{
    ...
    return 
# 2376 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          ((void *)0)
# 2376 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
# 2386 "./src/main/io/asyncfatfs/asyncfatfs.c"
static afatfsOperationStatus_e afatfs_ftruncateContinue(afatfsFilePtr_t file, 
# 2386 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                                             _Bool 
# 2386 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                                                  markDeleted)
{
...
# 2493 "./src/main/io/asyncfatfs/asyncfatfs.c"

# 2493 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 2493 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_ftruncate(afatfsFilePtr_t file, afatfsFileCallback_t callback)
{
    ...
    if (afatfs_fileIsBusy(file))
        return 
# 2498 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 2498 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    ...
    return 
# 2526 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          1
# 2526 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
            ...
            do {
                ...
                switch (status) {
                    case AFATFS_OPERATION_SUCCESS:
                        ...
                        if (entry == 
# 2561 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                    ((void *)0) 
# 2561 "./src/main/io/asyncfatfs/asyncfatfs.c"
        ...
        case AFATFS_CREATEFILE_PHASE_CREATE_NEW_FILE:
            ...
            if (status == AFATFS_OPERATION_SUCCESS) {
                ...
                uint16_t fileDate = (01 | (12 << 5) | ((2015 - 1980) << 9));
                uint16_t fileTime = ((00 / 2) | (00 << 5) | (00 << 11));
                ...
                rtcGetDateTime(&dt);
                if (dt.year != 0) {
                    fileDate = (dt.day | (dt.month << 5) | ((dt.year - 1980) << 9));
                    fileTime = ((dt.seconds / 2) | (dt.minutes << 5) | (dt.hours << 11));
                }
        ...
        case AFATFS_CREATEFILE_PHASE_FAILURE:
            ...
            opState->callback(
# 2697 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                             ((void *)0)
# 2697 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                 );
        break;
    }
}
...
# 2717 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                           1
# 2717 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                               );
...
# 2732 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 2732 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_funlink(afatfsFilePtr_t file, afatfsCallback_t callback)
{
    afatfsUnlinkFile_t *opState = &file->operation.state.unlinkFile;
    ...
    if (!file || file->type == AFATFS_FILE_TYPE_NONE) {
        return 
# 2737 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              1
# 2737 "./src/main/io/asyncfatfs/asyncfatfs.c"
                  ;
    }
...
# 2746 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                               ((void *)0)
# 2746 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                   ))
        return 
# 2747 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 2747 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    ...
    return 
# 2757 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          1
# 2757 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
# 2770 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 2825 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 2869 "./src/main/io/asyncfatfs/asyncfatfs.c"

# 2869 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 2869 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_fclose(afatfsFilePtr_t file, afatfsCallback_t callback)
{
    if (!file || file->type == AFATFS_FILE_TYPE_NONE) {
        return 
# 2872 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              1
# 2872 "./src/main/io/asyncfatfs/asyncfatfs.c"
                  ;
    } else if (afatfs_fileIsBusy(file)) {
        return 
# 2874 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 2874 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    } else {
        afatfs_fileUpdateFilesize(file);
        ...
        return 
# 2881 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              1
# 2881 "./src/main/io/asyncfatfs/asyncfatfs.c"
                  ;
    }
}
# 2892 "./src/main/io/asyncfatfs/asyncfatfs.c"

# 2892 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 2892 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 2899 "./src/main/io/asyncfatfs/asyncfatfs.c"
    ...
    return file != 
# 2902 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 2902 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
}
# 2912 "./src/main/io/asyncfatfs/asyncfatfs.c"

# 2912 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 2912 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_chdir(afatfsFilePtr_t directory)
{
    if (afatfs_fileIsBusy(&afatfs.currentDirectory)) {
        return 
# 2915 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 2915 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    }
    ...
    if (directory) {
        if (afatfs_fileIsBusy(directory)) {
            return 
# 2920 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  0
# 2920 "./src/main/io/asyncfatfs/asyncfatfs.c"
                       ;
        }

        memcpy(&afatfs.currentDirectory, directory, sizeof(*directory));
        return 
# 2924 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              1
# 2924 "./src/main/io/asyncfatfs/asyncfatfs.c"
                  ;
    } else {
        ...
        return 
# 2943 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              1
# 2943 "./src/main/io/asyncfatfs/asyncfatfs.c"
                  ;
    }
}
# 2973 "./src/main/io/asyncfatfs/asyncfatfs.c"

# 2973 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 2973 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_fopen(const char *filename, const char *mode, afatfsFileCallback_t complete)
{
    ...
    if (file) {
        ...
        complete(
# 3010 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                ((void *)0)
# 3010 "./src/main/io/asyncfatfs/asyncfatfs.c"
                    );
    }

    return file != 
# 3013 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 3013 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
}
...
# 3050 "./src/main/io/asyncfatfs/asyncfatfs.c"
uint32_t afatfs_fwrite(afatfsFilePtr_t file, const uint8_t *buffer, uint32_t len)
{
    if ((file->mode & (4 | 2)) == 0) {
        return 0;
...
# 3087 "./src/main/io/asyncfatfs/asyncfatfs.c"
        if (afatfs_fseekInternal(file, bytesToWriteThisSector, 
# 3087 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                              ((void *)0)
# 3087 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                                  ) == AFATFS_OPERATION_IN_PROGRESS) {
            break;
...
# 3117 "./src/main/io/asyncfatfs/asyncfatfs.c"
uint32_t afatfs_fread(afatfsFilePtr_t file, uint8_t *buffer, uint32_t len)
{
    if ((file->mode & 1) == 0) {
        return 0;
...
# 3178 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 3178 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_feof(afatfsFilePtr_t file)
{
...
# 3205 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                          0
# 3205 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                               );
        break;
...
# 3275 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 3380 "./src/main/io/asyncfatfs/asyncfatfs.c"
        ...
        case AFATFS_INITIALIZATION_READ_VOLUME_ID:
            if (afatfs_cacheSector(afatfs.partitionStartSector, &sector, 1 | 8, 0) == AFATFS_OPERATION_SUCCESS) {
                if (afatfs_parseVolumeID(sector)) {
                    ...
                    afatfs_chdir(
# 3406 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                ((void *)0)
# 3406 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                    );
        ...
        break;
# 3500 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 3573 "./src/main/io/asyncfatfs/asyncfatfs.c"
afatfsFilesystemState_e afatfs_getFilesystemState(void)
{
...
# 3599 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 3599 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_destroy(
# 3599 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                   _Bool 
# 3599 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 3607 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                   ((void *)0)
# 3607 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                       );

                openFileCount++;
            }
        }
# 3621 "./src/main/io/asyncfatfs/asyncfatfs.c"
        if (afatfs.freeFile.type != AFATFS_FILE_TYPE_NONE) {
            afatfs_fclose(&afatfs.freeFile, 
# 3622 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                           ((void *)0)
# 3622 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                               );
            openFileCount++;
        }
...
# 3628 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                   ((void *)0)
# 3628 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                       );
            openFileCount++;
        }
        ...
        if (!afatfs_flush()) {
            return 
# 3635 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  0
# 3635 "./src/main/io/asyncfatfs/asyncfatfs.c"
                       ;
        }

        if (afatfs.cacheFlushInProgress) {
            return 
# 3639 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  0
# 3639 "./src/main/io/asyncfatfs/asyncfatfs.c"
                       ;
        }
...
# 3654 "./src/main/io/asyncfatfs/asyncfatfs.c"
    }
    ...
    return 
# 3659 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          1
# 3659 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
