# 1 "./src/main/io/displayport_srxl.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/io/displayport_srxl.c"
# 18 "./src/main/io/displayport_srxl.c"
# 1 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\lib\\gcc\\arm-none-eabi\\7.2.1\\include\\stdbool.h" 1 3 4
# 19 "./src/main/io/displayport_srxl.c" 2
...
# 20 "./src/main/io/displayport_srxl.c" 2
...
# 21 "./src/main/io/displayport_srxl.c" 2
...
# 23 "./src/main/io/displayport_srxl.c" 2
...
# 28 "./src/main/io/displayport_srxl.c" 2
...
# 29 "./src/main/io/displayport_srxl.c" 2
...
# 31 "./src/main/io/displayport_srxl.c" 2
...
static int srxlClearScreen(displayPort_t *displayPort)
{
    ...
    if ( displayPort->grabCount == 0 ) {
        srxlWriteString(displayPort, 0, 3, "MENU:THR MID");
        srxlWriteString(displayPort, 2, 4, "+ YAW LEFT");
        srxlWriteString(displayPort, 2, 5, "+ PITCH UP");
    }
    return 0;
}

static 
# 77 "./src/main/io/displayport_srxl.c" 3 4
      _Bool 
# 77 "./src/main/io/displayport_srxl.c"
           srxlIsTransferInProgress(const displayPort_t *displayPort)
{
    (void)(displayPort);
    return 
# 80 "./src/main/io/displayport_srxl.c" 3 4
          0
# 80 "./src/main/io/displayport_srxl.c"
               ;
}
...
static uint32_t srxlTxBytesFree(const displayPort_t *displayPort)
{
    (void)(displayPort);
    return 
# 97 "./src/main/io/displayport_srxl.c" 3 4
          (0xffffffffUL)
# 97 "./src/main/io/displayport_srxl.c"
                    ;
}
...
{
    srxlDisplayPort.device = 
# 128 "./src/main/io/displayport_srxl.c" 3 4
                            ((void *)0)
# 128 "./src/main/io/displayport_srxl.c"
                                ;
    displayInit(&srxlDisplayPort, &srxlVTable);
    srxlDisplayPort.rows = 9;
    srxlDisplayPort.cols = 12;
