# 1 "./src/main/io/displayport_max7456.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/io/displayport_max7456.c"
# 18 "./src/main/io/displayport_max7456.c"
# 1 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\lib\\gcc\\arm-none-eabi\\7.2.1\\include\\stdbool.h" 1 3 4
# 19 "./src/main/io/displayport_max7456.c" 2
...
# 20 "./src/main/io/displayport_max7456.c" 2
...
# 22 "./src/main/io/displayport_max7456.c" 2
...
# 28 "./src/main/io/displayport_max7456.c" 2
...
# 29 "./src/main/io/displayport_max7456.c" 2
...
# 31 "./src/main/io/displayport_max7456.c" 2
...
# 33 "./src/main/io/displayport_max7456.c" 2
...
# 34 "./src/main/io/displayport_max7456.c" 2
# 1 "./src/main/io/osd_slave.h" 1
# 18 "./src/main/io/osd_slave.h"
       
# 35 "./src/main/io/displayport_max7456.c" 2
...
# 37 "./src/main/io/displayport_max7456.c" 2

# 1 "./src/main/pg/pg_ids.h" 1
# 18 "./src/main/pg/pg_ids.h"
       
# 39 "./src/main/io/displayport_max7456.c" 2
...
# 40 "./src/main/io/displayport_max7456.c" 2

displayPort_t max7456DisplayPort;

extern void pgResetFn_displayPortProfileMax7456(displayPortProfile_t *); displayPortProfile_t displayPortProfileMax7456_System; displayPortProfile_t displayPortProfileMax7456_Copy; extern const pgRegistry_t displayPortProfileMax7456_Registry; const pgRegistry_t displayPortProfileMax7456_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 513 | (0 << 12), .size = sizeof(displayPortProfile_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&displayPortProfileMax7456_System, .copy = (uint8_t*)&displayPortProfileMax7456_Copy, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_displayPortProfileMax7456 }, };
...
void pgResetFn_displayPortProfileMax7456(displayPortProfile_t *displayPortProfile)
{
    ...
    displayPortProfile->invert = 
# 51 "./src/main/io/displayport_max7456.c" 3 4
                                0
# 51 "./src/main/io/displayport_max7456.c"
                                     ;
...
static 
# 117 "./src/main/io/displayport_max7456.c" 3 4
      _Bool 
# 117 "./src/main/io/displayport_max7456.c"
           isTransferInProgress(const displayPort_t *displayPort)
{
    (void)(displayPort);
...
static uint32_t txBytesFree(const displayPort_t *displayPort)
{
    (void)(displayPort);
    return 
# 140 "./src/main/io/displayport_max7456.c" 3 4
          (0xffffffffUL)
# 140 "./src/main/io/displayport_max7456.c"
                    ;
}
