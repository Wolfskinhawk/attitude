# 1 "./src/main/io/statusindicator.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/io/statusindicator.c"
# 18 "./src/main/io/statusindicator.c"
# 1 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\lib\\gcc\\arm-none-eabi\\7.2.1\\include\\stdbool.h" 1 3 4
# 19 "./src/main/io/statusindicator.c" 2
...
# 20 "./src/main/io/statusindicator.c" 2
...
# 22 "./src/main/io/statusindicator.c" 2
...
# 64 "./src/main/drivers/light_led.h"
                         state);
# 24 "./src/main/io/statusindicator.c" 2
...
# 25 "./src/main/io/statusindicator.c" 2
...
# 27 "./src/main/io/statusindicator.c" 2
...
void warningLedRefresh(void)
{
    switch (warningLedState) {
        case WARNING_LED_OFF:
            ledSet(0, 
# 62 "./src/main/io/statusindicator.c" 3 4
           0
# 62 "./src/main/io/statusindicator.c"
           );
            break;
        case WARNING_LED_ON:
            ledSet(0, 
# 65 "./src/main/io/statusindicator.c" 3 4
           1
# 65 "./src/main/io/statusindicator.c"
           );
            break;
