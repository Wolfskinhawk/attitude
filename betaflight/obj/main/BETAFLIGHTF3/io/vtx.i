...
# 42 "./src/main/io/vtx.c" 2


extern const vtxSettingsConfig_t pgResetTemplate_vtxSettingsConfig; vtxSettingsConfig_t vtxSettingsConfig_System; vtxSettingsConfig_t vtxSettingsConfig_Copy; extern const pgRegistry_t vtxSettingsConfig_Registry; const pgRegistry_t vtxSettingsConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 259 | (0 << 12), .size = sizeof(vtxSettingsConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&vtxSettingsConfig_System, .copy = (uint8_t*)&vtxSettingsConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_vtxSettingsConfig}, };

const vtxSettingsConfig_t pgResetTemplate_vtxSettingsConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .band = 4, .channel = 1, .power = 1, .freq = 5740, .pitModeFreq = 0, .lowPowerDisarm = 0, }
...
# 67 "./src/main/io/vtx.c" 3 4
   _Bool 
# 67 "./src/main/io/vtx.c"
        settingsUpdated = 
# 67 "./src/main/io/vtx.c" 3 4
                          0
# 67 "./src/main/io/vtx.c"
    ...
    if (vtxSettingsConfig()->band && freq != vtxSettingsConfig()->freq) {
        ...
        settingsUpdated = 
# 73 "./src/main/io/vtx.c" 3 4
                         1
# 73 "./src/main/io/vtx.c"
                             ;
    }
    ...
    if (vtxSettingsConfig()->pitModeFreq) {
        const uint16_t constrainedPitModeFreq = __extension__ ({ __typeof__ (vtxSettingsConfig()->pitModeFreq) _a = (vtxSettingsConfig()->pitModeFreq); __typeof__ (5000) _b = (5000); _a > _b ? _a : _b; });
        if (constrainedPitModeFreq != vtxSettingsConfig()->pitModeFreq) {
            vtxSettingsConfigMutable()->pitModeFreq = constrainedPitModeFreq;
            settingsUpdated = 
# 82 "./src/main/io/vtx.c" 3 4
                             1
# 82 "./src/main/io/vtx.c"
                                 ;
        }
    }
...
static vtxSettingsConfig_t vtxGetSettings(void) {
    ...
    if (!(armingFlags & (ARMED)) && settings.lowPowerDisarm) {
        settings.power = 1;
    }
...
static 
# 117 "./src/main/io/vtx.c" 3 4
      _Bool 
# 117 "./src/main/io/vtx.c"
           vtxProcessBandAndChannel(void) {
    if(!(armingFlags & (ARMED))) {
        ...
        if (vtxCommonGetBandAndChannel(&vtxBand, &vtxChan)) {
            ...
            if (vtxBand != settings.band || vtxChan != settings.channel) {
                ...
                return 
# 125 "./src/main/io/vtx.c" 3 4
                      1
# 125 "./src/main/io/vtx.c"
                          ;
            }
        }
    }
    return 
# 129 "./src/main/io/vtx.c" 3 4
          0
# 129 "./src/main/io/vtx.c"
               ;
}


static 
# 133 "./src/main/io/vtx.c" 3 4
      _Bool 
# 133 "./src/main/io/vtx.c"
           vtxProcessFrequency(void) {
    if(!(armingFlags & (ARMED))) {
        uint16_t vtxFreq;
        if (vtxCommonGetFrequency(&vtxFreq)) {
            ...
            if (vtxFreq != settings.freq) {
                ...
                return 
# 140 "./src/main/io/vtx.c" 3 4
                      1
# 140 "./src/main/io/vtx.c"
                          ;
            }
        }
    }
    return 
# 144 "./src/main/io/vtx.c" 3 4
          0
# 144 "./src/main/io/vtx.c"
               ;
}


static 
# 148 "./src/main/io/vtx.c" 3 4
      _Bool 
# 148 "./src/main/io/vtx.c"
           vtxProcessPower(void) {
    uint8_t vtxPower;
    if (vtxCommonGetPowerIndex(&vtxPower)) {
        ...
        if (vtxPower != settings.power) {
            ...
            return 
# 154 "./src/main/io/vtx.c" 3 4
                  1
# 154 "./src/main/io/vtx.c"
                      ;
        }
    }
    return 
# 157 "./src/main/io/vtx.c" 3 4
          0
# 157 "./src/main/io/vtx.c"
               ;
}

static 
# 160 "./src/main/io/vtx.c" 3 4
      _Bool 
# 160 "./src/main/io/vtx.c"
           vtxProcessPitMode(void) {
    uint8_t pitOnOff;
    if (!(armingFlags & (ARMED)) && vtxCommonGetPitMode(&pitOnOff)) {
        if (IS_RC_MODE_ACTIVE(BOXVTXPITMODE)) {

            if (vtxSettingsConfig()->pitModeFreq) {
                return 
# 166 "./src/main/io/vtx.c" 3 4
                      0
# 166 "./src/main/io/vtx.c"
                           ;
            }
            ...
            if (isModeActivationConditionPresent(BOXVTXPITMODE)) {
                if (!pitOnOff) {
                    vtxCommonSetPitMode(
# 171 "./src/main/io/vtx.c" 3 4
                                       1
# 171 "./src/main/io/vtx.c"
                                           );
                    return 
# 172 "./src/main/io/vtx.c" 3 4
                          1
# 172 "./src/main/io/vtx.c"
                              ;
                }
            } else {
                if (pitOnOff) {
                    vtxCommonSetPitMode(
# 176 "./src/main/io/vtx.c" 3 4
                                       0
# 176 "./src/main/io/vtx.c"
                                            );
                    return 
# 177 "./src/main/io/vtx.c" 3 4
                          1
# 177 "./src/main/io/vtx.c"
                              ;
                }
            }
        }
    ...
    return 
# 182 "./src/main/io/vtx.c" 3 4
          0
# 182 "./src/main/io/vtx.c"
               ;
}

static 
# 185 "./src/main/io/vtx.c" 3 4
      _Bool 
# 185 "./src/main/io/vtx.c"
           vtxProcessStateUpdate(void)
{
    ...
    return (
# 200 "./src/main/io/vtx.c" 3 4
           _Bool
# 200 "./src/main/io/vtx.c"
               ) memcmp(&vtxSettingsState, &vtxState, sizeof(vtxSettingsConfig_t));
}
...
# 216 "./src/main/io/vtx.c" 3 4
       _Bool 
# 216 "./src/main/io/vtx.c"
            vtxUpdatePending = 
# 216 "./src/main/io/vtx.c" 3 4
                               0
# 216 "./src/main/io/vtx.c"
        ...
        if (currentTimeUs > lastCycleTimeUs + 100000) {
        ...
        if (!(armingFlags & (ARMED)) || vtxUpdatePending) {
