# 1 "./src/main/pg/rx_pwm.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/pg/rx_pwm.c"
# 18 "./src/main/pg/rx_pwm.c"
...
# 23 "./src/main/pg/rx_pwm.c" 2
# 1 "./src/main/drivers/nvic.h" 1

       
# 24 "./src/main/pg/rx_pwm.c" 2
...
# 28 "./src/main/pg/rx_pwm.c" 2
# 1 "./src/main/pg/pg_ids.h" 1
# 18 "./src/main/pg/pg_ids.h"
       
# 29 "./src/main/pg/rx_pwm.c" 2
...
# 31 "./src/main/pg/rx_pwm.c" 2


extern void pgResetFn_pwmConfig(pwmConfig_t *); pwmConfig_t pwmConfig_System; pwmConfig_t pwmConfig_Copy; extern const pgRegistry_t pwmConfig_Registry; const pgRegistry_t pwmConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 508 | (0 << 12), .size = sizeof(pwmConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&pwmConfig_System, .copy = (uint8_t*)&pwmConfig_Copy, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_pwmConfig }, };

void pgResetFn_pwmConfig(pwmConfig_t *pwmConfig)
{
    pwmConfig->inputFilteringMode = INPUT_FILTERING_DISABLED;
    int inputIndex = 0;
    for (int i = 0; i < 10 && inputIndex < 8; i++) {
...
extern void pgResetFn_ppmConfig(ppmConfig_t *); ppmConfig_t ppmConfig_System; ppmConfig_t ppmConfig_Copy; extern const pgRegistry_t ppmConfig_Registry; const pgRegistry_t ppmConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 507 | (0 << 12), .size = sizeof(ppmConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&ppmConfig_System, .copy = (uint8_t*)&ppmConfig_Copy, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_ppmConfig }, };
