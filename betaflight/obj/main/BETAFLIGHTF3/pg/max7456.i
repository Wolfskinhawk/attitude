# 1 "./src/main/pg/max7456.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/pg/max7456.c"
# 18 "./src/main/pg/max7456.c"
...
# 23 "./src/main/pg/max7456.c" 2
# 1 "./src/main/pg/pg_ids.h" 1
# 18 "./src/main/pg/pg_ids.h"
       
# 24 "./src/main/pg/max7456.c" 2
...
# 26 "./src/main/pg/max7456.c" 2

extern const max7456Config_t pgResetTemplate_max7456Config; max7456Config_t max7456Config_System; max7456Config_t max7456Config_Copy; extern const pgRegistry_t max7456Config_Registry; const pgRegistry_t max7456Config_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 524 | (0 << 12), .size = sizeof(max7456Config_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&max7456Config_System, .copy = (uint8_t*)&max7456Config_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_max7456Config}, };

const max7456Config_t pgResetTemplate_max7456Config __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .clockConfig = 1, }
