# 1 "./src/main/pg/beeper.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/pg/beeper.c"
# 18 "./src/main/pg/beeper.c"
...
# 23 "./src/main/pg/beeper.c" 2
# 1 "./src/main/pg/pg_ids.h" 1
# 18 "./src/main/pg/pg_ids.h"
       
# 24 "./src/main/pg/beeper.c" 2
...
# 26 "./src/main/pg/beeper.c" 2

extern const beeperConfig_t pgResetTemplate_beeperConfig; beeperConfig_t beeperConfig_System; beeperConfig_t beeperConfig_Copy; extern const pgRegistry_t beeperConfig_Registry; const pgRegistry_t beeperConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 502 | (1 << 12), .size = sizeof(beeperConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&beeperConfig_System, .copy = (uint8_t*)&beeperConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_beeperConfig}, };
const beeperConfig_t pgResetTemplate_beeperConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .dshotBeaconTone = 0 }
