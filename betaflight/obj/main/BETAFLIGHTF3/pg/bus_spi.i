# 1 "./src/main/pg/bus_spi.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/pg/bus_spi.c"
# 18 "./src/main/pg/bus_spi.c"
...
# 25 "./src/main/pg/bus_spi.c" 2
# 1 "./src/main/pg/pg_ids.h" 1
# 18 "./src/main/pg/pg_ids.h"
       
# 26 "./src/main/pg/bus_spi.c" 2
...
# 28 "./src/main/pg/bus_spi.c" 2
# 48 "./src/main/pg/bus_spi.c"
...
const spiDefaultConfig_t spiDefaultConfig[] = {
    ...
    { SPIDEV_1, ((ioTag_t)((((1) + 1) << 4) | (3))), ((ioTag_t)((((1) + 1) << 4) | (4))), ((ioTag_t)((((1) + 1) << 4) | (5))) },


    { SPIDEV_2, ((ioTag_t)((((1) + 1) << 4) | (13))), ((ioTag_t)((((1) + 1) << 4) | (14))), ((ioTag_t)((((1) + 1) << 4) | (15))) },
...
extern void pgResetFn_spiPinConfig(spiPinConfig_t *); spiPinConfig_t spiPinConfig_System; spiPinConfig_t spiPinConfig_Copy; extern const pgRegistry_t spiPinConfig_Registry; const pgRegistry_t spiPinConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 520 | (0 << 12), .size = sizeof(spiPinConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&spiPinConfig_System, .copy = (uint8_t*)&spiPinConfig_Copy, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_spiPinConfig }, };

void pgResetFn_spiPinConfig(spiPinConfig_t *spiPinConfig)
{
    for (size_t i = 0 ; i < (sizeof(spiDefaultConfig) / sizeof((spiDefaultConfig)[0])) ; i++) {
