...
# 21 "./src/main/drivers/adc_impl.h" 2

# 1 "./src/main/drivers/rcc_types.h" 1
       

typedef uint8_t rccPeriphTag_t;
# 23 "./src/main/drivers/adc_impl.h" 2
...
# 32 "./src/main/pg/adc.c" 2


extern void pgResetFn_adcConfig(adcConfig_t *); adcConfig_t adcConfig_System; adcConfig_t adcConfig_Copy; extern const pgRegistry_t adcConfig_Registry; const pgRegistry_t adcConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 510 | (0 << 12), .size = sizeof(adcConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&adcConfig_System, .copy = (uint8_t*)&adcConfig_Copy, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_adcConfig }, };

void pgResetFn_adcConfig(adcConfig_t *adcConfig)
{
    adcConfig->device = ((adcDeviceByInstance(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x0100)))) + 1);


    adcConfig->vbat.enabled = 
# 41 "./src/main/pg/adc.c" 3 4
                             1
# 41 "./src/main/pg/adc.c"
                                 ;
    adcConfig->vbat.ioTag = ((ioTag_t)((((0) + 1) << 4) | (4)));
# 51 "./src/main/pg/adc.c"
    adcConfig->current.enabled = 
# 51 "./src/main/pg/adc.c" 3 4
                                1
# 51 "./src/main/pg/adc.c"
                                    ;
    adcConfig->current.ioTag = ((ioTag_t)((((0) + 1) << 4) | (5)));



    adcConfig->rssi.enabled = 
# 56 "./src/main/pg/adc.c" 3 4
                             1
# 56 "./src/main/pg/adc.c"
                                 ;
    adcConfig->rssi.ioTag = ((ioTag_t)((((1) + 1) << 4) | (2)));
