# 1 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
# 241 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
# 1 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/inc/stm32f30x_rtc.h" 1
# 38 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/inc/stm32f30x_rtc.h"
...
# 39 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/inc/stm32f30x_rtc.h" 2
...
# 242 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c" 2
# 1 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/inc/stm32f30x_rcc.h" 1
# 243 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c" 2
# 276 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
static uint8_t RTC_ByteToBcd2(uint8_t Value);
static uint8_t RTC_Bcd2ToByte(uint8_t Value);
# 328 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
ErrorStatus RTC_DeInit(void)
{
  ...
  else
  {
    ...
    ((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x00002800))->CR &= (uint32_t)0x00000007;


    do
    {
      wutwfstatus = ((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x00002800))->ISR & ((uint32_t)0x00000004);
      wutcounter++;
    } while((wutcounter != ((uint32_t) 0x00002000)) && (wutwfstatus == 0x00));

    if ((((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x00002800))->ISR & ((uint32_t)0x00000004)) == RESET)
    {
      status = ERROR;
    }
    else
    {
      ...
      ((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x00002800))->WUTR = (uint32_t)0x0000FFFF;
      ...
      ((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x00002800))->ALRMBR = (uint32_t)0x00000000;
      ...
      ((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x00002800))->ALRMBSSR = (uint32_t)0x00000000;
...
# 411 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
ErrorStatus RTC_Init(RTC_InitTypeDef* RTC_InitStruct)
{
  ErrorStatus status = ERROR;
...
# 479 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_WriteProtectionCmd(FunctionalState NewState)
{
...
# 506 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
ErrorStatus RTC_EnterInitMode(void)
{
  ...
  if ((((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x00002800))->ISR & ((uint32_t)0x00000040)) == (uint32_t)RESET)
  {
    ...
    do
    {
      ...
      initcounter++;
    } while((initcounter != ((uint32_t) 0x00002000)) && (initstatus == 0x00));
...
# 551 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_ExitInitMode(void)
{

  ((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x00002800))->ISR &= (uint32_t)~((uint32_t)0x00000080);
}
# 573 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
ErrorStatus RTC_WaitForSynchro(void)
{
...
# 624 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
ErrorStatus RTC_RefClockCmd(FunctionalState NewState)
{
  ErrorStatus status = ERROR;
...
# 672 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_BypassShadowCmd(FunctionalState NewState)
{
...
# 726 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
ErrorStatus RTC_SetTime(uint32_t RTC_Format, RTC_TimeTypeDef* RTC_TimeStruct)
{
  uint32_t tmpreg = 0;
  ErrorStatus status = ERROR;
...
# 830 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_TimeStructInit(RTC_TimeTypeDef* RTC_TimeStruct)
{
...
# 849 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_GetTime(uint32_t RTC_Format, RTC_TimeTypeDef* RTC_TimeStruct)
{
  uint32_t tmpreg = 0;
...
# 882 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
uint32_t RTC_GetSubSecond(void)
{
  uint32_t tmpreg = 0;
...
# 907 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
ErrorStatus RTC_SetDate(uint32_t RTC_Format, RTC_DateTypeDef* RTC_DateStruct)
{
  uint32_t tmpreg = 0;
  ErrorStatus status = ERROR;
...
# 998 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_DateStructInit(RTC_DateTypeDef* RTC_DateStruct)
{
...
# 1017 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_GetDate(uint32_t RTC_Format, RTC_DateTypeDef* RTC_DateStruct)
{
  uint32_t tmpreg = 0;
...
# 1077 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_SetAlarm(uint32_t RTC_Format, uint32_t RTC_Alarm, RTC_AlarmTypeDef* RTC_AlarmStruct)
{
  uint32_t tmpreg = 0;
  ...
  {
    ((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x00002800))->ALRMBR = (uint32_t)tmpreg;
  }


  ((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x00002800))->WPR = 0xFF;
}
# 1188 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_AlarmStructInit(RTC_AlarmTypeDef* RTC_AlarmStruct)
{
...
# 1218 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_GetAlarm(uint32_t RTC_Format, uint32_t RTC_Alarm, RTC_AlarmTypeDef* RTC_AlarmStruct)
{
  uint32_t tmpreg = 0;
  ...
  {
    tmpreg = (uint32_t)(((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x00002800))->ALRMBR);
  }


  RTC_AlarmStruct->RTC_AlarmTime.RTC_Hours = (uint32_t)((tmpreg & (((uint32_t)0x00300000) |
                                                     ((uint32_t)0x000F0000))) >> 16);
  RTC_AlarmStruct->RTC_AlarmTime.RTC_Minutes = (uint32_t)((tmpreg & (((uint32_t)0x00007000) |
                                                     ((uint32_t)0x00000F00))) >> 8);
  RTC_AlarmStruct->RTC_AlarmTime.RTC_Seconds = (uint32_t)(tmpreg & (((uint32_t)0x00000070) |
                                                     ((uint32_t)0x0000000F)));
...
# 1272 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
ErrorStatus RTC_AlarmCmd(uint32_t RTC_Alarm, FunctionalState NewState)
{
  ...
  else
  {
    ...
    do
    {
      ...
      alarmcounter++;
    } while((alarmcounter != ((uint32_t) 0x00002000)) && (alarmstatus == 0x00));
...
# 1366 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_AlarmSubSecondConfig(uint32_t RTC_Alarm, uint32_t RTC_AlarmSubSecondValue, uint32_t RTC_AlarmSubSecondMask)
{
  uint32_t tmpreg = 0;
  ...
  else
  {
    ...
    ((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x00002800))->ALRMBSSR = tmpreg;
  }
...
# 1407 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
uint32_t RTC_GetAlarmSubSecond(uint32_t RTC_Alarm)
{
  uint32_t tmpreg = 0;
  ...
  {
    tmpreg = (uint32_t)((((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x00002800))->ALRMBSSR) & ((uint32_t)0x00007FFF));
  }

  return (tmpreg);
}
# 1455 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_WakeUpClockConfig(uint32_t RTC_WakeUpClock)
{
  ...
  ((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x00002800))->CR &= (uint32_t)~((uint32_t)0x00000007);


  ((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x00002800))->CR |= (uint32_t)RTC_WakeUpClock;


  ((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x00002800))->WPR = 0xFF;
}
# 1482 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_SetWakeUpCounter(uint32_t RTC_WakeUpCounter)
{
  ...
  ((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x00002800))->WUTR = (uint32_t)RTC_WakeUpCounter;
...
uint32_t RTC_GetWakeUpCounter(void)
{
  ...
  return ((uint32_t)(((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x00002800))->WUTR & ((uint32_t)0x0000FFFF)));
}
...
ErrorStatus RTC_WakeUpCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x00002800))->CR |= (uint32_t)((uint32_t)0x00000400);
    status = SUCCESS;
  }
  else
  {
...
# 1591 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_DayLightSavingConfig(uint32_t RTC_DayLightSaving, uint32_t RTC_StoreOperation)
{
...
# 1618 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
uint32_t RTC_GetStoreOperation(void)
{
  return (((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x00002800))->CR & ((uint32_t)0x00040000));
}
# 1656 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_OutputConfig(uint32_t RTC_Output, uint32_t RTC_OutputPolarity)
{
  ...
  ((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x00002800))->CR &= (uint32_t)~(((uint32_t)0x00600000) | ((uint32_t)0x00100000));
...
# 1699 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_CalibOutputCmd(FunctionalState NewState)
{
...
# 1731 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_CalibOutputConfig(uint32_t RTC_CalibOutput)
{
...
# 1767 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
ErrorStatus RTC_SmoothCalibConfig(uint32_t RTC_SmoothCalibPeriod,
                                  uint32_t RTC_SmoothCalibPlusPulses,
                                  uint32_t RTC_SmouthCalibMinusPulsesValue)
{
...
# 1843 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_TimeStampCmd(uint32_t RTC_TimeStampEdge, FunctionalState NewState)
{
  uint32_t tmpreg = 0;
...
# 1887 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_GetTimeStamp(uint32_t RTC_Format, RTC_TimeTypeDef* RTC_StampTimeStruct,
                                      RTC_DateTypeDef* RTC_StampDateStruct)
{
...
# 1969 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_TamperTriggerConfig(uint32_t RTC_Tamper, uint32_t RTC_TamperTrigger)
{
...
# 1999 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_TamperCmd(uint32_t RTC_Tamper, FunctionalState NewState)
{
...
# 2030 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_TamperFilterConfig(uint32_t RTC_TamperFilter)
{
...
# 2064 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_TamperSamplingFreqConfig(uint32_t RTC_TamperSamplingFreq)
{
...
# 2087 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_TamperPinsPrechargeDuration(uint32_t RTC_TamperPrechargeDuration)
{
...
# 2107 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_TimeStampOnTamperDetectionCmd(FunctionalState NewState)
{
...
# 2171 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_WriteBackupRegister(uint32_t RTC_BKP_DR, uint32_t Data)
{
  ...
  tmp = (((uint32_t)0x40000000) + 0x00002800) + 0x50;
  tmp += (RTC_BKP_DR * 4);


  *(volatile uint32_t *)tmp = (uint32_t)Data;
}
# 2192 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
uint32_t RTC_ReadBackupRegister(uint32_t RTC_BKP_DR)
{
  volatile uint32_t tmp = 0;
...
# 2232 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_OutputTypeConfig(uint32_t RTC_OutputType)
{
...
# 2270 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
ErrorStatus RTC_SynchroShiftConfig(uint32_t RTC_ShiftAdd1S, uint32_t RTC_ShiftSubFS)
{
  ErrorStatus status = ERROR;
  ...
  if ((((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x00002800))->ISR & ((uint32_t)0x00000008)) != RESET)
  {
    ...
    while (((((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x00002800))->ISR & ((uint32_t)0x00000008)) != RESET) && (shpfcount != ((uint32_t) 0x00002000)))
    {
      shpfcount++;
    }
  }
...
# 2386 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_ITConfig(uint32_t RTC_IT, FunctionalState NewState)
{
...
# 2436 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
FlagStatus RTC_GetFlagStatus(uint32_t RTC_FLAG)
{
  ...
  tmpreg = (uint32_t)(((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x00002800))->ISR & ((uint32_t)(((uint32_t)0x00001000) | ((uint32_t)0x00000800) | ((uint32_t)0x00000400) | ((uint32_t)0x00000200) | ((uint32_t)0x00000100) | ((uint32_t)0x00000040) | ((uint32_t)0x00000020) | ((uint32_t)0x00000010) | ((uint32_t)0x00000004) | ((uint32_t)0x00000002) | ((uint32_t)0x00000001) | ((uint32_t)0x00002000) | ((uint32_t)0x00004000) | ((uint32_t)0x00008000) | ((uint32_t)0x00010000) | ((uint32_t)0x00000008))));
...
# 2474 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_ClearFlag(uint32_t RTC_FLAG)
{
...
# 2496 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
ITStatus RTC_GetITStatus(uint32_t RTC_IT)
{
...
# 2538 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_ClearITPendingBit(uint32_t RTC_IT)
{
  uint32_t tmpreg = 0;
...
# 2561 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
static uint8_t RTC_ByteToBcd2(uint8_t Value)
{
  uint8_t bcdhigh = 0;
