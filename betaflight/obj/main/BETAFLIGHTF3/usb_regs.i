# 1 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
# 29 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
# 1 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_lib.h" 1
# 34 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_lib.h"
# 1 "./src/main/vcp/hw_config.h" 1
# 34 "./src/main/vcp/hw_config.h"
# 1 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_type.h" 1
# 34 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_type.h"
# 1 "./src/main/vcp/usb_conf.h" 1
# 35 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_type.h" 2
...
# 37 "./src/main/vcp/hw_config.h" 2
# 51 "./src/main/vcp/hw_config.h"
...
# 35 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_lib.h" 2
# 1 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_type.h" 1
# 36 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_lib.h" 2
# 1 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_regs.h" 1
# 35 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_regs.h"
...
# 614 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_regs.h"
...
# 37 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_lib.h" 2
# 1 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_def.h" 1
# 34 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_def.h"
...
# 38 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_lib.h" 2
# 1 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_core.h" 1
# 35 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_core.h"
...
{
# 93 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_core.h"
...
# 162 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_core.h"
  RESULT (*Class_Data_Setup)(uint8_t RequestNo);
# 173 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_core.h"
  RESULT (*Class_NoData_Setup)(uint8_t RequestNo);
# 183 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_core.h"
...
# 229 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_core.h"
...
# 39 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_lib.h" 2
# 1 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_init.h" 1
# 38 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_init.h"
void USB_Init(void);
...
# 40 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_lib.h" 2
# 1 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_sil.h" 1
# 39 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_sil.h"
uint32_t USB_SIL_Init(void);
uint32_t USB_SIL_Write(uint8_t bEpAddr, uint8_t* pBufferPointer, uint32_t wBufferSize);
uint32_t USB_SIL_Read(uint8_t bEpAddr, uint8_t* pBufferPointer);
# 41 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_lib.h" 2
# 1 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_mem.h" 1
# 38 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_mem.h"
void UserToPMABufferCopy(const uint8_t *pbUsrBuf, uint16_t wPMABufAddr, uint16_t wNBytes);
void PMAToUserBufferCopy(uint8_t *pbUsrBuf, uint16_t wPMABufAddr, uint16_t wNBytes);
# 42 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_lib.h" 2
# 1 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_int.h" 1
# 38 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_int.h"
void CTR_LP(void);
void CTR_HP(void);
# 43 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_lib.h" 2
# 30 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c" 2
# 46 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
void SetCNTR(uint16_t wRegValue)
{
  (*((volatile unsigned *)((0x40005C00L) + 0x40)) = (uint16_t)wRegValue);
}
# 58 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
uint16_t GetCNTR(void)
{
  return(((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x40))));
}
# 70 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
void SetISTR(uint16_t wRegValue)
{
  (*((volatile unsigned *)((0x40005C00L) + 0x44)) = (uint16_t)wRegValue);
}
# 82 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
uint16_t GetISTR(void)
{
  return(((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x44))));
}
# 94 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
uint16_t GetFNR(void)
{
  return(((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x48))));
}
# 106 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
void SetDADDR(uint16_t wRegValue)
{
  (*((volatile unsigned *)((0x40005C00L) + 0x4C)) = (uint16_t)wRegValue);
}
# 118 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
uint16_t GetDADDR(void)
{
  return(((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x4C))));
}
# 130 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
void SetBTABLE(uint16_t wRegValue)
{
  (*((volatile unsigned *)((0x40005C00L) + 0x50)) = (uint16_t)(wRegValue & 0xFFF8));
}
# 142 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
uint16_t GetBTABLE(void)
{
  return((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50))) & ~0x07));
}
# 155 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
void SetENDPOINT(uint8_t bEpNum, uint16_t wRegValue)
{
  (*(((volatile unsigned *)((0x40005C00L))) + bEpNum)= (uint16_t)wRegValue);
}
# 167 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
uint16_t GetENDPOINT(uint8_t bEpNum)
{
  return(((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + bEpNum))));
}
# 180 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
void SetEPType(uint8_t bEpNum, uint16_t wType)
{
  ((*(((volatile unsigned *)((0x40005C00L))) + bEpNum)= (uint16_t)((((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + bEpNum))) & (~(0x0600) & ((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F)))) | wType )));
}
# 192 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
uint16_t GetEPType(uint8_t bEpNum)
{
  return((((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + bEpNum))) & (0x0600)));
}
# 205 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
void SetEPTxStatus(uint8_t bEpNum, uint16_t wState)
{
  { register uint16_t _wRegVal; _wRegVal = ((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + bEpNum))) & ((0x0030)|((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))); if(((0x0010) & wState)!= 0) _wRegVal ^= (0x0010); if(((0x0020) & wState)!= 0) _wRegVal ^= (0x0020); (*(((volatile unsigned *)((0x40005C00L))) + bEpNum)= (uint16_t)(_wRegVal | (0x8000)|(0x0080))); };
}
# 218 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
void SetEPRxStatus(uint8_t bEpNum, uint16_t wState)
{
  { register uint16_t _wRegVal; _wRegVal = ((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + bEpNum))) & ((0x3000)|((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))); if(((0x1000) & wState)!= 0) _wRegVal ^= (0x1000); if(((0x2000) & wState)!= 0) _wRegVal ^= (0x2000); (*(((volatile unsigned *)((0x40005C00L))) + bEpNum)= (uint16_t)(_wRegVal | (0x8000)|(0x0080))); };
}
# 231 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
void SetDouBleBuffEPStall(uint8_t bEpNum, uint8_t bDir)
{
  ...
  if (bDir == EP_DBUF_OUT)
  {
    (*(((volatile unsigned *)((0x40005C00L))) + bEpNum)= (uint16_t)Endpoint_DTOG_Status & ~(0x1000));
  }
  else if (bDir == EP_DBUF_IN)
  {
    (*(((volatile unsigned *)((0x40005C00L))) + bEpNum)= (uint16_t)Endpoint_DTOG_Status & ~(0x0010));
  }
}
# 252 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
uint16_t GetEPTxStatus(uint8_t bEpNum)
{
  return(((volatile uint16_t)((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + bEpNum))) & (0x0030)));
}
# 264 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
uint16_t GetEPRxStatus(uint8_t bEpNum)
{
  return(((volatile uint16_t)((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + bEpNum))) & (0x3000)));
}
# 276 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
void SetEPTxValid(uint8_t bEpNum)
{
  { register uint16_t _wRegVal; _wRegVal = ((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + bEpNum))) & ((0x0030)|((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))); if(((0x0010) & (0x0030))!= 0) _wRegVal ^= (0x0010); if(((0x0020) & (0x0030))!= 0) _wRegVal ^= (0x0020); (*(((volatile unsigned *)((0x40005C00L))) + bEpNum)= (uint16_t)(_wRegVal | (0x8000)|(0x0080))); };
}
# 288 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
void SetEPRxValid(uint8_t bEpNum)
{
  { register uint16_t _wRegVal; _wRegVal = ((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + bEpNum))) & ((0x3000)|((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))); if(((0x1000) & (0x3000))!= 0) _wRegVal ^= (0x1000); if(((0x2000) & (0x3000))!= 0) _wRegVal ^= (0x2000); (*(((volatile unsigned *)((0x40005C00L))) + bEpNum)= (uint16_t)(_wRegVal | (0x8000)|(0x0080))); };
}
# 300 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
void SetEP_KIND(uint8_t bEpNum)
{
  ((*(((volatile unsigned *)((0x40005C00L))) + bEpNum)= (uint16_t)((0x8000)|(0x0080)|((((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + bEpNum))) | (0x0100)) & ((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))))));
}
# 312 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
...
{
  return((((volatile uint16_t)((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + bEpNum))) & (0x0030)) == (0x0010)));
}
...
{
  return((((volatile uint16_t)((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + bEpNum))) & (0x3000)) == (0x1000)));
}
...
{
  ((*(((volatile unsigned *)((0x40005C00L))) + bEpNum)= (uint16_t)((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + bEpNum))) & 0x7FFF & ((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))));
}
...
{
  ((*(((volatile unsigned *)((0x40005C00L))) + bEpNum)= (uint16_t)((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + bEpNum))) & 0xFF7F & ((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))));
}
...
{
  ((*(((volatile unsigned *)((0x40005C00L))) + bEpNum)= (uint16_t)(0x8000)|(0x0080)|(0x4000) | (((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + bEpNum))) & ((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F)))));
}
...
{
  ((*(((volatile unsigned *)((0x40005C00L))) + bEpNum)= (uint16_t)(0x8000)|(0x0080)|(0x0040) | (((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + bEpNum))) & ((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F)))));
}
...
{
  if((((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + bEpNum))) & (0x4000)) != 0) ((*(((volatile unsigned *)((0x40005C00L))) + bEpNum)= (uint16_t)(0x8000)|(0x0080)|(0x4000) | (((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + bEpNum))) & ((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F)))));
}
...
{
  if((((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + bEpNum))) & (0x0040)) != 0) ((*(((volatile unsigned *)((0x40005C00L))) + bEpNum)= (uint16_t)(0x8000)|(0x0080)|(0x0040) | (((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + bEpNum))) & ((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F)))));
}
# 456 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
void SetEPAddress(uint8_t bEpNum, uint8_t bAddr)
{
  (*(((volatile unsigned *)((0x40005C00L))) + bEpNum)= (uint16_t)(0x8000)|(0x0080)|(((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + bEpNum))) & ((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))) | bAddr);
}
...
{
  return(((volatile uint8_t)(((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + bEpNum))) & (0x000F))));
}
# 479 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
void SetEPTxAddr(uint8_t bEpNum, uint16_t wAddr)
{
  (*((volatile uint32_t *)(((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50))) & ~0x07)+bEpNum*8 )*2 + (0x40006000L))) = ((wAddr >> 1) << 1));
}
# 491 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
void SetEPRxAddr(uint8_t bEpNum, uint16_t wAddr)
{
  (*((volatile uint32_t *)(((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50))) & ~0x07)+bEpNum*8+4)*2 + (0x40006000L))) = ((wAddr >> 1) << 1));
}
...
{
  return(((volatile uint16_t)*((volatile uint32_t *)(((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50))) & ~0x07)+bEpNum*8 )*2 + (0x40006000L)))));
}
...
{
  return(((volatile uint16_t)*((volatile uint32_t *)(((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50))) & ~0x07)+bEpNum*8+4)*2 + (0x40006000L)))));
}
# 525 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
void SetEPTxCount(uint8_t bEpNum, uint16_t wCount)
{
  (*((volatile uint32_t *)(((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50))) & ~0x07)+bEpNum*8+2)*2 + (0x40006000L))) = wCount);
}
# 537 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
void SetEPCountRxReg(uint32_t *pdwReg, uint16_t wCount)
{
  { uint16_t wNBlocks; if(wCount > 62){{ wNBlocks = wCount >> 5; if((wCount & 0x1f) == 0) wNBlocks--; *pdwReg = (uint32_t)((wNBlocks << 10) | 0x8000); };} else {{ wNBlocks = wCount >> 1; if((wCount & 0x1) != 0) wNBlocks++; *pdwReg = (uint32_t)(wNBlocks << 10); };} };
}
# 549 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
void SetEPRxCount(uint8_t bEpNum, uint16_t wCount)
{
  { volatile uint32_t *pdwReg = ((volatile uint32_t *)(((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50))) & ~0x07)+bEpNum*8+6)*2 + (0x40006000L))); { uint16_t wNBlocks; if(wCount > 62){{ wNBlocks = wCount >> 5; if((wCount & 0x1f) == 0) wNBlocks--; *pdwReg = (uint32_t)((wNBlocks << 10) | 0x8000); };} else {{ wNBlocks = wCount >> 1; if((wCount & 0x1) != 0) wNBlocks++; *pdwReg = (uint32_t)(wNBlocks << 10); };} }; };
}
...
{
  return(((volatile uint16_t)(*((volatile uint32_t *)(((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50))) & ~0x07)+bEpNum*8+2)*2 + (0x40006000L)))) & 0x3ff));
}
...
{
  return(((volatile uint16_t)(*((volatile uint32_t *)(((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50))) & ~0x07)+bEpNum*8+6)*2 + (0x40006000L)))) & 0x3ff));
}
# 584 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
void SetEPDblBuffAddr(uint8_t bEpNum, uint16_t wBuf0Addr, uint16_t wBuf1Addr)
{
  { {(*((volatile uint32_t *)(((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50))) & ~0x07)+bEpNum*8 )*2 + (0x40006000L))) = ((wBuf0Addr >> 1) << 1));}; {(*((volatile uint32_t *)(((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50))) & ~0x07)+bEpNum*8+4)*2 + (0x40006000L))) = ((wBuf1Addr >> 1) << 1));}; };
}
# 596 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
void SetEPDblBuf0Addr(uint8_t bEpNum, uint16_t wBuf0Addr)
{
  {(*((volatile uint32_t *)(((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50))) & ~0x07)+bEpNum*8 )*2 + (0x40006000L))) = ((wBuf0Addr >> 1) << 1));};
}
# 608 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
void SetEPDblBuf1Addr(uint8_t bEpNum, uint16_t wBuf1Addr)
{
  {(*((volatile uint32_t *)(((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50))) & ~0x07)+bEpNum*8+4)*2 + (0x40006000L))) = ((wBuf1Addr >> 1) << 1));};
}
...
# 642 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
void SetEPDblBuffCount(uint8_t bEpNum, uint8_t bDir, uint16_t wCount)
{
  { { if(bDir == EP_DBUF_OUT) {{ volatile uint32_t *pdwReg = ((volatile uint32_t *)(((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50))) & ~0x07)+bEpNum*8+2)*2 + (0x40006000L))); { uint16_t wNBlocks; if(wCount > 62){{ wNBlocks = wCount >> 5; if((wCount & 0x1f) == 0) wNBlocks--; *pdwReg = (uint32_t)((wNBlocks << 10) | 0x8000); };} else {{ wNBlocks = wCount >> 1; if((wCount & 0x1) != 0) wNBlocks++; *pdwReg = (uint32_t)(wNBlocks << 10); };} }; };} else if(bDir == EP_DBUF_IN) *((volatile uint32_t *)(((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50))) & ~0x07)+bEpNum*8+2)*2 + (0x40006000L))) = (uint32_t)wCount; }; { if(bDir == EP_DBUF_OUT) {{ volatile uint32_t *pdwReg = ((volatile uint32_t *)(((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50))) & ~0x07)+bEpNum*8+6)*2 + (0x40006000L))); { uint16_t wNBlocks; if(wCount > 62){{ wNBlocks = wCount >> 5; if((wCount & 0x1f) == 0) wNBlocks--; *pdwReg = (uint32_t)((wNBlocks << 10) | 0x8000); };} else {{ wNBlocks = wCount >> 1; if((wCount & 0x1) != 0) wNBlocks++; *pdwReg = (uint32_t)(wNBlocks << 10); };} }; };} else if(bDir == EP_DBUF_IN) *((volatile uint32_t *)(((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50))) & ~0x07)+bEpNum*8+6)*2 + (0x40006000L))) = (uint32_t)wCount; }; };
}
# 654 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
void SetEPDblBuf0Count(uint8_t bEpNum, uint8_t bDir, uint16_t wCount)
{
  { if(bDir == EP_DBUF_OUT) {{ volatile uint32_t *pdwReg = ((volatile uint32_t *)(((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50))) & ~0x07)+bEpNum*8+2)*2 + (0x40006000L))); { uint16_t wNBlocks; if(wCount > 62){{ wNBlocks = wCount >> 5; if((wCount & 0x1f) == 0) wNBlocks--; *pdwReg = (uint32_t)((wNBlocks << 10) | 0x8000); };} else {{ wNBlocks = wCount >> 1; if((wCount & 0x1) != 0) wNBlocks++; *pdwReg = (uint32_t)(wNBlocks << 10); };} }; };} else if(bDir == EP_DBUF_IN) *((volatile uint32_t *)(((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50))) & ~0x07)+bEpNum*8+2)*2 + (0x40006000L))) = (uint32_t)wCount; };
}
# 666 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
void SetEPDblBuf1Count(uint8_t bEpNum, uint8_t bDir, uint16_t wCount)
{
  { if(bDir == EP_DBUF_OUT) {{ volatile uint32_t *pdwReg = ((volatile uint32_t *)(((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50))) & ~0x07)+bEpNum*8+6)*2 + (0x40006000L))); { uint16_t wNBlocks; if(wCount > 62){{ wNBlocks = wCount >> 5; if((wCount & 0x1f) == 0) wNBlocks--; *pdwReg = (uint32_t)((wNBlocks << 10) | 0x8000); };} else {{ wNBlocks = wCount >> 1; if((wCount & 0x1) != 0) wNBlocks++; *pdwReg = (uint32_t)(wNBlocks << 10); };} }; };} else if(bDir == EP_DBUF_IN) *((volatile uint32_t *)(((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50))) & ~0x07)+bEpNum*8+6)*2 + (0x40006000L))) = (uint32_t)wCount; };
}
# 678 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
uint16_t GetEPDblBuf0Count(uint8_t bEpNum)
{
  return((((volatile uint16_t)(*((volatile uint32_t *)(((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50))) & ~0x07)+bEpNum*8+2)*2 + (0x40006000L)))) & 0x3ff)));
}
# 690 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
uint16_t GetEPDblBuf1Count(uint8_t bEpNum)
{
  return((((volatile uint16_t)(*((volatile uint32_t *)(((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50))) & ~0x07)+bEpNum*8+6)*2 + (0x40006000L)))) & 0x3ff)));
}
# 702 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
EP_DBUF_DIR GetEPDblBufDir(uint8_t bEpNum)
{
  if ((uint16_t)(*((volatile uint32_t *)(((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50))) & ~0x07)+bEpNum*8+6)*2 + (0x40006000L))) & 0xFC00) != 0)
    return(EP_DBUF_OUT);
  else if (((uint16_t)(*((volatile uint32_t *)(((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50))) & ~0x07)+bEpNum*8+2)*2 + (0x40006000L)))) & 0x03FF) != 0)
    return(EP_DBUF_IN);
  else
    return(EP_DBUF_ERR);
}
# 719 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
void FreeUserBuffer(uint8_t bEpNum, uint8_t bDir)
{
  if (bDir == EP_DBUF_OUT)
  {
...
# 738 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
