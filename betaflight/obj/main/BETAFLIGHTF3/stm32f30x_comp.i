# 1 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_comp.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_comp.c"
# 167 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_comp.c"
...
# 168 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_comp.c" 2
# 214 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_comp.c"
void COMP_DeInit(uint32_t COMP_Selection)
{

  *(volatile uint32_t *) (((((uint32_t)0x40000000) + 0x00010000) + 0x0000001C) + COMP_Selection) = ((uint32_t)0x00000000);
}
# 242 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_comp.c"
void COMP_Init(uint32_t COMP_Selection, COMP_InitTypeDef* COMP_InitStruct)
{
  uint32_t tmpreg = 0;
  ...
  tmpreg = *(volatile uint32_t *) (((((uint32_t)0x40000000) + 0x00010000) + 0x0000001C) + COMP_Selection);


  tmpreg &= (uint32_t) (((uint32_t)0x00000003));
# 270 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_comp.c"
  ...
  *(volatile uint32_t *) (((((uint32_t)0x40000000) + 0x00010000) + 0x0000001C) + COMP_Selection) = tmpreg;
}
...
void COMP_StructInit(COMP_InitTypeDef* COMP_InitStruct)
{
  COMP_InitStruct->COMP_InvertingInput = ((uint32_t)0x00000000);
  COMP_InitStruct->COMP_NonInvertingInput = ((uint32_t)0x00000000);
  COMP_InitStruct->COMP_Output = ((uint32_t)0x00000000);
  COMP_InitStruct->COMP_BlankingSrce = ((uint32_t)0x00000000);
  COMP_InitStruct->COMP_OutputPol = ((uint32_t)0x00000000);
  COMP_InitStruct->COMP_Hysteresis = 0x00000000;
  COMP_InitStruct->COMP_Mode = ((uint32_t)0x0000000C);
}
# 311 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_comp.c"
void COMP_Cmd(uint32_t COMP_Selection, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    *(volatile uint32_t *) (((((uint32_t)0x40000000) + 0x00010000) + 0x0000001C) + COMP_Selection) |= (uint32_t) (((uint32_t)0x00000001));
  }
  else
  {
...
# 341 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_comp.c"
void COMP_SwitchCmd(uint32_t COMP_Selection, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    *(volatile uint32_t *) (((((uint32_t)0x40000000) + 0x00010000) + 0x0000001C) + COMP_Selection) |= (uint32_t) (((uint32_t)0x00000002));
  }
  else
  {
...
# 377 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_comp.c"
uint32_t COMP_GetOutputLevel(uint32_t COMP_Selection)
{
  ...
  if ((*(volatile uint32_t *) (((((uint32_t)0x40000000) + 0x00010000) + 0x0000001C) + COMP_Selection) & (((uint32_t)0x40000000))) != 0)
  {
    compout = ((uint32_t)0x40000000);
  }
  else
  {
...
# 434 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_comp.c"
void COMP_WindowCmd(uint32_t COMP_Selection, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    *(volatile uint32_t *) (((((uint32_t)0x40000000) + 0x00010000) + 0x0000001C) + COMP_Selection) |= (uint32_t) ((uint32_t)0x00000200);
  }
  else
  {
...
# 479 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_comp.c"
void COMP_LockConfig(uint32_t COMP_Selection)
{
  ...
  *(volatile uint32_t *) (((((uint32_t)0x40000000) + 0x00010000) + 0x0000001C) + COMP_Selection) |= (uint32_t) (((uint32_t)0x80000000));
}
