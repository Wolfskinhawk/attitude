# 1 "./src/main/blackbox/blackbox_io.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/blackbox/blackbox_io.c"
...
# 4 "./src/main/blackbox/blackbox_io.c" 2
...
# 5 "./src/main/blackbox/blackbox_io.c" 2
...
# 6 "./src/main/blackbox/blackbox_io.c" 2
...
# 8 "./src/main/blackbox/blackbox_io.c" 2
...
# 12 "./src/main/blackbox/blackbox_io.c" 2
...
# 13 "./src/main/blackbox/blackbox_io.c" 2
...
# 15 "./src/main/blackbox/blackbox_io.c" 2
...
# 17 "./src/main/blackbox/blackbox_io.c" 2
...
# 19 "./src/main/blackbox/blackbox_io.c" 2
...
# 51 "./src/main/io/flashfs.h"
    flashfsIsEOF(void);
# 20 "./src/main/blackbox/blackbox_io.c" 2
...
# 21 "./src/main/blackbox/blackbox_io.c" 2
...
# 23 "./src/main/blackbox/blackbox_io.c" 2
...
# 32 "./src/main/blackbox/blackbox_io.c" 3 4
                                   ((void *)0)
# 32 "./src/main/blackbox/blackbox_io.c"
                                       ;
...
int blackboxWriteString(const char *s)
{
    ...
    switch (blackboxConfig()->device) {
# 102 "./src/main/blackbox/blackbox_io.c"
    case BLACKBOX_DEVICE_SDCARD:
        length = strlen(s);
...
{
    switch (blackboxConfig()->device) {
# 141 "./src/main/blackbox/blackbox_io.c"
    default:
        ;
    }
}
...
# 151 "./src/main/blackbox/blackbox_io.c" 3 4
_Bool 
# 151 "./src/main/blackbox/blackbox_io.c"
    blackboxDeviceFlushForce(void)
{
    switch (blackboxConfig()->device) {
    case BLACKBOX_DEVICE_SERIAL:
    ...
    default:
        return 
# 172 "./src/main/blackbox/blackbox_io.c" 3 4
              0
# 172 "./src/main/blackbox/blackbox_io.c"
                   ;
    }
}
...
# 179 "./src/main/blackbox/blackbox_io.c" 3 4
_Bool 
# 179 "./src/main/blackbox/blackbox_io.c"
    blackboxDeviceOpen(void)
{
    switch (blackboxConfig()->device) {
    case BLACKBOX_DEVICE_SERIAL:
        {
            ...
            if (!portConfig) {
                return 
# 189 "./src/main/blackbox/blackbox_io.c" 3 4
                      0
# 189 "./src/main/blackbox/blackbox_io.c"
                           ;
            }
            ...
            blackboxPort = openSerialPort(portConfig->identifier, FUNCTION_BLACKBOX, 
# 205 "./src/main/blackbox/blackbox_io.c" 3 4
                                                                                    ((void *)0)
# 205 "./src/main/blackbox/blackbox_io.c"
                                                                                        , 
# 205 "./src/main/blackbox/blackbox_io.c" 3 4
                                                                                          ((void *)0)
# 205 "./src/main/blackbox/blackbox_io.c"
                ...
                MODE_TX, portOptions);
# 224 "./src/main/blackbox/blackbox_io.c"
            ...
            case BAUD_2470000:
                ...
                blackboxMaxHeaderBytesPerIteration = 64;
                break;
            default:
                blackboxMaxHeaderBytesPerIteration = constrain((targetPidLooptime * 3) / 500, 1, 64);
                break;
            };

            return blackboxPort != 
# 237 "./src/main/blackbox/blackbox_io.c" 3 4
                                  ((void *)0)
# 237 "./src/main/blackbox/blackbox_io.c"
                                      ;
        }
        break;
# 252 "./src/main/blackbox/blackbox_io.c"
    case BLACKBOX_DEVICE_SDCARD:
        if (afatfs_getFilesystemState() == AFATFS_FILESYSTEM_STATE_FATAL || afatfs_getFilesystemState() == AFATFS_FILESYSTEM_STATE_UNKNOWN || afatfs_isFull()) {
            return 
# 254 "./src/main/blackbox/blackbox_io.c" 3 4
                  0
# 254 "./src/main/blackbox/blackbox_io.c"
                       ;
        }
        ...
        return 
# 259 "./src/main/blackbox/blackbox_io.c" 3 4
              1
# 259 "./src/main/blackbox/blackbox_io.c"
                  ;
        break;

    default:
        return 
# 263 "./src/main/blackbox/blackbox_io.c" 3 4
              0
# 263 "./src/main/blackbox/blackbox_io.c"
                   ;
    }
}
# 303 "./src/main/blackbox/blackbox_io.c"
void blackboxDeviceClose(void)
{
    switch (blackboxConfig()->device) {
    case BLACKBOX_DEVICE_SERIAL:
        ...
        blackboxPort = 
# 309 "./src/main/blackbox/blackbox_io.c" 3 4
                      ((void *)0)
# 309 "./src/main/blackbox/blackbox_io.c"
                          ;
...
static 
# 375 "./src/main/blackbox/blackbox_io.c" 3 4
      _Bool 
# 375 "./src/main/blackbox/blackbox_io.c"
           blackboxSDCardBeginLog(void)
{
    ...
    case BLACKBOX_SDCARD_ENUMERATE_FILES:
        while (afatfs_findNext(blackboxSDCard.logDirectory, &blackboxSDCard.logDirectoryFinder, &directoryEntry) == AFATFS_OPERATION_SUCCESS) {
            if (directoryEntry && !fat_isDirectoryEntryTerminator(directoryEntry)) {
                ...
                if (strncmp(directoryEntry->filename, "LOG", strlen("LOG")) == 0
                    && strncmp(directoryEntry->filename + 8, "BFL", strlen("BFL")) == 0) {
                    char logSequenceNumberString[6];

                    memcpy(logSequenceNumberString, directoryEntry->filename + 3, 5);
                    logSequenceNumberString[5] = '\0';

                    blackboxSDCard.largestLogFileNumber = __extension__ ({ __typeof__ ((uint32_t) atoi(logSequenceNumberString)) _a = ((uint32_t) atoi(logSequenceNumberString)); __typeof__ (blackboxSDCard.largestLogFileNumber) _b = (blackboxSDCard.largestLogFileNumber); _a > _b ? _a : _b; });
                }
            } else {
    ...
    case BLACKBOX_SDCARD_CHANGE_INTO_LOG_DIRECTORY:
        ...
        if (afatfs_chdir(blackboxSDCard.logDirectory)) {
            ...
            afatfs_fclose(blackboxSDCard.logDirectory, 
# 420 "./src/main/blackbox/blackbox_io.c" 3 4
                                                      ((void *)0)
# 420 "./src/main/blackbox/blackbox_io.c"
                                                          );
            blackboxSDCard.logDirectory = 
# 421 "./src/main/blackbox/blackbox_io.c" 3 4
                                         ((void *)0)
# 421 "./src/main/blackbox/blackbox_io.c"
                                             ;
    ...
    case BLACKBOX_SDCARD_READY_TO_LOG:
        return 
# 433 "./src/main/blackbox/blackbox_io.c" 3 4
              1
# 433 "./src/main/blackbox/blackbox_io.c"
                  ;
    }


    return 
# 437 "./src/main/blackbox/blackbox_io.c" 3 4
          0
# 437 "./src/main/blackbox/blackbox_io.c"
               ;
}
# 447 "./src/main/blackbox/blackbox_io.c"

# 447 "./src/main/blackbox/blackbox_io.c" 3 4
_Bool 
# 447 "./src/main/blackbox/blackbox_io.c"
    blackboxDeviceBeginLog(void)
{
    ...
    default:
        return 
# 455 "./src/main/blackbox/blackbox_io.c" 3 4
              1
# 455 "./src/main/blackbox/blackbox_io.c"
                  ;
    }

}
# 467 "./src/main/blackbox/blackbox_io.c"

# 467 "./src/main/blackbox/blackbox_io.c" 3 4
_Bool 
# 467 "./src/main/blackbox/blackbox_io.c"
    blackboxDeviceEndLog(
# 467 "./src/main/blackbox/blackbox_io.c" 3 4
                              ...
                              retainLog)
{
    ...
    case BLACKBOX_DEVICE_SDCARD:
        ...
        if (
            (retainLog && afatfs_fclose(blackboxSDCard.logFile, 
# 478 "./src/main/blackbox/blackbox_io.c" 3 4
                                                               ((void *)0)
# 478 "./src/main/blackbox/blackbox_io.c"
                                                                   ))
            || (!retainLog && afatfs_funlink(blackboxSDCard.logFile, 
# 479 "./src/main/blackbox/blackbox_io.c" 3 4
                                                                    ((void *)0)
# 479 "./src/main/blackbox/blackbox_io.c"
                                                                        ))
        ) {

            blackboxSDCard.logFile = 
# 482 "./src/main/blackbox/blackbox_io.c" 3 4
                                    ((void *)0)
# 482 "./src/main/blackbox/blackbox_io.c"
                                        ;
            blackboxSDCard.state = BLACKBOX_SDCARD_READY_TO_CREATE_LOG;
            return 
# 484 "./src/main/blackbox/blackbox_io.c" 3 4
                  1
# 484 "./src/main/blackbox/blackbox_io.c"
                      ;
        }
        return 
# 486 "./src/main/blackbox/blackbox_io.c" 3 4
              0
# 486 "./src/main/blackbox/blackbox_io.c"
                   ;

    default:
        return 
# 489 "./src/main/blackbox/blackbox_io.c" 3 4
              1
# 489 "./src/main/blackbox/blackbox_io.c"
                  ;
    }
}


# 493 "./src/main/blackbox/blackbox_io.c" 3 4
_Bool 
# 493 "./src/main/blackbox/blackbox_io.c"
    isBlackboxDeviceFull(void)
{
    switch (blackboxConfig()->device) {
    case BLACKBOX_DEVICE_SERIAL:
        return 
# 497 "./src/main/blackbox/blackbox_io.c" 3 4
              0
# 497 "./src/main/blackbox/blackbox_io.c"
                   ;
    ...
    default:
        return 
# 510 "./src/main/blackbox/blackbox_io.c" 3 4
              0
# 510 "./src/main/blackbox/blackbox_io.c"
                   ;
    }
}
...
void blackboxReplenishHeaderBudget(void)
{
    ...
    blackboxHeaderBudget = __extension__ ({ __typeof__ (__extension__ ({ __typeof__ (freeSpace) _a = (freeSpace); __typeof__ (blackboxHeaderBudget + blackboxMaxHeaderBytesPerIteration) _b = (blackboxHeaderBudget + blackboxMaxHeaderBytesPerIteration); _a < _b ? _a : _b; })) _a = (__extension__ ({ __typeof__ (freeSpace) _a = (freeSpace); __typeof__ (blackboxHeaderBudget + blackboxMaxHeaderBytesPerIteration) _b = (blackboxHeaderBudget + blackboxMaxHeaderBytesPerIteration); _a < _b ? _a : _b; })); __typeof__ (256) _b = (256); _a < _b ? _a : _b; });
}
# 568 "./src/main/blackbox/blackbox_io.c"
blackboxBufferReserveStatus_e blackboxDeviceReserveBufferSpace(int32_t bytes)
{
...
# 604 "./src/main/blackbox/blackbox_io.c"
    case BLACKBOX_DEVICE_SDCARD:
