# 1 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_core.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_core.c"
# 30 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_core.c"
...
# 31 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_core.c" 2
# 51 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_core.c"
...
# 69 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_core.c"
uint8_t *Standard_GetConfiguration(uint16_t Length)
{
  if (Length == 0)
  {
...
# 90 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_core.c"
RESULT Standard_SetConfiguration(void)
{
...
# 115 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_core.c"
uint8_t *Standard_GetInterface(uint16_t Length)
{
  if (Length == 0)
  {
...
# 136 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_core.c"
RESULT Standard_SetInterface(void)
{
  RESULT Re;
...
# 171 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_core.c"
uint8_t *Standard_GetStatus(uint16_t Length)
{
  if (Length == 0)
  {
  ...
  else if ((pInformation->USBbmRequestType & (0x60 | 0x1F)) == (0x00 | ENDPOINT_RECIPIENT))
  {
    ...
    if ((wIndex0 & (1 << 7)))
    {
      ...
      if ((((volatile uint16_t)((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + Related_Endpoint))) & (0x0030)) == (0x0010)))
      {
        (StatusInfo.bw.bb1 |= (1 << 0));
      }
    }
    else
    {
      ...
      if ((((volatile uint16_t)((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + Related_Endpoint))) & (0x3000)) == (0x1000)))
      {
        (StatusInfo.bw.bb1 |= (1 << 0));
      }
    }
...
# 253 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_core.c"
RESULT Standard_ClearFeature(void)
{
  uint32_t Type_Rec = (pInformation->USBbmRequestType & (0x60 | 0x1F));
  uint32_t Status;
  ...
  else if (Type_Rec == (0x00 | ENDPOINT_RECIPIENT))
  {
    ...
    rEP = wIndex0 & ~0x80;
    Related_Endpoint = ((uint8_t)0) + rEP;

    if ((pInformation->USBwIndexs.bw.bb0 & (1 << 7)))
    {


      Status = ((volatile uint16_t)((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + Related_Endpoint))) & (0x0030));
    }
    else
    {
      Status = ((volatile uint16_t)((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + Related_Endpoint))) & (0x3000));
    }
    ...
    else
    {
      ...
      if ((((volatile uint16_t)((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + Related_Endpoint))) & (0x3000)) == (0x1000)))
      {
        if (Related_Endpoint == ((uint8_t)0))
        {

          SetEPRxCount(Related_Endpoint, Device_Property.MaxPacketSize);
          { register uint16_t _wRegVal; _wRegVal = ((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + Related_Endpoint))) & ((0x3000)|((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))); if(((0x1000) & (0x3000))!= 0) _wRegVal ^= (0x1000); if(((0x2000) & (0x3000))!= 0) _wRegVal ^= (0x2000); (*(((volatile unsigned *)((0x40005C00L))) + Related_Endpoint)= (uint16_t)(_wRegVal | (0x8000)|(0x0080))); };
        }
        else
        {
...
# 342 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_core.c"
RESULT Standard_SetEndPointFeature(void)
{
  uint32_t wIndex0;
  uint32_t Related_Endpoint;
  ...
  else
  {
    if (wIndex0 & 0x80)
    {
      ...
      { register uint16_t _wRegVal; _wRegVal = ((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + Related_Endpoint))) & ((0x0030)|((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))); if(((0x0010) & (0x0010))!= 0) _wRegVal ^= (0x0010); if(((0x0020) & (0x0010))!= 0) _wRegVal ^= (0x0020); (*(((volatile unsigned *)((0x40005C00L))) + Related_Endpoint)= (uint16_t)(_wRegVal | (0x8000)|(0x0080))); };
    }

    else
    {

      { register uint16_t _wRegVal; _wRegVal = ((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + Related_Endpoint))) & ((0x3000)|((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))); if(((0x1000) & (0x1000))!= 0) _wRegVal ^= (0x1000); if(((0x2000) & (0x1000))!= 0) _wRegVal ^= (0x2000); (*(((volatile unsigned *)((0x40005C00L))) + Related_Endpoint)= (uint16_t)(_wRegVal | (0x8000)|(0x0080))); };
    }
  }
  pUser_Standard_Requests->User_SetEndPointFeature();
  return USB_SUCCESS;
}
# 396 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_core.c"
RESULT Standard_SetDeviceFeature(void)
{
...
# 422 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_core.c"
...
# 443 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_core.c"
void DataStageOut(void)
{
  ...
  if (pEPinfo->CopyData && save_rLength)
  {
    ...
    PMAToUserBufferCopy(Buffer, GetEPRxAddr(((uint8_t)0)), Length);
  ...
  else
  {
    ...
    else if (pEPinfo->Usb_wLength == 0)
    {
      ...
      { (*((volatile uint32_t *)(((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50))) & ~0x07)+((uint8_t)0)*8+2)*2 + (0x40006000L))) = 0); (SaveTState = (0x0030)); };
    }
  }
}
# 500 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_core.c"
void DataStageIn(void)
{
  ...
  UserToPMABufferCopy(DataBuffer, GetEPTxAddr(((uint8_t)0)), Length);

  SetEPTxCount(((uint8_t)0), Length);
...
# 560 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_core.c"
...
# 683 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_core.c"
void Data_Setup0(void)
{
  ...
  if (Request_No == GET_DESCRIPTOR)
  {
    if ((pInformation->USBbmRequestType & (0x60 | 0x1F)) == (0x00 | DEVICE_RECIPIENT))
    {
      uint8_t wValue1 = pInformation->USBwValues.bw.bb1;
  ...
  if ((pInformation->USBbmRequestType & (1 << 7)))
  {
    ...
    volatile uint32_t wLength = pInformation->USBwLengths.w;
...
# 862 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_core.c"
uint8_t Setup0_Process(void)
{
  ...
  pBuf.b = (0x40006000L) + (uint8_t *)(((volatile uint16_t)*((volatile uint32_t *)(((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50))) & ~0x07)+((uint8_t)0)*8+4)*2 + (0x40006000L)))) * 2);
...
# 907 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_core.c"
uint8_t In0_Process(void)
{
  uint32_t ControlState = pInformation->ControlState;
...
# 947 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_core.c"
uint8_t Out0_Process(void)
{
  uint32_t ControlState = pInformation->ControlState;
...
# 988 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_core.c"
uint8_t Post0_Process(void)
{

  SetEPRxCount(((uint8_t)0), Device_Property.MaxPacketSize);
...
# 1009 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_core.c"
void SetDeviceAddress(uint8_t Val)
{
  ...
  for (i = 0; i < nEP; i++)
  {
    (*(((volatile unsigned *)((0x40005C00L))) + (uint8_t)i)= (uint16_t)(0x8000)|(0x0080)|(((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + (uint8_t)i))) & ((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))) | (uint8_t)i);
  }
  (*((volatile unsigned *)((0x40005C00L) + 0x4C)) = (uint16_t)Val | (0x80));
}
# 1029 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_core.c"
void NOP_Process(void)
{
}
