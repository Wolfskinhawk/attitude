...
# 20 "./src/main/telemetry/srxl.c" 2
...
# 21 "./src/main/telemetry/srxl.c" 2
...
# 23 "./src/main/telemetry/srxl.c" 2
...
# 29 "./src/main/telemetry/srxl.c" 2
...
# 30 "./src/main/telemetry/srxl.c" 2
...
# 33 "./src/main/telemetry/srxl.c" 2
...
# 35 "./src/main/telemetry/srxl.c" 2
...
# 36 "./src/main/telemetry/srxl.c" 2
...
# 38 "./src/main/telemetry/srxl.c" 2
...
# 39 "./src/main/telemetry/srxl.c" 2
...
void mwDisarm(void);
# 40 "./src/main/telemetry/srxl.c" 2
...
# 42 "./src/main/telemetry/srxl.c" 2
...
# 46 "./src/main/telemetry/srxl.c" 2
...
# 53 "./src/main/rx/spektrum.h"
    srxlRxIsActive(void);
# 47 "./src/main/telemetry/srxl.c" 2
...
# 49 "./src/main/telemetry/srxl.c" 2
...
# 51 "./src/main/telemetry/srxl.c" 2
# 1 "./src/main/telemetry/srxl.h" 1
# 18 "./src/main/telemetry/srxl.h"
...
# 23 "./src/main/telemetry/srxl.h" 3 4
_Bool 
# 23 "./src/main/telemetry/srxl.h"
    checkSrxlTelemetryState(void);
...
# 52 "./src/main/telemetry/srxl.c" 2
# 65 "./src/main/telemetry/srxl.c"
static 
# 65 "./src/main/telemetry/srxl.c" 3 4
      _Bool 
# 65 "./src/main/telemetry/srxl.c"
           srxlTelemetryEnabled;
static uint8_t srxlFrame[(16 + 5)];

static void srxlInitializeFrame(sbuf_t *dst)
{
    dst->ptr = srxlFrame;
    dst->end = (&(srxlFrame)[(sizeof(srxlFrame) / sizeof((srxlFrame)[0]))]);

    sbufWriteU8(dst, 0xA5);
    sbufWriteU8(dst, 0x80);
    sbufWriteU8(dst, 0x15);
}

static void srxlFinalize(sbuf_t *dst)
{
    crc16_ccitt_sbuf_append(dst, &srxlFrame[3]);
    sbufSwitchToReader(dst, srxlFrame);

    srxlRxWriteTelemetryData(sbufPtr(dst), sbufBytesRemaining(dst));
}
# 106 "./src/main/telemetry/srxl.c"

# 106 "./src/main/telemetry/srxl.c" 3 4
_Bool 
# 106 "./src/main/telemetry/srxl.c"
    srxlFrameQos(sbuf_t *dst, timeUs_t currentTimeUs)
{
    (void)(currentTimeUs);

    sbufWriteU8(dst, 0x7F);
    ...
    sbufWriteU16BigEndian(dst, 0xFFFF);
    return 
# 119 "./src/main/telemetry/srxl.c" 3 4
          1
# 119 "./src/main/telemetry/srxl.c"
              ;
}
# 135 "./src/main/telemetry/srxl.c"

# 135 "./src/main/telemetry/srxl.c" 3 4
_Bool 
# 135 "./src/main/telemetry/srxl.c"
    srxlFrameRpm(sbuf_t *dst, timeUs_t currentTimeUs)
{
    (void)(currentTimeUs);

    sbufWriteU8(dst, 0x7E);
    sbufWriteU8(dst, 0x00);
    sbufWriteU16BigEndian(dst, 0xFFFF);
    sbufWriteU16BigEndian(dst, getBatteryVoltage() * 10);
    sbufWriteU16BigEndian(dst, 0x7FFF);
    ...
    sbufWriteU16BigEndian(dst, 0xFFFF);
    return 
# 151 "./src/main/telemetry/srxl.c" 3 4
          1
# 151 "./src/main/telemetry/srxl.c"
              ;
}
# 171 "./src/main/telemetry/srxl.c"

# 171 "./src/main/telemetry/srxl.c" 3 4
_Bool 
# 171 "./src/main/telemetry/srxl.c"
    srxlFrameFlightPackCurrent(sbuf_t *dst, timeUs_t currentTimeUs)
{
    ...
    if ( (amps != sentAmps) || (mah != sentMah) ||
         keepAlive > 2000000 ) {
        sbufWriteU8(dst, 0x34);
        sbufWriteU8(dst, 0x00);
        sbufWriteU16(dst, amps);
        sbufWriteU16(dst, mah);
        sbufWriteU16(dst, 0x7fff);
        ...
        return 
# 196 "./src/main/telemetry/srxl.c" 3 4
              1
# 196 "./src/main/telemetry/srxl.c"
                  ;
    }
    return 
# 198 "./src/main/telemetry/srxl.c" 3 4
          0
# 198 "./src/main/telemetry/srxl.c"
               ;
}
# 223 "./src/main/telemetry/srxl.c"
static char srxlTextBuff[(9)][(13)];
static 
# 224 "./src/main/telemetry/srxl.c" 3 4
      _Bool 
# 224 "./src/main/telemetry/srxl.c"
           lineSent[(9)];
...
int spektrumTmTextGenPutChar(uint8_t col, uint8_t row, char c)
{
    if (row < 9 && col < 12) {
      ...
      lineSent[row] = 
# 233 "./src/main/telemetry/srxl.c" 3 4
                     0
# 233 "./src/main/telemetry/srxl.c"
                          ;
    }
    return 0;
}
...
# 239 "./src/main/telemetry/srxl.c" 3 4
_Bool 
# 239 "./src/main/telemetry/srxl.c"
    srxlFrameText(sbuf_t *dst, timeUs_t currentTimeUs)
{
    (void)(currentTimeUs);
    ...
    sbufWriteU8(dst, (0x0C));
    sbufWriteU8(dst, 0x00);
    sbufWriteU8(dst, lineNo);
    sbufWriteData(dst, srxlTextBuff[lineNo], (13));

    lineSent[lineNo] = 
# 257 "./src/main/telemetry/srxl.c" 3 4
                      1
# 257 "./src/main/telemetry/srxl.c"
                          ;
    lineNo = (lineNo + 1) % (9);
    ...
    return 
# 263 "./src/main/telemetry/srxl.c" 3 4
          1
# 263 "./src/main/telemetry/srxl.c"
              ;
}
# 286 "./src/main/telemetry/srxl.c"
typedef 
# 286 "./src/main/telemetry/srxl.c" 3 4
       _Bool 
# 286 "./src/main/telemetry/srxl.c"
            (*srxlScheduleFnPtr)(sbuf_t *dst, timeUs_t currentTimeUs);

const srxlScheduleFnPtr srxlScheduleFuncs[(2 + (1 + 1))] = {
...
static void processSrxl(timeUs_t currentTimeUs)
{
    ...
    srxlScheduleIndex = (srxlScheduleIndex + 1) % (2 + 1);
}
...
# 330 "./src/main/telemetry/srxl.c" 3 4
_Bool 
# 330 "./src/main/telemetry/srxl.c"
    checkSrxlTelemetryState(void)
{
...
void handleSrxlTelemetry(timeUs_t currentTimeUs)
{
    ...
    if (currentTimeUs >= srxlLastCycleTime + 33000) {
