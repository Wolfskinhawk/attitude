...
# 20 "./src/main/telemetry/crsf.c" 2
...
# 21 "./src/main/telemetry/crsf.c" 2
...
# 23 "./src/main/telemetry/crsf.c" 2
...
# 31 "./src/main/telemetry/crsf.c" 2

# 1 "./src/main/pg/pg_ids.h" 1
# 18 "./src/main/pg/pg_ids.h"
       
# 33 "./src/main/telemetry/crsf.c" 2
...
# 35 "./src/main/telemetry/crsf.c" 2
...
# 36 "./src/main/telemetry/crsf.c" 2
...
# 37 "./src/main/telemetry/crsf.c" 2
...
# 38 "./src/main/telemetry/crsf.c" 2


# 1 "./src/main/drivers/nvic.h" 1

       
# 41 "./src/main/telemetry/crsf.c" 2
...
# 43 "./src/main/telemetry/crsf.c" 2
...
# 44 "./src/main/telemetry/crsf.c" 2
...
void mwDisarm(void);
# 45 "./src/main/telemetry/crsf.c" 2
...
# 47 "./src/main/telemetry/crsf.c" 2
...
# 49 "./src/main/telemetry/crsf.c" 2
...
# 51 "./src/main/telemetry/crsf.c" 2
...
# 46 "./src/main/rx/crsf.h"
    crsfRxIsActive(void);
# 54 "./src/main/telemetry/crsf.c" 2
...
# 56 "./src/main/telemetry/crsf.c" 2
...
# 57 "./src/main/telemetry/crsf.c" 2
...
# 59 "./src/main/telemetry/crsf.c" 2
# 1 "./src/main/telemetry/crsf.h" 1
# 18 "./src/main/telemetry/crsf.h"
       
# 30 "./src/main/telemetry/crsf.h"
...
# 60 "./src/main/telemetry/crsf.c" 2
...
# 6 "./src/main/telemetry/msp_shared.h" 2
...
# 61 "./src/main/telemetry/crsf.c" 2
# 70 "./src/main/telemetry/crsf.c"
static 
# 70 "./src/main/telemetry/crsf.c" 3 4
      _Bool 
# 70 "./src/main/telemetry/crsf.c"
           crsfTelemetryEnabled;
static 
# 71 "./src/main/telemetry/crsf.c" 3 4
      _Bool 
# 71 "./src/main/telemetry/crsf.c"
           deviceInfoReplyPending;
...
# 87 "./src/main/telemetry/crsf.c" 3 4
_Bool 
# 87 "./src/main/telemetry/crsf.c"
    bufferCrsfMspFrame(uint8_t *frameStart, int frameLength)
{
    if (mspRxBuffer.len + 1 + frameLength > 96) {
        return 
# 90 "./src/main/telemetry/crsf.c" 3 4
              0
# 90 "./src/main/telemetry/crsf.c"
                   ;
    } else {
        uint8_t *p = mspRxBuffer.bytes + mspRxBuffer.len;
        *p++ = frameLength;
        memcpy(p, frameStart, frameLength);
        mspRxBuffer.len += 1 + frameLength;
        return 
# 96 "./src/main/telemetry/crsf.c" 3 4
              1
# 96 "./src/main/telemetry/crsf.c"
                  ;
    }
}


# 100 "./src/main/telemetry/crsf.c" 3 4
_Bool 
# 100 "./src/main/telemetry/crsf.c"
    handleCrsfMspFrameBuffer(uint8_t payloadSize, mspResponseFnPtr responseFn)
{
    
# 102 "./src/main/telemetry/crsf.c" 3 4
   _Bool 
# 102 "./src/main/telemetry/crsf.c"
        requestHandled = 
# 102 "./src/main/telemetry/crsf.c" 3 4
                         0
# 102 "./src/main/telemetry/crsf.c"
    ...
    if (!mspRxBuffer.len) {
        return 
# 104 "./src/main/telemetry/crsf.c" 3 4
              0
# 104 "./src/main/telemetry/crsf.c"
                   ;
    }
    int pos = 0;
    while (
# 107 "./src/main/telemetry/crsf.c" 3 4
          1
# 107 "./src/main/telemetry/crsf.c"
              ) {
        const int mspFrameLength = mspRxBuffer.bytes[pos];
        if (handleMspFrame(&mspRxBuffer.bytes[1 + pos], mspFrameLength)) {
            requestHandled |= sendMspReply(payloadSize, responseFn);
        }
        pos += 1 + mspFrameLength;
...
{
    dst->ptr = crsfFrame;
    dst->end = (&(crsfFrame)[(sizeof(crsfFrame) / sizeof((crsfFrame)[0]))]);
...
void crsfFrameGps(sbuf_t *dst)
{
    ...
    sbufWriteU32BigEndian(dst, gpsSol.llh.lat);
    sbufWriteU32BigEndian(dst, gpsSol.llh.lon);
    sbufWriteU16BigEndian(dst, (gpsSol.groundSpeed * 36 + 5) / 10);
    sbufWriteU16BigEndian(dst, gpsSol.groundCourse * 10);

    const uint16_t altitude = ((stateFlags & (GPS_FIX)) ? gpsSol.llh.alt : 0) + 1000;
    sbufWriteU16BigEndian(dst, altitude);
    sbufWriteU8(dst, gpsSol.numSat);
}
# 193 "./src/main/telemetry/crsf.c"
...
# 239 "./src/main/telemetry/crsf.c"
void crsfFrameAttitude(sbuf_t *dst)
{
     sbufWriteU8(dst, CRSF_FRAME_ATTITUDE_PAYLOAD_SIZE + CRSF_FRAME_LENGTH_TYPE_CRC);
     sbufWriteU8(dst, CRSF_FRAMETYPE_ATTITUDE);
     sbufWriteU16BigEndian(dst, ((int16_t)(1000.0f * (attitude.values.pitch) * (3.14159265358979323846f / 180.0f))));
     sbufWriteU16BigEndian(dst, ((int16_t)(1000.0f * (attitude.values.roll) * (3.14159265358979323846f / 180.0f))));
     sbufWriteU16BigEndian(dst, ((int16_t)(1000.0f * (attitude.values.yaw) * (3.14159265358979323846f / 180.0f))));
}
...
# 290 "./src/main/telemetry/crsf.c"
void crsfFrameDeviceInfo(sbuf_t *dst) {

    char buff[30];
    tfp_sprintf(buff, "%s %s: %s", "Betaflight", "3" "." "3" "." "0", systemConfig()->boardIdentifier);
...
static 
# 326 "./src/main/telemetry/crsf.c" 3 4
      _Bool 
# 326 "./src/main/telemetry/crsf.c"
           mspReplyPending;

void crsfScheduleMspResponse(void)
{
    mspReplyPending = 
# 330 "./src/main/telemetry/crsf.c" 3 4
                     1
# 330 "./src/main/telemetry/crsf.c"
                         ;
}
...
static void processCrsf(void)
{
    ...
    if (currentSchedule & (1 << (CRSF_FRAME_ATTITUDE_INDEX))) {
        crsfInitializeFrame(dst);
        crsfFrameAttitude(dst);
        crsfFinalize(dst);
    }
    if (currentSchedule & (1 << (CRSF_FRAME_BATTERY_SENSOR_INDEX))) {
        crsfInitializeFrame(dst);
        crsfFrameBatterySensor(dst);
        crsfFinalize(dst);
    }

    if (currentSchedule & (1 << (CRSF_FRAME_FLIGHT_MODE_INDEX))) {
        crsfInitializeFrame(dst);
...
{
    deviceInfoReplyPending = 
# 384 "./src/main/telemetry/crsf.c" 3 4
                            1
# 384 "./src/main/telemetry/crsf.c"
                                ;
}
...
void initCrsfTelemetry(void)
{
    ...
    deviceInfoReplyPending = 
# 393 "./src/main/telemetry/crsf.c" 3 4
                            0
# 393 "./src/main/telemetry/crsf.c"
                                 ;

    mspReplyPending = 
# 395 "./src/main/telemetry/crsf.c" 3 4
                     0
# 395 "./src/main/telemetry/crsf.c"
                          ;


    int index = 0;
    if (sensors(SENSOR_ACC)) {
        crsfSchedule[index++] = (1 << (CRSF_FRAME_ATTITUDE_INDEX));
    }
    if (isBatteryVoltageAvailable() || isAmperageAvailable()) {
        crsfSchedule[index++] = (1 << (CRSF_FRAME_BATTERY_SENSOR_INDEX));
    }
    crsfSchedule[index++] = (1 << (CRSF_FRAME_FLIGHT_MODE_INDEX));
    if (feature(FEATURE_GPS)) {
        crsfSchedule[index++] = (1 << (CRSF_FRAME_GPS_INDEX));
    }
...
# 413 "./src/main/telemetry/crsf.c" 3 4
_Bool 
# 413 "./src/main/telemetry/crsf.c"
    checkCrsfTelemetryState(void)
{
...
void handleCrsfTelemetry(timeUs_t currentTimeUs)
{
    ...
    if (deviceInfoReplyPending) {
        ...
        crsfFinalize(dst);
        deviceInfoReplyPending = 
# 448 "./src/main/telemetry/crsf.c" 3 4
                                0
# 448 "./src/main/telemetry/crsf.c"
                                     ;
        crsfLastCycleTime = currentTimeUs;
        return;
    }
    ...
    if (currentTimeUs >= crsfLastCycleTime + (100000 / crsfScheduleCount)) {
        crsfLastCycleTime = currentTimeUs;
        processCrsf();
    }
}
