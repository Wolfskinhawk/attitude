...
# 6 "./src/main/telemetry/smartport.c" 2
...
# 7 "./src/main/telemetry/smartport.c" 2
...
# 8 "./src/main/telemetry/smartport.c" 2
...
# 9 "./src/main/telemetry/smartport.c" 2
...
# 10 "./src/main/telemetry/smartport.c" 2
...
# 12 "./src/main/telemetry/smartport.c" 2
...
# 16 "./src/main/telemetry/smartport.c" 2
...
# 17 "./src/main/telemetry/smartport.c" 2
...
# 18 "./src/main/telemetry/smartport.c" 2
...
# 21 "./src/main/telemetry/smartport.c" 2

# 1 "./src/main/pg/pg_ids.h" 1
# 18 "./src/main/pg/pg_ids.h"
       
# 23 "./src/main/telemetry/smartport.c" 2
...
# 25 "./src/main/telemetry/smartport.c" 2
...
# 26 "./src/main/telemetry/smartport.c" 2
...
# 28 "./src/main/telemetry/smartport.c" 2
...
# 30 "./src/main/telemetry/smartport.c" 2
...
# 31 "./src/main/telemetry/smartport.c" 2
...
# 32 "./src/main/telemetry/smartport.c" 2
...
void mwDisarm(void);
# 33 "./src/main/telemetry/smartport.c" 2
...
# 35 "./src/main/telemetry/smartport.c" 2
...
# 36 "./src/main/telemetry/smartport.c" 2
...
# 37 "./src/main/telemetry/smartport.c" 2
...
# 38 "./src/main/telemetry/smartport.c" 2
...
# 39 "./src/main/telemetry/smartport.c" 2
...
# 41 "./src/main/telemetry/smartport.c" 2
...
# 64 "./src/main/io/beeper.h"
    isBeeperOn(void);
# 43 "./src/main/telemetry/smartport.c" 2
# 1 "./src/main/io/motors.h" 1
# 18 "./src/main/io/motors.h"
       
# 44 "./src/main/telemetry/smartport.c" 2
...
# 45 "./src/main/telemetry/smartport.c" 2
...
# 46 "./src/main/telemetry/smartport.c" 2
...
# 48 "./src/main/telemetry/smartport.c" 2
...
# 49 "./src/main/telemetry/smartport.c" 2
...
# 50 "./src/main/telemetry/smartport.c" 2
...
# 51 "./src/main/telemetry/smartport.c" 2
...
# 52 "./src/main/telemetry/smartport.c" 2
...
# 61 "./src/main/sensors/compass.h"
    compassInit(void);
# 53 "./src/main/telemetry/smartport.c" 2
...
# 54 "./src/main/telemetry/smartport.c" 2
...
# 56 "./src/main/telemetry/smartport.c" 2
...
# 58 "./src/main/telemetry/smartport.c" 2
...
typedef 
# 44 "./src/main/telemetry/smartport.h" 3 4
       _Bool 
# 44 "./src/main/telemetry/smartport.h"
            smartPortCheckQueueEmptyFn(void);


# 46 "./src/main/telemetry/smartport.h" 3 4
_Bool 
# 46 "./src/main/telemetry/smartport.h"
    initSmartPortTelemetry(void);
void checkSmartPortTelemetryState(void);

# 48 "./src/main/telemetry/smartport.h" 3 4
_Bool 
# 48 "./src/main/telemetry/smartport.h"
...
# 51 "./src/main/telemetry/smartport.h" 3 4
                                                                    _Bool 
# 51 "./src/main/telemetry/smartport.h"
                                                                         *hasRequest, const uint32_t *requestTimeout);

smartPortPayload_t *smartPortDataReceive(uint16_t c, 
# 53 "./src/main/telemetry/smartport.h" 3 4
                                                    _Bool 
# 53 "./src/main/telemetry/smartport.h"
                                                         *clearToSend, smartPortCheckQueueEmptyFn *checkQueueEmpty, 
# 53 "./src/main/telemetry/smartport.h" 3 4
                                                                                                                    _Bool 
# 53 "./src/main/telemetry/smartport.h"
                                                                                                                         withChecksum);
...
# 59 "./src/main/telemetry/smartport.c" 2
...
# 1 "./src/main/interface/crsf_protocol.h" 1
...
# 25 "./src/main/telemetry/crsf.h" 2
...
# 31 "./src/main/telemetry/crsf.h" 3 4
_Bool 
# 31 "./src/main/telemetry/crsf.h"
...
# 38 "./src/main/telemetry/crsf.h" 3 4
_Bool 
# 38 "./src/main/telemetry/crsf.h"
    bufferCrsfMspFrame(uint8_t *frameStart, int frameLength);
# 5 "./src/main/telemetry/msp_shared.h" 2
...
# 29 "./src/main/telemetry/msp_shared.h" 3 4
_Bool 
# 29 "./src/main/telemetry/msp_shared.h"
    handleMspFrame(uint8_t *frameStart, int frameLength);

# 30 "./src/main/telemetry/msp_shared.h" 3 4
_Bool 
# 30 "./src/main/telemetry/msp_shared.h"
    sendMspReply(uint8_t payloadSize, mspResponseFnPtr responseFn);
# 60 "./src/main/telemetry/smartport.c" 2
...
static serialPort_t *smartPortSerialPort = 
# 125 "./src/main/telemetry/smartport.c" 3 4
                                          ((void *)0)
# 125 "./src/main/telemetry/smartport.c"
                                              ;
...
static 
# 151 "./src/main/telemetry/smartport.c" 3 4
      _Bool 
# 151 "./src/main/telemetry/smartport.c"
...
smartPortPayload_t *smartPortDataReceive(uint16_t c, 
# 154 "./src/main/telemetry/smartport.c" 3 4
                                                    _Bool 
# 154 "./src/main/telemetry/smartport.c"
                                                         *clearToSend, smartPortCheckQueueEmptyFn *checkQueueEmpty, 
# 154 "./src/main/telemetry/smartport.c" 3 4
                                                                                                                    _Bool 
# 154 "./src/main/telemetry/smartport.c"
                                                                                                                         useChecksum)
{
    ...
    static 
# 158 "./src/main/telemetry/smartport.c" 3 4
          _Bool 
# 158 "./src/main/telemetry/smartport.c"
               skipUntilStart = 
# 158 "./src/main/telemetry/smartport.c" 3 4
                                1
# 158 "./src/main/telemetry/smartport.c"
                                    ;
    static 
# 159 "./src/main/telemetry/smartport.c" 3 4
          _Bool 
# 159 "./src/main/telemetry/smartport.c"
               awaitingSensorId = 
# 159 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 159 "./src/main/telemetry/smartport.c"
                                       ;
    static 
# 160 "./src/main/telemetry/smartport.c" 3 4
          _Bool 
# 160 "./src/main/telemetry/smartport.c"
               byteStuffing = 
# 160 "./src/main/telemetry/smartport.c" 3 4
                              0
# 160 "./src/main/telemetry/smartport.c"
    ...
    if (c == FSSP_START_STOP) {
        *clearToSend = 
# 164 "./src/main/telemetry/smartport.c" 3 4
                      0
# 164 "./src/main/telemetry/smartport.c"
                           ;
        smartPortRxBytes = 0;
        awaitingSensorId = 
# 166 "./src/main/telemetry/smartport.c" 3 4
                          1
# 166 "./src/main/telemetry/smartport.c"
                              ;
        skipUntilStart = 
# 167 "./src/main/telemetry/smartport.c" 3 4
                        0
# 167 "./src/main/telemetry/smartport.c"
                             ;

        return 
# 169 "./src/main/telemetry/smartport.c" 3 4
              ((void *)0)
# 169 "./src/main/telemetry/smartport.c"
                  ;
    } else if (skipUntilStart) {
        return 
# 171 "./src/main/telemetry/smartport.c" 3 4
              ((void *)0)
# 171 "./src/main/telemetry/smartport.c"
                  ;
    }

    if (awaitingSensorId) {
        awaitingSensorId = 
# 175 "./src/main/telemetry/smartport.c" 3 4
                          0
# 175 "./src/main/telemetry/smartport.c"
                               ;
        if ((c == FSSP_SENSOR_ID1) && checkQueueEmpty()) {

            *clearToSend = 
# 178 "./src/main/telemetry/smartport.c" 3 4
                          1
# 178 "./src/main/telemetry/smartport.c"
                              ;
            skipUntilStart = 
# 179 "./src/main/telemetry/smartport.c" 3 4
                            1
# 179 "./src/main/telemetry/smartport.c"
                                ;
        } else if (c == FSSP_SENSOR_ID2) {
            checksum = 0;
        } else {
            skipUntilStart = 
# 183 "./src/main/telemetry/smartport.c" 3 4
                            1
# 183 "./src/main/telemetry/smartport.c"
                                ;
        }
    } else {
        if (c == FSSP_DLE) {
            byteStuffing = 
# 187 "./src/main/telemetry/smartport.c" 3 4
                          1
# 187 "./src/main/telemetry/smartport.c"
                              ;

            return 
# 189 "./src/main/telemetry/smartport.c" 3 4
                  ((void *)0)
# 189 "./src/main/telemetry/smartport.c"
                      ;
        } else if (byteStuffing) {
            c ^= FSSP_DLE_XOR;
            byteStuffing = 
# 192 "./src/main/telemetry/smartport.c" 3 4
                          0
# 192 "./src/main/telemetry/smartport.c"
                               ;
        }
        ...
        if (smartPortRxBytes < sizeof(smartPortPayload_t)) {
            ...
            if (!useChecksum && (smartPortRxBytes == sizeof(smartPortPayload_t))) {
                skipUntilStart = 
# 200 "./src/main/telemetry/smartport.c" 3 4
                                1
# 200 "./src/main/telemetry/smartport.c"
                                    ;
            ...
            skipUntilStart = 
# 205 "./src/main/telemetry/smartport.c" 3 4
                            1
# 205 "./src/main/telemetry/smartport.c"
                                ;
    ...
    return 
# 215 "./src/main/telemetry/smartport.c" 3 4
          ((void *)0)
# 215 "./src/main/telemetry/smartport.c"
              ;
}
...
void smartPortSendByte(uint8_t c, uint16_t *checksum, serialPort_t *port)
{
    ...
    if (checksum != 
# 228 "./src/main/telemetry/smartport.c" 3 4
                   ((void *)0)
# 228 "./src/main/telemetry/smartport.c"
                       ) {
        *checksum += c;
    }
}
...
void smartPortWriteFrameSerial(const smartPortPayload_t *payload, serialPort_t *port, uint16_t checksum)
{
    ...
    smartPortSendByte((uint8_t)checksum, 
# 240 "./src/main/telemetry/smartport.c" 3 4
                                        ((void *)0)
# 240 "./src/main/telemetry/smartport.c"
                                            , port);
}
...
# 258 "./src/main/telemetry/smartport.c" 3 4
_Bool 
# 258 "./src/main/telemetry/smartport.c"
    initSmartPortTelemetry(void)
{
    if (telemetryState == TELEMETRY_STATE_UNINITIALIZED) {
        ...
        return 
# 270 "./src/main/telemetry/smartport.c" 3 4
              1
# 270 "./src/main/telemetry/smartport.c"
                  ;
    }

    return 
# 273 "./src/main/telemetry/smartport.c" 3 4
          0
# 273 "./src/main/telemetry/smartport.c"
               ;
}


# 276 "./src/main/telemetry/smartport.c" 3 4
_Bool 
# 276 "./src/main/telemetry/smartport.c"
    initSmartPortTelemetryExternal(smartPortWriteFrameFn *smartPortWriteFrameExternal)
{
    if (telemetryState == TELEMETRY_STATE_UNINITIALIZED) {
        ...
        return 
# 283 "./src/main/telemetry/smartport.c" 3 4
              1
# 283 "./src/main/telemetry/smartport.c"
                  ;
    }

    return 
# 286 "./src/main/telemetry/smartport.c" 3 4
          0
# 286 "./src/main/telemetry/smartport.c"
               ;
}
...
static void freeSmartPortTelemetryPort(void)
{
    ...
    smartPortSerialPort = 
# 292 "./src/main/telemetry/smartport.c" 3 4
                         ((void *)0)
# 292 "./src/main/telemetry/smartport.c"
                             ;
}
...
static void configureSmartPortTelemetryPort(void)
{
    if (portConfig) {
        ...
        smartPortSerialPort = openSerialPort(portConfig->identifier, FUNCTION_TELEMETRY_SMARTPORT, 
# 300 "./src/main/telemetry/smartport.c" 3 4
                                                                                                  ((void *)0)
# 300 "./src/main/telemetry/smartport.c"
                                                                                                      , 
# 300 "./src/main/telemetry/smartport.c" 3 4
                                                                                                        ((void *)0)
# 300 "./src/main/telemetry/smartport.c"
                                                                                                            , 57600, MODE_RXTX, portOptions);
    }
}
...
# 307 "./src/main/telemetry/smartport.c" 3 4
       _Bool 
# 307 "./src/main/telemetry/smartport.c"
            enableSerialTelemetry = telemetryDetermineEnabledState(smartPortPortSharing);
...
static void smartPortSendMspResponse(uint8_t *data) {
    ...
    memcpy(&payload.valueId, data, (sizeof(smartPortPayload_t) - sizeof(uint8_t)));
...
void processSmartPortTelemetry(smartPortPayload_t *payload, volatile 
# 327 "./src/main/telemetry/smartport.c" 3 4
                                                                    _Bool 
# 327 "./src/main/telemetry/smartport.c"
                                                                         *clearToSend, const uint32_t *requestTimeout)
{
    if (payload) {
        ...
        if (payload->frameId == FSSP_MSPC_FRAME_SMARTPORT || payload->frameId == FSSP_MSPC_FRAME_FPORT) {
            ...
            smartPortMspReplyPending = handleMspFrame(frameStart, (sizeof(smartPortPayload_t) - sizeof(uint8_t)));
        }

    }

    
# 342 "./src/main/telemetry/smartport.c" 3 4
   _Bool 
# 342 "./src/main/telemetry/smartport.c"
        doRun = 
# 342 "./src/main/telemetry/smartport.c" 3 4
                1
# 342 "./src/main/telemetry/smartport.c"
    ...
    while (doRun && *clearToSend) {
        ...
        if (requestTimeout) {
            if (millis() >= *requestTimeout) {
                *clearToSend = 
# 347 "./src/main/telemetry/smartport.c" 3 4
                              0
# 347 "./src/main/telemetry/smartport.c"
                                   ;
            ...
            doRun = 
# 352 "./src/main/telemetry/smartport.c" 3 4
                   0
# 352 "./src/main/telemetry/smartport.c"
                        ;
        }


        if (smartPortMspReplyPending) {
            smartPortMspReplyPending = sendMspReply((sizeof(smartPortPayload_t) - sizeof(uint8_t)), &smartPortSendMspResponse);
            *clearToSend = 
# 358 "./src/main/telemetry/smartport.c" 3 4
                          0
# 358 "./src/main/telemetry/smartport.c"
                               ;
        ...
        switch (id) {
            case FSSP_DATAID_VFAS :
                if (isBatteryVoltageAvailable()) {
                    ...
                    smartPortSendPackage(id, vfasVoltage * 10);
                    *clearToSend = 
# 387 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 387 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            case FSSP_DATAID_CURRENT :
                if (isAmperageAvailable()) {
                    smartPortSendPackage(id, getAmperage() / 10);
                    *clearToSend = 
# 393 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 393 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            ...
            case FSSP_DATAID_ALTITUDE :
                if (sensors(SENSOR_BARO)) {
                    smartPortSendPackage(id, getEstimatedAltitude());
                    *clearToSend = 
# 400 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 400 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            case FSSP_DATAID_FUEL :
                if (isAmperageAvailable()) {
                    smartPortSendPackage(id, getMAhDrawn());
                    *clearToSend = 
# 406 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 406 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            ...
            case FSSP_DATAID_VARIO :
                if (sensors(SENSOR_BARO)) {
                    smartPortSendPackage(id, getEstimatedVario());
                    *clearToSend = 
# 415 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 415 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            case FSSP_DATAID_HEADING :
                ...
                *clearToSend = 
# 420 "./src/main/telemetry/smartport.c" 3 4
                              0
# 420 "./src/main/telemetry/smartport.c"
                                   ;
                break;
            case FSSP_DATAID_ACCX :
                smartPortSendPackage(id, 100 * acc.accADC[X] / acc.dev.acc_1G);
                *clearToSend = 
# 424 "./src/main/telemetry/smartport.c" 3 4
                              0
# 424 "./src/main/telemetry/smartport.c"
                                   ;
                break;
            case FSSP_DATAID_ACCY :
                smartPortSendPackage(id, 100 * acc.accADC[Y] / acc.dev.acc_1G);
                *clearToSend = 
# 428 "./src/main/telemetry/smartport.c" 3 4
                              0
# 428 "./src/main/telemetry/smartport.c"
                                   ;
                break;
            case FSSP_DATAID_ACCZ :
                smartPortSendPackage(id, 100 * acc.accADC[Z] / acc.dev.acc_1G);
                *clearToSend = 
# 432 "./src/main/telemetry/smartport.c" 3 4
                              0
# 432 "./src/main/telemetry/smartport.c"
                                   ;
                break;
            case FSSP_DATAID_T1 :
                ...
                if ((flightModeFlags & (ANGLE_MODE)))
                    tmpi += 10;
                if ((flightModeFlags & (HORIZON_MODE)))
                    tmpi += 20;
                if ((flightModeFlags & (UNUSED_MODE)))
                    tmpi += 40;
                if ((flightModeFlags & (PASSTHRU_MODE)))
                    tmpi += 40;

                if ((flightModeFlags & (MAG_MODE)))
                    tmpi += 100;
                if ((flightModeFlags & (BARO_MODE)))
                    tmpi += 200;
                ...
                *clearToSend = 
# 478 "./src/main/telemetry/smartport.c" 3 4
                              0
# 478 "./src/main/telemetry/smartport.c"
                                   ;
                break;
            case FSSP_DATAID_T2 :
                if (sensors(SENSOR_GPS)) {
                    ...
                    *clearToSend = 
# 489 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 489 "./src/main/telemetry/smartport.c"
                                       ;
                    ...
                    *clearToSend = 
# 519 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 519 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
# 565 "./src/main/telemetry/smartport.c"
            case FSSP_DATAID_A4 :
                if (isBatteryVoltageAvailable()) {
                    smartPortSendPackage(id, getBatteryVoltage() * 10 / getBatteryCellCount());
                    *clearToSend = 
# 568 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 568 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
...
static 
# 581 "./src/main/telemetry/smartport.c" 3 4
      _Bool 
# 581 "./src/main/telemetry/smartport.c"
           serialCheckQueueEmpty(void)
{
...
{
    static 
# 588 "./src/main/telemetry/smartport.c" 3 4
          _Bool 
# 588 "./src/main/telemetry/smartport.c"
               clearToSend = 
# 588 "./src/main/telemetry/smartport.c" 3 4
                             0
# 588 "./src/main/telemetry/smartport.c"
    ...
    static smartPortPayload_t *payload = 
# 590 "./src/main/telemetry/smartport.c" 3 4
                                        ((void *)0)
# 590 "./src/main/telemetry/smartport.c"
                                            ;

    const uint32_t requestTimeout = millis() + 1;
    ...
    if (telemetryState == TELEMETRY_STATE_INITIALIZED_SERIAL && smartPortSerialPort) {
        while (serialRxBytesWaiting(smartPortSerialPort) > 0 && !payload) {
            ...
            payload = smartPortDataReceive(c, &clearToSend, serialCheckQueueEmpty, 
# 597 "./src/main/telemetry/smartport.c" 3 4
                                                                                  1
# 597 "./src/main/telemetry/smartport.c"
                                                                                      );
            if (payload) {
        ...
        if (cmpTimeUs(micros(), lastTelemetryFrameReceivedUs) >= 500) {
            processSmartPortTelemetry(payload, &clearToSend, &requestTimeout);
            payload = 
# 605 "./src/main/telemetry/smartport.c" 3 4
                     ((void *)0)
# 605 "./src/main/telemetry/smartport.c"
                         ;
        }
    }
}
