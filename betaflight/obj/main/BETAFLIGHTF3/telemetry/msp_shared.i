...
# 3 "./src/main/telemetry/msp_shared.c" 2
...
# 4 "./src/main/telemetry/msp_shared.c" 2
...
# 6 "./src/main/telemetry/msp_shared.c" 2
...
# 10 "./src/main/telemetry/msp_shared.c" 2
...
# 14 "./src/main/telemetry/msp_shared.c" 2
...
# 24 "./src/main/telemetry/crsf.h" 2
...
# 16 "./src/main/telemetry/msp_shared.c" 2
...
# 17 "./src/main/telemetry/msp_shared.c" 2
# 27 "./src/main/telemetry/msp_shared.c"
enum {
...
# 59 "./src/main/telemetry/msp_shared.c" 3 4
                                          ((void *)0)
# 59 "./src/main/telemetry/msp_shared.c"
                                              ;
    ...
    if (mspPostProcessFn) {
        mspPostProcessFn(
# 64 "./src/main/telemetry/msp_shared.c" 3 4
                        ((void *)0)
# 64 "./src/main/telemetry/msp_shared.c"
                            );
    }
...
# 81 "./src/main/telemetry/msp_shared.c" 3 4
_Bool 
# 81 "./src/main/telemetry/msp_shared.c"
    handleMspFrame(uint8_t *frameStart, int frameLength)
{
    ...
    if (version != 1) {
        ...
        return 
# 103 "./src/main/telemetry/msp_shared.c" 3 4
              1
# 103 "./src/main/telemetry/msp_shared.c"
                  ;
    }
    ...
    if (header & (1 << 4)) {
        ...
        return 
# 119 "./src/main/telemetry/msp_shared.c" 3 4
              0
# 119 "./src/main/telemetry/msp_shared.c"
                   ;
    } else if (((lastSeq + 1) & 0x0F) != seqNumber) {

        mspStarted = 0;
        return 
# 123 "./src/main/telemetry/msp_shared.c" 3 4
              0
# 123 "./src/main/telemetry/msp_shared.c"
                   ;
    }
    ...
    if (bufferBytesRemaining >= frameBytesRemaining) {
        ...
        return 
# 136 "./src/main/telemetry/msp_shared.c" 3 4
              0
# 136 "./src/main/telemetry/msp_shared.c"
                   ;
    } else {
...
# 149 "./src/main/telemetry/msp_shared.c"
    ...
    processMspPacket();
    return 
# 156 "./src/main/telemetry/msp_shared.c" 3 4
          1
# 156 "./src/main/telemetry/msp_shared.c"
              ;
}


# 159 "./src/main/telemetry/msp_shared.c" 3 4
_Bool 
# 159 "./src/main/telemetry/msp_shared.c"
    sendMspReply(uint8_t payloadSize, mspResponseFnPtr responseFn)
{
    static uint8_t checksum = 0;
    ...
    if (bufferBytesRemaining >= payloadBytesRemaining) {
        ...
        return 
# 197 "./src/main/telemetry/msp_shared.c" 3 4
              1
# 197 "./src/main/telemetry/msp_shared.c"
                  ;
    ...
    responseFn(payloadOut);
    return 
# 220 "./src/main/telemetry/msp_shared.c" 3 4
          0
# 220 "./src/main/telemetry/msp_shared.c"
               ;
}
