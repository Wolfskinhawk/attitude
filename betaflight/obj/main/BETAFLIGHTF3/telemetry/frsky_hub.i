# 1 "./src/main/telemetry/frsky_hub.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/telemetry/frsky_hub.c"
# 23 "./src/main/telemetry/frsky_hub.c"
...
# 26 "./src/main/telemetry/frsky_hub.c" 2
...
# 28 "./src/main/telemetry/frsky_hub.c" 2
...
# 32 "./src/main/telemetry/frsky_hub.c" 2
...
# 33 "./src/main/telemetry/frsky_hub.c" 2
...
# 36 "./src/main/telemetry/frsky_hub.c" 2

# 1 "./src/main/pg/pg_ids.h" 1
# 18 "./src/main/pg/pg_ids.h"
       
# 38 "./src/main/telemetry/frsky_hub.c" 2
...
# 40 "./src/main/telemetry/frsky_hub.c" 2
...
# 42 "./src/main/telemetry/frsky_hub.c" 2
...
# 43 "./src/main/telemetry/frsky_hub.c" 2
...
# 45 "./src/main/telemetry/frsky_hub.c" 2
...
# 46 "./src/main/telemetry/frsky_hub.c" 2
...
void mwDisarm(void);
# 47 "./src/main/telemetry/frsky_hub.c" 2
...
# 49 "./src/main/telemetry/frsky_hub.c" 2
...
# 50 "./src/main/telemetry/frsky_hub.c" 2
...
# 51 "./src/main/telemetry/frsky_hub.c" 2
...
# 52 "./src/main/telemetry/frsky_hub.c" 2
...
# 53 "./src/main/telemetry/frsky_hub.c" 2
...
# 55 "./src/main/telemetry/frsky_hub.c" 2
...
# 56 "./src/main/telemetry/frsky_hub.c" 2
...
# 58 "./src/main/telemetry/frsky_hub.c" 2
...
# 59 "./src/main/telemetry/frsky_hub.c" 2
...
# 60 "./src/main/telemetry/frsky_hub.c" 2
...
# 61 "./src/main/telemetry/frsky_hub.c" 2
...
# 63 "./src/main/telemetry/frsky_hub.c" 2
...
# 65 "./src/main/telemetry/frsky_hub.c" 2
...
# 68 "./src/main/telemetry/frsky_hub.c" 2
...
# 71 "./src/main/telemetry/frsky_hub.c" 2

static serialPort_t *frSkyHubPort = 
# 72 "./src/main/telemetry/frsky_hub.c" 3 4
                                   ((void *)0)
# 72 "./src/main/telemetry/frsky_hub.c"
                                       ;
static serialPortConfig_t *portConfig = 
# 73 "./src/main/telemetry/frsky_hub.c" 3 4
                                       ((void *)0)
# 73 "./src/main/telemetry/frsky_hub.c"
                                           ;
...
static frSkyHubWriteByteFn *frSkyHubWriteByte = 
# 80 "./src/main/telemetry/frsky_hub.c" 3 4
                                               ((void *)0)
# 80 "./src/main/telemetry/frsky_hub.c"
                                                   ;
# 131 "./src/main/telemetry/frsky_hub.c"
enum
{
...
static void sendAccel(void)
{
    for (unsigned i = 0; i < 3; i++) {
        frSkyHubWriteFrame(0x24 + i, ((float)acc.accADC[i] / acc.dev.acc_1G) * 1000);
    }
}
...
static void sendThrottleOrBatterySizeAsRpm(void)
{
    ...
    data = escData->dataAge < 255 ? escData->rpm : 0;
# 199 "./src/main/telemetry/frsky_hub.c"
    frSkyHubWriteFrame(0x03, data);
}
...
static void sendTemperature1(void)
{
    ...
    escSensorData_t *escData = getEscSensorData(255);
    data = escData->dataAge < 255 ? escData->temperature : 0;





    frSkyHubWriteFrame(0x02, data);
}
...
static void sendTime(void)
{
    ...
    frSkyHubWriteFrame(0x17, minutes << 8);
    frSkyHubWriteFrame(0x18, seconds % 60);
}
# 352 "./src/main/telemetry/frsky_hub.c"
...
# 370 "./src/main/telemetry/frsky_hub.c"
...
static void sendVoltageAmp(void)
{
    ...
    if (telemetryConfig()->frsky_vfas_precision == FRSKY_VFAS_PRECISION_HIGH) {
        ...
        frSkyHubWriteFrame(0x39, voltage);
    } else {
        ...
        frSkyHubWriteFrame(0x3A, voltage / 100);
        frSkyHubWriteFrame(0x3B, ((voltage % 100) + 5) / 10);
    }
}

static void sendAmperage(void)
{
    frSkyHubWriteFrame(0x28, (uint16_t)(getAmperage() / 10));
}
...
static void sendFuelLevel(void)
{
    ...
    frSkyHubWriteFrame(0x04, data);
}
# 443 "./src/main/telemetry/frsky_hub.c"

# 443 "./src/main/telemetry/frsky_hub.c" 3 4
_Bool 
# 443 "./src/main/telemetry/frsky_hub.c"
    initFrSkyHubTelemetry(void)
{
    if (telemetryState == TELEMETRY_STATE_UNINITIALIZED) {
        ...
        return 
# 455 "./src/main/telemetry/frsky_hub.c" 3 4
              1
# 455 "./src/main/telemetry/frsky_hub.c"
                  ;
    }

    return 
# 458 "./src/main/telemetry/frsky_hub.c" 3 4
          0
# 458 "./src/main/telemetry/frsky_hub.c"
               ;
}


# 461 "./src/main/telemetry/frsky_hub.c" 3 4
_Bool 
# 461 "./src/main/telemetry/frsky_hub.c"
    initFrSkyHubTelemetryExternal(frSkyHubWriteByteFn *frSkyHubWriteByteExternal)
{
    if (telemetryState == TELEMETRY_STATE_UNINITIALIZED) {
        ...
        return 
# 468 "./src/main/telemetry/frsky_hub.c" 3 4
              1
# 468 "./src/main/telemetry/frsky_hub.c"
                  ;
    }

    return 
# 471 "./src/main/telemetry/frsky_hub.c" 3 4
          0
# 471 "./src/main/telemetry/frsky_hub.c"
               ;
}
...
void freeFrSkyHubTelemetryPort(void)
{
    ...
    frSkyHubPort = 
# 477 "./src/main/telemetry/frsky_hub.c" 3 4
                  ((void *)0)
# 477 "./src/main/telemetry/frsky_hub.c"
                      ;
}
...
{
    if (portConfig) {
        frSkyHubPort = openSerialPort(portConfig->identifier, FUNCTION_TELEMETRY_FRSKY_HUB, 
# 483 "./src/main/telemetry/frsky_hub.c" 3 4
                                                                                           ((void *)0)
# 483 "./src/main/telemetry/frsky_hub.c"
                                                                                               , 
# 483 "./src/main/telemetry/frsky_hub.c" 3 4
                                                                                                 ((void *)0)
# 483 "./src/main/telemetry/frsky_hub.c"
                                                                                                     , 9600, MODE_TX, telemetryConfig()->telemetry_inverted ? SERIAL_NOT_INVERTED : SERIAL_INVERTED);
    }
}
...
void checkFrSkyHubTelemetryState(void)
{
    if (telemetryState == TELEMETRY_STATE_INITIALIZED_SERIAL) {
        if (telemetryCheckRxPortShared(portConfig)) {
            if (frSkyHubPort == 
# 491 "./src/main/telemetry/frsky_hub.c" 3 4
                               ((void *)0) 
# 491 "./src/main/telemetry/frsky_hub.c"
                                    && telemetrySharedPort != 
# 491 "./src/main/telemetry/frsky_hub.c" 3 4
                                                              ((void *)0)
# 491 "./src/main/telemetry/frsky_hub.c"
...
# 495 "./src/main/telemetry/frsky_hub.c" 3 4
           _Bool 
# 495 "./src/main/telemetry/frsky_hub.c"
                enableSerialTelemetry = telemetryDetermineEnabledState(frSkyHubPortSharing);
...
void processFrSkyHubTelemetry(timeUs_t currentTimeUs)
{
    ...
    if (cmpTimeUs(currentTimeUs, frSkyHubLastCycleTime) < 125000) {
        return;
    }
...
# 553 "./src/main/telemetry/frsky_hub.c"
    if ((cycleNum % 8) == 0) {
        sendTemperature1();
...
# 580 "./src/main/telemetry/frsky_hub.c"
        {}
