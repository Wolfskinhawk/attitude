# 1 "./src/main/vcp/hw_config.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/vcp/hw_config.c"
# 30 "./src/main/vcp/hw_config.c"
# 1 "./src/main/vcp/stm32_it.h" 1
# 33 "./src/main/vcp/stm32_it.h"
# 1 "./src/main/vcp/platform_config.h" 1
# 36 "./src/main/vcp/platform_config.h"
...
# 37 "./src/main/vcp/platform_config.h" 2
# 34 "./src/main/vcp/stm32_it.h" 2
...
# 33 "./src/main/vcp/hw_config.c" 2
# 1 "./src/main/vcp/usb_prop.h" 1
# 34 "./src/main/vcp/usb_prop.h"
typedef struct {
    uint32_t bitrate;
    uint8_t format;
    uint8_t paritytype;
...
# 34 "./src/main/vcp/hw_config.c" 2
# 1 "./src/main/vcp/usb_desc.h" 1
# 56 "./src/main/vcp/usb_desc.h"
...
# 35 "./src/main/vcp/hw_config.c" 2
# 1 "./src/main/vcp/hw_config.h" 1
# 36 "./src/main/vcp/hw_config.c" 2
# 1 "./src/main/vcp/usb_pwr.h" 1
# 34 "./src/main/vcp/usb_pwr.h"
...
extern volatile boolean fSuspendEnabled;
# 37 "./src/main/vcp/hw_config.c" 2

# 1 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\lib\\gcc\\arm-none-eabi\\7.2.1\\include\\stdbool.h" 1 3 4
# 39 "./src/main/vcp/hw_config.c" 2
...
# 41 "./src/main/vcp/hw_config.c" 2
# 1 "./src/main/drivers/nvic.h" 1

       
# 42 "./src/main/vcp/hw_config.c" 2
# 50 "./src/main/vcp/hw_config.c"
ErrorStatus HSEStartUpStatus;
EXTI_InitTypeDef EXTI_InitStructure;
volatile uint32_t packetSent;
extern volatile uint32_t receiveLength;

uint8_t receiveBuffer[64];
uint32_t sendLength;
static void IntToUnicode(uint32_t value, uint8_t *pbuf, uint8_t len);
# 68 "./src/main/vcp/hw_config.c"
void Set_System(void)
{

    GPIO_InitTypeDef GPIO_InitStructure;
# 86 "./src/main/vcp/hw_config.c"
    ...
    GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0000)), &GPIO_InitStructure);


    GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0000)), ((uint8_t)0x0B), ((uint8_t)0x0E));
    GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0000)), ((uint8_t)0x0C), ((uint8_t)0x0E));
# 116 "./src/main/vcp/hw_config.c"
    EXTI_ClearITPendingBit(((uint32_t)0x12));
    EXTI_InitStructure.EXTI_Line = ((uint32_t)0x12);
...
void USB_Interrupts_Config(void)
{
    ...
    NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = ((((((((2)<<(4-(7-(((uint32_t)0x500)>>8))))|((0)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0))>>(4-(7-(((uint32_t)0x500)>>8))))>>4);
    NVIC_InitStructure.NVIC_IRQChannelSubPriority = ((((((((2)<<(4-(7-(((uint32_t)0x500)>>8))))|((0)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0))&(0x0f>>(7-(((uint32_t)0x500)>>8))))>>4);
    NVIC_InitStructure.NVIC_IRQChannelCmd = ENABLE;
    NVIC_Init(&NVIC_InitStructure);


    NVIC_InitStructure.NVIC_IRQChannel = USBWakeUp_IRQn;
    NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = ((((((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((0)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0))>>(4-(7-(((uint32_t)0x500)>>8))))>>4);
    NVIC_InitStructure.NVIC_IRQChannelSubPriority = ((((((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((0)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0))&(0x0f>>(7-(((uint32_t)0x500)>>8))))>>4);
    NVIC_Init(&NVIC_InitStructure);
}
# 228 "./src/main/vcp/hw_config.c"
void USB_Cable_Config(FunctionalState NewState)
{
    (void)(NewState);
}
# 240 "./src/main/vcp/hw_config.c"
void Get_SerialNum(void)
{
...
uint32_t CDC_Send_DATA(const uint8_t *ptrBuffer, uint32_t sendLength)
{
    ...
    if (sendLength) {
        UserToPMABufferCopy(ptrBuffer, (0xC0), sendLength);
        SetEPTxCount(((uint8_t)1), sendLength);
...
uint32_t CDC_Receive_DATA(uint8_t* recvBuf, uint32_t len)
{
    ...
    if (receiveLength == 0) {
        SetEPRxCount(((uint8_t)3), 64);
        SetEPRxStatus(((uint8_t)3), (0x3000));
        offset = 0;
    }
...
# 361 "./src/main/vcp/hw_config.c"
uint8_t usbIsConfigured(void)
{
    return (bDeviceState == CONFIGURED);
}
# 373 "./src/main/vcp/hw_config.c"
uint8_t usbIsConnected(void)
{
    return (bDeviceState != UNCONNECTED);
}
# 386 "./src/main/vcp/hw_config.c"
uint32_t CDC_BaudRate(void)
{
