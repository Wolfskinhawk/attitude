# 1 "./src/main/vcp/usb_istr.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/vcp/usb_istr.c"
# 29 "./src/main/vcp/usb_istr.c"
...
# 32 "./src/main/vcp/usb_istr.c" 2
# 1 "./src/main/vcp/usb_istr.h" 1
# 33 "./src/main/vcp/usb_istr.h"
# 1 "./src/main/vcp/usb_conf.h" 1
# 34 "./src/main/vcp/usb_istr.h" 2
...
volatile uint32_t esof_counter = 0;
...
# 76 "./src/main/vcp/usb_istr.c"
void USB_Istr(void)
{
    wIstr = ((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x44)));


    if (wIstr & (0x0200) & wInterrupt_Mask) {
        (*((volatile unsigned *)((0x40005C00L) + 0x44)) = (uint16_t)(uint16_t)(~(0x0200)));
        bIntPackSOF++;
...
# 133 "./src/main/vcp/usb_istr.c"
    if (wIstr & (0x1000) & wInterrupt_Mask) {
        (*((volatile unsigned *)((0x40005C00L) + 0x44)) = (uint16_t)(uint16_t)(~(0x1000)));
        Resume(RESUME_EXTERNAL);



    }
# 220 "./src/main/vcp/usb_istr.c"
}
