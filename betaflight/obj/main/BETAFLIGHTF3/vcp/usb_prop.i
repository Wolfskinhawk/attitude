# 1 "./src/main/vcp/usb_prop.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/vcp/usb_prop.c"
# 29 "./src/main/vcp/usb_prop.c"
...
# 30 "./src/main/vcp/usb_prop.c" 2
# 1 "./src/main/vcp/usb_conf.h" 1
# 31 "./src/main/vcp/usb_prop.c" 2
...
# 34 "./src/main/vcp/usb_prop.c" 2
# 1 "./src/main/vcp/hw_config.h" 1
# 35 "./src/main/vcp/usb_prop.c" 2
...
DEVICE_PROP Device_Property = { Virtual_Com_Port_init, Virtual_Com_Port_Reset, Virtual_Com_Port_Status_In, Virtual_Com_Port_Status_Out, Virtual_Com_Port_Data_Setup, Virtual_Com_Port_NoData_Setup, Virtual_Com_Port_Get_Interface_Setting, Virtual_Com_Port_GetDeviceDescriptor,
        Virtual_Com_Port_GetConfigDescriptor, Virtual_Com_Port_GetStringDescriptor, 0, 0x40
};

USER_STANDARD_REQUESTS User_Standard_Requests = {
NOP_Process, Virtual_Com_Port_SetConfiguration,
NOP_Process,
NOP_Process,
NOP_Process,
NOP_Process,
NOP_Process,
NOP_Process, Virtual_Com_Port_SetDeviceAddress };
...
ONE_DESCRIPTOR String_Descriptor[4] = { { (uint8_t*)Virtual_Com_Port_StringLangID, 4 }, { (uint8_t*)Virtual_Com_Port_StringVendor, 38 }, { (uint8_t*)Virtual_Com_Port_StringProduct,
        50 }, { (uint8_t*)Virtual_Com_Port_StringSerial, 26 } };
# 88 "./src/main/vcp/usb_prop.c"
void Virtual_Com_Port_init(void)
{
...
void Virtual_Com_Port_Reset(void)
{
    ...
    SetEPType(((uint8_t)0), (0x0200));
    SetEPTxStatus(((uint8_t)0), (0x0010));
    SetEPRxAddr(((uint8_t)0), (0x40));
    SetEPTxAddr(((uint8_t)0), (0x80));
    Clear_Status_Out(((uint8_t)0));
    SetEPRxCount(((uint8_t)0), Device_Property.MaxPacketSize);
    SetEPRxValid(((uint8_t)0));


    SetEPType(((uint8_t)1), (0x0000));
    SetEPTxAddr(((uint8_t)1), (0xC0));
    SetEPTxStatus(((uint8_t)1), (0x0020));
    SetEPRxStatus(((uint8_t)1), (0x0000));


    SetEPType(((uint8_t)2), (0x0600));
    SetEPTxAddr(((uint8_t)2), (0x100));
    SetEPRxStatus(((uint8_t)2), (0x0000));
    SetEPTxStatus(((uint8_t)2), (0x0020));


    SetEPType(((uint8_t)3), (0x0000));
    SetEPRxAddr(((uint8_t)3), (0x110));
    SetEPRxCount(((uint8_t)3), 64);
    SetEPRxStatus(((uint8_t)3), (0x3000));
    SetEPTxStatus(((uint8_t)3), (0x0000));
...
# 188 "./src/main/vcp/usb_prop.c"
void Virtual_Com_Port_SetDeviceAddress(void)
{
    bDeviceState = ADDRESSED;
}
# 200 "./src/main/vcp/usb_prop.c"
void Virtual_Com_Port_Status_In(void)
{
    if (Request == 0x20) {
        Request = 0;
...
# 214 "./src/main/vcp/usb_prop.c"
void Virtual_Com_Port_Status_Out(void)
{
}
# 225 "./src/main/vcp/usb_prop.c"
...
# 280 "./src/main/vcp/usb_prop.c"
uint8_t *Virtual_Com_Port_GetDeviceDescriptor(uint16_t Length)
{
    return Standard_GetDescriptorData(Length, &Device_Descriptor);
}
# 292 "./src/main/vcp/usb_prop.c"
uint8_t *Virtual_Com_Port_GetConfigDescriptor(uint16_t Length)
{
    return Standard_GetDescriptorData(Length, &Config_Descriptor);
}
# 304 "./src/main/vcp/usb_prop.c"
uint8_t *Virtual_Com_Port_GetStringDescriptor(uint16_t Length)
{
    uint8_t wValue0 = pInformation->USBwValues.bw.bb0;
    if (wValue0 > 4) {
        return ((void *)0);
    } else {
