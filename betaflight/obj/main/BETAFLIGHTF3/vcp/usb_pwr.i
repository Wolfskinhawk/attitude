# 1 "./src/main/vcp/usb_pwr.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/vcp/usb_pwr.c"
# 29 "./src/main/vcp/usb_pwr.c"
...
# 30 "./src/main/vcp/usb_pwr.c" 2
# 1 "./src/main/vcp/usb_conf.h" 1
# 31 "./src/main/vcp/usb_pwr.c" 2
...
# 32 "./src/main/vcp/usb_pwr.c" 2
# 1 "./src/main/vcp/hw_config.h" 1
# 33 "./src/main/vcp/usb_pwr.c" 2
...
volatile boolean fSuspendEnabled = TRUE;
...
RESULT PowerOn(void)
{
    ...
    wRegVal = (0x0001);
    (*((volatile unsigned *)((0x40005C00L) + 0x40)) = (uint16_t)wRegVal);


    wInterrupt_Mask = 0;
    (*((volatile unsigned *)((0x40005C00L) + 0x40)) = (uint16_t)wInterrupt_Mask);

    (*((volatile unsigned *)((0x40005C00L) + 0x44)) = (uint16_t)0);
...
# 91 "./src/main/vcp/usb_pwr.c"
RESULT PowerOff(void)
{

    (*((volatile unsigned *)((0x40005C00L) + 0x40)) = (uint16_t)(0x0001));

    (*((volatile unsigned *)((0x40005C00L) + 0x44)) = (uint16_t)0);

    USB_Cable_Config(DISABLE);

    (*((volatile unsigned *)((0x40005C00L) + 0x40)) = (uint16_t)(0x0001) + (0x0002));



    return USB_SUCCESS;
}
# 114 "./src/main/vcp/usb_pwr.c"
void Suspend(void)
{
    uint32_t i = 0;
    uint16_t wCNTR;
    ...
    wCNTR = ((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x40)));




    for (i = 0; i < 8; i++)
        EP[i] = ((volatile uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + i)));


    wCNTR |= (0x0400);
    (*((volatile unsigned *)((0x40005C00L) + 0x40)) = (uint16_t)wCNTR);
    ...
    while ((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x44))) & (0x0400)) == 0)
        ;


    (*((volatile unsigned *)((0x40005C00L) + 0x44)) = (uint16_t)(uint16_t)(~(0x0400)));


    for (i = 0; i < 8; i++)
        (*(((volatile unsigned *)((0x40005C00L))) + i)= (uint16_t)EP[i]);
    ...
    savePWR_CR = ((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x00007000))->CR;
    ...
    if ((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x44))) & (0x1000)) == 0) {
        __WFI();
        ...
        (*((volatile unsigned *)((0x40005C00L) + 0x44)) = (uint16_t)(~(0x1000)));
        ...
        ((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x00007000))->CR = savePWR_CR;
...
void Resume_Init(void)
{
    ...
    (*((volatile unsigned *)((0x40005C00L) + 0x40)) = (uint16_t)((0x8000) | (0x1000) | (0x0200) | (0x0400) ));




}
# 255 "./src/main/vcp/usb_pwr.c"
void Resume(RESUME_STATE eResumeSetVal)
{
    uint16_t wCNTR;
