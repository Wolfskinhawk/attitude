# 1 "./src/main/vcp/usb_desc.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/vcp/usb_desc.c"
# 29 "./src/main/vcp/usb_desc.c"
...
const uint8_t Virtual_Com_Port_StringLangID[4] = {
4,
0x03, 0x09, 0x04
};

const uint8_t Virtual_Com_Port_StringVendor[38] = {
38,
0x03,

'S', 0, 'T', 0, 'M', 0, 'i', 0, 'c', 0, 'r', 0, 'o', 0, 'e', 0, 'l', 0, 'e', 0, 'c', 0, 't', 0, 'r', 0, 'o', 0, 'n', 0, 'i', 0, 'c', 0, 's', 0 };

const uint8_t Virtual_Com_Port_StringProduct[50] = {
50,
0x03,
