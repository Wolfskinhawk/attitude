# 1 "./src/main/vcp/usb_endp.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/vcp/usb_endp.c"
# 29 "./src/main/vcp/usb_endp.c"
...
# 31 "./src/main/vcp/usb_endp.c" 2
# 1 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_mem.h" 1
# 32 "./src/main/vcp/usb_endp.c" 2
# 1 "./src/main/vcp/hw_config.h" 1
# 33 "./src/main/vcp/usb_endp.c" 2
...
# 35 "./src/main/vcp/usb_endp.c" 2
# 43 "./src/main/vcp/usb_endp.c"
extern volatile uint32_t packetSent;
extern volatile uint8_t receiveBuffer[64];
volatile uint32_t receiveLength;
# 57 "./src/main/vcp/usb_endp.c"
void EP1_IN_Callback(void)
{
    packetSent = 0;
}
# 69 "./src/main/vcp/usb_endp.c"
void EP3_OUT_Callback(void)
{
    receiveLength = GetEPRxCount(((uint8_t)3));
    PMAToUserBufferCopy((unsigned char*)receiveBuffer, (0x110), receiveLength);
}
