...
# 19 "./src/main/drivers/max7456.c" 2
...
# 20 "./src/main/drivers/max7456.c" 2
...
# 21 "./src/main/drivers/max7456.c" 2
...
# 23 "./src/main/drivers/max7456.c" 2
...
# 27 "./src/main/drivers/max7456.c" 2

# 1 "./src/main/pg/max7456.h" 1
# 18 "./src/main/pg/max7456.h"
...
extern max7456Config_t max7456Config_System; extern max7456Config_t max7456Config_Copy; static inline const max7456Config_t* max7456Config(void) { return &max7456Config_System; } static inline max7456Config_t* max7456ConfigMutable(void) { return &max7456Config_System; } struct _dummy;
# 29 "./src/main/drivers/max7456.c" 2

# 1 "./src/main/pg/pg_ids.h" 1
# 18 "./src/main/pg/pg_ids.h"
       
# 31 "./src/main/drivers/max7456.c" 2
...
# 32 "./src/main/drivers/max7456.c" 2
...
# 34 "./src/main/drivers/max7456.c" 2
...
# 35 "./src/main/drivers/max7456.c" 2
...
# 36 "./src/main/drivers/max7456.c" 2
...
# 64 "./src/main/drivers/light_led.h"
                         state);
# 37 "./src/main/drivers/max7456.c" 2
...
# 41 "./src/main/drivers/max7456.c" 2
# 190 "./src/main/drivers/max7456.c"
static uint16_t max7456SpiClock = (SPI_CLOCK_STANDARD);

uint16_t maxScreenSize = 480;





static uint8_t screenBuffer[480 +40];
static uint8_t shadowBuffer[480];
# 208 "./src/main/drivers/max7456.c"
static uint8_t spiBuff[100*6];

static uint8_t videoSignalCfg;
static uint8_t videoSignalReg = 0x08;
static uint8_t displayMemoryModeReg = 0;

static uint8_t hosRegValue;
static uint8_t vosRegValue;

static 
# 217 "./src/main/drivers/max7456.c" 3 4
      _Bool 
# 217 "./src/main/drivers/max7456.c"
           max7456Lock = 
# 217 "./src/main/drivers/max7456.c" 3 4
                                 0
# 217 "./src/main/drivers/max7456.c"
                                      ;
static 
# 218 "./src/main/drivers/max7456.c" 3 4
      _Bool 
# 218 "./src/main/drivers/max7456.c"
           fontIsLoading = 
# 218 "./src/main/drivers/max7456.c" 3 4
                                 0
# 218 "./src/main/drivers/max7456.c"
                                      ;
static IO_t max7456CsPin = ((IO_t)0);
...
{
    spiTransferByte(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00003000)), add);
    return spiTransferByte(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00003000)), data);
}
# 346 "./src/main/drivers/max7456.c"
uint8_t max7456GetRowsCount(void)
{
    return (videoSignalReg & 0x40) ? 16 : 13;
}
...
void max7456ReInit(void)
{
    uint8_t srdata = 0;
    static 
# 354 "./src/main/drivers/max7456.c" 3 4
          _Bool 
# 354 "./src/main/drivers/max7456.c"
               firstInit = 
# 354 "./src/main/drivers/max7456.c" 3 4
                           1
# 354 "./src/main/drivers/max7456.c"
    ...
    {spiSetDivisor(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00003000)), max7456SpiClock);IOLo(max7456CsPin);};

    switch (videoSignalCfg) {
    case VIDEO_SYSTEM_PAL:
        videoSignalReg = 0x40 | 0x08;
        break;

    case VIDEO_SYSTEM_NTSC:
        videoSignalReg = 0x00 | 0x08;
        break;

    case VIDEO_SYSTEM_AUTO:
        srdata = max7456Send(0xA0, 0x00);

        if ((!((srdata) & 0x04) && ((srdata) & 0x02))) {
            videoSignalReg = 0x00 | 0x08;
        } else if ((!((srdata) & 0x04) && ((srdata) & 0x01))) {
            videoSignalReg = 0x40 | 0x08;
        } else {
    ...
    max7456Send(0x00, videoSignalReg);
    max7456Send(0x02, hosRegValue);
    max7456Send(0x03, vosRegValue);

    max7456Send(0x04, displayMemoryModeReg | 0x04);
    {IOHi(max7456CsPin);spiSetDivisor(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00003000)), (SPI_CLOCK_FAST));};
    ...
    if (firstInit) {
        max7456RefreshAll();
        firstInit = 
# 404 "./src/main/drivers/max7456.c" 3 4
                   0
# 404 "./src/main/drivers/max7456.c"
                        ;
    }
}
...
void max7456Init(const max7456Config_t *max7456Config, const vcdProfile_t *pVcdProfile, 
# 412 "./src/main/drivers/max7456.c" 3 4
                                                                                       _Bool 
# 412 "./src/main/drivers/max7456.c"
                                                                                            cpuOverclock)
{
    max7456HardwareReset();


    max7456CsPin = IOGetByTag(((ioTag_t)((((0) + 1) << 4) | (1))));

    IOInit(max7456CsPin, OWNER_OSD_CS, 0);
    IOConfigGPIO(max7456CsPin, ((GPIO_Mode_OUT) | ((GPIO_Speed_Level_3) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
    IOHi(max7456CsPin);



    spiSetDivisor(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00003000)), (SPI_CLOCK_STANDARD) * 2);

    max7456Send(0x0a, (1 << 6));

    if (max7456Send(0x0a|0x80, 0xff) & (1 << 6)) {
        max7456DeviceType = 1;
    } else {
        max7456DeviceType = 0;
    }
# 456 "./src/main/drivers/max7456.c"
    (void)(max7456Config);
    (void)(cpuOverclock);


    spiSetDivisor(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00003000)), max7456SpiClock);


    {spiSetDivisor(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00003000)), max7456SpiClock);IOLo(max7456CsPin);};
    max7456Send(0x00, 0x02);
    {IOHi(max7456CsPin);spiSetDivisor(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00003000)), (SPI_CLOCK_FAST));};
...
void max7456Invert(
# 482 "./src/main/drivers/max7456.c" 3 4
                  _Bool 
# 482 "./src/main/drivers/max7456.c"
                       invert)
{
    if (invert) {
        displayMemoryModeReg |= 0x08;
    } else {
        displayMemoryModeReg &= ~0x08;
    }

    {spiSetDivisor(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00003000)), max7456SpiClock);IOLo(max7456CsPin);};
    max7456Send(0x04, displayMemoryModeReg);
    {IOHi(max7456CsPin);spiSetDivisor(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00003000)), (SPI_CLOCK_FAST));};
}
...
# 537 "./src/main/drivers/max7456.c" 3 4
_Bool 
# 537 "./src/main/drivers/max7456.c"
    max7456DmaInProgress(void)
{
    ...
    return 
# 542 "./src/main/drivers/max7456.c" 3 4
          0
# 542 "./src/main/drivers/max7456.c"
               ;
...
void max7456DrawScreen(void)
{
    ...
    if (!max7456Lock && !fontIsLoading) {
        ...
        max7456Lock = 
# 558 "./src/main/drivers/max7456.c" 3 4
                     1
# 558 "./src/main/drivers/max7456.c"
                         ;
        {spiSetDivisor(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00003000)), max7456SpiClock);IOLo(max7456CsPin);};
        const uint8_t stallCheck = max7456Send(0x00|0x80, 0x00);
        {IOHi(max7456CsPin);spiSetDivisor(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00003000)), (SPI_CLOCK_FAST));};
        ...
        if (stallCheck != videoSignalReg) {
            max7456ReInit();
                  ...
                  && ((nowMs - lastSigCheckMs) > 1000)) {



            {spiSetDivisor(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00003000)), max7456SpiClock);IOLo(max7456CsPin);};
            const uint8_t videoSense = max7456Send(0xA0, 0x00);
            {IOHi(max7456CsPin);spiSetDivisor(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00003000)), (SPI_CLOCK_FAST));};

            {if (debugMode == (DEBUG_MAX7456_SIGNAL)) {debug[(0)] = (videoSignalReg & 0x40);}};
            {if (debugMode == (DEBUG_MAX7456_SIGNAL)) {debug[(1)] = (videoSense & 0x7);}};
            {if (debugMode == (DEBUG_MAX7456_SIGNAL)) {debug[(3)] = (max7456GetRowsCount());}};

            if (videoSense & 0x04) {
                videoDetectTimeMs = 0;
            } else {
                if (((!((videoSense) & 0x04) && ((videoSense) & 0x01)) && (((videoSignalReg) & 0x40) == 0x00))
                  || ((!((videoSense) & 0x04) && !((videoSense) & 0x01)) && (((videoSignalReg) & 0x40) == 0x40))) {
                    if (videoDetectTimeMs) {
                        if (millis() - videoDetectTimeMs > 100) {
                            max7456ReInit();
                            {if (debugMode == (DEBUG_MAX7456_SIGNAL)) {debug[(2)] = (++reInitCount);}};
                        }
                    } else {
        ...
        for (int k = 0; k < 100; k++) {
            if (screenBuffer[pos] != shadowBuffer[pos]) {
                spiBuff[buff_len++] = 0x05;
                spiBuff[buff_len++] = pos >> 8;
                spiBuff[buff_len++] = 0x06;
                spiBuff[buff_len++] = pos & 0xff;
                spiBuff[buff_len++] = 0x07;
        ...
        if (buff_len) {
            ...
            {spiSetDivisor(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00003000)), max7456SpiClock);IOLo(max7456CsPin);};
            spiTransfer(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00003000)), spiBuff, 
# 627 "./src/main/drivers/max7456.c" 3 4
                                                      ((void *)0)
# 627 "./src/main/drivers/max7456.c"
                                                          , buff_len);
            {IOHi(max7456CsPin);spiSetDivisor(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00003000)), (SPI_CLOCK_FAST));};

        }
        max7456Lock = 
# 631 "./src/main/drivers/max7456.c" 3 4
                     0
# 631 "./src/main/drivers/max7456.c"
                          ;
    }
}
...
void max7456RefreshAll(void)
{
    if (!max7456Lock) {
        ...
        max7456Lock = 
# 643 "./src/main/drivers/max7456.c" 3 4
                     1
# 643 "./src/main/drivers/max7456.c"
                         ;
        {spiSetDivisor(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00003000)), max7456SpiClock);IOLo(max7456CsPin);};
        max7456Send(0x05, 0);
        max7456Send(0x06, 0);
        max7456Send(0x04, displayMemoryModeReg | 1);

        for (int xx = 0; xx < maxScreenSize; ++xx) {
            max7456Send(0x07, screenBuffer[xx]);
            shadowBuffer[xx] = screenBuffer[xx];
        }

        max7456Send(0x07, 0xFF);
        max7456Send(0x04, displayMemoryModeReg);
        {IOHi(max7456CsPin);spiSetDivisor(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00003000)), (SPI_CLOCK_FAST));};
        max7456Lock = 
# 657 "./src/main/drivers/max7456.c" 3 4
                     0
# 657 "./src/main/drivers/max7456.c"
                          ;
    }
}
...
void max7456WriteNvm(uint8_t char_address, const uint8_t *font_data)
{
    ...
    while (max7456Lock);
    max7456Lock = 
# 667 "./src/main/drivers/max7456.c" 3 4
                 1
# 667 "./src/main/drivers/max7456.c"
                     ;

    {spiSetDivisor(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00003000)), max7456SpiClock);IOLo(max7456CsPin);};

    fontIsLoading = 
# 671 "./src/main/drivers/max7456.c" 3 4
                   1
# 671 "./src/main/drivers/max7456.c"
                       ;
    max7456Send(0x00, 0);

    max7456Send(0x09, char_address);

    for (int x = 0; x < 54; x++) {
        max7456Send(0x0a, x);
        max7456Send(0x0b, font_data[x]);
    ...
    max7456Send(0x08, 0xA0);



    while ((max7456Send(0xA0, 0x00) & 0x20) != 0x00);

    {IOHi(max7456CsPin);spiSetDivisor(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00003000)), (SPI_CLOCK_FAST));};

    max7456Lock = 
# 696 "./src/main/drivers/max7456.c" 3 4
                 0
# 696 "./src/main/drivers/max7456.c"
                      ;
}
...
void max7456HardwareReset(void)
{
# 718 "./src/main/drivers/max7456.c"
}
