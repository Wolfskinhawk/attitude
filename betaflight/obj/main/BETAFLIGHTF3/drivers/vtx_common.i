# 1 "./src/main/drivers/vtx_common.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/vtx_common.c"
# 20 "./src/main/drivers/vtx_common.c"
# 1 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\lib\\gcc\\arm-none-eabi\\7.2.1\\include\\stdbool.h" 1 3 4
# 21 "./src/main/drivers/vtx_common.c" 2
...
# 22 "./src/main/drivers/vtx_common.c" 2
...
int toupper (int __c);
int isblank (int __c);
# 23 "./src/main/drivers/vtx_common.c" 2
...
# 24 "./src/main/drivers/vtx_common.c" 2
...
# 26 "./src/main/drivers/vtx_common.c" 2
...
# 30 "./src/main/drivers/vtx_common.c" 2
...
# 31 "./src/main/drivers/vtx_common.c" 2


vtxDevice_t *vtxDevice = 
# 33 "./src/main/drivers/vtx_common.c" 3 4
                        ((void *)0)
# 33 "./src/main/drivers/vtx_common.c"
                            ;
...
# 44 "./src/main/drivers/vtx_common.c" 3 4
_Bool 
# 44 "./src/main/drivers/vtx_common.c"
    vtxCommonDeviceRegistered(void)
{
    return vtxDevice;
}
...
# 99 "./src/main/drivers/vtx_common.c" 3 4
_Bool 
# 99 "./src/main/drivers/vtx_common.c"
    vtxCommonGetBandAndChannel(uint8_t *pBand, uint8_t *pChannel)
{
    if (vtxDevice && vtxDevice->vTable->getBandAndChannel) {
        ...
        return 
# 104 "./src/main/drivers/vtx_common.c" 3 4
              0
# 104 "./src/main/drivers/vtx_common.c"
                   ;
    }
}


# 108 "./src/main/drivers/vtx_common.c" 3 4
_Bool 
# 108 "./src/main/drivers/vtx_common.c"
    vtxCommonGetPowerIndex(uint8_t *pIndex)
{
    if (vtxDevice && vtxDevice->vTable->getPowerIndex) {
        ...
        return 
# 113 "./src/main/drivers/vtx_common.c" 3 4
              0
# 113 "./src/main/drivers/vtx_common.c"
                   ;
    }
}


# 117 "./src/main/drivers/vtx_common.c" 3 4
_Bool 
# 117 "./src/main/drivers/vtx_common.c"
    vtxCommonGetPitMode(uint8_t *pOnOff)
{
    if (vtxDevice && vtxDevice->vTable->getPitMode) {
        ...
        return 
# 122 "./src/main/drivers/vtx_common.c" 3 4
              0
# 122 "./src/main/drivers/vtx_common.c"
                   ;
    }
}


# 126 "./src/main/drivers/vtx_common.c" 3 4
_Bool 
# 126 "./src/main/drivers/vtx_common.c"
    vtxCommonGetFrequency(uint16_t *pFreq)
{
    if (vtxDevice && vtxDevice->vTable->getFrequency) {
        ...
        return 
# 131 "./src/main/drivers/vtx_common.c" 3 4
              0
# 131 "./src/main/drivers/vtx_common.c"
                   ;
    }
}


# 135 "./src/main/drivers/vtx_common.c" 3 4
_Bool 
# 135 "./src/main/drivers/vtx_common.c"
    vtxCommonGetDeviceCapability(vtxDeviceCapability_t *pDeviceCapability)
{
    if (!vtxDevice) {
        return 
# 138 "./src/main/drivers/vtx_common.c" 3 4
              0
# 138 "./src/main/drivers/vtx_common.c"
                   ;
    }

    memcpy(pDeviceCapability, &vtxDevice->capability, sizeof(vtxDeviceCapability_t));
    return 
# 142 "./src/main/drivers/vtx_common.c" 3 4
          1
# 142 "./src/main/drivers/vtx_common.c"
              ;
}
