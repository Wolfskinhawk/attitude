...
# 20 "./src/main/drivers/bus_spi.c" 2
...
# 21 "./src/main/drivers/bus_spi.c" 2
...
# 23 "./src/main/drivers/bus_spi.c" 2
...
# 27 "./src/main/drivers/bus_spi.c" 2
...
# 28 "./src/main/drivers/bus_spi.c" 2
...
# 29 "./src/main/drivers/bus_spi.c" 2
...
# 41 "./src/main/drivers/exti.h"
                             enable);
# 30 "./src/main/drivers/bus_spi.c" 2
...
# 31 "./src/main/drivers/bus_spi.c" 2
...
# 32 "./src/main/drivers/bus_spi.c" 2
...
SPIDevice spiDeviceByInstance(SPI_TypeDef *instance)
{
    ...
    if (instance == ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00003000)))
        return SPIDEV_1;



    if (instance == ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)))
        return SPIDEV_2;
# 57 "./src/main/drivers/bus_spi.c"
    return SPIINVALID;
}
...
SPI_TypeDef *spiInstanceByDevice(SPIDevice device)
{
    if (device >= 3) {
        return 
# 63 "./src/main/drivers/bus_spi.c" 3 4
              ((void *)0)
# 63 "./src/main/drivers/bus_spi.c"
                  ;
    }
...
# 69 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 69 "./src/main/drivers/bus_spi.c"
    spiInit(SPIDevice device)
{
    switch (device) {
    case SPIINVALID:
        return 
# 73 "./src/main/drivers/bus_spi.c" 3 4
              0
# 73 "./src/main/drivers/bus_spi.c"
                   ;
    case SPIDEV_1:

        spiInitDevice(device);
        return 
# 77 "./src/main/drivers/bus_spi.c" 3 4
              1
# 77 "./src/main/drivers/bus_spi.c"
                  ;
    ...
    case SPIDEV_2:
        ...
        spiInitDevice(device);
        return 
# 84 "./src/main/drivers/bus_spi.c" 3 4
              1
# 84 "./src/main/drivers/bus_spi.c"
                  ;
    ...
    return 
# 103 "./src/main/drivers/bus_spi.c" 3 4
          0
# 103 "./src/main/drivers/bus_spi.c"
               ;
}
...
# 116 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 116 "./src/main/drivers/bus_spi.c"
    spiBusTransfer(const busDevice_t *bus, const uint8_t *txData, uint8_t *rxData, int length)
{
    ...
    return 
# 121 "./src/main/drivers/bus_spi.c" 3 4
          1
# 121 "./src/main/drivers/bus_spi.c"
              ;
}
...
# 141 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 141 "./src/main/drivers/bus_spi.c"
    spiBusWriteRegister(const busDevice_t *bus, uint8_t reg, uint8_t data)
{
    IOLo(bus->busdev_u.spi.csnPin);
    ...
    return 
# 148 "./src/main/drivers/bus_spi.c" 3 4
          1
# 148 "./src/main/drivers/bus_spi.c"
              ;
}


# 151 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 151 "./src/main/drivers/bus_spi.c"
    spiBusReadRegisterBuffer(const busDevice_t *bus, uint8_t reg, uint8_t *data, uint8_t length)
{
    IOLo(bus->busdev_u.spi.csnPin);
    spiTransferByte(bus->busdev_u.spi.instance, reg | 0x80);
    spiTransfer(bus->busdev_u.spi.instance, 
# 155 "./src/main/drivers/bus_spi.c" 3 4
                                           ((void *)0)
# 155 "./src/main/drivers/bus_spi.c"
                                               , data, length);
    IOHi(bus->busdev_u.spi.csnPin);

    return 
# 158 "./src/main/drivers/bus_spi.c" 3 4
          1
# 158 "./src/main/drivers/bus_spi.c"
              ;
}
...
uint8_t spiBusReadRegister(const busDevice_t *bus, uint8_t reg)
{
    ...
    spiTransferByte(bus->busdev_u.spi.instance, reg | 0x80);
    spiTransfer(bus->busdev_u.spi.instance, 
# 166 "./src/main/drivers/bus_spi.c" 3 4
                                           ((void *)0)
# 166 "./src/main/drivers/bus_spi.c"
                                               , &data, 1);
    IOHi(bus->busdev_u.spi.csnPin);
