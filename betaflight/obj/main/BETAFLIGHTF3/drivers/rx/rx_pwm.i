...
# 20 "./src/main/drivers/rx/rx_pwm.c" 2
...
# 22 "./src/main/drivers/rx/rx_pwm.c" 2
...
# 26 "./src/main/drivers/rx/rx_pwm.c" 2
...
# 27 "./src/main/drivers/rx/rx_pwm.c" 2
...
# 31 "./src/main/drivers/rx/rx_pwm.c" 2
# 1 "./src/main/drivers/nvic.h" 1

       
# 32 "./src/main/drivers/rx/rx_pwm.c" 2
...
# 33 "./src/main/drivers/rx/rx_pwm.c" 2
...
# 36 "./src/main/drivers/rx/rx_pwm.c" 2
# 52 "./src/main/drivers/rx/rx_pwm.c"
...
static pwmInputPort_t pwmInputPorts[8];

static uint16_t captures[12];
...
# 100 "./src/main/drivers/rx/rx_pwm.c" 3 4
   _Bool 
# 100 "./src/main/drivers/rx/rx_pwm.c"
            tracking;
    
# 101 "./src/main/drivers/rx/rx_pwm.c" 3 4
   _Bool 
# 101 "./src/main/drivers/rx/rx_pwm.c"
            overflowed;
} ppmDevice_t;

static ppmDevice_t ppmDev;
# 113 "./src/main/drivers/rx/rx_pwm.c"

# 113 "./src/main/drivers/rx/rx_pwm.c" 3 4
_Bool 
# 113 "./src/main/drivers/rx/rx_pwm.c"
    isPPMDataBeingReceived(void)
{
...
static void ppmResetDevice(void)
{
    ...
    ppmDev.tracking = 
# 160 "./src/main/drivers/rx/rx_pwm.c" 3 4
                         0
# 160 "./src/main/drivers/rx/rx_pwm.c"
                              ;
    ppmDev.overflowed = 
# 161 "./src/main/drivers/rx/rx_pwm.c" 3 4
                         0
# 161 "./src/main/drivers/rx/rx_pwm.c"
                              ;
}
...
static void ppmOverflowCallback(timerOvrHandlerRec_t* cbRec, captureCompare_t capture)
{
    ...
    if (capture == 0x10000 - 1) {
        ppmDev.overflowed = 
# 171 "./src/main/drivers/rx/rx_pwm.c" 3 4
                           1
# 171 "./src/main/drivers/rx/rx_pwm.c"
                               ;
    }
}
...
static void ppmEdgeCallback(timerCCHandlerRec_t* cbRec, captureCompare_t capture)
{
    ...
    if (currentTime > previousTime) {
        ppmDev.deltaTime = currentTime - (previousTime + (ppmDev.overflowed ? (0x10000 / ppmCountDivisor) : 0));
    } else {
        ppmDev.deltaTime = (0x10000 / ppmCountDivisor) + currentTime - previousTime;
    }

    ppmDev.overflowed = 
# 207 "./src/main/drivers/rx/rx_pwm.c" 3 4
                       0
# 207 "./src/main/drivers/rx/rx_pwm.c"
                            ;
    ...
    if (ppmDev.deltaTime > 2700) {
        if (ppmDev.pulseIndex == ppmDev.numChannelsPrevFrame
            && ppmDev.pulseIndex >= 4
            && ppmDev.pulseIndex <= 12) {


            if (ppmDev.stableFramesSeenCount < 25) {
        ...
        if (ppmDev.pulseIndex == ppmDev.numChannels && ppmDev.tracking) {
            ...
            for (i = ppmDev.numChannels; i < 12; i++) {
                captures[i] = 0;
            }
            ppmFrameCount++;
        }
        ...
        ppmDev.tracking = 
# 242 "./src/main/drivers/rx/rx_pwm.c" 3 4
                           1
# 242 "./src/main/drivers/rx/rx_pwm.c"
                               ;
        ...
        if (ppmDev.deltaTime > 750
            && ppmDev.deltaTime < 2250
            && ppmDev.pulseIndex < 12) {
            ...
            ppmDev.tracking = 
# 257 "./src/main/drivers/rx/rx_pwm.c" 3 4
                             0
# 257 "./src/main/drivers/rx/rx_pwm.c"
                                  ;
            for (i = 0; i < 12; i++) {
                ppmDev.captures[i] = 0;
            }
...
# 267 "./src/main/drivers/rx/rx_pwm.c" 3 4
_Bool 
# 267 "./src/main/drivers/rx/rx_pwm.c"
    isPWMDataBeingReceived(void)
{
    int channel;
    for (channel = 0; channel < 12; channel++) {
        if (captures[channel] != 0) {
            return 
# 272 "./src/main/drivers/rx/rx_pwm.c" 3 4
                  1
# 272 "./src/main/drivers/rx/rx_pwm.c"
                      ;
        }
    }
    return 
# 275 "./src/main/drivers/rx/rx_pwm.c" 3 4
          0
# 275 "./src/main/drivers/rx/rx_pwm.c"
               ;
}
...
{
    (void)(capture);
    pwmInputPort_t *pwmInputPort = ( __extension__ ({ const typeof( ((pwmInputPort_t *)0)->overflowCb ) *__mptr = (cbRec); (pwmInputPort_t *)( (char *)__mptr - 
# 281 "./src/main/drivers/rx/rx_pwm.c" 3 4
                                  __builtin_offsetof (
# 281 "./src/main/drivers/rx/rx_pwm.c"
                                  pwmInputPort_t
# 281 "./src/main/drivers/rx/rx_pwm.c" 3 4
                                  , 
# 281 "./src/main/drivers/rx/rx_pwm.c"
...
# 281 "./src/main/drivers/rx/rx_pwm.c"
    ...
    if (++pwmInputPort->missedEvents > 10) {
        captures[pwmInputPort->channel] = 0;
...
{
    pwmInputPort_t *pwmInputPort = ( __extension__ ({ const typeof( ((pwmInputPort_t *)0)->edgeCb ) *__mptr = (cbRec); (pwmInputPort_t *)( (char *)__mptr - 
# 291 "./src/main/drivers/rx/rx_pwm.c" 3 4
                                  __builtin_offsetof (
# 291 "./src/main/drivers/rx/rx_pwm.c"
                                  pwmInputPort_t
# 291 "./src/main/drivers/rx/rx_pwm.c" 3 4
                                  , 
# 291 "./src/main/drivers/rx/rx_pwm.c"
...
# 291 "./src/main/drivers/rx/rx_pwm.c"
    ...
    if (pwmInputPort->state == 0) {
        ...
        pwmICConfig(timerHardwarePtr->tim, timerHardwarePtr->channel, ((uint16_t)0x0002));
        ...
        pwmICConfig(timerHardwarePtr->tim, timerHardwarePtr->channel, ((uint16_t)0x0000));

        pwmInputPort->missedEvents = 0;
    }
}
# 343 "./src/main/drivers/rx/rx_pwm.c"
void pwmICConfig(TIM_TypeDef *tim, uint8_t channel, uint16_t polarity)
{
...
void pwmRxInit(const pwmConfig_t *pwmConfig)
{
    ...
    for (int channel = 0; channel < 8; channel++) {
        ...
        IOInit(io, OWNER_PWMINPUT, (channel + 1));



        IOConfigGPIOAF(io, ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)), timer->alternateFunction);

        timerConfigure(timer, (uint16_t)0x10000, ((1) * 1000000));
        ...
        pwmICConfig(timer->tim, timer->channel, ((uint16_t)0x0000));
...
void ppmRxInit(const ppmConfig_t *ppmConfig)
{
    ...
    pwmInputPort_t *port = &pwmInputPorts[0];
