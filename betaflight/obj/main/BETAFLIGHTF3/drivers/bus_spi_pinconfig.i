# 1 "./src/main/drivers/bus_spi_pinconfig.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/bus_spi_pinconfig.c"
# 18 "./src/main/drivers/bus_spi_pinconfig.c"
# 1 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\lib\\gcc\\arm-none-eabi\\7.2.1\\include\\stdbool.h" 1 3 4
# 19 "./src/main/drivers/bus_spi_pinconfig.c" 2
...
# 20 "./src/main/drivers/bus_spi_pinconfig.c" 2
...
# 21 "./src/main/drivers/bus_spi_pinconfig.c" 2
...
# 23 "./src/main/drivers/bus_spi_pinconfig.c" 2
...
# 27 "./src/main/drivers/bus_spi_pinconfig.c" 2
...
# 29 "./src/main/drivers/bus_spi_pinconfig.c" 2
# 1 "./src/main/drivers/bus_spi_impl.h" 1
# 18 "./src/main/drivers/bus_spi_impl.h"
...
typedef struct spiHardware_s {
    SPIDevice device;
    SPI_TypeDef *reg;
    spiPinDef_t sckPins[2];
    spiPinDef_t misoPins[2];
    spiPinDef_t mosiPins[2];
...
# 64 "./src/main/drivers/bus_spi_impl.h" 3 4
   _Bool 
# 64 "./src/main/drivers/bus_spi_impl.h"
        leadingEdge;
...
extern spiDevice_t spiDevice[3];

void spiInitDevice(SPIDevice device);
uint32_t spiTimeoutUserCallback(SPI_TypeDef *instance);
# 30 "./src/main/drivers/bus_spi_pinconfig.c" 2
...
# 31 "./src/main/drivers/bus_spi_pinconfig.c" 2
...
# 41 "./src/main/drivers/exti.h"
                             enable);
# 32 "./src/main/drivers/bus_spi_pinconfig.c" 2
...
# 33 "./src/main/drivers/bus_spi_pinconfig.c" 2
...
# 34 "./src/main/drivers/bus_spi_pinconfig.c" 2
...
# 36 "./src/main/drivers/bus_spi_pinconfig.c" 2

const spiHardware_t spiHardware[] = {
# 89 "./src/main/drivers/bus_spi_pinconfig.c"
    {
        .device = SPIDEV_1,
        .reg = ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00003000)),
        .sckPins = {
            { ((ioTag_t)((((0) + 1) << 4) | (5))) },
            { ((ioTag_t)((((1) + 1) << 4) | (3))) },
        },
        ...
        .af = ((uint8_t)0x05),
        .rcc = (((RCC_APB2) << 5) | (16*((((uint32_t)0x00001000))>65535L) + (8*(((((uint32_t)0x00001000))*1L >>16*((((uint32_t)0x00001000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00001000))*1L >>16*((((uint32_t)0x00001000))>65535L)) >>8*(((((uint32_t)0x00001000))*1L >>16*((((uint32_t)0x00001000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00001000))*1L >>16*((((uint32_t)0x00001000))>65535L)) >>8*(((((uint32_t)0x00001000))*1L >>16*((((uint32_t)0x00001000))>65535L))>255))/2+1))))),
    },
    {
        .device = SPIDEV_2,
        .reg = ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)),
        .sckPins = {
            { ((ioTag_t)((((1) + 1) << 4) | (13))) },
            { ((ioTag_t)((((1) + 1) << 4) | (3))) },
        },
        ...
        .af = ((uint8_t)0x05),
        .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00004000))>65535L) + (8*(((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L)) >>8*(((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L)) >>8*(((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L))>255))/2+1))))),
    },
    {
        .device = SPIDEV_3,
        .reg = ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003C00)),
        .sckPins = {
            { ((ioTag_t)((((1) + 1) << 4) | (3))) },
            { 0 },
        },
        ...
        .af = ((uint8_t)0x06),
        .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00008000))>65535L) + (8*(((((uint32_t)0x00008000))*1L >>16*((((uint32_t)0x00008000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00008000))*1L >>16*((((uint32_t)0x00008000))>65535L)) >>8*(((((uint32_t)0x00008000))*1L >>16*((((uint32_t)0x00008000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00008000))*1L >>16*((((uint32_t)0x00008000))>65535L)) >>8*(((((uint32_t)0x00008000))*1L >>16*((((uint32_t)0x00008000))>65535L))>255))/2+1))))),
    },
# 279 "./src/main/drivers/bus_spi_pinconfig.c"
};

void spiPinConfigure(const spiPinConfig_t *pConfig)
{
    for (size_t hwindex = 0 ; hwindex < (sizeof(spiHardware) / sizeof((spiHardware)[0])) ; hwindex++) {
        ...
        if (pDev->sck && pDev->miso && pDev->mosi) {
            ...
            pDev->rcc = hw->rcc;
            pDev->leadingEdge = 
# 320 "./src/main/drivers/bus_spi_pinconfig.c" 3 4
                               0
# 320 "./src/main/drivers/bus_spi_pinconfig.c"
                                    ;
