# 1 "./src/main/drivers/serial_usb_vcp.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/serial_usb_vcp.c"
# 18 "./src/main/drivers/serial_usb_vcp.c"
...
# 22 "./src/main/drivers/serial_usb_vcp.c" 2
...
# 26 "./src/main/drivers/serial_usb_vcp.c" 2
...
# 29 "./src/main/drivers/serial_usb_vcp.c" 2
# 39 "./src/main/drivers/serial_usb_vcp.c"
...
# 40 "./src/main/drivers/serial_usb_vcp.c" 2
...
# 41 "./src/main/drivers/serial_usb_vcp.c" 2
...
# 42 "./src/main/drivers/serial_usb_vcp.c" 2
...
# 45 "./src/main/drivers/serial_usb_vcp.c" 2
...
# 47 "./src/main/drivers/serial_usb_vcp.c" 2
...
# 48 "./src/main/drivers/serial_usb_vcp.c" 2
...
static 
# 70 "./src/main/drivers/serial_usb_vcp.c" 3 4
      _Bool 
# 70 "./src/main/drivers/serial_usb_vcp.c"
           isUsbVcpTransmitBufferEmpty(const serialPort_t *instance)
{
    (void)(instance);
    return 
# 73 "./src/main/drivers/serial_usb_vcp.c" 3 4
          1
# 73 "./src/main/drivers/serial_usb_vcp.c"
              ;
}
...
static uint8_t usbVcpRead(serialPort_t *instance)
{
    ...
    while (
# 89 "./src/main/drivers/serial_usb_vcp.c" 3 4
          1
# 89 "./src/main/drivers/serial_usb_vcp.c"
              ) {
...
static 
# 116 "./src/main/drivers/serial_usb_vcp.c" 3 4
      _Bool 
# 116 "./src/main/drivers/serial_usb_vcp.c"
           usbVcpFlush(vcpPort_t *port)
{
    ...
    if (count == 0) {
        return 
# 122 "./src/main/drivers/serial_usb_vcp.c" 3 4
              1
# 122 "./src/main/drivers/serial_usb_vcp.c"
                  ;
    }

    if (!usbIsConnected() || !usbIsConfigured()) {
        return 
# 126 "./src/main/drivers/serial_usb_vcp.c" 3 4
              0
# 126 "./src/main/drivers/serial_usb_vcp.c"
                   ;
    }
...
{
    vcpPort_t *port = ( __extension__ ({ const typeof( ((vcpPort_t *)0)->port ) *__mptr = (instance); (vcpPort_t *)( (char *)__mptr - 
# 145 "./src/main/drivers/serial_usb_vcp.c" 3 4
                     __builtin_offsetof (
# 145 "./src/main/drivers/serial_usb_vcp.c"
                     vcpPort_t
# 145 "./src/main/drivers/serial_usb_vcp.c" 3 4
                     , 
# 145 "./src/main/drivers/serial_usb_vcp.c"
...
# 145 "./src/main/drivers/serial_usb_vcp.c"
    ...
    if (!port->buffering || port->txAt >= (sizeof(port->txBuf) / sizeof((port->txBuf)[0]))) {
        usbVcpFlush(port);
    }
}
...
{
    vcpPort_t *port = ( __extension__ ({ const typeof( ((vcpPort_t *)0)->port ) *__mptr = (instance); (vcpPort_t *)( (char *)__mptr - 
# 155 "./src/main/drivers/serial_usb_vcp.c" 3 4
                     __builtin_offsetof (
# 155 "./src/main/drivers/serial_usb_vcp.c"
                     vcpPort_t
# 155 "./src/main/drivers/serial_usb_vcp.c" 3 4
                     , 
# 155 "./src/main/drivers/serial_usb_vcp.c"
...
# 155 "./src/main/drivers/serial_usb_vcp.c"
    ...
    port->buffering = 
# 156 "./src/main/drivers/serial_usb_vcp.c" 3 4
                     1
# 156 "./src/main/drivers/serial_usb_vcp.c"
                         ;
}
...
{
    vcpPort_t *port = ( __extension__ ({ const typeof( ((vcpPort_t *)0)->port ) *__mptr = (instance); (vcpPort_t *)( (char *)__mptr - 
# 167 "./src/main/drivers/serial_usb_vcp.c" 3 4
                     __builtin_offsetof (
# 167 "./src/main/drivers/serial_usb_vcp.c"
                     vcpPort_t
# 167 "./src/main/drivers/serial_usb_vcp.c" 3 4
                     , 
# 167 "./src/main/drivers/serial_usb_vcp.c"
...
# 167 "./src/main/drivers/serial_usb_vcp.c"
    ...
    port->buffering = 
# 168 "./src/main/drivers/serial_usb_vcp.c" 3 4
                     0
# 168 "./src/main/drivers/serial_usb_vcp.c"
                          ;
    usbVcpFlush(port);
}
...
{
    vcpPort_t *s;
# 214 "./src/main/drivers/serial_usb_vcp.c"
    Set_System();
    Set_USBClock();
    USB_Init();
