# 1 "./src/main/drivers/system_stm32f30x.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/system_stm32f30x.c"
# 18 "./src/main/drivers/system_stm32f30x.c"
# 1 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\lib\\gcc\\arm-none-eabi\\7.2.1\\include\\stdbool.h" 1 3 4
# 19 "./src/main/drivers/system_stm32f30x.c" 2
...
# 20 "./src/main/drivers/system_stm32f30x.c" 2
...
# 22 "./src/main/drivers/system_stm32f30x.c" 2

# 1 "./src/main/drivers/nvic.h" 1

       
# 24 "./src/main/drivers/system_stm32f30x.c" 2
...
# 25 "./src/main/drivers/system_stm32f30x.c" 2
...
void systemReset(void)
{
    ...
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->AIRCR = ((uint32_t)0x05FA0000) | (uint32_t)0x04;
}
...
void enableGPIOPowerUsageAndNoiseReductions(void)
{
    ...
    GPIO_InitStructure.GPIO_Pin = ((uint16_t)0xFFFF) & ~(((uint16_t)0x2000) | ((uint16_t)0x4000) | ((uint16_t)0x8000));
    ...
    GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0400)), &GPIO_InitStructure);
    GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0800)), &GPIO_InitStructure);
    GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0C00)), &GPIO_InitStructure);
    GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x1000)), &GPIO_InitStructure);
    GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x1400)), &GPIO_InitStructure);
}


# 75 "./src/main/drivers/system_stm32f30x.c" 3 4
_Bool 
# 75 "./src/main/drivers/system_stm32f30x.c"
    isMPUSoftReset(void)
{
    if (cachedRccCsrValue & ((uint32_t)0x10000000))
        return 
# 78 "./src/main/drivers/system_stm32f30x.c" 3 4
              1
# 78 "./src/main/drivers/system_stm32f30x.c"
                  ;
    else
        return 
# 80 "./src/main/drivers/system_stm32f30x.c" 3 4
              0
# 80 "./src/main/drivers/system_stm32f30x.c"
                   ;
}
...
void systemInit(void)
{
    ...
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->CPACR = (0x3 << (10 * 2)) | (0x3 << (11 * 2));
    SetSysClock();
    ...
    cachedRccCsrValue = ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CSR;
    RCC_ClearFlag();
