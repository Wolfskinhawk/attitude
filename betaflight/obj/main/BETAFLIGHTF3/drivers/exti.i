...
# 24 "./src/main/drivers/io_impl.h" 2
...
static uint8_t extiGroupPriority[7];
# 36 "./src/main/drivers/exti.c"
...
void EXTIInit(void)
{
    ...
    SYSCFG_DMAChannelRemapConfig(((uint32_t)0x00000800), ENABLE);


    SYSCFG_DMAChannelRemapConfig(((uint32_t)0x00001000), ENABLE);
...
void EXTIRelease(IO_t io)
{
    ...
    EXTIEnable(io, 
# 153 "./src/main/drivers/exti.c" 3 4
                  0
# 153 "./src/main/drivers/exti.c"
                       );
    ...
    extiChannelRec_t *rec = &extiChannelRecs[chIdx];
    rec->handler = 
# 160 "./src/main/drivers/exti.c" 3 4
                  ((void *)0)
# 160 "./src/main/drivers/exti.c"
                      ;
}

void EXTIEnable(IO_t io, 
# 163 "./src/main/drivers/exti.c" 3 4
                        _Bool 
# 163 "./src/main/drivers/exti.c"
                             enable)
{
# 174 "./src/main/drivers/exti.c"
    int extiLine = IO_EXTI_Line(io);
    if (extiLine < 0)
        return;

    if (enable)
        ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000400))->IMR |= 1 << extiLine;
    else
        ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000400))->IMR &= ~(1 << extiLine);
...
{
    uint32_t exti_active = ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000400))->IMR & ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000400))->PR;

    while (exti_active) {
        unsigned idx = 31 - __builtin_clz(exti_active);
        uint32_t mask = 1 << idx;
        extiChannelRecs[idx].handler->fn(extiChannelRecs[idx].handler);
        ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000400))->PR = mask;
        exti_active &= ~mask;
    }
}
# 208 "./src/main/drivers/exti.c"
void EXTI0_IRQHandler(void) { EXTI_IRQHandler(); } struct dummy;
void EXTI1_IRQHandler(void) { EXTI_IRQHandler(); } struct dummy;



void EXTI2_TS_IRQHandler(void) { EXTI_IRQHandler(); } struct dummy;



void EXTI3_IRQHandler(void) { EXTI_IRQHandler(); } struct dummy;
void EXTI4_IRQHandler(void) { EXTI_IRQHandler(); } struct dummy;
void EXTI9_5_IRQHandler(void) { EXTI_IRQHandler(); } struct dummy;
void EXTI15_10_IRQHandler(void) { EXTI_IRQHandler(); } struct dummy;
