# 1 "./src/main/drivers/camera_control.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/camera_control.c"
# 18 "./src/main/drivers/camera_control.c"
...
# 19 "./src/main/drivers/camera_control.c" 2
...
# 22 "./src/main/drivers/camera_control.h" 2
...
# 23 "./src/main/drivers/camera_control.c" 2
...
# 24 "./src/main/drivers/camera_control.c" 2
...
# 25 "./src/main/drivers/camera_control.c" 2
...
# 3 "./src/main/drivers/rcc_types.h"
...
# 50 "./src/main/drivers/camera_control.c" 2
# 60 "./src/main/drivers/camera_control.c"
...
# 61 "./src/main/drivers/camera_control.c" 2


extern const cameraControlConfig_t pgResetTemplate_cameraControlConfig; cameraControlConfig_t cameraControlConfig_System; cameraControlConfig_t cameraControlConfig_Copy; extern const pgRegistry_t cameraControlConfig_Registry; const pgRegistry_t cameraControlConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 522 | (0 << 12), .size = sizeof(cameraControlConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&cameraControlConfig_System, .copy = (uint8_t*)&cameraControlConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_cameraControlConfig}, };

const cameraControlConfig_t pgResetTemplate_cameraControlConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .mode = CAMERA_CONTROL_MODE_HARDWARE_PWM, .refVoltage = 330, .keyDelayMs = 180, .internalResistance = 470, .ioTag = 0 }
...
# 74 "./src/main/drivers/camera_control.c" 3 4
   _Bool 
# 74 "./src/main/drivers/camera_control.c"
        enabled;
    IO_t io;
    timerChannel_t channel;
    uint32_t period;
...
void TIM6_DAC_IRQHandler(void)
{
    ...
    ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00001000))->SR = 0;
}
...
void TIM7_IRQHandler(void)
{
    ...
    ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00001400))->SR = 0;
}
...
void cameraControlInit(void)
{
    ...
    if (CAMERA_CONTROL_MODE_HARDWARE_PWM == cameraControlConfig()->mode) {
        ...
        if (!timerHardware) {
            ...
            IOConfigGPIOAF(cameraControlRuntime.io, ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)), timerHardware->alternateFunction);


        pwmOutConfig(&cameraControlRuntime.channel, timerHardware, ((72) * 1000000), 128, 0, 0);

        cameraControlRuntime.period = 128;
        *cameraControlRuntime.channel.ccr = cameraControlRuntime.period;
        cameraControlRuntime.enabled = 
# 124 "./src/main/drivers/camera_control.c" 3 4
                                      1
# 124 "./src/main/drivers/camera_control.c"
                                          ;

    } else if (CAMERA_CONTROL_MODE_SOFTWARE_PWM == cameraControlConfig()->mode) {

        IOConfigGPIO(cameraControlRuntime.io, ((GPIO_Mode_OUT) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
        IOHi(cameraControlRuntime.io);

        cameraControlRuntime.period = 448;
        cameraControlRuntime.enabled = 
# 132 "./src/main/drivers/camera_control.c" 3 4
                                      1
# 132 "./src/main/drivers/camera_control.c"
                                          ;

        NVIC_InitTypeDef nvicTIM6 = {
            TIM6_DAC_IRQn, ((((((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0))>>(4-(7-(((uint32_t)0x500)>>8))))>>4), ((((((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0))&(0x0f>>(7-(((uint32_t)0x500)>>8))))>>4), ENABLE
        };
        NVIC_Init(&nvicTIM6);
        NVIC_InitTypeDef nvicTIM7 = {
            TIM7_IRQn, ((((((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0))>>(4-(7-(((uint32_t)0x500)>>8))))>>4), ((((((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0))&(0x0f>>(7-(((uint32_t)0x500)>>8))))>>4), ENABLE
        };
        NVIC_Init(&nvicTIM7);

        ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->APB1ENR |= ((uint32_t)0x00000010) | ((uint32_t)0x00000020);
        ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00001000))->PSC = 0;
        ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00001400))->PSC = 0;
    ...
    if (CAMERA_CONTROL_MODE_HARDWARE_PWM == cameraControlConfig()->mode) {
        ...
        *cameraControlRuntime.channel.ccr = lrintf(dutyCycle * cameraControlRuntime.period);
        ...
        if (0 == hiTime) {
            ...
            ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00001000))->CNT = hiTime;
            ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00001000))->ARR = cameraControlRuntime.period;

            ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00001400))->CNT = 0;
            ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00001400))->ARR = cameraControlRuntime.period;
            ...
            for ( uint8_t __basepri_save __attribute__ ((__cleanup__ (__basepriRestoreMem), __unused__)) = __get_BASEPRI(), __ToDo = __basepriSetMemRetVal((((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0)); __ToDo ; __ToDo = 0 ) {
                ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00001000))->CR1 = ((uint16_t)0x0001);
                ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00001400))->CR1 = ((uint16_t)0x0001);
            }


            ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00001000))->DIER = ((uint16_t)0x0001);
            ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00001400))->DIER = ((uint16_t)0x0001);
            ...
            ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00001000))->CR1 &= ~((uint16_t)0x0001);
            ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00001400))->CR1 &= ~((uint16_t)0x0001);
            ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00001000))->DIER = 0;
            ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00001400))->DIER = 0;
