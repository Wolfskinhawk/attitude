# 1 "./src/main/drivers/pwm_output.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/pwm_output.c"
# 18 "./src/main/drivers/pwm_output.c"
# 1 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\lib\\gcc\\arm-none-eabi\\7.2.1\\include\\stdbool.h" 1 3 4
# 19 "./src/main/drivers/pwm_output.c" 2
...
# 20 "./src/main/drivers/pwm_output.c" 2
...
# 21 "./src/main/drivers/pwm_output.c" 2
...
# 22 "./src/main/drivers/pwm_output.c" 2
...
# 24 "./src/main/drivers/pwm_output.c" 2
...
# 25 "./src/main/drivers/pwm_output.c" 2
...
# 27 "./src/main/drivers/pwm_output.c" 2
...
# 28 "./src/main/drivers/pwm_output.c" 2



static pwmWriteFn *pwmWrite;
static pwmOutputPort_t motors[8];
static pwmCompleteWriteFn *pwmCompleteWrite = 
# 33 "./src/main/drivers/pwm_output.c" 3 4
                                             ((void *)0)
# 33 "./src/main/drivers/pwm_output.c"
                                                 ;
...
static pwmOutputPort_t servos[8];
...
static 
# 48 "./src/main/drivers/pwm_output.c" 3 4
      _Bool 
# 48 "./src/main/drivers/pwm_output.c"
           pwmMotorsEnabled = 
# 48 "./src/main/drivers/pwm_output.c" 3 4
                              0
# 48 "./src/main/drivers/pwm_output.c"
                                   ;
static 
# 49 "./src/main/drivers/pwm_output.c" 3 4
      _Bool 
# 49 "./src/main/drivers/pwm_output.c"
           isDshot = 
# 49 "./src/main/drivers/pwm_output.c" 3 4
                     0
# 49 "./src/main/drivers/pwm_output.c"
...
{
# 69 "./src/main/drivers/pwm_output.c"
    TIM_OCInitTypeDef TIM_OCInitStructure;

    TIM_OCStructInit(&TIM_OCInitStructure);
    TIM_OCInitStructure.TIM_OCMode = ((uint32_t)0x00060);

    if (output & TIMER_OUTPUT_N_CHANNEL) {
        TIM_OCInitStructure.TIM_OutputNState = ((uint16_t)0x0004);
        TIM_OCInitStructure.TIM_OCNIdleState = ((uint16_t)0x0000);
        TIM_OCInitStructure.TIM_OCNPolarity = (output & TIMER_OUTPUT_INVERTED) ? ((uint16_t)0x0008) : ((uint16_t)0x0000);
    } else {
        TIM_OCInitStructure.TIM_OutputState = ((uint16_t)0x0001);
        TIM_OCInitStructure.TIM_OCIdleState = ((uint16_t)0x0100);
        TIM_OCInitStructure.TIM_OCPolarity = (output & TIMER_OUTPUT_INVERTED) ? ((uint16_t)0x0002) : ((uint16_t)0x0000);
    }
    TIM_OCInitStructure.TIM_Pulse = value;

    timerOCInit(tim, channel, &TIM_OCInitStructure);
    timerOCPreloadConfig(tim, channel, ((uint16_t)0x0008));
...
# 111 "./src/main/drivers/pwm_output.c"
...
{
    for (int i = 0; i < 16; i++) {
        dmaBuffer[i * stride] = (packet & 0x8000) ? 14 : 7;
        packet <<= 1;
    }
...
{
    for (int i = 0; i < 4; i++) {
        dmaBuffer[i * stride] = 24 + ((packet & 0xF000) >> 12) * 3;
        packet <<= 4;
    }
...
void pwmDisableMotors(void)
{
    pwmShutdownPulsesForAllMotors(8);
    pwmMotorsEnabled = 
# 179 "./src/main/drivers/pwm_output.c" 3 4
                      0
# 179 "./src/main/drivers/pwm_output.c"
                           ;
}
...
# 188 "./src/main/drivers/pwm_output.c" 3 4
_Bool 
# 188 "./src/main/drivers/pwm_output.c"
    pwmAreMotorsEnabled(void)
{
...
# 219 "./src/main/drivers/pwm_output.c" 3 4
   _Bool 
# 219 "./src/main/drivers/pwm_output.c"
    ...
    case PWM_TYPE_BRUSHED:
        sMin = 0;
        useUnsyncedPwm = 
# 239 "./src/main/drivers/pwm_output.c" 3 4
                        1
# 239 "./src/main/drivers/pwm_output.c"
                            ;
        idlePulse = 0;
        break;
    case PWM_TYPE_STANDARD:
        ...
        sLen = 1e-3f;
        useUnsyncedPwm = 
# 245 "./src/main/drivers/pwm_output.c" 3 4
                        1
# 245 "./src/main/drivers/pwm_output.c"
                            ;
        idlePulse = 0;
        break;
    ...
    case PWM_TYPE_PROSHOT1000:
        ...
        isDshot = 
# 253 "./src/main/drivers/pwm_output.c" 3 4
                 1
# 253 "./src/main/drivers/pwm_output.c"
                     ;
        break;
    ...
    case PWM_TYPE_DSHOT150:
        ...
        pwmCompleteWrite = &pwmCompleteDshotMotorUpdate;
        isDshot = 
# 262 "./src/main/drivers/pwm_output.c" 3 4
                 1
# 262 "./src/main/drivers/pwm_output.c"
                     ;
        break;
    ...
    for (int motorIndex = 0; motorIndex < 8 && motorIndex < motorCount; motorIndex++) {
        const ioTag_t tag = motorConfig->ioTags[motorIndex];
        const timerHardware_t *timerHardware = timerGetByTag(tag, TIM_USE_ANY);

        if (timerHardware == 
# 276 "./src/main/drivers/pwm_output.c" 3 4
                            ((void *)0)
# 276 "./src/main/drivers/pwm_output.c"
                                ) {
        ...
        IOInit(motors[motorIndex].io, OWNER_MOTOR, (motorIndex + 1));
        ...
        if (isDshot) {
            ...
            motors[motorIndex].enabled = 
# 293 "./src/main/drivers/pwm_output.c" 3 4
                                        1
# 293 "./src/main/drivers/pwm_output.c"
                                            ;
            continue;
        }
        ...
        IOConfigGPIO(motors[motorIndex].io, ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
        ...
        const unsigned prescaler = ((clock / pwmRateHz) + 0xffff) / 0x10000;
...
# 324 "./src/main/drivers/pwm_output.c" 3 4
       _Bool 
# 324 "./src/main/drivers/pwm_output.c"
            timerAlreadyUsed = 
# 324 "./src/main/drivers/pwm_output.c" 3 4
                               0
# 324 "./src/main/drivers/pwm_output.c"
        ...
        for (int i = 0; i < motorIndex; i++) {
            if (motors[i].channel.tim == motors[motorIndex].channel.tim) {
                timerAlreadyUsed = 
# 327 "./src/main/drivers/pwm_output.c" 3 4
                                  1
# 327 "./src/main/drivers/pwm_output.c"
                                      ;
                break;
            }
        }
        ...
        motors[motorIndex].enabled = 
# 332 "./src/main/drivers/pwm_output.c" 3 4
                                    1
# 332 "./src/main/drivers/pwm_output.c"
                                        ;
    }

    pwmMotorsEnabled = 
# 335 "./src/main/drivers/pwm_output.c" 3 4
                      1
# 335 "./src/main/drivers/pwm_output.c"
                          ;
}
...
# 343 "./src/main/drivers/pwm_output.c" 3 4
_Bool 
# 343 "./src/main/drivers/pwm_output.c"
    isMotorProtocolDshot(void)
{
    return isDshot;
}
...
# 389 "./src/main/drivers/pwm_output.c" 3 4
                                             1
# 389 "./src/main/drivers/pwm_output.c"
                                                 ;
...
uint16_t prepareDshotPacket(motorDmaOutput_t *const motor, const uint16_t value)
{
    ...
    motor->requestTelemetry = 
# 403 "./src/main/drivers/pwm_output.c" 3 4
                             0
# 403 "./src/main/drivers/pwm_output.c"
                                  ;
...
void pwmWriteServo(uint8_t index, float value)
{
    if (index < 8 && servos[index].channel.ccr) {
...
{
    for (uint8_t servoIndex = 0; servoIndex < 8; servoIndex++) {
        ...
        IOInit(servos[servoIndex].io, OWNER_SERVO, (servoIndex + 1));

        const timerHardware_t *timer = timerGetByTag(tag, TIM_USE_ANY);



        IOConfigGPIO(servos[servoIndex].io, ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)));


        if (timer == 
# 448 "./src/main/drivers/pwm_output.c" 3 4
                    ((void *)0)
# 448 "./src/main/drivers/pwm_output.c"
                        ) {

            break;
        }
        pwmOutConfig(&servos[servoIndex].channel, timer, ((1) * 1000000), ((1) * 1000000) / servoConfig->servoPwmRate, servoConfig->servoCenterPulse, 0);
        servos[servoIndex].enabled = 
# 453 "./src/main/drivers/pwm_output.c" 3 4
                                    1
# 453 "./src/main/drivers/pwm_output.c"
                                        ;
    }
}
...
void pwmWriteBeeper(
# 460 "./src/main/drivers/pwm_output.c" 3 4
                   _Bool 
# 460 "./src/main/drivers/pwm_output.c"
                        onoffBeep)
{
        if (!beeperPwm.io)
            return;
        if (onoffBeep == 
# 464 "./src/main/drivers/pwm_output.c" 3 4
                        1
# 464 "./src/main/drivers/pwm_output.c"
                            ) {
            *beeperPwm.channel.ccr = (((1) * 1000000) / freqBeep) / 2;
            beeperPwm.enabled = 
# 466 "./src/main/drivers/pwm_output.c" 3 4
                               1
# 466 "./src/main/drivers/pwm_output.c"
                                   ;
        } else {
            *beeperPwm.channel.ccr = 0;
            beeperPwm.enabled = 
# 469 "./src/main/drivers/pwm_output.c" 3 4
                               0
# 469 "./src/main/drivers/pwm_output.c"
                                    ;
        }
}
...
void beeperPwmInit(const ioTag_t tag, uint16_t frequency)
{
        ...
        if (beeperPwm.io && timer) {
            IOInit(beeperPwm.io, OWNER_BEEPER, (0 + 1));



            IOConfigGPIO(beeperPwm.io, ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)));

            freqBeep = frequency;
            pwmOutConfig(&beeperPwm.channel, timer, ((1) * 1000000), ((1) * 1000000) / freqBeep, (((1) * 1000000) / freqBeep) / 2, 0);
        }
        *beeperPwm.channel.ccr = 0;
        beeperPwm.enabled = 
# 493 "./src/main/drivers/pwm_output.c" 3 4
                           0
# 493 "./src/main/drivers/pwm_output.c"
                                ;
}
