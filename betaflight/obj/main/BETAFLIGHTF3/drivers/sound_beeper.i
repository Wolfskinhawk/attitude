# 1 "./src/main/drivers/sound_beeper.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/sound_beeper.c"
# 18 "./src/main/drivers/sound_beeper.c"
# 1 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\lib\\gcc\\arm-none-eabi\\7.2.1\\include\\stdbool.h" 1 3 4
# 19 "./src/main/drivers/sound_beeper.c" 2
...
# 20 "./src/main/drivers/sound_beeper.c" 2
...
# 22 "./src/main/drivers/sound_beeper.c" 2
...
# 24 "./src/main/drivers/sound_beeper.c" 2
...
# 25 "./src/main/drivers/sound_beeper.c" 2
...
# 27 "./src/main/drivers/sound_beeper.c" 2
...
# 29 "./src/main/drivers/sound_beeper.c" 2


static IO_t beeperIO = (IO_t)
# 31 "./src/main/drivers/sound_beeper.c" 3 4
                      ((void *)0)
# 31 "./src/main/drivers/sound_beeper.c"
                                    ;
static 
# 32 "./src/main/drivers/sound_beeper.c" 3 4
      _Bool 
# 32 "./src/main/drivers/sound_beeper.c"
           beeperInverted = 
# 32 "./src/main/drivers/sound_beeper.c" 3 4
                            0
# 32 "./src/main/drivers/sound_beeper.c"
...
void systemBeep(
# 36 "./src/main/drivers/sound_beeper.c" 3 4
               _Bool 
# 36 "./src/main/drivers/sound_beeper.c"
                    onoff)
{
...
void beeperInit(const beeperDevConfig_t *config)
{
    ...
    if (beeperFrequency == 0) {
        ...
        if (beeperIO) {
            ...
            IOConfigGPIO(beeperIO, config->isOpenDrain ? ((GPIO_Mode_OUT) | ((0) << 2) | ((GPIO_OType_OD) << 4) | ((GPIO_PuPd_NOPULL) << 5)) : ((GPIO_Mode_OUT) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
        }
        systemBeep(
# 71 "./src/main/drivers/sound_beeper.c" 3 4
                  0
# 71 "./src/main/drivers/sound_beeper.c"
                       );
    } else {
