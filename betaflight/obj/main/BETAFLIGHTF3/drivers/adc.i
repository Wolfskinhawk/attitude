...
ADCDevice adcDeviceByInstance(ADC_TypeDef *instance)
{
    if (instance == ((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x0000))) {
        return ADCDEV_1;
    }


    if (instance == ((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x0100))) {
        return ADCDEV_2;
    }

    if (instance == ((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x0400))) {
        return ADCDEV_3;
    }



    if (instance == ((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x0500))) {
        return ADCDEV_4;
    }
...
# 103 "./src/main/drivers/adc.c" 3 4
_Bool 
# 103 "./src/main/drivers/adc.c"
    adcVerifyPin(ioTag_t tag, ADCDevice device)
{
    if (!tag) {
        return 
# 106 "./src/main/drivers/adc.c" 3 4
              0
# 106 "./src/main/drivers/adc.c"
                   ;
    }

    for (int map = 0 ; map < 39 ; map++) {
        ...
        if ((adcTagMap[map].tag == tag) && (adcTagMap[map].devices & (1 << device))) {
            return 
# 117 "./src/main/drivers/adc.c" 3 4
                  1
# 117 "./src/main/drivers/adc.c"
                      ;
        }
    ...
    return 
# 122 "./src/main/drivers/adc.c" 3 4
          0
# 122 "./src/main/drivers/adc.c"
               ;
}
