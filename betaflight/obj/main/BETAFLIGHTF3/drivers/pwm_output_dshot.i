...
# 19 "./src/main/drivers/pwm_output_dshot.c" 2
...
# 20 "./src/main/drivers/pwm_output_dshot.c" 2
...
# 28 "./src/main/drivers/pwm_output_dshot.c" 2
...
# 29 "./src/main/drivers/pwm_output_dshot.c" 2
...
# 38 "./src/main/drivers/pwm_output_dshot.c" 2

static uint8_t dmaMotorTimerCount = 0;
static motorDmaTimer_t dmaMotorTimers[8];
static motorDmaOutput_t dmaMotors[8];
...
{
    if ((descriptor->dma->ISR & (((uint32_t)0x00000002) << descriptor->flagsShift))) {
        ...
        descriptor->dma->IFCR = (((uint32_t)0x00000002) << descriptor->flagsShift);
    }
}
...
void pwmDshotMotorHardwareConfig(const timerHardware_t *timerHardware, uint8_t motorIndex, motorPwmProtocolTypes_e pwmProtocolType, uint8_t output)
{
    ...
    if (dmaRef == 
# 134 "./src/main/drivers/pwm_output_dshot.c" 3 4
                 ((void *)0)
# 134 "./src/main/drivers/pwm_output_dshot.c"
                     ) {
        return;
    }
    ...
    const 
# 148 "./src/main/drivers/pwm_output_dshot.c" 3 4
         _Bool 
# 148 "./src/main/drivers/pwm_output_dshot.c"
              configureTimer = (timerIndex == dmaMotorTimerCount-1);

    IOConfigGPIOAF(motorIO, ((GPIO_Mode_AF) | ((GPIO_Speed_Level_3) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_UP) << 5)), timerHardware->alternateFunction);
    ...
    if (configureTimer) {
        ...
        TIM_TimeBaseStructure.TIM_Period = pwmProtocolType == PWM_TYPE_PROSHOT1000 ? 96 : 19;
    ...
    dmaSetHandler(timerHardware->dmaTimUPIrqHandler, motor_DMA_IRQHandler, (((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((2)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0), motorIndex);


    DMA_InitStructure.DMA_MemoryBaseAddr = (uint32_t)motor->timer->dmaBurstBuffer;
    DMA_InitStructure.DMA_DIR = ((uint32_t)0x00000010);
# 228 "./src/main/drivers/pwm_output_dshot.c"
    DMA_InitStructure.DMA_PeripheralBaseAddr = (uint32_t)&timerHardware->tim->DMAR;
    DMA_InitStructure.DMA_BufferSize = (pwmProtocolType == PWM_TYPE_PROSHOT1000) ? 6 : 18;
...
# 266 "./src/main/drivers/pwm_output_dshot.c"
    DMA_Init(dmaRef, &DMA_InitStructure);
    DMA_ITConfig(dmaRef, ((uint32_t)0x00000002), ENABLE);
}
