# 1 "./src/main/drivers/serial_uart.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/serial_uart.c"
# 25 "./src/main/drivers/serial_uart.c"
# 1 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\lib\\gcc\\arm-none-eabi\\7.2.1\\include\\stdbool.h" 1 3 4
# 26 "./src/main/drivers/serial_uart.c" 2
...
# 27 "./src/main/drivers/serial_uart.c" 2
...
# 29 "./src/main/drivers/serial_uart.c" 2

# 1 "./src/main/build/build_config.h" 1
# 18 "./src/main/build/build_config.h"
       
# 31 "./src/main/drivers/serial_uart.c" 2
...
# 32 "./src/main/drivers/serial_uart.c" 2
...
# 36 "./src/main/drivers/serial_uart.c" 2
...
# 28 "./src/main/drivers/inverter.h"
                                               on);
# 37 "./src/main/drivers/serial_uart.c" 2
# 1 "./src/main/drivers/nvic.h" 1

       
# 38 "./src/main/drivers/serial_uart.c" 2
...
# 39 "./src/main/drivers/serial_uart.c" 2
...
# 42 "./src/main/drivers/serial_uart.c" 2
...
# 43 "./src/main/drivers/serial_uart.c" 2
...
# 103 "./src/main/drivers/serial_uart.c"
        ...
        if (s->port.txBufferHead == s->port.txBufferTail) {
            ...
            s->txDMAEmpty = 
# 119 "./src/main/drivers/serial_uart.c" 3 4
                           1
# 119 "./src/main/drivers/serial_uart.c"
                               ;
            return;
        }
        ...
        s->txDMAEmpty = 
# 133 "./src/main/drivers/serial_uart.c" 3 4
                       0
# 133 "./src/main/drivers/serial_uart.c"
                            ;
...
# 185 "./src/main/drivers/serial_uart.c"
    if (s->txDMAChannel) {
...
# 200 "./src/main/drivers/serial_uart.c"
...
static 
# 208 "./src/main/drivers/serial_uart.c" 3 4
      _Bool 
# 208 "./src/main/drivers/serial_uart.c"
...
const struct serialPortVTable uartVTable[] = {
    {
        ...
        .setMode = uartSetMode,
        .writeBuf = 
# 277 "./src/main/drivers/serial_uart.c" 3 4
                   ((void *)0)
# 277 "./src/main/drivers/serial_uart.c"
                       ,
        .beginWrite = 
# 278 "./src/main/drivers/serial_uart.c" 3 4
                     ((void *)0)
# 278 "./src/main/drivers/serial_uart.c"
                         ,
        .endWrite = 
# 279 "./src/main/drivers/serial_uart.c" 3 4
                   ((void *)0)
# 279 "./src/main/drivers/serial_uart.c"
                       ,
    }
};
