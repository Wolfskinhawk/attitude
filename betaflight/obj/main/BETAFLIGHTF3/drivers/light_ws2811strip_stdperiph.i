# 1 "./src/main/drivers/light_ws2811strip_stdperiph.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/light_ws2811strip_stdperiph.c"
# 18 "./src/main/drivers/light_ws2811strip_stdperiph.c"
# 1 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\lib\\gcc\\arm-none-eabi\\7.2.1\\include\\stdbool.h" 1 3 4
# 19 "./src/main/drivers/light_ws2811strip_stdperiph.c" 2
...
# 20 "./src/main/drivers/light_ws2811strip_stdperiph.c" 2
...
# 22 "./src/main/drivers/light_ws2811strip_stdperiph.c" 2
...
# 26 "./src/main/drivers/light_ws2811strip_stdperiph.c" 2
...
# 28 "./src/main/drivers/light_ws2811strip_stdperiph.c" 2
# 1 "./src/main/drivers/nvic.h" 1

       
# 29 "./src/main/drivers/light_ws2811strip_stdperiph.c" 2
...
# 31 "./src/main/drivers/light_ws2811strip_stdperiph.c" 2
...
# 32 "./src/main/drivers/light_ws2811strip_stdperiph.c" 2
...
# 33 "./src/main/drivers/light_ws2811strip_stdperiph.c" 2
...
# 34 "./src/main/drivers/light_ws2811strip_stdperiph.c" 2
...
# 35 "./src/main/drivers/light_ws2811strip_stdperiph.c" 2

static IO_t ws2811IO = ((IO_t)0);

# 37 "./src/main/drivers/light_ws2811strip_stdperiph.c" 3 4
_Bool 
# 37 "./src/main/drivers/light_ws2811strip_stdperiph.c"
    ws2811Initialised = 
# 37 "./src/main/drivers/light_ws2811strip_stdperiph.c" 3 4
                        0
# 37 "./src/main/drivers/light_ws2811strip_stdperiph.c"
...
static DMA_Channel_TypeDef *dmaRef = 
# 41 "./src/main/drivers/light_ws2811strip_stdperiph.c" 3 4
                                    ((void *)0)
# 41 "./src/main/drivers/light_ws2811strip_stdperiph.c"
                                        ;



static TIM_TypeDef *timer = 
# 45 "./src/main/drivers/light_ws2811strip_stdperiph.c" 3 4
                           ((void *)0)
# 45 "./src/main/drivers/light_ws2811strip_stdperiph.c"
                               ;
...
void ws2811LedStripHardwareInit(ioTag_t ioTag)
{
    ...
    if (timerHardware->dmaRef == 
# 69 "./src/main/drivers/light_ws2811strip_stdperiph.c" 3 4
                                ((void *)0)
# 69 "./src/main/drivers/light_ws2811strip_stdperiph.c"
                                    ) {
        return;
    }
    ...
    IOConfigGPIOAF(ws2811IO, ((GPIO_Mode_AF) | ((GPIO_Speed_Level_3) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_UP) << 5)), timerHardware->alternateFunction);
    ...
    uint16_t prescaler = timerGetPrescalerByDesiredMhz(timer, 48);
    uint16_t period = timerGetPeriodByPrescaler(timer, prescaler, 800000);
    ...
    if (timerHardware->output & TIMER_OUTPUT_N_CHANNEL) {
        ...
        TIM_OCInitStructure.TIM_OCNPolarity = (timerHardware->output & TIMER_OUTPUT_INVERTED) ? ((uint16_t)0x0008) : ((uint16_t)0x0000);
    } else {
        TIM_OCInitStructure.TIM_OutputState = ((uint16_t)0x0001);
        TIM_OCInitStructure.TIM_OCIdleState = ((uint16_t)0x0100);
        TIM_OCInitStructure.TIM_OCPolarity = (timerHardware->output & TIMER_OUTPUT_INVERTED) ? ((uint16_t)0x0002) : ((uint16_t)0x0000);
    }
    ...
    dmaSetHandler(timerHardware->dmaIrqHandler, WS2811_DMA_IRQHandler, (((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((2)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0), 0);
...
# 154 "./src/main/drivers/light_ws2811strip_stdperiph.c"
    ...
    ws2811Initialised = 
# 166 "./src/main/drivers/light_ws2811strip_stdperiph.c" 3 4
                       1
# 166 "./src/main/drivers/light_ws2811strip_stdperiph.c"
                           ;
}
...
void ws2811LedStripDMAEnable(void)
{
    ...
    DMA_SetCurrDataCounter(dmaRef, ((24 * 32) + 42));
