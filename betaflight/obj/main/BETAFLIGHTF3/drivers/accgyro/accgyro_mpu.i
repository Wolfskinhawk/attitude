# 1 "./src/main/drivers/accgyro/accgyro_mpu.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/accgyro/accgyro_mpu.c"
# 18 "./src/main/drivers/accgyro/accgyro_mpu.c"
# 1 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\lib\\gcc\\arm-none-eabi\\7.2.1\\include\\stdbool.h" 1 3 4
# 19 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 20 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 21 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 22 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 24 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 26 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
# 1 "./src/main/build/build_config.h" 1
# 18 "./src/main/build/build_config.h"
       
# 27 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 28 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 30 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 33 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 26 "./src/main/drivers/bus_spi.h" 2
...
# 35 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 41 "./src/main/drivers/exti.h"
                             enable);
# 36 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 37 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
# 1 "./src/main/drivers/nvic.h" 1

       
# 38 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 39 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 40 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 41 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 43 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 44 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 45 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 46 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 47 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 48 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 49 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 50 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 51 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 52 "./src/main/drivers/accgyro/accgyro_mpu.c" 2



mpuResetFnPtr mpuResetFn;
# 107 "./src/main/drivers/accgyro/accgyro_mpu.c"
static void mpuIntExtiHandler(extiCallbackRec_t *cb)
{
    ...
    gyroDev_t *gyro = ( __extension__ ({ const typeof( ((gyroDev_t *)0)->exti ) *__mptr = (cb); (gyroDev_t *)( (char *)__mptr - 
# 115 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
                     __builtin_offsetof (
# 115 "./src/main/drivers/accgyro/accgyro_mpu.c"
                     gyroDev_t
# 115 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
                     , 
# 115 "./src/main/drivers/accgyro/accgyro_mpu.c"
...
# 115 "./src/main/drivers/accgyro/accgyro_mpu.c"
    ...
    gyro->dataReady = 
# 116 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
                     1
# 116 "./src/main/drivers/accgyro/accgyro_mpu.c"
                         ;
...
{
    if (gyro->mpuIntExtiTag == 0) {
        return;
    }

    const IO_t mpuIntIO = IOGetByTag(gyro->mpuIntExtiTag);
# 144 "./src/main/drivers/accgyro/accgyro_mpu.c"
    IOInit(mpuIntIO, OWNER_MPU_EXTI, 0);
    IOConfigGPIO(mpuIntIO, ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_NOPULL) << 5)));

    EXTIHandlerInit(&gyro->exti, mpuIntExtiHandler);
    EXTIConfig(mpuIntIO, &gyro->exti, (((((0x0f)<<(4-(7-(((uint32_t)0x500)>>8))))|((0x0f)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0), EXTI_Trigger_Rising);
    EXTIEnable(mpuIntIO, 
# 149 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
                        1
# 149 "./src/main/drivers/accgyro/accgyro_mpu.c"
                            );
...
# 154 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
_Bool 
# 154 "./src/main/drivers/accgyro/accgyro_mpu.c"
    mpuAccRead(accDev_t *acc)
{
    uint8_t data[6];

    const 
# 158 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
         _Bool 
# 158 "./src/main/drivers/accgyro/accgyro_mpu.c"
              ack = busReadRegisterBuffer(&acc->bus, 0x3B, data, 6);
    if (!ack) {
        return 
# 160 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
              0
# 160 "./src/main/drivers/accgyro/accgyro_mpu.c"
                   ;
    }
    ...
    return 
# 167 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
          1
# 167 "./src/main/drivers/accgyro/accgyro_mpu.c"
              ;
}


# 170 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
_Bool 
# 170 "./src/main/drivers/accgyro/accgyro_mpu.c"
    mpuGyroRead(gyroDev_t *gyro)
{
    uint8_t data[6];

    const 
# 174 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
         _Bool 
# 174 "./src/main/drivers/accgyro/accgyro_mpu.c"
              ack = busReadRegisterBuffer(&gyro->bus, 0x43, data, 6);
    if (!ack) {
        return 
# 176 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
              0
# 176 "./src/main/drivers/accgyro/accgyro_mpu.c"
                   ;
    }
    ...
    return 
# 183 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
          1
# 183 "./src/main/drivers/accgyro/accgyro_mpu.c"
              ;
}
...
gyroOverflow_e mpuGyroCheckOverflow(const gyroDev_t *gyro)
{
    ...
    const int16_t overflowValue = 0x7C00;
...
# 203 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
_Bool 
# 203 "./src/main/drivers/accgyro/accgyro_mpu.c"
    mpuGyroReadSPI(gyroDev_t *gyro)
{
    static const uint8_t dataToSend[7] = {0x43 | 0x80, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF};
    uint8_t data[7];

    const 
# 208 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
         _Bool 
# 208 "./src/main/drivers/accgyro/accgyro_mpu.c"
              ack = spiBusTransfer(&gyro->bus, dataToSend, data, 7);
    if (!ack) {
        return 
# 210 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
              0
# 210 "./src/main/drivers/accgyro/accgyro_mpu.c"
                   ;
    }
    ...
    return 
# 217 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
          1
# 217 "./src/main/drivers/accgyro/accgyro_mpu.c"
              ;
}


static 
# 221 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
      _Bool 
# 221 "./src/main/drivers/accgyro/accgyro_mpu.c"
           detectSPISensorsAndUpdateDetectionResult(gyroDev_t *gyro)
{
    (void)(gyro);
    ...
    spiBusSetInstance(&gyro->bus, ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00003000)));


    gyro->bus.busdev_u.spi.csnPin = gyro->bus.busdev_u.spi.csnPin == ((IO_t)0) ? IOGetByTag(((ioTag_t)((((0) + 1) << 4) | (15)))) : gyro->bus.busdev_u.spi.csnPin;

    sensor = mpu6000SpiDetect(&gyro->bus);
    if (sensor != MPU_NONE) {
        gyro->mpuDetectionResult.sensor = sensor;
        return 
# 238 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
              1
# 238 "./src/main/drivers/accgyro/accgyro_mpu.c"
                  ;
    }
# 314 "./src/main/drivers/accgyro/accgyro_mpu.c"
    return 
# 314 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
          0
# 314 "./src/main/drivers/accgyro/accgyro_mpu.c"
               ;
}
...
void mpuDetect(gyroDev_t *gyro)
{
    ...
    delay(35);
# 330 "./src/main/drivers/accgyro/accgyro_mpu.c"
    
# 330 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
   _Bool 
# 330 "./src/main/drivers/accgyro/accgyro_mpu.c"
        ack = 
# 330 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
...
# 358 "./src/main/drivers/accgyro/accgyro_mpu.c"
}
