# 1 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c"
# 25 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c"
# 1 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\lib\\gcc\\arm-none-eabi\\7.2.1\\include\\stdbool.h" 1 3 4
# 26 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c" 2
...
# 27 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c" 2
...
# 29 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c" 2
...
# 33 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c" 2
...
# 34 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c" 2
...
# 36 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c" 2
...
# 38 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c" 2
...
# 39 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c" 2
...
# 41 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c" 2
...
# 42 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c" 2
...
# 44 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c" 2


static void mpu6000AccAndGyroInit(gyroDev_t *gyro);

static 
# 48 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c" 3 4
      _Bool 
# 48 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c"
           mpuSpi6000InitDone = 
# 48 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c" 3 4
                                0
# 48 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c"
                                     ;
# 100 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c"
void mpu6000SpiGyroInit(gyroDev_t *gyro)
{
    ...
    spiBusWriteRegister(&gyro->bus, 0x1A, gyro->lpf);
    delayMicroseconds(1);
...
uint8_t mpu6000SpiDetect(const busDevice_t *bus)
{
    ...
    IOConfigGPIO(bus->busdev_u.spi.csnPin, ((GPIO_Mode_OUT) | ((GPIO_Speed_Level_3) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
    IOHi(bus->busdev_u.spi.csnPin);

    spiSetDivisor(bus->busdev_u.spi.instance, SPI_CLOCK_INITIALIZATON);

    spiBusWriteRegister(bus, 0x6B, 0x80);

    uint8_t attemptsRemaining = 5;
    do {
        delay(150);

        const uint8_t whoAmI = spiBusReadRegister(bus, 0x75);
        if (whoAmI == (0x68)) {
            break;
        }
    ...
    const uint8_t productID = spiBusReadRegister(bus, 0x0C);
...
static void mpu6000AccAndGyroInit(gyroDev_t *gyro)
{
    ...
    spiBusWriteRegister(&gyro->bus, 0x6B, 0x80);
    delay(150);

    spiBusWriteRegister(&gyro->bus, 0x68, 3 | 2 | 1);
    delay(150);


    spiBusWriteRegister(&gyro->bus, 0x6B, 0x03);
    delayMicroseconds(15);


    spiBusWriteRegister(&gyro->bus, 0x6A, 0x10);
    delayMicroseconds(15);

    spiBusWriteRegister(&gyro->bus, 0x6C, 0x00);
    delayMicroseconds(15);



    spiBusWriteRegister(&gyro->bus, 0x19, gyro->mpuDividerDrops);
    delayMicroseconds(15);


    spiBusWriteRegister(&gyro->bus, 0x1B, INV_FSR_2000DPS << 3);
    delayMicroseconds(15);


    spiBusWriteRegister(&gyro->bus, 0x1C, INV_FSR_8G << 3);
    delayMicroseconds(15);

    spiBusWriteRegister(&gyro->bus, 0x37, 0 << 7 | 0 << 6 | 0 << 5 | 1 << 4 | 0 << 3 | 0 << 2 | 0 << 1 | 0 << 0);
    delayMicroseconds(15);


    spiBusWriteRegister(&gyro->bus, 0x38, (1 << 0));
    delayMicroseconds(15);
    ...
    mpuSpi6000InitDone = 
# 223 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c" 3 4
                        1
# 223 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c"
                            ;
}


# 226 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c" 3 4
_Bool 
# 226 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c"
    mpu6000SpiAccDetect(accDev_t *acc)
{
    if (acc->mpuDetectionResult.sensor != MPU_60x0_SPI) {
        return 
# 229 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c" 3 4
              0
# 229 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c"
                   ;
    }
    ...
    return 
# 235 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c" 3 4
          1
# 235 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c"
              ;
}


# 238 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c" 3 4
_Bool 
# 238 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c"
    mpu6000SpiGyroDetect(gyroDev_t *gyro)
{
    if (gyro->mpuDetectionResult.sensor != MPU_60x0_SPI) {
        return 
# 241 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c" 3 4
              0
# 241 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c"
                   ;
    }
    ...
    return 
# 249 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c" 3 4
          1
# 249 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c"
              ;
}
