# 1 "./src/main/drivers/serial_softserial.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/serial_softserial.c"
# 23 "./src/main/drivers/serial_softserial.c"
# 1 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\lib\\gcc\\arm-none-eabi\\7.2.1\\include\\stdbool.h" 1 3 4
# 24 "./src/main/drivers/serial_softserial.c" 2
...
# 25 "./src/main/drivers/serial_softserial.c" 2
...
# 27 "./src/main/drivers/serial_softserial.c" 2
...
# 31 "./src/main/drivers/serial_softserial.c" 2
...
# 32 "./src/main/drivers/serial_softserial.c" 2
...
# 34 "./src/main/drivers/serial_softserial.c" 2
...
# 38 "./src/main/drivers/serial_softserial.c" 2
...
# 39 "./src/main/drivers/serial_softserial.c" 2
...
# 40 "./src/main/drivers/serial_softserial.c" 2
...
# 42 "./src/main/drivers/serial_softserial.c" 2
...
# 43 "./src/main/drivers/serial_softserial.c" 2
...
# 45 "./src/main/drivers/serial_softserial.c" 2
# 55 "./src/main/drivers/serial_softserial.c"
typedef enum {
    TIMER_MODE_SINGLE,
    TIMER_MODE_DUAL,
} timerMode_e;
...
static softSerial_t softSerialPorts[2];
...
static void serialEnableCC(softSerial_t *softSerial)
{
    ...
    TIM_CCxCmd(softSerial->timerHardware->tim, softSerial->timerHardware->channel, ((uint16_t)0x0001));
...
static void serialInputPortActivate(softSerial_t *softSerial)
{
    if (softSerial->port.options & SERIAL_INVERTED) {
        ...
        IOConfigGPIOAF(softSerial->rxIO, ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_DOWN) << 5)), softSerial->timerHardware->alternateFunction);

    } else {



        IOConfigGPIOAF(softSerial->rxIO, ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_UP) << 5)), softSerial->timerHardware->alternateFunction);

    }

    softSerial->rxActive = 
# 145 "./src/main/drivers/serial_softserial.c" 3 4
                          1
# 145 "./src/main/drivers/serial_softserial.c"
                              ;
    softSerial->isSearchingForStartBit = 
# 146 "./src/main/drivers/serial_softserial.c" 3 4
                                        1
# 146 "./src/main/drivers/serial_softserial.c"
                                            ;
...
static void serialInputPortDeActivate(softSerial_t *softSerial)
{
    ...
    TIM_CCxCmd(softSerial->timerHardware->tim, softSerial->timerHardware->channel, ((uint16_t)0x0000));


    IOConfigGPIO(softSerial->rxIO, ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
    softSerial->rxActive = 
# 165 "./src/main/drivers/serial_softserial.c" 3 4
                          0
# 165 "./src/main/drivers/serial_softserial.c"
                               ;
}
...
static void serialOutputPortActivate(softSerial_t *softSerial)
{
    ...
    if (softSerial->exTimerHardware)
        IOConfigGPIOAF(softSerial->txIO, ((GPIO_Mode_OUT) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)), softSerial->exTimerHardware->alternateFunction);
    else
        IOConfigGPIO(softSerial->txIO, ((GPIO_Mode_OUT) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
...
static void serialOutputPortDeActivate(softSerial_t *softSerial)
{
    ...
    if (softSerial->exTimerHardware)
        IOConfigGPIOAF(softSerial->txIO, ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_NOPULL) << 5)), softSerial->exTimerHardware->alternateFunction);
    else
        IOConfigGPIO(softSerial->txIO, ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_NOPULL) << 5)));

}

static 
# 192 "./src/main/drivers/serial_softserial.c" 3 4
      _Bool 
# 192 "./src/main/drivers/serial_softserial.c"
...
serialPort_t *openSoftSerial(softSerialPortIndex_e portIndex, serialReceiveCallbackPtr rxCallback, void *rxCallbackData, uint32_t baud, portMode_e mode, portOptions_e options)
{
    ...
    if (options & SERIAL_BIDIR) {
        ...
        if (!timerTx || (timerTx->output & TIMER_OUTPUT_N_CHANNEL)) {
            return 
# 251 "./src/main/drivers/serial_softserial.c" 3 4
                  ((void *)0)
# 251 "./src/main/drivers/serial_softserial.c"
                      ;
        }
        ...
        IOInit(txIO, OWNER_SERIAL_TX, (portIndex + 10 + 1));
    } else {
        if (mode & MODE_RX) {

            if (!timerRx || (timerRx->output & TIMER_OUTPUT_N_CHANNEL)) {
                return 
# 262 "./src/main/drivers/serial_softserial.c" 3 4
                      ((void *)0)
# 262 "./src/main/drivers/serial_softserial.c"
                          ;
            }

            softSerial->rxIO = rxIO;
            softSerial->timerHardware = timerRx;
            IOInit(rxIO, OWNER_SERIAL_RX, (portIndex + 10 + 1));
        }
        ...
        if (mode & MODE_TX) {
            ...
            if (!tagTx)
                return 
# 273 "./src/main/drivers/serial_softserial.c" 3 4
                      ((void *)0)
# 273 "./src/main/drivers/serial_softserial.c"
                          ;
            ...
            if (!(mode & MODE_RX)) {
                ...
                if (!timerTx)
                    return 
# 280 "./src/main/drivers/serial_softserial.c" 3 4
                          ((void *)0)
# 280 "./src/main/drivers/serial_softserial.c"
                              ;
                softSerial->timerHardware = timerTx;
            } else {
    ...
    softSerial->rxActive = 
# 304 "./src/main/drivers/serial_softserial.c" 3 4
                          0
# 304 "./src/main/drivers/serial_softserial.c"
                               ;
    softSerial->isTransmittingData = 
# 305 "./src/main/drivers/serial_softserial.c" 3 4
                                    0
# 305 "./src/main/drivers/serial_softserial.c"
                                         ;



    serialTimerConfigureTimebase(softSerial->timerHardware, baud);
    timerChConfigIC(softSerial->timerHardware, (options & SERIAL_INVERTED) ? 
# 310 "./src/main/drivers/serial_softserial.c" 3 4
                                                                            1 
# 310 "./src/main/drivers/serial_softserial.c"
                                                                                              : 
# 310 "./src/main/drivers/serial_softserial.c" 3 4
                                                                                                0
# 310 "./src/main/drivers/serial_softserial.c"
...
# 324 "./src/main/drivers/serial_softserial.c" 3 4
                                                           ((void *)0)
# 324 "./src/main/drivers/serial_softserial.c"
                                                               , &softSerial->overCb);
        timerChConfigCallbacks(softSerial->timerHardware, &softSerial->edgeCb, 
# 325 "./src/main/drivers/serial_softserial.c" 3 4
                                                                              ((void *)0)
# 325 "./src/main/drivers/serial_softserial.c"
                                                                                  );
    } else {
...
void processTxState(softSerial_t *softSerial)
{
    ...
    if (!softSerial->isTransmittingData) {
        ...
        softSerial->internalTxBuffer = (1 << (10 - 1)) | (byteToSend << 1);
        softSerial->bitsLeftToTransmit = 10;
        softSerial->isTransmittingData = 
# 374 "./src/main/drivers/serial_softserial.c" 3 4
                                        1
# 374 "./src/main/drivers/serial_softserial.c"
                                            ;
    ...
    softSerial->isTransmittingData = 
# 399 "./src/main/drivers/serial_softserial.c" 3 4
                                    0
# 399 "./src/main/drivers/serial_softserial.c"
                                         ;
}
...
void prepareForNextRxByte(softSerial_t *softSerial)
{
    ...
    softSerial->rxBitIndex = 0;
    softSerial->isSearchingForStartBit = 
# 421 "./src/main/drivers/serial_softserial.c" 3 4
                                        1
# 421 "./src/main/drivers/serial_softserial.c"
                                            ;
    if (softSerial->rxEdge == LEADING) {
        softSerial->rxEdge = TRAILING;
        timerChConfigIC(softSerial->timerHardware, (softSerial->port.options & SERIAL_INVERTED) ? 
# 424 "./src/main/drivers/serial_softserial.c" 3 4
                                                                                                 1 
# 424 "./src/main/drivers/serial_softserial.c"
                                                                                                                   : 
# 424 "./src/main/drivers/serial_softserial.c" 3 4
                                                                                                                     0
# 424 "./src/main/drivers/serial_softserial.c"
...
void extractAndStoreRxByte(softSerial_t *softSerial)
{
    ...
    uint8_t haveStartBit = (softSerial->internalRxBuffer & (1 << (10 - 1))) == 0;
    uint8_t haveStopBit = (softSerial->internalRxBuffer & (1 << 0)) == 1;
...
void processRxState(softSerial_t *softSerial)
{
    ...
    if (softSerial->rxBitIndex == 10 - 1) {
        applyChangedBits(softSerial);
        return;
    }

    if (softSerial->rxBitIndex == 10) {

        if (softSerial->rxEdge == TRAILING) {
            softSerial->internalRxBuffer |= (1 << 0);
        }
...
{
    (void)(capture);
    softSerial_t *self = ( __extension__ ({ const typeof( ((softSerial_t *)0)->overCb ) *__mptr = (cbRec); (softSerial_t *)( (char *)__mptr - 
# 483 "./src/main/drivers/serial_softserial.c" 3 4
                        __builtin_offsetof (
# 483 "./src/main/drivers/serial_softserial.c"
                        softSerial_t
# 483 "./src/main/drivers/serial_softserial.c" 3 4
                        , 
# 483 "./src/main/drivers/serial_softserial.c"
...
void onSerialRxPinChange(timerCCHandlerRec_t *cbRec, captureCompare_t capture)
{
    ...
    softSerial_t *self = ( __extension__ ({ const typeof( ((softSerial_t *)0)->edgeCb ) *__mptr = (cbRec); (softSerial_t *)( (char *)__mptr - 
# 496 "./src/main/drivers/serial_softserial.c" 3 4
                        __builtin_offsetof (
# 496 "./src/main/drivers/serial_softserial.c"
                        softSerial_t
# 496 "./src/main/drivers/serial_softserial.c" 3 4
                        , 
# 496 "./src/main/drivers/serial_softserial.c"
...
# 497 "./src/main/drivers/serial_softserial.c" 3 4
   _Bool 
# 497 "./src/main/drivers/serial_softserial.c"
        inverted = self->port.options & SERIAL_INVERTED;
    ...
    if (self->isSearchingForStartBit) {
        ...
        timerChConfigIC(self->timerHardware, inverted ? 
# 522 "./src/main/drivers/serial_softserial.c" 3 4
                                                       0 
# 522 "./src/main/drivers/serial_softserial.c"
                                                                          : 
# 522 "./src/main/drivers/serial_softserial.c" 3 4
                                                                            1
# 522 "./src/main/drivers/serial_softserial.c"
...
# 531 "./src/main/drivers/serial_softserial.c" 3 4
                                      0
# 531 "./src/main/drivers/serial_softserial.c"
                                           ;
        return;
    }
    ...
    if (self->rxEdge == TRAILING) {
        self->rxEdge = LEADING;
        timerChConfigIC(self->timerHardware, inverted ? 
# 543 "./src/main/drivers/serial_softserial.c" 3 4
                                                       0 
# 543 "./src/main/drivers/serial_softserial.c"
                                                                          : 
# 543 "./src/main/drivers/serial_softserial.c" 3 4
                                                                            1
# 543 "./src/main/drivers/serial_softserial.c"
        ...
        timerChConfigIC(self->timerHardware, inverted ? 
# 546 "./src/main/drivers/serial_softserial.c" 3 4
                                                       1 
# 546 "./src/main/drivers/serial_softserial.c"
                                                                         : 
# 546 "./src/main/drivers/serial_softserial.c" 3 4
                                                                           0
# 546 "./src/main/drivers/serial_softserial.c"
...
# 623 "./src/main/drivers/serial_softserial.c" 3 4
_Bool 
# 623 "./src/main/drivers/serial_softserial.c"
    isSoftSerialTransmitBufferEmpty(const serialPort_t *instance)
{
...
static const struct serialPortVTable softSerialVTable = {
    ...
    .writeBuf = 
# 636 "./src/main/drivers/serial_softserial.c" 3 4
               ((void *)0)
# 636 "./src/main/drivers/serial_softserial.c"
                   ,
    .beginWrite = 
# 637 "./src/main/drivers/serial_softserial.c" 3 4
                 ((void *)0)
# 637 "./src/main/drivers/serial_softserial.c"
                     ,
    .endWrite = 
# 638 "./src/main/drivers/serial_softserial.c" 3 4
               ((void *)0)

# 639 "./src/main/drivers/serial_softserial.c"
};
