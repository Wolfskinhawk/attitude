# 1 "./src/main/drivers/serial_escserial.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/serial_escserial.c"
# 18 "./src/main/drivers/serial_escserial.c"
# 1 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\lib\\gcc\\arm-none-eabi\\7.2.1\\include\\stdbool.h" 1 3 4
# 19 "./src/main/drivers/serial_escserial.c" 2
...
# 20 "./src/main/drivers/serial_escserial.c" 2
...
# 21 "./src/main/drivers/serial_escserial.c" 2
...
# 23 "./src/main/drivers/serial_escserial.c" 2
...
# 27 "./src/main/drivers/serial_escserial.c" 2
...
# 28 "./src/main/drivers/serial_escserial.c" 2
...
# 32 "./src/main/drivers/serial_escserial.c" 2
# 1 "./src/main/pg/pg_ids.h" 1
# 18 "./src/main/pg/pg_ids.h"
       
# 33 "./src/main/drivers/serial_escserial.c" 2
...
# 35 "./src/main/drivers/serial_escserial.c" 2
...
# 64 "./src/main/drivers/light_led.h"
                         state);
# 36 "./src/main/drivers/serial_escserial.c" 2
# 1 "./src/main/drivers/nvic.h" 1

       
# 37 "./src/main/drivers/serial_escserial.c" 2
...
# 38 "./src/main/drivers/serial_escserial.c" 2
...
# 39 "./src/main/drivers/serial_escserial.c" 2
...
# 40 "./src/main/drivers/serial_escserial.c" 2
...
# 41 "./src/main/drivers/serial_escserial.c" 2
...
# 44 "./src/main/drivers/serial_escserial.c" 2
...
# 46 "./src/main/drivers/serial_escserial.c" 2
...
static serialPort_t *escPort = 
# 58 "./src/main/drivers/serial_escserial.c" 3 4
                              ((void *)0)
# 58 "./src/main/drivers/serial_escserial.c"
                                  ;
static serialPort_t *passPort = 
# 59 "./src/main/drivers/serial_escserial.c" 3 4
                               ((void *)0)
# 59 "./src/main/drivers/serial_escserial.c"
                                   ;
...
typedef struct escSerial_s {
    ...
    volatile uint8_t txBuffer[1024];
...
escOutputs_t escOutputs[8];

extern timerHardware_t* serialTimerHardware;

const struct serialPortVTable escSerialVTable[];

escSerial_t escSerialPorts[1];

extern const escSerialConfig_t pgResetTemplate_escSerialConfig; escSerialConfig_t escSerialConfig_System; escSerialConfig_t escSerialConfig_Copy; extern const pgRegistry_t escSerialConfig_Registry; const pgRegistry_t escSerialConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 521 | (0 << 12), .size = sizeof(escSerialConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&escSerialConfig_System, .copy = (uint8_t*)&escSerialConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_escSerialConfig}, };





const escSerialConfig_t pgResetTemplate_escSerialConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .ioTag = ((ioTag_t)((((1) + 1) << 4) | (7))), }
...
# 143 "./src/main/drivers/serial_escserial.c"
...
static void escSerialInputPortConfig(const timerHardware_t *timerHardwarePtr)
{
    ...
    escSerialGPIOConfig(timerHardwarePtr, ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_UP) << 5)));
...
static 
# 202 "./src/main/drivers/serial_escserial.c" 3 4
      _Bool 
# 202 "./src/main/drivers/serial_escserial.c"
           isTimerPeriodTooLarge(uint32_t timerPeriod)
{
    return timerPeriod > 0xFFFF;
}

static 
# 207 "./src/main/drivers/serial_escserial.c" 3 4
      _Bool 
# 207 "./src/main/drivers/serial_escserial.c"
           isEscSerialTransmitBufferEmpty(const serialPort_t *instance)
{
...
{
    escSerialGPIOConfig(timerHardwarePtr, ((GPIO_Mode_OUT) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
...
static void processTxStateBL(escSerial_t *escSerial)
{
    ...
    if (!escSerial->isTransmittingData) {
        ...
        escSerial->internalTxBuffer = (1 << (10 - 1)) | (byteToSend << 1);
        escSerial->bitsLeftToTransmit = 10;
        escSerial->isTransmittingData = 
# 242 "./src/main/drivers/serial_escserial.c" 3 4
                                       1
# 242 "./src/main/drivers/serial_escserial.c"
                                           ;
    ...
    escSerial->isTransmittingData = 
# 261 "./src/main/drivers/serial_escserial.c" 3 4
                                   0
# 261 "./src/main/drivers/serial_escserial.c"
                                        ;
    if (isEscSerialTransmitBufferEmpty((serialPort_t *)escSerial)) {
        if (escSerial->mode==PROTOCOL_BLHELI || escSerial->mode==PROTOCOL_CASTLE)
        {
...
static void extractAndStoreRxByteBL(escSerial_t *escSerial)
{
    ...
    uint8_t haveStartBit = (escSerial->internalRxBuffer & (1 << (10 - 1))) == 0;
    uint8_t haveStopBit = (escSerial->internalRxBuffer & (1 << 0)) == 1;
...
static void prepareForNextRxByteBL(escSerial_t *escSerial)
{
    ...
    escSerial->isSearchingForStartBit = 
# 298 "./src/main/drivers/serial_escserial.c" 3 4
                                       1
# 298 "./src/main/drivers/serial_escserial.c"
                                           ;
    if (escSerial->rxEdge == LEADING) {
        escSerial->rxEdge = TRAILING;
        timerChConfigIC(
            escSerial->rxTimerHardware,
            (escSerial->port.options & SERIAL_INVERTED) ? 
# 303 "./src/main/drivers/serial_escserial.c" 3 4
                                                         1 
# 303 "./src/main/drivers/serial_escserial.c"
                                                                           : 
# 303 "./src/main/drivers/serial_escserial.c" 3 4
                                                                             0
# 303 "./src/main/drivers/serial_escserial.c"
...
static void processRxStateBL(escSerial_t *escSerial)
{
    ...
    if (escSerial->rxBitIndex == 10 - 1) {
        applyChangedBitsBL(escSerial);
        return;
    }

    if (escSerial->rxBitIndex == 10) {

        if (escSerial->rxEdge == TRAILING) {
            escSerial->internalRxBuffer |= (1 << 0);
        }
...
{
    (void)(capture);
    escSerial_t *escSerial = ( __extension__ ({ const typeof( ((escSerial_t *)0)->timerCb ) *__mptr = (cbRec); (escSerial_t *)( (char *)__mptr - 
# 345 "./src/main/drivers/serial_escserial.c" 3 4
                            __builtin_offsetof (
# 345 "./src/main/drivers/serial_escserial.c"
                            escSerial_t
# 345 "./src/main/drivers/serial_escserial.c" 3 4
                            , 
# 345 "./src/main/drivers/serial_escserial.c"
...
static void serialTimerTxConfigBL(const timerHardware_t *timerHardwarePtr, uint8_t reference, uint32_t baud)
{
    ...
    timerChConfigCallbacks(timerHardwarePtr, &escSerialPorts[reference].timerCb, 
# 370 "./src/main/drivers/serial_escserial.c" 3 4
                                                                                ((void *)0)
# 370 "./src/main/drivers/serial_escserial.c"
                                                                                    );
}
...
static void onSerialRxPinChangeBL(timerCCHandlerRec_t *cbRec, captureCompare_t capture)
{
    ...
    escSerial_t *escSerial = ( __extension__ ({ const typeof( ((escSerial_t *)0)->edgeCb ) *__mptr = (cbRec); (escSerial_t *)( (char *)__mptr - 
# 377 "./src/main/drivers/serial_escserial.c" 3 4
                            __builtin_offsetof (
# 377 "./src/main/drivers/serial_escserial.c"
                            escSerial_t
# 377 "./src/main/drivers/serial_escserial.c" 3 4
                            , 
# 377 "./src/main/drivers/serial_escserial.c"
...
# 378 "./src/main/drivers/serial_escserial.c" 3 4
   _Bool 
# 378 "./src/main/drivers/serial_escserial.c"
        inverted = escSerial->port.options & SERIAL_INVERTED;
    ...
    if (escSerial->isSearchingForStartBit) {
        ...
        timerChConfigIC(escSerial->rxTimerHardware, inverted ? 
# 397 "./src/main/drivers/serial_escserial.c" 3 4
                                                              0 
# 397 "./src/main/drivers/serial_escserial.c"
                                                                                 : 
# 397 "./src/main/drivers/serial_escserial.c" 3 4
                                                                                   1
# 397 "./src/main/drivers/serial_escserial.c"
        ...
        escSerial->isSearchingForStartBit = 
# 403 "./src/main/drivers/serial_escserial.c" 3 4
                                           0
# 403 "./src/main/drivers/serial_escserial.c"
                                                ;
        return;
    }
    ...
    if (escSerial->rxEdge == TRAILING) {
        escSerial->rxEdge = LEADING;
        timerChConfigIC(escSerial->rxTimerHardware, inverted ? 
# 415 "./src/main/drivers/serial_escserial.c" 3 4
                                                              0 
# 415 "./src/main/drivers/serial_escserial.c"
                                                                                 : 
# 415 "./src/main/drivers/serial_escserial.c" 3 4
                                                                                   1
# 415 "./src/main/drivers/serial_escserial.c"
        ...
        escSerial->rxEdge = TRAILING;
        timerChConfigIC(escSerial->rxTimerHardware, inverted ? 
# 418 "./src/main/drivers/serial_escserial.c" 3 4
                                                              1 
# 418 "./src/main/drivers/serial_escserial.c"
                                                                                : 
# 418 "./src/main/drivers/serial_escserial.c" 3 4
                                                                                  0
# 418 "./src/main/drivers/serial_escserial.c"
...
static void serialTimerRxConfigBL(const timerHardware_t *timerHardwarePtr, uint8_t reference, portOptions_e options)
{
    ...
    timerChConfigIC(timerHardwarePtr, (options & SERIAL_INVERTED) ? 
# 427 "./src/main/drivers/serial_escserial.c" 3 4
                                                                   1 
# 427 "./src/main/drivers/serial_escserial.c"
                                                                                     : 
# 427 "./src/main/drivers/serial_escserial.c" 3 4
                                                                                       0
# 427 "./src/main/drivers/serial_escserial.c"
    ...
    timerChConfigCallbacks(timerHardwarePtr, &escSerialPorts[reference].edgeCb, 
# 429 "./src/main/drivers/serial_escserial.c" 3 4
                                                                               ((void *)0)
# 429 "./src/main/drivers/serial_escserial.c"
                                                                                   );
}
...
reload:
        ...
        escSerial->isTransmittingData = 
# 475 "./src/main/drivers/serial_escserial.c" 3 4
                                       1
# 475 "./src/main/drivers/serial_escserial.c"
                                           ;
    ...
    if (isEscSerialTransmitBufferEmpty((serialPort_t *)escSerial)) {
        escSerial->isTransmittingData = 
# 521 "./src/main/drivers/serial_escserial.c" 3 4
                                       0
# 521 "./src/main/drivers/serial_escserial.c"
                                            ;
        escSerialInputPortConfig(escSerial->rxTimerHardware);
    }
}
...
static void onSerialTimerEsc(timerCCHandlerRec_t *cbRec, captureCompare_t capture)
{
    (void)(capture);
    escSerial_t *escSerial = ( __extension__ ({ const typeof( ((escSerial_t *)0)->timerCb ) *__mptr = (cbRec); (escSerial_t *)( (char *)__mptr - 
# 529 "./src/main/drivers/serial_escserial.c" 3 4
                            __builtin_offsetof (
# 529 "./src/main/drivers/serial_escserial.c"
                            escSerial_t
# 529 "./src/main/drivers/serial_escserial.c" 3 4
                            , 
# 529 "./src/main/drivers/serial_escserial.c"
...
# 538 "./src/main/drivers/serial_escserial.c" 3 4
                                                       0
# 538 "./src/main/drivers/serial_escserial.c"
                                                                         , 0);
        }
    }
...
static void escSerialTimerTxConfig(const timerHardware_t *timerHardwarePtr, uint8_t reference)
{
    ...
    TIM_DeInit(timerHardwarePtr->tim);
    timerConfigure(timerHardwarePtr, timerPeriod, ((1) * 1000000));
    timerChCCHandlerInit(&escSerialPorts[reference].timerCb, onSerialTimerEsc);
    timerChConfigCallbacks(timerHardwarePtr, &escSerialPorts[reference].timerCb, 
# 551 "./src/main/drivers/serial_escserial.c" 3 4
                                                                                ((void *)0)
# 551 "./src/main/drivers/serial_escserial.c"
                                                                                    );
}
...
static void onSerialRxPinChangeEsc(timerCCHandlerRec_t *cbRec, captureCompare_t capture)
{
    ...
    escSerial_t *escSerial = ( __extension__ ({ const typeof( ((escSerial_t *)0)->edgeCb ) *__mptr = (cbRec); (escSerial_t *)( (char *)__mptr - 
# 577 "./src/main/drivers/serial_escserial.c" 3 4
                            __builtin_offsetof (
# 577 "./src/main/drivers/serial_escserial.c"
                            escSerial_t
# 577 "./src/main/drivers/serial_escserial.c" 3 4
                            , 
# 577 "./src/main/drivers/serial_escserial.c"
...
# 577 "./src/main/drivers/serial_escserial.c"
    ...
    else
    {
        if (!escSerial->isReceivingData)
        {
            ...
            timerChConfigIC(escSerial->rxTimerHardware, 
# 616 "./src/main/drivers/serial_escserial.c" 3 4
                                                       1
# 616 "./src/main/drivers/serial_escserial.c"
                                                                        , 0);
        }
    }
    escSerial->receiveTimeout = 0;
...
static void escSerialTimerRxConfig(const timerHardware_t *timerHardwarePtr, uint8_t reference)
{
    ...
    TIM_DeInit(timerHardwarePtr->tim);
    timerConfigure(timerHardwarePtr, 0xFFFF, ((1) * 1000000));
    timerChConfigIC(timerHardwarePtr, 
# 639 "./src/main/drivers/serial_escserial.c" 3 4
                                     0
# 639 "./src/main/drivers/serial_escserial.c"
                                                       , 0);
    timerChCCHandlerInit(&escSerialPorts[reference].edgeCb, onSerialRxPinChangeEsc);
    timerChConfigCallbacks(timerHardwarePtr, &escSerialPorts[reference].edgeCb, 
# 641 "./src/main/drivers/serial_escserial.c" 3 4
                                                                               ((void *)0)
# 641 "./src/main/drivers/serial_escserial.c"
                                                                                   );
}

static void resetBuffers(escSerial_t *escSerial)
{
    escSerial->port.rxBufferSize = 1024;
    ...
    escSerial->port.txBufferSize = 1024;
    escSerial->port.txBufferTail = 0;
...
static serialPort_t *openEscSerial(escSerialPortIndex_e portIndex, serialReceiveCallbackPtr callback, uint16_t output, uint32_t baud, portOptions_e options, uint8_t mode)
{
    ...
    if (mode != PROTOCOL_KISSALL) {
        ...
        if (escSerial->rxTimerHardware->output & TIMER_OUTPUT_N_CHANNEL) {
            return 
# 665 "./src/main/drivers/serial_escserial.c" 3 4
                  ((void *)0)
# 665 "./src/main/drivers/serial_escserial.c"
                      ;
        }
    ...
    escSerial->isTransmittingData = 
# 687 "./src/main/drivers/serial_escserial.c" 3 4
                                   0
# 687 "./src/main/drivers/serial_escserial.c"
                                        ;

    escSerial->isSearchingForStartBit = 
# 689 "./src/main/drivers/serial_escserial.c" 3 4
                                       1
# 689 "./src/main/drivers/serial_escserial.c"
                                           ;
    escSerial->rxBitIndex = 0;
...
static void escSerialInputPortDeConfig(const timerHardware_t *timerHardwarePtr)
{
    timerChClearCCFlag(timerHardwarePtr);
    timerChITConfig(timerHardwarePtr,DISABLE);
    escSerialGPIOConfig(timerHardwarePtr, ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_UP) << 5)));
}
...
# 766 "./src/main/drivers/serial_escserial.c" 3 4
                                                         ((void *)0)
# 766 "./src/main/drivers/serial_escserial.c"
                                                             ,
# 766 "./src/main/drivers/serial_escserial.c" 3 4
                                                              ((void *)0)
# 766 "./src/main/drivers/serial_escserial.c"
...
# 770 "./src/main/drivers/serial_escserial.c" 3 4
                                                     ((void *)0)
# 770 "./src/main/drivers/serial_escserial.c"
                                                         ,
# 770 "./src/main/drivers/serial_escserial.c" 3 4
                                                          ((void *)0)
# 770 "./src/main/drivers/serial_escserial.c"
...
const struct serialPortVTable escSerialVTable[] = {
    {
        ...
        .writeBuf = 
# 845 "./src/main/drivers/serial_escserial.c" 3 4
                   ((void *)0)
# 845 "./src/main/drivers/serial_escserial.c"
                       ,
        .beginWrite = 
# 846 "./src/main/drivers/serial_escserial.c" 3 4
                     ((void *)0)
# 846 "./src/main/drivers/serial_escserial.c"
                         ,
        .endWrite = 
# 847 "./src/main/drivers/serial_escserial.c" 3 4
                   ((void *)0)
    
# 848 "./src/main/drivers/serial_escserial.c"
   }
};
...
static 
# 873 "./src/main/drivers/serial_escserial.c" 3 4
      _Bool 
# 873 "./src/main/drivers/serial_escserial.c"
           processExitCommand(uint8_t c)
{
    if (currentPort.c_state == IDLE) {
        if (c == '$') {
            ...
            return 
# 879 "./src/main/drivers/serial_escserial.c" 3 4
                  0
# 879 "./src/main/drivers/serial_escserial.c"
                       ;
        }
        ...
        if (currentPort.checksum == c) {
            ...
            if ((currentPort.cmdMSP == 0xF4) && (currentPort.dataSize==0))
            {
                currentPort.c_state = IDLE;
                return 
# 911 "./src/main/drivers/serial_escserial.c" 3 4
                      1
# 911 "./src/main/drivers/serial_escserial.c"
                          ;
            }
        } else {
            currentPort.c_state = IDLE;
    ...
    return 
# 917 "./src/main/drivers/serial_escserial.c" 3 4
          0
# 917 "./src/main/drivers/serial_escserial.c"
               ;
}
...
# 923 "./src/main/drivers/serial_escserial.c" 3 4
   _Bool 
# 923 "./src/main/drivers/serial_escserial.c"
        exitEsc = 
# 923 "./src/main/drivers/serial_escserial.c" 3 4
                  0
# 923 "./src/main/drivers/serial_escserial.c"
    ...
    ledSet(0, 
# 925 "./src/main/drivers/serial_escserial.c" 3 4
   0
# 925 "./src/main/drivers/serial_escserial.c"
   );
    ledSet(1, 
# 926 "./src/main/drivers/serial_escserial.c" 3 4
   0
# 926 "./src/main/drivers/serial_escserial.c"
   );
    ...
    escPort = openEscSerial(ESCSERIAL1, 
# 964 "./src/main/drivers/serial_escserial.c" 3 4
                                       ((void *)0)
# 964 "./src/main/drivers/serial_escserial.c"
                                           , motor_output, escBaudrate, 0, mode);
    ...
    while (1) {
        if (mode!=2)
        {
            if (serialRxBytesWaiting(escPort)) {
                ledSet(0, 
# 975 "./src/main/drivers/serial_escserial.c" 3 4
               1
# 975 "./src/main/drivers/serial_escserial.c"
               );
                ...
                ledSet(0, 
# 981 "./src/main/drivers/serial_escserial.c" 3 4
               0
# 981 "./src/main/drivers/serial_escserial.c"
               );
            }
        }
        if (serialRxBytesWaiting(escPassthroughPort)) {
            ledSet(1, 
# 985 "./src/main/drivers/serial_escserial.c" 3 4
           1
# 985 "./src/main/drivers/serial_escserial.c"
           );
            ...
            ledSet(1, 
# 1006 "./src/main/drivers/serial_escserial.c" 3 4
           0
# 1006 "./src/main/drivers/serial_escserial.c"
           );
        }
