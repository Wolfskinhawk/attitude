# 1 "./src/main/drivers/serial_uart_pinconfig.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/serial_uart_pinconfig.c"
# 27 "./src/main/drivers/serial_uart_pinconfig.c"
# 1 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\lib\\gcc\\arm-none-eabi\\7.2.1\\include\\stdbool.h" 1 3 4
# 28 "./src/main/drivers/serial_uart_pinconfig.c" 2
...
# 29 "./src/main/drivers/serial_uart_pinconfig.c" 2
...
# 31 "./src/main/drivers/serial_uart_pinconfig.c" 2

# 1 "./src/main/build/build_config.h" 1
# 18 "./src/main/build/build_config.h"
       
# 33 "./src/main/drivers/serial_uart_pinconfig.c" 2
...
# 35 "./src/main/drivers/serial_uart_pinconfig.c" 2
...
# 36 "./src/main/drivers/serial_uart_pinconfig.c" 2
...
# 37 "./src/main/drivers/serial_uart_pinconfig.c" 2
...
# 38 "./src/main/drivers/serial_uart_pinconfig.c" 2

uartDevice_t uartDevice[(1 + 1 + 1 + 0 + 0 + 0 + 0 + 0)];
uartDevice_t *uartDevmap[5];

void uartPinConfigure(const serialPinConfig_t *pSerialPinConfig)
{
    uartDevice_t *uartdev = uartDevice;

    for (size_t hindex = 0; hindex < (1 + 1 + 1 + 0 + 0 + 0 + 0 + 0); hindex++) {
