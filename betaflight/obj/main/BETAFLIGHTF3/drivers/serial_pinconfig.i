# 1 "./src/main/drivers/serial_pinconfig.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/serial_pinconfig.c"
# 18 "./src/main/drivers/serial_pinconfig.c"
# 1 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\lib\\gcc\\arm-none-eabi\\7.2.1\\include\\stdbool.h" 1 3 4
# 19 "./src/main/drivers/serial_pinconfig.c" 2
...
# 20 "./src/main/drivers/serial_pinconfig.c" 2
...
# 21 "./src/main/drivers/serial_pinconfig.c" 2
...
# 23 "./src/main/drivers/serial_pinconfig.c" 2

# 1 "./src/main/build/build_config.h" 1
# 18 "./src/main/build/build_config.h"
       
# 25 "./src/main/drivers/serial_pinconfig.c" 2
...
# 27 "./src/main/drivers/serial_pinconfig.c" 2
...
# 29 "./src/main/drivers/serial_pinconfig.c" 2


# 1 "./src/main/pg/pg_ids.h" 1
# 18 "./src/main/pg/pg_ids.h"
       
# 32 "./src/main/drivers/serial_pinconfig.c" 2
# 223 "./src/main/drivers/serial_pinconfig.c"
...
static const serialDefaultPin_t serialDefaultPin[] = {
    ...
    { SERIAL_PORT_USART1, ((ioTag_t)((((0) + 1) << 4) | (10))), ((ioTag_t)((((0) + 1) << 4) | (9))), 0 },


    { SERIAL_PORT_USART2, ((ioTag_t)((((0) + 1) << 4) | (3))), ((ioTag_t)((((0) + 1) << 4) | (2))), 0 },


    { SERIAL_PORT_USART3, ((ioTag_t)((((1) + 1) << 4) | (11))), ((ioTag_t)((((1) + 1) << 4) | (10))), 0 },
# 254 "./src/main/drivers/serial_pinconfig.c"
    { SERIAL_PORT_SOFTSERIAL1, ((ioTag_t)((((1) + 1) << 4) | (0))), ((ioTag_t)((((1) + 1) << 4) | (1))), 0 },


    { SERIAL_PORT_SOFTSERIAL2, 0, 0, 0 },

};

extern void pgResetFn_serialPinConfig(serialPinConfig_t *); serialPinConfig_t serialPinConfig_System; serialPinConfig_t serialPinConfig_Copy; extern const pgRegistry_t serialPinConfig_Registry; const pgRegistry_t serialPinConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 509 | (0 << 12), .size = sizeof(serialPinConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&serialPinConfig_System, .copy = (uint8_t*)&serialPinConfig_Copy, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_serialPinConfig }, };

void pgResetFn_serialPinConfig(serialPinConfig_t *serialPinConfig)
{
    for (size_t index = 0 ; index < (sizeof(serialDefaultPin) / sizeof((serialDefaultPin)[0])) ; index++) {
        const serialDefaultPin_t *defpin = &serialDefaultPin[index];
        serialPinConfig->ioTagRx[(((defpin->ident) <= SERIAL_PORT_USART8) ? (defpin->ident) : (10 + ((defpin->ident) - SERIAL_PORT_SOFTSERIAL1)))] = defpin->rxIO;
        serialPinConfig->ioTagTx[(((defpin->ident) <= SERIAL_PORT_USART8) ? (defpin->ident) : (10 + ((defpin->ident) - SERIAL_PORT_SOFTSERIAL1)))] = defpin->txIO;
        serialPinConfig->ioTagInverter[(((defpin->ident) <= SERIAL_PORT_USART8) ? (defpin->ident) : (10 + ((defpin->ident) - SERIAL_PORT_SOFTSERIAL1)))] = defpin->inverterIO;
    }
}
