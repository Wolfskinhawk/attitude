...
# 20 "./src/main/drivers/usb_io.c" 2
...
# 22 "./src/main/drivers/usb_io.c" 2
...
# 26 "./src/main/drivers/usb_io.c" 2
...
# 27 "./src/main/drivers/usb_io.c" 2
...
# 28 "./src/main/drivers/usb_io.c" 2
...
# 29 "./src/main/drivers/usb_io.c" 2
...
# 54 "./src/main/drivers/usb_io.c" 3 4
_Bool 
# 54 "./src/main/drivers/usb_io.c"
    usbCableIsInserted(void)
{
    
# 56 "./src/main/drivers/usb_io.c" 3 4
   _Bool 
# 56 "./src/main/drivers/usb_io.c"
        result = 
# 56 "./src/main/drivers/usb_io.c" 3 4
                 0
# 56 "./src/main/drivers/usb_io.c"
...
void usbGenerateDisconnectPulse(void)
{
    ...
    IO_t usbPin = IOGetByTag(((ioTag_t)((((0) + 1) << 4) | (12))));
    IOConfigGPIO(usbPin, ((GPIO_Mode_OUT) | ((0) << 2) | ((GPIO_OType_OD) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
