...
# 20 "./src/main/drivers/system.c" 2
...
# 64 "./src/main/drivers/light_led.h"
                         state);
# 26 "./src/main/drivers/system.c" 2
# 1 "./src/main/drivers/nvic.h" 1

       
# 27 "./src/main/drivers/system.c" 2
...
# 28 "./src/main/drivers/system.c" 2
...
# 30 "./src/main/drivers/system.c" 2
...
{
    for ( uint8_t __basepri_save __attribute__ ((__cleanup__ (__basepriRestoreMem), __unused__)) = __get_BASEPRI(), __ToDo = __basepriSetMemRetVal((((((0)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0)); __ToDo ; __ToDo = 0 ) {
        sysTickUptime++;
        sysTickPending = 0;
        (void)(((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL);
    }
...
uint32_t microsISR(void)
{
    ...
    for ( uint8_t __basepri_save __attribute__ ((__cleanup__ (__basepriRestoreMem), __unused__)) = __get_BASEPRI(), __ToDo = __basepriSetMemRetVal((((((0)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0)); __ToDo ; __ToDo = 0 ) {
        cycle_cnt = ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL;
...
uint32_t micros(void)
{
    ...
    if ((((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->ICSR & (0x1FFUL )) || (__get_BASEPRI())) {
        return microsISR();
    }
...
static void indicate(uint8_t count, uint16_t duration)
{
    if (count) {
        ledSet(1, 
# 167 "./src/main/drivers/system.c" 3 4
       1
# 167 "./src/main/drivers/system.c"
       );
        ledSet(0, 
# 168 "./src/main/drivers/system.c" 3 4
       0
# 168 "./src/main/drivers/system.c"
       );
        ...
        while (count--) {
            ...
            ledToggle(0);
            systemBeep(
# 173 "./src/main/drivers/system.c" 3 4
           1
# 173 "./src/main/drivers/system.c"
           );
            delay(duration);
            ...
            ledToggle(0);
            systemBeep(
# 178 "./src/main/drivers/system.c" 3 4
           0
# 178 "./src/main/drivers/system.c"
           );
            delay(duration);
        }
    }
