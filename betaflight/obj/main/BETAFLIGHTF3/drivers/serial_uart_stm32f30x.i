# 1 "./src/main/drivers/serial_uart_stm32f30x.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/serial_uart_stm32f30x.c"
# 27 "./src/main/drivers/serial_uart_stm32f30x.c"
# 1 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\lib\\gcc\\arm-none-eabi\\7.2.1\\include\\stdbool.h" 1 3 4
# 28 "./src/main/drivers/serial_uart_stm32f30x.c" 2
...
# 29 "./src/main/drivers/serial_uart_stm32f30x.c" 2
...
# 31 "./src/main/drivers/serial_uart_stm32f30x.c" 2
...
# 33 "./src/main/drivers/serial_uart_stm32f30x.c" 2
...
# 34 "./src/main/drivers/serial_uart_stm32f30x.c" 2
# 1 "./src/main/drivers/nvic.h" 1

       
# 35 "./src/main/drivers/serial_uart_stm32f30x.c" 2
...
# 36 "./src/main/drivers/serial_uart_stm32f30x.c" 2
...
# 37 "./src/main/drivers/serial_uart_stm32f30x.c" 2
...
# 39 "./src/main/drivers/serial_uart_stm32f30x.c" 2
...
# 40 "./src/main/drivers/serial_uart_stm32f30x.c" 2
# 1 "./src/main/drivers/serial_uart_impl.h" 1
# 18 "./src/main/drivers/serial_uart_impl.h"
       
# 114 "./src/main/drivers/serial_uart_impl.h"
...
# 41 "./src/main/drivers/serial_uart_stm32f30x.c" 2
# 83 "./src/main/drivers/serial_uart_stm32f30x.c"
const uartHardware_t uartHardware[(1 + 1 + 1 + 0 + 0 + 0 + 0 + 0)] = {

    {
        .device = UARTDEV_1,
        .reg = ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00003800)),
        .rxDMAChannel = 0,
        .txDMAChannel = 0,
        .rxPins = { ((ioTag_t)((((0) + 1) << 4) | (10))), ((ioTag_t)((((1) + 1) << 4) | (7))), 0, 0 },
        .txPins = { ((ioTag_t)((((0) + 1) << 4) | (9))), ((ioTag_t)((((1) + 1) << 4) | (6))), 0, 0 },
        .rcc = (((RCC_APB2) << 5) | (16*((((uint32_t)0x00004000))>65535L) + (8*(((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L)) >>8*(((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L)) >>8*(((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L))>255))/2+1))))),
        .af = ((uint8_t)0x07),
        .irqn = USART1_IRQn,
        .txPriority = (((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0),
        .rxPriority = (((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0),
    },
    ...
    {
        .device = UARTDEV_2,
        .reg = ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x00004400)),
        .rxDMAChannel = 0,
        .txDMAChannel = 0,
        .rxPins = { ((ioTag_t)((((0) + 1) << 4) | (15))), ((ioTag_t)((((0) + 1) << 4) | (3))), ((ioTag_t)((((1) + 1) << 4) | (4))), 0 },
        .txPins = { ((ioTag_t)((((0) + 1) << 4) | (14))), ((ioTag_t)((((0) + 1) << 4) | (2))), ((ioTag_t)((((1) + 1) << 4) | (3))), 0 },
        .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00020000))>65535L) + (8*(((((uint32_t)0x00020000))*1L >>16*((((uint32_t)0x00020000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00020000))*1L >>16*((((uint32_t)0x00020000))>65535L)) >>8*(((((uint32_t)0x00020000))*1L >>16*((((uint32_t)0x00020000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00020000))*1L >>16*((((uint32_t)0x00020000))>65535L)) >>8*(((((uint32_t)0x00020000))*1L >>16*((((uint32_t)0x00020000))>65535L))>255))/2+1))))),
        .af = ((uint8_t)0x07),
        .irqn = USART2_IRQn,
        .txPriority = (((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((0)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0),
        .rxPriority = (((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0),
    },
    ...
    {
        .device = UARTDEV_3,
        .reg = ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x00004800)),
        .rxDMAChannel = 0,
        .txDMAChannel = 0,
        .rxPins = { ((ioTag_t)((((1) + 1) << 4) | (11))), 0, 0, 0 },
        .txPins = { ((ioTag_t)((((1) + 1) << 4) | (10))), 0, 0, 0 },
        .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00040000))>65535L) + (8*(((((uint32_t)0x00040000))*1L >>16*((((uint32_t)0x00040000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00040000))*1L >>16*((((uint32_t)0x00040000))>65535L)) >>8*(((((uint32_t)0x00040000))*1L >>16*((((uint32_t)0x00040000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00040000))*1L >>16*((((uint32_t)0x00040000))>65535L)) >>8*(((((uint32_t)0x00040000))*1L >>16*((((uint32_t)0x00040000))>65535L))>255))/2+1))))),
        .af = ((uint8_t)0x07),
        .irqn = USART3_IRQn,
        .txPriority = (((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((0)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0),
        .rxPriority = (((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0),
    },
# 165 "./src/main/drivers/serial_uart_stm32f30x.c"
};
...
void serialUARTInitIO(IO_t txIO, IO_t rxIO, portMode_e mode, portOptions_e options, uint8_t af, uint8_t index)
{
    if ((options & SERIAL_BIDIR) && txIO) {
        ioConfig_t ioCfg = ((GPIO_Mode_AF) | ((GPIO_Speed_Level_3) << 2) | ((((options & SERIAL_INVERTED) || (options & SERIAL_BIDIR_PP)) ? GPIO_OType_PP : GPIO_OType_OD) << 4) | ((((options & SERIAL_INVERTED) || (options & SERIAL_BIDIR_PP)) ? GPIO_PuPd_DOWN : GPIO_PuPd_UP) << 5))


         ;

        IOInit(txIO, OWNER_SERIAL_TX, (index + 1));
        IOConfigGPIOAF(txIO, ioCfg, af);

        if (!(options & SERIAL_INVERTED))
            IOLo(txIO);
    } else {
        ioConfig_t ioCfg = ((GPIO_Mode_AF) | ((GPIO_Speed_Level_3) << 2) | ((GPIO_OType_PP) << 4) | (((options & SERIAL_INVERTED) ? GPIO_PuPd_DOWN : GPIO_PuPd_UP) << 5));
        ...
        if ((mode & MODE_RX) && rxIO) {
            IOInit(rxIO, OWNER_SERIAL_RX, (index + 1));
...
uartPort_t *serialUART(UARTDevice_e device, uint32_t baudRate, portMode_e mode, portOptions_e options)
{
    ...
    if (!uartDev) {
        return 
# 209 "./src/main/drivers/serial_uart_stm32f30x.c" 3 4
              ((void *)0)
# 209 "./src/main/drivers/serial_uart_stm32f30x.c"
                  ;
    }
    ...
    if (hardware->rxDMAChannel) {
        dmaInit(dmaGetIdentifier(hardware->rxDMAChannel), OWNER_SERIAL_RX, (device + 1));
    ...
    if (hardware->txDMAChannel) {
        ...
        dmaInit(identifier, OWNER_SERIAL_TX, (device + 1));
    ...
    if (!s->rxDMAChannel || !s->txDMAChannel) {
        ...
        NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = (((hardware->rxPriority)>>(4-(7-(((uint32_t)0x500)>>8))))>>4);
        NVIC_InitStructure.NVIC_IRQChannelSubPriority = (((hardware->rxPriority)&(0x0f>>(7-(((uint32_t)0x500)>>8))))>>4);
...
void uartIrqHandler(uartPort_t *s)
{
    ...
    if (!s->rxDMAChannel && (ISR & ((uint32_t)0x00000020))) {
    ...
    if (!s->txDMAChannel && (ISR & ((uint32_t)0x00000080))) {
        if (s->port.txBufferTail != s->port.txBufferHead) {
            ...
            USART_ITConfig(s->USARTx, ((uint32_t)0x00070107), DISABLE);
        }
    }

    if (ISR & ((uint32_t)0x00000008))
    {
        USART_ClearITPendingBit (s->USARTx, ((uint32_t)0x00030300));
    }
}
