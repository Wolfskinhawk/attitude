# 1 "./src/main/drivers/bus_spi_config.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/bus_spi_config.c"
# 18 "./src/main/drivers/bus_spi_config.c"
# 1 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\lib\\gcc\\arm-none-eabi\\7.2.1\\include\\stdbool.h" 1 3 4
# 19 "./src/main/drivers/bus_spi_config.c" 2
...
# 20 "./src/main/drivers/bus_spi_config.c" 2
...
# 22 "./src/main/drivers/bus_spi_config.c" 2
...
# 26 "./src/main/drivers/bus_spi_config.c" 2
...
# 27 "./src/main/drivers/bus_spi_config.c" 2
# 39 "./src/main/drivers/bus_spi_config.c"
void spiPreInitCs(ioTag_t iotag)
{
    IO_t io = IOGetByTag(iotag);
    if (io) {
        IOInit(io, OWNER_SPI_PREINIT, 0);
        IOConfigGPIO(io, ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_UP) << 5)));
    }
}
...
void spiPreInitCsOutPU(ioTag_t iotag)
{
    ...
    if (io) {
        IOInit(io, OWNER_SPI_PREINIT, 0);
        IOConfigGPIO(io, ((GPIO_Mode_OUT) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
        IOHi(io);
    }
}
