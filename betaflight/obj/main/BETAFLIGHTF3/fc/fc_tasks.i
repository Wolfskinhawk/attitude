...
# 26 "./src/main/io/rcdevice_cam.h" 2
...
# 91 "./src/main/fc/fc_tasks.c" 3 4
_Bool 
# 91 "./src/main/fc/fc_tasks.c"
...
# 110 "./src/main/fc/fc_tasks.c" 3 4
   _Bool 
# 110 "./src/main/fc/fc_tasks.c"
...
static void taskUpdateRxMain(timeUs_t currentTimeUs)
{
    ...
    isRXDataNew = 
# 139 "./src/main/fc/fc_tasks.c" 3 4
                 1
# 139 "./src/main/fc/fc_tasks.c"
                     ;
    ...
    updateArmingStatus();
# 160 "./src/main/fc/fc_tasks.c"
}
# 193 "./src/main/fc/fc_tasks.c"
...
# 217 "./src/main/fc/fc_tasks.c" 3 4
                               1
# 217 "./src/main/fc/fc_tasks.c"
                                   );

    const 
# 219 "./src/main/fc/fc_tasks.c" 3 4
         _Bool 
# 219 "./src/main/fc/fc_tasks.c"
...
# 247 "./src/main/fc/fc_tasks.c" 3 4
                                  1
# 247 "./src/main/fc/fc_tasks.c"
                                      );
...
# 256 "./src/main/fc/fc_tasks.c" 3 4
                           1
# 256 "./src/main/fc/fc_tasks.c"
                               );

    setTaskEnabled(TASK_DISPATCH, dispatchIsEnabled());


    setTaskEnabled(TASK_BEEPER, 
# 261 "./src/main/fc/fc_tasks.c" 3 4
                               1
# 261 "./src/main/fc/fc_tasks.c"
                                   );
# 282 "./src/main/fc/fc_tasks.c"
    ...
    setTaskEnabled(TASK_CMS, 
# 313 "./src/main/fc/fc_tasks.c" 3 4
                            1
# 313 "./src/main/fc/fc_tasks.c"
                                );
...
# 320 "./src/main/fc/fc_tasks.c" 3 4
                                1
# 320 "./src/main/fc/fc_tasks.c"
                                    );



    setTaskEnabled(TASK_CAMCTRL, 
# 324 "./src/main/fc/fc_tasks.c" 3 4
                                1
# 324 "./src/main/fc/fc_tasks.c"
                                    );
...
# 503 "./src/main/fc/fc_tasks.c"
    [TASK_OSD] = {
        .taskName = "OSD",
        .taskFunc = osdUpdate,
        .desiredPeriod = (1000000 / (60)),
        .staticPriority = TASK_PRIORITY_LOW,
    },
