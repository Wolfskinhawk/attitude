...
# 81 "./src/main/cms/cms_types.h"
typedef long (*CMSMenuFuncPtr)(void);
# 93 "./src/main/cms/cms_types.h"
...
# 1 "./src/main/drivers/buttons.h" 1
# 18 "./src/main/drivers/buttons.h"
       

void buttonsInit(void);


# 22 "./src/main/drivers/buttons.h" 3 4
_Bool 
# 22 "./src/main/drivers/buttons.h"
    buttonAPressed(void);

# 23 "./src/main/drivers/buttons.h" 3 4
_Bool 
# 23 "./src/main/drivers/buttons.h"
    buttonBPressed(void);
...
# 26 "./src/main/drivers/flash_m25p16.h" 3 4
_Bool 
# 26 "./src/main/drivers/flash_m25p16.h"
    m25p16_init(const struct flashConfig_s *flashConfig);
...
# 39 "./src/main/drivers/flash_m25p16.h" 3 4
_Bool 
# 39 "./src/main/drivers/flash_m25p16.h"
    m25p16_isReady(void);

# 40 "./src/main/drivers/flash_m25p16.h" 3 4
_Bool 
# 40 "./src/main/drivers/flash_m25p16.h"
    m25p16_waitForReady(uint32_t timeoutMillis);
...
# 35 "./src/main/drivers/serial_softserial.h" 3 4
_Bool 
# 35 "./src/main/drivers/serial_softserial.h"
    isSoftSerialTransmitBufferEmpty(const serialPort_t *s);
# 62 "./src/main/fc/fc_init.c" 2
# 1 "./src/main/drivers/serial_uart.h" 1
# 18 "./src/main/drivers/serial_uart.h"
       
# 31 "./src/main/drivers/serial_uart.h"
typedef enum {
    UARTDEV_1 = 0,
    UARTDEV_2 = 1,
    UARTDEV_3 = 2,
...
typedef struct uartPort_s {
    serialPort_t port;
# 55 "./src/main/drivers/serial_uart.h"
...
# 71 "./src/main/drivers/serial_uart.h" 3 4
   _Bool 
# 71 "./src/main/drivers/serial_uart.h"
        txDMAEmpty;
} uartPort_t;
...
# 1 "./src/main/drivers/usb_io.h" 1
# 18 "./src/main/drivers/usb_io.h"
...
# 24 "./src/main/drivers/usb_io.h" 3 4
_Bool 
# 24 "./src/main/drivers/usb_io.h"
    usbCableIsInserted(void);
# 71 "./src/main/fc/fc_init.c" 2
# 1 "./src/main/drivers/vtx_rtc6705.h" 1
# 25 "./src/main/drivers/vtx_rtc6705.h"
       
# 45 "./src/main/drivers/vtx_rtc6705.h"
...
# 75 "./src/main/fc/fc_init.c" 2
# 1 "./src/main/fc/fc_init.h" 1
# 18 "./src/main/fc/fc_init.h"
...
# 1 "./src/main/pg/flash.h" 1
# 18 "./src/main/pg/flash.h"
...
extern flashConfig_t flashConfig_System; extern flashConfig_t flashConfig_Copy; static inline const flashConfig_t* flashConfig(void) { return &flashConfig_System; } static inline flashConfig_t* flashConfigMutable(void) { return &flashConfig_System; } struct _dummy;
...
extern displayPortProfile_t displayPortProfileMax7456_System; extern displayPortProfile_t displayPortProfileMax7456_Copy; static inline const displayPortProfile_t* displayPortProfileMax7456(void) { return &displayPortProfileMax7456_System; } static inline displayPortProfile_t* displayPortProfileMax7456Mutable(void) { return &displayPortProfileMax7456_System; } struct _dummy;

struct vcdProfile_s;
displayPort_t *max7456DisplayPortInit(const struct vcdProfile_s *vcdProfile);
# 101 "./src/main/fc/fc_init.c" 2
# 1 "./src/main/io/displayport_rcdevice.h" 1
# 18 "./src/main/io/displayport_rcdevice.h"
       

struct vcdProfile_s;
displayPort_t *rcdeviceDisplayPortInit(const struct vcdProfile_s *vcdProfile);
# 102 "./src/main/fc/fc_init.c" 2
# 1 "./src/main/io/displayport_srxl.h" 1
# 18 "./src/main/io/displayport_srxl.h"
...
# 34 "./src/main/io/dashboard.h"
typedef struct dashboardConfig_s {
    I2CDevice device;
    uint8_t address;
} dashboardConfig_t;

extern dashboardConfig_t dashboardConfig_System; extern dashboardConfig_t dashboardConfig_Copy; static inline const dashboardConfig_t* dashboardConfig(void) { return &dashboardConfig_System; } static inline dashboardConfig_t* dashboardConfigMutable(void) { return &dashboardConfig_System; } struct _dummy;
...
extern displayPortProfile_t displayPortProfileMsp_System; extern displayPortProfile_t displayPortProfileMsp_Copy; static inline const displayPortProfile_t* displayPortProfileMsp(void) { return &displayPortProfileMsp_System; } static inline displayPortProfile_t* displayPortProfileMspMutable(void) { return &displayPortProfileMsp_System; } struct _dummy;
...
# 1 "./src/main/io/vtx_rtc6705.h" 1
# 18 "./src/main/io/vtx_rtc6705.h"
...
# 28 "./src/main/io/vtx_rtc6705.h" 3 4
_Bool 
# 28 "./src/main/io/vtx_rtc6705.h"
    vtxRTC6705CanUpdate(void);

# 29 "./src/main/io/vtx_rtc6705.h" 3 4
_Bool 
# 29 "./src/main/io/vtx_rtc6705.h"
    vtxRTC6705Init(void);
...
# 27 "./src/main/io/vtx_control.h" 2
...
# 119 "./src/main/fc/fc_init.c" 2
# 1 "./src/main/io/vtx_smartaudio.h" 1
# 18 "./src/main/io/vtx_smartaudio.h"
       
# 62 "./src/main/io/vtx_smartaudio.h"
...
extern 
# 93 "./src/main/io/vtx_smartaudio.h" 3 4
      _Bool 
# 93 "./src/main/io/vtx_smartaudio.h"
           saDeferred;
...
# 101 "./src/main/io/vtx_smartaudio.h" 3 4
_Bool 
# 101 "./src/main/io/vtx_smartaudio.h"
    vtxSmartAudioInit(void);
# 120 "./src/main/fc/fc_init.c" 2
...
# 131 "./src/main/fc/fc_init.c" 2
# 1 "./src/main/sensors/initialisation.h" 1
# 18 "./src/main/sensors/initialisation.h"
       


# 20 "./src/main/sensors/initialisation.h" 3 4
_Bool 
# 20 "./src/main/sensors/initialisation.h"
    sensorsAutodetect(void);
# 132 "./src/main/fc/fc_init.c" 2
...
# 151 "./src/main/fc/fc_init.c" 2
# 160 "./src/main/fc/fc_init.c"
uint8_t systemState = SYSTEM_STATE_INITIALISING;

void processLoopback(void)
{
# 173 "./src/main/fc/fc_init.c"
}
# 194 "./src/main/fc/fc_init.c"
void spiPreInit(void)
{

    spiPreInitCs(((ioTag_t)((((0) + 1) << 4) | (15))));
# 218 "./src/main/fc/fc_init.c"
    spiPreInitCsOutPU(((ioTag_t)((((0) + 1) << 4) | (1))));


    spiPreInitCs(sdcardConfig()->chipSelectTag);
# 247 "./src/main/fc/fc_init.c"
}


void init(void)
{
# 264 "./src/main/fc/fc_init.c"
    printfSupportInit();
...
# 279 "./src/main/fc/fc_init.c"
    ...
    if (strncasecmp(systemConfig()->boardIdentifier, "BFF3", sizeof("BFF3"))) {
        resetEEPROM();
    }
    ...
    ledSet(2, 
# 305 "./src/main/fc/fc_init.c" 3 4
   1
# 305 "./src/main/fc/fc_init.c"
   );


    EXTIInit();
# 339 "./src/main/fc/fc_init.c"
...
# 434 "./src/main/fc/fc_init.c"
    ...
    spiInit(SPIDEV_2);
# 484 "./src/main/fc/fc_init.c"
    cameraControlInit();
# 502 "./src/main/fc/fc_init.c"
    ...
    ledSet(1, 
# 536 "./src/main/fc/fc_init.c" 3 4
   1
# 536 "./src/main/fc/fc_init.c"
   );
    ledSet(0, 
# 537 "./src/main/fc/fc_init.c" 3 4
   0
# 537 "./src/main/fc/fc_init.c"
   );
    ledSet(2, 
# 538 "./src/main/fc/fc_init.c" 3 4
   0
# 538 "./src/main/fc/fc_init.c"
   );
    ...
    for (int i = 0; i < 10; i++) {
        ...
        ledToggle(0);
        delay(25);
        if (!(getBeeperOffMask() & (1 << (BEEPER_SYSTEM_INIT - 1)))) systemBeep(
# 544 "./src/main/fc/fc_init.c" 3 4
                                                                    1
# 544 "./src/main/fc/fc_init.c"
                                                                    );
        delay(25);
        systemBeep(
# 546 "./src/main/fc/fc_init.c" 3 4
       0
# 546 "./src/main/fc/fc_init.c"
       );
    }
    ledSet(0, 
# 548 "./src/main/fc/fc_init.c" 3 4
   0
# 548 "./src/main/fc/fc_init.c"
   );
    ledSet(1, 
# 549 "./src/main/fc/fc_init.c" 3 4
   0
# 549 "./src/main/fc/fc_init.c"
   );
...
# 572 "./src/main/fc/fc_init.c" 3 4
                                   ((void *)0)
# 572 "./src/main/fc/fc_init.c"
                                       ;
...
# 601 "./src/main/fc/fc_init.c"
    if (!osdDisplayPort)
        cmsDisplayPortRegister(displayPortMspInit());
# 614 "./src/main/fc/fc_init.c"
    cmsDisplayPortRegister(displayPortSrxlInit());
# 627 "./src/main/fc/fc_init.c"
    ledStripInit();
...
# 684 "./src/main/fc/fc_init.c" 3 4
                        0
# 684 "./src/main/fc/fc_init.c"
                             );
    ...
    vtxTrampInit();
# 718 "./src/main/fc/fc_init.c"
    timerStart();

    (stateFlags |= (SMALL_ANGLE));
# 731 "./src/main/fc/fc_init.c"
    batteryInit();
# 749 "./src/main/fc/fc_init.c"
    rcdeviceInit();
