# 1 "./src/main/fc/controlrate_profile.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/fc/controlrate_profile.c"
# 18 "./src/main/fc/controlrate_profile.c"
# 1 "d:\\gcc-arm-none-eabi-7-2017-q4-major-win32\\lib\\gcc\\arm-none-eabi\\7.2.1\\include\\stdbool.h" 1 3 4
# 19 "./src/main/fc/controlrate_profile.c" 2
...
# 20 "./src/main/fc/controlrate_profile.c" 2
...
# 21 "./src/main/fc/controlrate_profile.c" 2
...
# 23 "./src/main/fc/controlrate_profile.c" 2
...
# 25 "./src/main/fc/controlrate_profile.c" 2

# 1 "./src/main/config/config_reset.h" 1
# 18 "./src/main/config/config_reset.h"
       
# 27 "./src/main/fc/controlrate_profile.c" 2
...
# 28 "./src/main/fc/controlrate_profile.c" 2
# 1 "./src/main/pg/pg_ids.h" 1
# 18 "./src/main/pg/pg_ids.h"
       
# 29 "./src/main/fc/controlrate_profile.c" 2
...
# 31 "./src/main/fc/controlrate_profile.c" 2
...
# 32 "./src/main/fc/controlrate_profile.c" 2
...
# 33 "./src/main/fc/controlrate_profile.c" 2

controlRateConfig_t *currentControlRateProfile;

extern void pgResetFn_controlRateProfiles(controlRateConfig_t *); controlRateConfig_t controlRateProfiles_SystemArray[3]; controlRateConfig_t controlRateProfiles_CopyArray[3]; extern const pgRegistry_t controlRateProfiles_Registry; const pgRegistry_t controlRateProfiles_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 12 | (1 << 12), .size = (sizeof(controlRateConfig_t) * 3) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&controlRateProfiles_SystemArray, .copy = (uint8_t*)&controlRateProfiles_CopyArray, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_controlRateProfiles}, };

void pgResetFn_controlRateProfiles(controlRateConfig_t *controlRateConfig)
{
    for (int i = 0; i < 3; i++) {
        static const controlRateConfig_t _reset_template_56 = { .thrMid8 = 50, .thrExpo8 = 0, .dynThrPID = 10, .tpa_breakpoint = 1650, .rates_type = RATES_TYPE_BETAFLIGHT, .rcRates[FD_ROLL] = 100, .rcRates[FD_PITCH] = 100, .rcRates[FD_YAW] = 100, .rcExpo[FD_ROLL] = 0, .rcExpo[FD_PITCH] = 0, .rcExpo[FD_YAW] = 0, .rates[FD_ROLL] = 70, .rates[FD_PITCH] = 70, .rates[FD_YAW] = 70 }; memcpy((&controlRateConfig[i]), &_reset_template_56, sizeof(*(&controlRateConfig[i])));
# 56 "./src/main/fc/controlrate_profile.c"
         ;
    }
}
...
void copyControlRateProfile(const uint8_t dstControlRateProfileIndex, const uint8_t srcControlRateProfileIndex) {
    if ((dstControlRateProfileIndex < 3 -1 && srcControlRateProfileIndex < 3 -1)
