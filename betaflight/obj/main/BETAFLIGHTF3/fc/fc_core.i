...
# 34 "./src/main/fc/fc_core.c" 2

# 1 "./src/main/pg/pg_ids.h" 1
# 18 "./src/main/pg/pg_ids.h"
       
# 36 "./src/main/fc/fc_core.c" 2
...
# 22 "./src/main/drivers/light_led.h" 2
...
# 22 "./src/main/msp/msp_serial.h" 2
...
# 105 "./src/main/fc/fc_core.c"
static 
# 105 "./src/main/fc/fc_core.c" 3 4
      _Bool 
# 105 "./src/main/fc/fc_core.c"
...
# 109 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 109 "./src/main/fc/fc_core.c"
    isRXDataNew;
static int lastArmingDisabledReason = 0;

extern const throttleCorrectionConfig_t pgResetTemplate_throttleCorrectionConfig; throttleCorrectionConfig_t throttleCorrectionConfig_System; throttleCorrectionConfig_t throttleCorrectionConfig_Copy; extern const pgRegistry_t throttleCorrectionConfig_Registry; const pgRegistry_t throttleCorrectionConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 39 | (0 << 12), .size = sizeof(throttleCorrectionConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&throttleCorrectionConfig_System, .copy = (uint8_t*)&throttleCorrectionConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_throttleCorrectionConfig}, };
...
static 
# 127 "./src/main/fc/fc_core.c" 3 4
      _Bool 
# 127 "./src/main/fc/fc_core.c"
           isCalibrating(void)
{
# 137 "./src/main/fc/fc_core.c"
...
void updateArmingStatus(void)
{
    if ((armingFlags & (ARMED))) {
        ledSet(0, 
# 148 "./src/main/fc/fc_core.c" 3 4
       1
# 148 "./src/main/fc/fc_core.c"
       );
    } else {
        ...
        if (!isUsingSticksForArming()) {
            static 
# 158 "./src/main/fc/fc_core.c" 3 4
                  _Bool 
# 158 "./src/main/fc/fc_core.c"
                       hadRx = 
# 158 "./src/main/fc/fc_core.c" 3 4
                               0
# 158 "./src/main/fc/fc_core.c"
                                    ;
            const 
# 159 "./src/main/fc/fc_core.c" 3 4
                 _Bool 
# 159 "./src/main/fc/fc_core.c"
                      haveRx = rxIsReceivingSignal();

            const 
# 161 "./src/main/fc/fc_core.c" 3 4
                 _Bool 
# 161 "./src/main/fc/fc_core.c"
                      justGotRxBack = !hadRx && haveRx;
        ...
        if (!(stateFlags & (SMALL_ANGLE)) && !IS_RC_MODE_ACTIVE(BOXFLIPOVERAFTERCRASH)) {
        ...
        if (isModeActivationConditionPresent(BOXPREARM)) {
            if (IS_RC_MODE_ACTIVE(BOXPREARM) && !(armingFlags & (WAS_ARMED_WITH_PREARM))) {
...
# 214 "./src/main/fc/fc_core.c" 3 4
         _Bool 
# 214 "./src/main/fc/fc_core.c"
              ignoreGyro = armingConfig()->gyro_cal_on_first_arm
                         && !(getArmingDisableFlags() & ~(ARMING_DISABLED_ARM_SWITCH | ARMING_DISABLED_CALIBRATING));


          
# 218 "./src/main/fc/fc_core.c" 3 4
         _Bool 
# 218 "./src/main/fc/fc_core.c"
              ignoreThrottle = feature(FEATURE_3D)
...
void disarm(void)
{
    if ((armingFlags & (ARMED))) {
        ...
        systemBeep(
# 254 "./src/main/fc/fc_core.c" 3 4
       0
# 254 "./src/main/fc/fc_core.c"
       );
...
# 262 "./src/main/fc/fc_core.c" 3 4
                            1
# 262 "./src/main/fc/fc_core.c"
                                );
    }
    ...
    if (!isArmingDisabled()) {
        ...
        if (isMotorProtocolDshot() && isModeActivationConditionPresent(BOXFLIPOVERAFTERCRASH)) {
            ...
            if (!IS_RC_MODE_ACTIVE(BOXFLIPOVERAFTERCRASH)) {
                flipOverAfterCrashMode = 
# 277 "./src/main/fc/fc_core.c" 3 4
                                        0
# 277 "./src/main/fc/fc_core.c"
                                             ;
                if (!feature(FEATURE_3D)) {
                    pwmWriteDshotCommand(255, getMotorCount(), DSHOT_CMD_SPIN_DIRECTION_NORMAL);
                }
            } else {
                flipOverAfterCrashMode = 
# 282 "./src/main/fc/fc_core.c" 3 4
                                        1
# 282 "./src/main/fc/fc_core.c"
                                            ;
                if (!feature(FEATURE_3D)) {
                    pwmWriteDshotCommand(255, getMotorCount(), DSHOT_CMD_SPIN_DIRECTION_REVERSED);
                }
            }
        ...
        (armingFlags |= (ARMED));
        (armingFlags |= (WAS_EVER_ARMED));

        if (isModeActivationConditionPresent(BOXPREARM)) {
            (armingFlags |= (WAS_ARMED_WITH_PREARM));
        }
...
# 327 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 327 "./src/main/fc/fc_core.c"
...
# 328 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 328 "./src/main/fc/fc_core.c"
...
# 329 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 329 "./src/main/fc/fc_core.c"
...
# 330 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 330 "./src/main/fc/fc_core.c"
...
void handleInflightCalibrationStickPosition(void)
{
    if (AccInflightCalibrationMeasurementDone) {
        ...
        AccInflightCalibrationMeasurementDone = 
# 337 "./src/main/fc/fc_core.c" 3 4
                                               0
# 337 "./src/main/fc/fc_core.c"
                                                    ;
        AccInflightCalibrationSavetoEEProm = 
# 338 "./src/main/fc/fc_core.c" 3 4
                                            1
# 338 "./src/main/fc/fc_core.c"
                                                ;
    } else {
...
{
    if (AccInflightCalibrationArmed && (armingFlags & (ARMED)) && rcData[THROTTLE] > rxConfig()->mincheck && !IS_RC_MODE_ACTIVE(BOXARM)) {
        InflightcalibratingA = 50;
        AccInflightCalibrationArmed = 
# 353 "./src/main/fc/fc_core.c" 3 4
                                     0
# 353 "./src/main/fc/fc_core.c"
                                          ;
    }
    if (IS_RC_MODE_ACTIVE(BOXCALIB)) {
        if (!AccInflightCalibrationActive && !AccInflightCalibrationMeasurementDone)
            InflightcalibratingA = 50;
        AccInflightCalibrationActive = 
# 358 "./src/main/fc/fc_core.c" 3 4
                                      1
# 358 "./src/main/fc/fc_core.c"
                                          ;
    } else if (AccInflightCalibrationMeasurementDone && !(armingFlags & (ARMED))) {
        AccInflightCalibrationMeasurementDone = 
# 360 "./src/main/fc/fc_core.c" 3 4
                                               0
# 360 "./src/main/fc/fc_core.c"
                                                    ;
        AccInflightCalibrationSavetoEEProm = 
# 361 "./src/main/fc/fc_core.c" 3 4
                                            1
# 361 "./src/main/fc/fc_core.c"
                                                ;
    }
}
# 383 "./src/main/fc/fc_core.c"
static 
# 383 "./src/main/fc/fc_core.c" 3 4
      _Bool 
# 383 "./src/main/fc/fc_core.c"
           canUpdateVTX(void)
{
    ...
    return 
# 388 "./src/main/fc/fc_core.c" 3 4
          1
# 388 "./src/main/fc/fc_core.c"
              ;
}
...
# 395 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 395 "./src/main/fc/fc_core.c"
    processRx(timeUs_t currentTimeUs)
{
    static 
# 397 "./src/main/fc/fc_core.c" 3 4
          _Bool 
# 397 "./src/main/fc/fc_core.c"
               armedBeeperOn = 
# 397 "./src/main/fc/fc_core.c" 3 4
                               0
# 397 "./src/main/fc/fc_core.c"
                                    ;
    static 
# 398 "./src/main/fc/fc_core.c" 3 4
          _Bool 
# 398 "./src/main/fc/fc_core.c"
               airmodeIsActivated;

    if (!calculateRxChannelsAndUpdateFailsafe(currentTimeUs)) {
        return 
# 401 "./src/main/fc/fc_core.c" 3 4
              0
# 401 "./src/main/fc/fc_core.c"
                   ;
    }
    ...
    if (currentTimeUs > (1000 * 1000 * 5) && !failsafeIsMonitoring()) {
    ...
    if (isAirmodeActive() && (armingFlags & (ARMED))) {
        if (rcData[THROTTLE] >= rxConfig()->airModeActivateThreshold) {
            airmodeIsActivated = 
# 421 "./src/main/fc/fc_core.c" 3 4
                                1
# 421 "./src/main/fc/fc_core.c"
                                    ;
        }
    } else {
        airmodeIsActivated = 
# 424 "./src/main/fc/fc_core.c" 3 4
                            0
# 424 "./src/main/fc/fc_core.c"
                                 ;
    }
        ...
        if (isUsingSticksForArming()) {
            if (throttleStatus == THROTTLE_LOW) {
                if (armingConfig()->auto_disarm_delay != 0
                    ...
                    disarm();
                    armedBeeperOn = 
# 455 "./src/main/fc/fc_core.c" 3 4
                                   0
# 455 "./src/main/fc/fc_core.c"
                                        ;
                } else {

                    beeper(BEEPER_ARMED);
                    armedBeeperOn = 
# 459 "./src/main/fc/fc_core.c" 3 4
                                   1
# 459 "./src/main/fc/fc_core.c"
                                       ;
                }
            } else {
                ...
                if (armedBeeperOn) {
                    beeperSilence();
                    armedBeeperOn = 
# 470 "./src/main/fc/fc_core.c" 3 4
                                   0
# 470 "./src/main/fc/fc_core.c"
                                        ;
                }
            }
        } else {
            ...
            if (throttleStatus == THROTTLE_LOW) {
                beeper(BEEPER_ARMED);
                armedBeeperOn = 
# 477 "./src/main/fc/fc_core.c" 3 4
                               1
# 477 "./src/main/fc/fc_core.c"
                                   ;
            } else if (armedBeeperOn) {
                beeperSilence();
                armedBeeperOn = 
# 480 "./src/main/fc/fc_core.c" 3 4
                               0
# 480 "./src/main/fc/fc_core.c"
                                    ;
            }
        }
    }
...
# 505 "./src/main/fc/fc_core.c" 3 4
   _Bool 
# 505 "./src/main/fc/fc_core.c"
        canUseHorizonMode = 
# 505 "./src/main/fc/fc_core.c" 3 4
                            1
# 505 "./src/main/fc/fc_core.c"
    ...
    if ((IS_RC_MODE_ACTIVE(BOXANGLE) || failsafeIsActive()) && (sensors(SENSOR_ACC))) {
        ...
        canUseHorizonMode = 
# 509 "./src/main/fc/fc_core.c" 3 4
                           0
# 509 "./src/main/fc/fc_core.c"
                                ;
    ...
    if ((flightModeFlags & (ANGLE_MODE)) || (flightModeFlags & (HORIZON_MODE))) {
        ledSet(1, 
# 530 "./src/main/fc/fc_core.c" 3 4
       1
# 530 "./src/main/fc/fc_core.c"
       );
    } else {
        ledSet(1, 
# 532 "./src/main/fc/fc_core.c" 3 4
       0
# 532 "./src/main/fc/fc_core.c"
       );
    }
...
# 572 "./src/main/fc/fc_core.c"
    if (IS_RC_MODE_ACTIVE(BOXPASSTHRU)) {
        enableFlightMode(PASSTHRU_MODE);
    } else {
        disableFlightMode(PASSTHRU_MODE);
    }
    ...
    if (feature(FEATURE_TELEMETRY)) {
        if ((!telemetryConfig()->telemetry_switch && (armingFlags & (ARMED))) ||
    ...
    return 
# 604 "./src/main/fc/fc_core.c" 3 4
          1
# 604 "./src/main/fc/fc_core.c"
              ;
}
...
# 646 "./src/main/fc/fc_core.c"
    ...
    if (throttleCorrectionConfig()->throttle_correction_value && ((flightModeFlags & (ANGLE_MODE)) || (flightModeFlags & (HORIZON_MODE)))) {
        rcCommand[THROTTLE] += calculateThrottleAngleCorrection(throttleCorrectionConfig()->throttle_correction_value);
    }

    processRcCommand();
# 673 "./src/main/fc/fc_core.c"
    afatfs_poll();
...
# 741 "./src/main/fc/fc_core.c"
    gyroUpdate(currentTimeUs);
    {if (debugMode == (DEBUG_PIDLOOP)) {debug[(0)] = (micros() - currentTimeUs);}};
...
# 760 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 760 "./src/main/fc/fc_core.c"
    isFlipOverAfterCrashMode(void)
{
