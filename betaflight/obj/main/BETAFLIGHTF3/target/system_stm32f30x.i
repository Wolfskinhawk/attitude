# 1 "./src/main/target/system_stm32f30x.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/target/system_stm32f30x.c"
# 102 "./src/main/target/system_stm32f30x.c"
...
# 103 "./src/main/target/system_stm32f30x.c" 2

uint32_t hse_value = 8000000;
# 130 "./src/main/target/system_stm32f30x.c"
  uint32_t SystemCoreClock = 72000000;

  volatile const uint8_t AHBPrescTable[16] = {0, 0, 0, 0, 0, 0, 0, 0, 1, 2, 3, 4, 6, 7, 8, 9};
# 142 "./src/main/target/system_stm32f30x.c"
void SetSysClock(void);
# 159 "./src/main/target/system_stm32f30x.c"
void SystemInit(void)
{
  ...
  ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFGR &= 0xF87FC00C;
  ...
  ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFGR3 &= (uint32_t)0xFF00FCCC;


  ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CIR = 0x00000000;
# 198 "./src/main/target/system_stm32f30x.c"
  ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->VTOR = ((uint32_t)0x08000000) | 0x0;

}
# 238 "./src/main/target/system_stm32f30x.c"
  ...
  switch (tmp)
  {
    ...
    case 0x08:
      ...
      else
      {
        ...
        SystemCoreClock = (8000000 / prediv1factor) * pllmull;
      }
      break;
    default:
      SystemCoreClock = ((uint32_t)8000000);
...
# 290 "./src/main/target/system_stm32f30x.c"
void SetSysClock(void)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    ((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00002000))->ACR = ((uint8_t)0x10) | (uint32_t)((uint8_t)0x02);
     ...
     ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFGR |= (uint32_t)((uint32_t)0x00000400);
    ...
    if (8000000 == 12000000) {
        ...
        ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFGR |= (uint32_t)(((uint32_t)0x00010000) | ((uint32_t)0x00000000) | ((uint32_t)0x001C0000));
    }
