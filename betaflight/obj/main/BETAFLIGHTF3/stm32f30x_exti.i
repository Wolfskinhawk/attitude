# 1 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_exti.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_exti.c"
# 81 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_exti.c"
# 1 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/inc/stm32f30x_exti.h" 1
# 38 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/inc/stm32f30x_exti.h"
...
# 39 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/inc/stm32f30x_exti.h" 2
...
# 82 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_exti.c" 2
# 124 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_exti.c"
void EXTI_DeInit(void)
{
  ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000400))->IMR = 0x1F800000;
  ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000400))->EMR = 0x00000000;
  ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000400))->RTSR = 0x00000000;
  ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000400))->FTSR = 0x00000000;
  ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000400))->SWIER = 0x00000000;
  ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000400))->PR = 0xE07FFFFF;
  ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000400))->IMR2 = 0x0000000C;
  ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000400))->EMR2 = 0x00000000;
  ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000400))->RTSR2 = 0x00000000;
  ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000400))->FTSR2 = 0x00000000;
  ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000400))->SWIER2 = 0x00000000;
  ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000400))->PR2 = 0x00000003;
}
# 154 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_exti.c"
void EXTI_Init(EXTI_InitTypeDef* EXTI_InitStruct)
{
  uint32_t tmp = 0;
  ...
  tmp = (uint32_t)((((uint32_t)0x40000000) + 0x00010000) + 0x00000400);

  if (EXTI_InitStruct->EXTI_LineCmd != DISABLE)
  {

    *(volatile uint32_t *) (((uint32_t) &(((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000400))->IMR)) + ((EXTI_InitStruct->EXTI_Line) >> 5 ) * 0x20) &= ~(uint32_t)(1 << (EXTI_InitStruct->EXTI_Line & 0x1F));
    *(volatile uint32_t *) (((uint32_t) &(((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000400))->EMR)) + ((EXTI_InitStruct->EXTI_Line) >> 5 ) * 0x20) &= ~(uint32_t)(1 << (EXTI_InitStruct->EXTI_Line & 0x1F));

    tmp += EXTI_InitStruct->EXTI_Mode + (((EXTI_InitStruct->EXTI_Line) >> 5 ) * 0x20);

    *(volatile uint32_t *) tmp |= (uint32_t)(1 << (EXTI_InitStruct->EXTI_Line & 0x1F));

    tmp = (uint32_t)((((uint32_t)0x40000000) + 0x00010000) + 0x00000400);


    *(volatile uint32_t *) (((uint32_t) &(((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000400))->RTSR)) + ((EXTI_InitStruct->EXTI_Line) >> 5 ) * 0x20) &= ~(uint32_t)(1 << (EXTI_InitStruct->EXTI_Line & 0x1F));
    *(volatile uint32_t *) (((uint32_t) &(((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000400))->FTSR)) + ((EXTI_InitStruct->EXTI_Line) >> 5 ) * 0x20) &= ~(uint32_t)(1 << (EXTI_InitStruct->EXTI_Line & 0x1F));
...
# 228 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_exti.c"
void EXTI_GenerateSWInterrupt(uint32_t EXTI_Line)
{

  ((void)0);

  *(volatile uint32_t *) (((uint32_t) &(((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000400))->SWIER)) + ((EXTI_Line) >> 5 ) * 0x20) |= (uint32_t)(1 << (EXTI_Line & 0x1F));

}
# 262 "./lib/main/STM32F3/Drivers/STM32F30x_StdPeriph_Driver/src/stm32f30x_exti.c"
FlagStatus EXTI_GetFlagStatus(uint32_t EXTI_Line)
{
  ...
  if ((*(volatile uint32_t *) (((uint32_t) &(((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000400))->PR)) + ((EXTI_Line) >> 5 ) * 0x20)& (uint32_t)(1 << (EXTI_Line & 0x1F))) != (uint32_t)RESET)
  {
    bitstatus = SET;
  }
  else
...
void EXTI_ClearFlag(uint32_t EXTI_Line)
{
  ...
  *(volatile uint32_t *) (((uint32_t) &(((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000400))->PR)) + ((EXTI_Line) >> 5 ) * 0x20) = (1 << (EXTI_Line & 0x1F));
}
